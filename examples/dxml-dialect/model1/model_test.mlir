...
group_count = #dxgml.constant_value<[1]> : !dxgml.tensor<1x!dxgml.int64>, 
dilations = #dxgml.constant_value<[1, 1]> : !dxgml.tensor<2x!dxgml.int64>,
start_padding = #dxgml.constant_value<[1, 1]> : !dxgml.tensor<2x!dxgml.int64>, 
end_padding = #dxgml.constant_value<[1, 1]> : !dxgml.tensor<2x!dxgml.int64>, 
strides = #dxgml.constant_value<[2, 2]> : !dxgml.tensor<2x!dxgml.int64>
...
start_padding = #dxgml.constant_value<[1, 1]> : !dxgml.tensor<2x!dxgml.int64>, 
end_padding = #dxgml.constant_value<[1, 1]> : !dxgml.tensor<2x!dxgml.int64>, 
strides = #dxgml.constant_value<[1, 1]> : !dxgml.tensor<2x!dxgml.int64>
...
%12 = dxgml_op.convolution(%11, %_RDB3.conv1.weight, %_RDB3.conv1.bias) {
group_count = #dxgml.constant_value<[1]> : !dxgml.tensor<1x!dxgml.int64>, 
dilations = #dxgml.constant_value<[1, 1]> : !dxgml.tensor<2x!dxgml.int64>,
start_padding = #dxgml.constant_value<[1, 1]> : !dxgml.tensor<2x!dxgml.int64>, 
end_padding = #dxgml.constant_value<[1, 1]> : !dxgml.tensor<2x!dxgml.int64>, 
...
%14 = dxgml_op.add(%13, %8) : (!dxgml.tensor<1x32x1080x1920x!dxgml.float16>, !dxgml.tensor<1x32x1080x1920x!dxgml.float16>) -> !dxgml.tensor<1x32x1080x1920x!dxgml.float16>
%15 = dxgml_op.convolution(%14, %_RDB3.conv3.weight, %_RDB3.conv3.bias) {
group_count = #dxgml.constant_value<[1]> : !dxgml.tensor<1x!dxgml.int64>, 
dilations = #dxgml.constant_value<[1, 1]> : !dxgml.tensor<2x!dxgml.int64>,
start_padding = #dxgml.constant_value<[1, 1]> : !dxgml.tensor<2x!dxgml.int64>, 
end_padding = #dxgml.constant_value<[1, 1]> : !dxgml.tensor<2x!dxgml.int64>, 
...
%16 = dxgml_op.add(%15, %11) : (!dxgml.tensor<1x32x1080x1920x!dxgml.float16>, !dxgml.tensor<1x32x1080x1920x!dxgml.float16>) -> !dxgml.tensor<1x32x1080x1920x!dxgml.float16>
%17 = dxgml_op.convolution(%16, %_conv_post.weight, %_conv_post.bias) {
group_count = #dxgml.constant_value<[1]> : !dxgml.tensor<1x!dxgml.int64>, 
dilations = #dxgml.constant_value<[1, 1]> : !dxgml.tensor<2x!dxgml.int64>,
start_padding = #dxgml.constant_value<[1, 1]> : !dxgml.tensor<2x!dxgml.int64>, 
end_padding = #dxgml.constant_value<[1, 1]> : !dxgml.tensor<2x!dxgml.int64>, 
...
%18 = dxgml_op.relu(%17) : (!dxgml.tensor<1x96x1080x1920x!dxgml.float16>) -> !dxgml.tensor<1x96x1080x1920x!dxgml.float16>
%19 = dxgml_op.convolution(%18, %_conv_final.weight, %_conv_final.bias) {
group_count = #dxgml.constant_value<[1]> : !dxgml.tensor<1x!dxgml.int64>, 
dilations = #dxgml.constant_value<[1, 1]> : !dxgml.tensor<2x!dxgml.int64>,
start_padding = #dxgml.constant_value<[0, 0]> : !dxgml.tensor<2x!dxgml.int64>, 
end_padding = #dxgml.constant_value<[0, 0]> : !dxgml.tensor<2x!dxgml.int64>, 
strides = #dxgml.constant_value<[1, 1]> : !dxgml.tensor<2x!dxgml.int64>
...
%20 = dxgml_op.depth_to_space(%19) {
block_size = #dxgml.constant_value<[2]> : !dxgml.tensor<1x!dxgml.int64>,
