...
//
// The body is 40 bytes: the `global_prefetch_b8 v0, s[0:1] scope:SCOPE_SE;
// v_nop` unclaused-VMEM workaround prefix (ROCm/llvm-project#3483), then an
// s_get_pc / s_add64 / s_set_pc PC-relative redirect. The scratch pair is
// spelled s[100:101]; the runtime rewrites the six SGPR register-field bytes
