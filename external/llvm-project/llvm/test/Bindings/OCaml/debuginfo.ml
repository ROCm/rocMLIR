...
let test_types dibuilder file_di m_di =
  ...
  (* CHECK: [[STRUCTPTR_PTR:<0x[0-9a-f]*>]] = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: [[STRUCT_PTR]], size: 192, dwarfAddressSpace: 0, memorySpace: DW_MSPACE_LLVM_constant)
   *)
  insist
