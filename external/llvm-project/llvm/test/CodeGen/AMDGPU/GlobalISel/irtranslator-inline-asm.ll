...
define i32 @asm_vgpr_early_clobber() {
  ...
  ; CHECK: bb.1 (%ir-block.0):
  ; CHECK-NEXT:   INLINEASM &"v_mov_b32 $0, 7; v_mov_b32 $1, 7", 1 /* sideeffect attdialect */, 1769483 /* regdef-ec:VGPR_32 */, def early-clobber %6, 1769483 /* regdef-ec:VGPR_32 */, def early-clobber %7, !0
  ; CHECK-NEXT:   [[COPY:%[0-9]+]]:_(s32) = COPY %6
  ; CHECK-NEXT:   [[COPY1:%[0-9]+]]:_(s32) = COPY %7
...
define i32 @test_single_vgpr_output() nounwind {
  ...
  ; CHECK: bb.1.entry:
  ; CHECK-NEXT:   INLINEASM &"v_mov_b32 $0, 7", 0 /* attdialect */, 1769482 /* regdef:VGPR_32 */, def %6
  ; CHECK-NEXT:   [[COPY:%[0-9]+]]:_(s32) = COPY %6
  ; CHECK-NEXT:   $vgpr0 = COPY [[COPY]](s32)
  ; CHECK-NEXT:   SI_RETURN implicit $vgpr0
entry:
...
define i32 @test_single_sgpr_output_s32() nounwind {
  ...
  ; CHECK: bb.1.entry:
  ; CHECK-NEXT:   INLINEASM &"s_mov_b32 $0, 7", 0 /* attdialect */, 1900554 /* regdef:SReg_32 */, def %6
  ; CHECK-NEXT:   [[COPY:%[0-9]+]]:_(s32) = COPY %6
  ; CHECK-NEXT:   $vgpr0 = COPY [[COPY]](s32)
  ; CHECK-NEXT:   SI_RETURN implicit $vgpr0
entry:
...
define float @test_multiple_register_outputs_same() #0 {
  ...
  ; CHECK: bb.1 (%ir-block.0):
  ; CHECK-NEXT:   INLINEASM &"v_mov_b32 $0, 0; v_mov_b32 $1, 1", 0 /* attdialect */, 1769482 /* regdef:VGPR_32 */, def %6, 1769482 /* regdef:VGPR_32 */, def %7
  ; CHECK-NEXT:   [[COPY:%[0-9]+]]:_(s32) = COPY %6
  ; CHECK-NEXT:   [[COPY1:%[0-9]+]]:_(s32) = COPY %7
...
define double @test_multiple_register_outputs_mixed() #0 {
  ...
  ; CHECK: bb.1 (%ir-block.0):
  ; CHECK-NEXT:   INLINEASM &"v_mov_b32 $0, 0; v_add_f64 $1, 0, 0", 0 /* attdialect */, 1769482 /* regdef:VGPR_32 */, def %6, 3080202 /* regdef:VReg_64 */, def %7
  ; CHECK-NEXT:   [[COPY:%[0-9]+]]:_(s32) = COPY %6
  ; CHECK-NEXT:   [[COPY1:%[0-9]+]]:_(s64) = COPY %7
...
define float @test_input_vgpr(i32 %src) nounwind {
  ...
  ; CHECK-NEXT:   INLINEASM &"v_add_f32 $0, 1.0, $1", 0 /* attdialect */, 1769482 /* regdef:VGPR_32 */, def %7, 1769481 /* reguse:VGPR_32 */, [[COPY1]]
  ; CHECK-NEXT:   [[COPY2:%[0-9]+]]:_(s32) = COPY %7
...
define i32 @test_memory_constraint(ptr addrspace(3) %a) nounwind {
  ...
  ; CHECK-NEXT:   INLINEASM &"ds_read_b32 $0, $1", 8 /* mayload attdialect */, 1769482 /* regdef:VGPR_32 */, def %7, 262158 /* mem:m */, [[COPY]](p3)
  ; CHECK-NEXT:   [[COPY1:%[0-9]+]]:_(s32) = COPY %7
...
define i32 @test_vgpr_matching_constraint(i32 %a) nounwind {
  ...
  ; CHECK-NEXT:   INLINEASM &";", 1 /* sideeffect attdialect */, 1769482 /* regdef:VGPR_32 */, def %9, 2147483657 /* reguse tiedto:$0 */, [[COPY1]](tied-def 3)
...
define i32 @test_sgpr_matching_constraint() nounwind {
  ...
  ; CHECK-NEXT:   INLINEASM &"s_mov_b32 $0, 7", 0 /* attdialect */, 1900554 /* regdef:SReg_32 */, def %6
  ; CHECK-NEXT:   [[COPY:%[0-9]+]]:_(s32) = COPY %6
  ; CHECK-NEXT:   INLINEASM &"s_mov_b32 $0, 8", 0 /* attdialect */, 1900554 /* regdef:SReg_32 */, def %8
  ; CHECK-NEXT:   [[COPY1:%[0-9]+]]:_(s32) = COPY %8
  ; CHECK-NEXT:   [[COPY2:%[0-9]+]]:sreg_32 = COPY [[COPY]](s32)
  ; CHECK-NEXT:   [[COPY3:%[0-9]+]]:sreg_32 = COPY [[COPY1]](s32)
  ; CHECK-NEXT:   INLINEASM &"s_add_u32 $0, $1, $2", 0 /* attdialect */, 1900554 /* regdef:SReg_32 */, def %10, 1900553 /* reguse:SReg_32 */, [[COPY2]], 2147483657 /* reguse tiedto:$0 */, [[COPY3]](tied-def 3)
  ; CHECK-NEXT:   [[COPY4:%[0-9]+]]:_(s32) = COPY %10
...
define void @test_many_matching_constraints(i32 %a, i32 %b, i32 %c) nounwind {
  ...
  ; CHECK-NEXT:   INLINEASM &"; ", 1 /* sideeffect attdialect */, 1769482 /* regdef:VGPR_32 */, def %9, 1769482 /* regdef:VGPR_32 */, def %10, 1769482 /* regdef:VGPR_32 */, def %11, 2147483657 /* reguse tiedto:$0 */, [[COPY3]](tied-def 3), 2147614729 /* reguse tiedto:$2 */, [[COPY4]](tied-def 7), 2147549193 /* reguse tiedto:$1 */, [[COPY5]](tied-def 5)
  ; CHECK-NEXT:   [[COPY6:%[0-9]+]]:_(s32) = COPY %9
  ; CHECK-NEXT:   [[COPY7:%[0-9]+]]:_(s32) = COPY %10
  ; CHECK-NEXT:   [[COPY8:%[0-9]+]]:_(s32) = COPY %11
...
define i32 @test_sgpr_to_vgpr_move_matching_constraint() nounwind {
  ...
  ; CHECK-NEXT:   [[COPY:%[0-9]+]]:_(s32) = COPY %6
  ; CHECK-NEXT:   [[COPY1:%[0-9]+]]:vgpr_32 = COPY [[COPY]](s32)
  ; CHECK-NEXT:   INLINEASM &"v_mov_b32 $0, $1", 0 /* attdialect */, 1769482 /* regdef:VGPR_32 */, def %8, 2147483657 /* reguse tiedto:$0 */, [[COPY1]](tied-def 3)
