...
; GFX11-NEXT:    s_load_b32 s22, s[6:7], 0x24
...
; GFX11-NEXT:    s_load_b32 s1, s[6:7], 0x54
; GFX11-NEXT:    s_bitcmp1_b32 s19, 0
; GFX11-NEXT:    s_cselect_b32 s0, -1, 0
; GFX11-NEXT:    s_and_b32 s8, s19, 1
; GFX11-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX11-NEXT:    s_waitcnt lgkmcnt(0)
; GFX11-NEXT:    s_mul_hi_u32 s1, s25, s24
; GFX11-NEXT:    s_mul_i32 s8, s25, s24
; GFX11-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX11-NEXT:    v_alignbit_b32 v0, s1, s8, 1
; GFX11-NEXT:    v_readfirstlane_b32 s1, v0
; GFX11-NEXT:    v_mov_b32_e32 v0, 0
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(SALU_CYCLE_1)
; GFX11-NEXT:    s_or_b32 s1, s1, 1
; GFX11-NEXT:    s_lshr_b32 s1, s1, s26
; GFX11-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(NEXT) | instid1(SALU_CYCLE_1)
; GFX11-NEXT:    s_mul_i32 s1, s1, s18
; GFX11-NEXT:    s_mul_i32 s1, s1, s16
; GFX11-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(NEXT) | instid1(SALU_CYCLE_1)
; GFX11-NEXT:    s_or_b32 s8, s22, s1
; GFX11-NEXT:    s_lshl_b64 s[18:19], s[8:9], 1
; GFX11-NEXT:    global_load_u16 v1, v0, s[18:19]
; GFX11-NEXT:    s_waitcnt vmcnt(0)
; GFX11-NEXT:    v_cmp_eq_u16_e64 s1, 0, v1
...
; GFX11-NEXT:    s_and_b32 vcc_lo, s13, vcc_lo
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_1) | instid1(VALU_DEP_2)
; GFX11-NEXT:    v_cndmask_b32_e64 v1, v2, v1, s0
; GFX11-NEXT:    v_cndmask_b32_e64 v2, 0, 1, s21
...
; GFX11-NEXT:    s_and_b32 s16, s2, exec_lo
