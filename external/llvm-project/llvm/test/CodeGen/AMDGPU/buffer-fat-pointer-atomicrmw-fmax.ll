...
; GFX11-NEXT:    v_dual_mov_b32 v5, s16 :: v_dual_mov_b32 v0, v3
...
; GFX12-TRUE16-NEXT:    v_max_num_f16_e32 v1.l, v1.l, v0.h
...
; GFX11-TRUE16-NEXT:    v_max_f16_e32 v1.l, v1.l, v0.h
...
; GFX12-TRUE16-NEXT:    v_max_num_f16_e32 v5.h, v5.l, v5.l
; GFX12-TRUE16-NEXT:    v_mov_b16_e32 v6.h, 0
; GFX12-TRUE16-NEXT:    s_mov_b32 s2, exec_lo
; GFX12-TRUE16-NEXT:    s_wait_storecnt 0x0
; GFX12-TRUE16-NEXT:    v_max_num_f16_e32 v6.l, v6.l, v6.l
; GFX12-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX12-TRUE16-NEXT:    v_max_num_f16_e32 v6.l, v6.l, v5.h
...
; GFX11-TRUE16-NEXT:    v_max_f16_e32 v5.h, v5.l, v5.l
; GFX11-TRUE16-NEXT:    v_mov_b16_e32 v6.h, 0
; GFX11-TRUE16-NEXT:    s_mov_b32 s2, exec_lo
; GFX11-TRUE16-NEXT:    s_waitcnt_vscnt null, 0x0
; GFX11-TRUE16-NEXT:    v_max_f16_e32 v6.l, v6.l, v6.l
; GFX11-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX11-TRUE16-NEXT:    v_max_f16_e32 v6.l, v6.l, v5.h
...
; GFX12-TRUE16-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-TRUE16-NEXT:    s_not_b32 s7, s6
; GFX12-TRUE16-NEXT:    buffer_load_b32 v1, v1, s[0:3], null offen
; GFX12-TRUE16-NEXT:    s_mov_b32 s6, 0
; GFX12-TRUE16-NEXT:  .LBB13_1: ; %atomicrmw.start
; GFX12-TRUE16-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX12-TRUE16-NEXT:    s_wait_loadcnt 0x0
; GFX12-TRUE16-NEXT:    v_lshrrev_b32_e32 v0, s5, v1
; GFX12-TRUE16-NEXT:    s_wait_storecnt 0x0
; GFX12-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX12-TRUE16-NEXT:    v_dual_mov_b32 v5, s4 :: v_dual_lshlrev_b32 v0, 16, v0
; GFX12-TRUE16-NEXT:    v_max_num_f32_e32 v0, v0, v4
...
; GFX12-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX12-TRUE16-NEXT:    v_lshlrev_b32_e32 v0, s5, v2
; GFX12-TRUE16-NEXT:    v_and_or_b32 v0, v1, s7, v0
...
; GFX12-TRUE16-NEXT:  ; %bb.2: ; %atomicrmw.end
; GFX12-TRUE16-NEXT:    s_or_b32 exec_lo, exec_lo, s6
; GFX12-TRUE16-NEXT:    v_lshrrev_b32_e32 v0, s5, v2
; GFX12-TRUE16-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX12-FAKE16-NEXT:    v_max_num_f32_e32 v0, v0, v4
...
; GFX11-TRUE16-NEXT:    s_lshl_b32 s6, 0xffff, s5
; GFX11-TRUE16-NEXT:    s_not_b32 s7, s6
; GFX11-TRUE16-NEXT:    buffer_load_b32 v1, v1, s[0:3], 0 offen
; GFX11-TRUE16-NEXT:    s_mov_b32 s6, 0
; GFX11-TRUE16-NEXT:    .p2align 6
; GFX11-TRUE16-NEXT:  .LBB13_1: ; %atomicrmw.start
; GFX11-TRUE16-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX11-TRUE16-NEXT:    s_waitcnt vmcnt(0)
; GFX11-TRUE16-NEXT:    v_lshrrev_b32_e32 v0, s5, v1
; GFX11-TRUE16-NEXT:    s_waitcnt_vscnt null, 0x0
; GFX11-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX11-TRUE16-NEXT:    v_dual_mov_b32 v5, s4 :: v_dual_lshlrev_b32 v0, 16, v0
; GFX11-TRUE16-NEXT:    v_max_f32_e32 v0, v0, v4
...
; GFX11-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX11-TRUE16-NEXT:    v_lshlrev_b32_e32 v0, s5, v2
; GFX11-TRUE16-NEXT:    v_and_or_b32 v0, v1, s7, v0
...
; GFX11-TRUE16-NEXT:  ; %bb.2: ; %atomicrmw.end
; GFX11-TRUE16-NEXT:    s_or_b32 exec_lo, exec_lo, s6
; GFX11-TRUE16-NEXT:    v_lshrrev_b32_e32 v0, s5, v2
; GFX11-TRUE16-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX11-FAKE16-NEXT:    v_max_f32_e32 v0, v0, v4
...
; GFX12-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX12-TRUE16-NEXT:    v_lshlrev_b32_e32 v0, s5, v3
; GFX12-TRUE16-NEXT:    v_and_or_b32 v0, v1, s7, v0
; GFX12-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX12-TRUE16-NEXT:    v_dual_mov_b32 v4, v1 :: v_dual_mov_b32 v3, v0
; GFX12-TRUE16-NEXT:    buffer_atomic_cmpswap_b32 v[3:4], v5, s[0:3], null offen th:TH_ATOMIC_RETURN
; GFX12-TRUE16-NEXT:    s_wait_loadcnt 0x0
; GFX12-TRUE16-NEXT:    global_inv scope:SCOPE_DEV
; GFX12-TRUE16-NEXT:    v_cmp_eq_u32_e32 vcc_lo, v3, v1
...
; GFX11-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX11-TRUE16-NEXT:    v_lshlrev_b32_e32 v0, s5, v3
; GFX11-TRUE16-NEXT:    v_and_or_b32 v0, v1, s7, v0
; GFX11-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1)
...
; GFX11-TRUE16-NEXT:    buffer_gl1_inv
; GFX11-TRUE16-NEXT:    buffer_gl0_inv
; GFX11-TRUE16-NEXT:    v_cmp_eq_u32_e32 vcc_lo, v3, v1
...
; GFX12-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX12-NEXT:    s_wait_loadcnt 0x0
; GFX12-NEXT:    v_dual_mov_b32 v4, v0 :: v_dual_mov_b32 v5, s16
...
; GFX12-NEXT:    buffer_atomic_cmpswap_b32 v[0:1], v5, s[0:3], null offen offset:1024 th:TH_ATOMIC_RETURN
; GFX12-NEXT:    s_wait_loadcnt 0x0
; GFX12-NEXT:    global_inv scope:SCOPE_DEV
...
; GFX12-NEXT:    v_dual_mov_b32 v5, s16 :: v_dual_mov_b32 v4, v2
; GFX12-NEXT:    v_mov_b32_e32 v3, v1
; GFX12-NEXT:    buffer_atomic_cmpswap_b32 v[3:4], v5, s[0:3], null offen offset:1024 th:TH_ATOMIC_RETURN
; GFX12-NEXT:    s_wait_loadcnt 0x0
; GFX12-NEXT:    global_inv scope:SCOPE_DEV
...
; GFX12-NEXT:    v_pk_max_num_f16 v6, v5, v5
; GFX12-NEXT:    s_wait_loadcnt 0x0
; GFX12-NEXT:    v_pk_max_num_f16 v7, v8, v8
; GFX12-NEXT:    s_mov_b32 s2, exec_lo
; GFX12-NEXT:    s_wait_storecnt 0x0
; GFX12-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX12-NEXT:    v_pk_max_num_f16 v7, v7, v6
...
; GFX11-NEXT:    v_pk_max_f16 v6, v5, v5
; GFX11-NEXT:    s_waitcnt vmcnt(0)
; GFX11-NEXT:    v_pk_max_f16 v7, v8, v8
; GFX11-NEXT:    s_mov_b32 s2, exec_lo
; GFX11-NEXT:    s_waitcnt_vscnt null, 0x0
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX11-NEXT:    v_pk_max_f16 v7, v7, v6
...
; GFX12-TRUE16-NEXT:    v_mov_b16_e32 v3.l, v0.h
; GFX12-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX12-TRUE16-NEXT:    v_dual_mov_b32 v5, s16 :: v_dual_mov_b32 v0, v3
...
; GFX12-FAKE16-NEXT:    v_dual_mov_b32 v0, v3 :: v_dual_mov_b32 v1, v4
...
; GFX11-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX11-TRUE16-NEXT:    v_mov_b16_e32 v3.l, v0.h
; GFX11-TRUE16-NEXT:    v_dual_mov_b32 v5, s16 :: v_dual_mov_b32 v0, v3
...
; GFX6-NEXT:    s_mov_b64 s[4:5], 0
; GFX6-NEXT:    s_add_i32 s6, s20, 0x400
; GFX6-NEXT:    v_and_b32_e32 v0, 0xffff0000, v2
; GFX6-NEXT:    s_waitcnt vmcnt(0)
...
; GFX12-TRUE16-NEXT:    s_mov_b32 s4, 0
; GFX12-TRUE16-NEXT:    buffer_load_b32 v2, v1, s[0:3], null offen offset:1024
...
; GFX12-TRUE16-NEXT:    v_dual_mov_b32 v4, v2 :: v_dual_mov_b32 v5, s16
; GFX12-TRUE16-NEXT:    v_mov_b32_e32 v3, v1
...
; GFX12-FAKE16-NEXT:    s_mov_b32 s5, 0
; GFX12-FAKE16-NEXT:    buffer_load_b32 v2, v1, s[0:3], null offen offset:1024
...
; GFX11-TRUE16-NEXT:    v_dual_mov_b32 v4, v2 :: v_dual_mov_b32 v5, s16
; GFX11-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_2)
; GFX11-TRUE16-NEXT:    v_mov_b32_e32 v3, v1
...
; GFX12-TRUE16-NEXT:    s_and_saveexec_b32 s0, s0
; GFX12-TRUE16-NEXT:    s_wait_loadcnt 0x0
; GFX12-TRUE16-NEXT:    buffer_load_b32 v8, v4, s[4:7], null offen offset:1024
; GFX12-TRUE16-NEXT:    s_xor_b32 exec_lo, exec_lo, s0
...
; GFX12-TRUE16-NEXT:    s_wait_storecnt 0x0
; GFX12-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX12-TRUE16-NEXT:    v_dual_max_num_f32 v6, v7, v6 :: v_dual_max_num_f32 v7, v10, v9
...
; GFX12-TRUE16-NEXT:    s_and_saveexec_b32 s0, s0
; GFX12-TRUE16-NEXT:    s_wait_loadcnt 0x0
; GFX12-TRUE16-NEXT:    buffer_atomic_cmpswap_b32 v[6:7], v4, s[4:7], null offen offset:1024 th:TH_ATOMIC_RETURN
; GFX12-TRUE16-NEXT:    s_xor_b32 exec_lo, exec_lo, s0
...
; GFX12-FAKE16-NEXT:    s_and_saveexec_b32 s0, s0
; GFX12-FAKE16-NEXT:    s_wait_loadcnt 0x0
; GFX12-FAKE16-NEXT:    buffer_load_b32 v8, v4, s[4:7], null offen offset:1024
; GFX12-FAKE16-NEXT:    s_xor_b32 exec_lo, exec_lo, s0
...
; GFX12-FAKE16-NEXT:    s_wait_storecnt 0x0
; GFX12-FAKE16-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX12-FAKE16-NEXT:    v_dual_max_num_f32 v6, v7, v6 :: v_dual_max_num_f32 v7, v10, v9
...
; GFX12-FAKE16-NEXT:    s_and_saveexec_b32 s0, s0
; GFX12-FAKE16-NEXT:    s_wait_loadcnt 0x0
; GFX12-FAKE16-NEXT:    buffer_atomic_cmpswap_b32 v[6:7], v4, s[4:7], null offen offset:1024 th:TH_ATOMIC_RETURN
; GFX12-FAKE16-NEXT:    s_xor_b32 exec_lo, exec_lo, s0
...
; GFX11-TRUE16-NEXT:    s_waitcnt_vscnt null, 0x0
; GFX11-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX11-TRUE16-NEXT:    v_dual_max_f32 v6, v7, v6 :: v_dual_max_f32 v7, v10, v9
...
; GFX11-FAKE16-NEXT:    s_waitcnt_vscnt null, 0x0
; GFX11-FAKE16-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX11-FAKE16-NEXT:    v_dual_max_f32 v6, v7, v6 :: v_dual_max_f32 v7, v10, v9
