...
; SSE-NEXT:    [[ADD3:%.*]] = extractelement <4 x double> [[TMP4]], i64 0
; SSE-NEXT:    [[ADD2:%.*]] = extractelement <4 x double> [[TMP4]], i64 2
...
; SSE-NEXT:    [[ADD5:%.*]] = fadd double [[TMP7]], [[TMP8]]
; SSE-NEXT:    [[ADD6:%.*]] = fadd double [[ADD4]], [[ADD5]]
; SSE-NEXT:    ret double [[ADD6]]
;
