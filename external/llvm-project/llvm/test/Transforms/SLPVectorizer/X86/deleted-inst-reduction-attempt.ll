...
; CHECK-NEXT:    [[TMP10:%.*]] = insertelement <4 x double> poison, double [[TMP6]], i64 0
...
; CHECK-NEXT:    [[TMP25:%.*]] = extractelement <4 x double> [[TMP21]], i64 0
; CHECK-NEXT:    [[TMP22:%.*]] = extractelement <4 x double> [[TMP16]], i64 0
; CHECK-NEXT:    [[TMP23:%.*]] = fadd double [[TMP22]], [[TMP25]]
; CHECK-NEXT:    [[TMP24:%.*]] = extractelement <4 x double> [[TMP21]], i64 1
; CHECK-NEXT:    [[TMP28:%.*]] = extractelement <4 x double> [[TMP21]], i64 2
; CHECK-NEXT:    [[TMP29:%.*]] = fadd double [[TMP24]], [[TMP28]]
; CHECK-NEXT:    [[TMP27:%.*]] = fadd double [[TMP29]], [[TMP6]]
; CHECK-NEXT:    [[TMP30:%.*]] = fadd double [[TMP23]], [[TMP27]]
; CHECK-NEXT:    ret double [[TMP30]]
;
