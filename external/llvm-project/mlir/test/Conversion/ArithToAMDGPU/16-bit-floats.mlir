...
func.func @scalar_trunc(%v: f32) -> f16{
  // CHECK: %[[trunc:.*]] = amdgpu.packed_trunc_fp16x2 %[[value]], undef : f32 to vector<2xf16>
...
// CHECK  @vector_trunc(%[[value:.*]] : vector<2xf32>)
func.func @vector_trunc_short(%v: vector<2xf32>) -> vector<2xf16> {
  ...
  // CHECK: %[[ret:.*]] = amdgpu.packed_trunc_fp16x2 %[[elem0]], %[[elem1]] : f32 to vector<2xf16>
  // CHECK: return %[[ret]]
...
func.func @vector_trunc_long(%v: vector<9xf32>) -> vector<9xf16> {
  ...
  // CHECK: %[[packed0:.*]] = amdgpu.packed_trunc_fp16x2 %[[elem0]], %[[elem1]] : f32 to vector<2xf16>
  ...
  // CHECK: %[[packed1:.*]] = amdgpu.packed_trunc_fp16x2 %[[elem2]], %[[elem3]] : f32 to vector<2xf16>
  ...
  // CHECK: %[[packed2:.*]] = amdgpu.packed_trunc_fp16x2 %[[elem4]], %[[elem5]] : f32 to vector<2xf16>
  ...
  // CHECK: %[[packed3:.*]] = amdgpu.packed_trunc_fp16x2 %[[elem6]], %[[elem7]] : f32 to vector<2xf16>
  ...
  // CHECK: %[[packed4:.*]] = amdgpu.packed_trunc_fp16x2 %[[elem8:.*]], undef : f32 to vector<2xf16>
