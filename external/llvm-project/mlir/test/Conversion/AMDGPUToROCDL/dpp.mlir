...
func.func @test_dpp(%arg0: i32) -> i32 {
  ...
  // CHECK: rocdl.update.dpp %arg0, %arg0 with 257, 10, 15, false : i32
  // CHECK: return %0 : i32
...
func.func @quad_dpp(%arg0: i32) -> i32 {
  ...
  // CHECK: rocdl.update.dpp %arg0, %arg0 with 145, 1, 1, true : i32
  // CHECK: return %0 : i32
...
func.func @quad_perm_dpp(%arg0: i32) -> i32 {
  ...
  // CHECK: rocdl.update.dpp %arg0, %arg0 with 88, 15, 15, false : i32
  // CHECK: return %0 : i32
...
func.func @wave_shr_dpp(%arg0: i32) -> i32 {
  ...
  // CHECK: rocdl.update.dpp %arg0, %arg0 with 312, 10, 1, true : i32
  // CHECK: return %0 : i32
...
func.func @row_bcast_dpp(%arg0: i32) -> i32 {
  ...
  // CHECK: rocdl.update.dpp %arg0, %arg0 with 323, 4, 1, false : i32
  // CHECK: return %0 : i32
...
func.func @row_bcast_dpp_f32(%arg0: f32) -> f32 {
  ...
  // CHECK: rocdl.update.dpp %0, %0 with 322, 15, 15, true : i32
...
func.func @test_dpp_f32(%arg0: f32) -> f32 {
  ...
  // CHECK: llvm.bitcast %arg0 : f32 to i32
  // CHECK: rocdl.update.dpp %0, %0 with 320, 1, 4, true : i32
  // CHECK: llvm.bitcast %1 : i32 to f32
  // CHECK: return %2 : f32
...
func.func @test_dpp_f16(%arg0: f16) -> f16 {
  ...
  // CHECK: rocdl.update.dpp %4, %4 with 273, 15, 3, false : i32
...
func.func @row_shl_dpp_i16(%arg0: i16) -> i16 {
  ...
  // CHECK: rocdl.update.dpp %3, %3 with 298, 10, 1, false : i32
...
func.func @row_half_mirror_update_dpp(%arg0: i32, %arg1: i32) -> i32 {
  ...
  // CHECK: return %0 : i32
%0 = amdgpu.dpp %arg0 (%arg1 : i32) row_half_mirror { bank_mask = 0x1 : i32 } : i32
    return %0 : i32
}
...
func.func @wave_rol_update_dpp(%arg0: i32, %arg1: i32) -> i32 {
  ...
  // CHECK: return %0 : i32
  %0 = amdgpu.dpp %arg0 (%arg1 : i32) wave_rol { row_mask = 0xa : i32, bank_mask = 0x1 : i32 } : i32
    return %0 : i32
}
...
func.func @quad_perm_update_dpp_f32(%arg0: f32, %arg1: f32) -> f32 {
  ...
  // CHECK: return %3 : f32
  %0 = amdgpu.dpp %arg0 (%arg1 : f32) quad_perm ( [0,2,1,1] ) { bank_mask = 0x1 : i32 } : f32
    return %0 : f32
}
...
func.func @row_bcast_update_dpp_f16(%arg0: f16, %arg1: f16) -> f16 {
  ...
  // CHECK: return %12 : f16
  %0 = amdgpu.dpp %arg0 (%arg1 : f16) row_bcast_15 { bound_ctrl = true } : f16
    return %0 : f16
}
