// RUN: mlir-spirv-cpu-runner %s -e main --entry-point-result=void --shared-libs=%linalg_test_lib_dir/%prefix_mlir_runner_utils%shlibext,%linalg_test_lib_dir/libmlir_test_spirv_cpu_runner_c_wrappers%shlibext
