...
func.func @forward(%arg0: tensor<2x128x128xf32>, %arg1: tensor<512x128xf32>, %arg2: tensor<1x1x512xf32>) -> (tensor<2x128x512xf32>) {
  ...
  %15 = "tosa.mul"(%14, %7, %shift)  : (tensor<2x128x512xf32>, tensor<1x1x1xf32>, tensor<1xi8>) -> tensor<2x128x512xf32>
  %16 = "tosa.abs"(%15) : (tensor<2x128x512xf32>) -> tensor<2x128x512xf32>
  %19 = "tosa.mul"(%16, %16, %shift) : (tensor<2x128x512xf32>, tensor<2x128x512xf32>, tensor<1xi8>) -> tensor<2x128x512xf32>
  ...
  %37 = "tosa.mul"(%14, %34, %shift) : (tensor<2x128x512xf32>, tensor<2x128x512xf32>, tensor<1xi8>) -> tensor<2x128x512xf32>
