...
LogicalResult MFMAOp::verify() {
  ...
  if (isa<Float8E5M2FNUZType, Float8E4M3FNUZType, Float8E5M2Type, Float8E4M3FNType>(sourceElem)) {
    ...
    if (!isa<Float8E5M2FNUZType, Float8E4M3FNUZType, Float8E5M2Type, Float8E4M3FNType>(sourceBElem))
