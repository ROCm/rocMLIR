...
namespace mlir {
namespace mhal {
#define GEN_PASS_DEF_MHALTOSAPARTITION
...
class MHALTosaPartitionPass
    : public mhal::impl::MHALTosaPartitionBase<MHALTosaPartitionPass> {
public:
  using mhal::impl::MHALTosaPartitionBase<
      MHALTosaPartitionPass>::MHALTosaPartitionBase;

  void runOnOperation() override;
};

void MHALTosaPartitionPass::runOnOperation() {
