...
#   ghp_/gho_/ghu_/ghs_/ghr_/github_pat_   GitHub PATs (all forms)
#   xox[baprs]-...            Slack tokens
#   AKIA<16>                  AWS access key id
#   -----BEGIN ... PRIVATE KEY-----
suspicious_patterns='sk-ant-api[0-9]{2}-[A-Za-z0-9_-]{20,}|sk-[A-Za-z0-9_-]{30,}|[Bb]earer[[:space:]]+[A-Za-z0-9_.-]{20,}|[Oo]cp-[Aa]pim-[Ss]ubscription-[Kk]ey[[:space:]]*:[[:space:]]*[A-Za-z0-9_-]{20,}|gh[pousr]_[A-Za-z0-9]{30,}|github_pat_[A-Za-z0-9_]{30,}|xox[baprs]-[A-Za-z0-9-]{10,}|AKIA[0-9A-Z]{16}|-----BEGIN[[:space:]]+([A-Z]+[[:space:]]+)?PRIVATE[[:space:]]+KEY-----'
