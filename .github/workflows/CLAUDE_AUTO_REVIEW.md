...
| URL allow-list hosts | `ALLOWED_HOST_RE` in the sanitizer; prompt "Hard constraints". (The skill's "Rules" defers to the prompt's full enumeration, so it's not a third sync site.) |
