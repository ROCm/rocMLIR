//===- mlir-rock-driver.cpp - MLIR Rock Dialect Driver ----------------===//
//
...
//===----------------------------------------------------------------------===//
//
// Main entry function for mlir-rock-driver.
//
//===----------------------------------------------------------------------===//
...
static cl::opt<std::string>
    kernelPipeline("kernel-pipeline",
                   cl::desc("mlir-rock-driver kernel pipeline list"),
...
static cl::opt<std::string>
    hostPipeline("host-pipeline",
                 cl::desc("mlir-rock-driver host pipeline list"),
                 cl::value_desc("comma separated list of rock pipelines: "
