...
//   Type outputElemType = b.getF32Type();
  ...
  Type outputElemType = typeFromString(genConfig.dataTypeStr, module.getContext());
...
// +++pf: this guy should be unnecessary.
...
//         // use f32 data type to verify non-f32 or xdlops f32 kernels
//         // except that i8 xdlops is verified with i8 non-xdlops and tuned i8 is
