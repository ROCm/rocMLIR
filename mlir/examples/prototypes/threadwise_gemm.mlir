//./bin/mlir-opt --convert-linalg-to-affine-loops --lower-affine --convert-linalg-to-llvm --convert-std-to-llvm ../mlir/examples/prototypes/threadwise_gemm.mlir | ./bin/mlir-runner -e main --entry-point-result=void -shared-libs=lib/libmlir_runner_utils.so
