...
module {
  func @miopen_conv2d_kcyx_nchw_nkhw(%arg0: memref<1024x1024x1x1xf32>, %arg1: memref<128x1024x14x14xf32>, %arg2: memref<128x1024x14x14xf32>) {
    ...
    %26 = addi %12, %25 : i32
    %27 = miopen.alloc() : memref<6144xf32, 3>
    %28 = miopen.subview(%27, %c0) : memref<6144xf32, 3> to memref<4096xf32, 3>
    %29 = miopen.subview(%28, %c0) : memref<4096xf32, 3> to memref<16x256xf32, #map3, 3>
    %30 = miopen.subview(%27, %c4096) : memref<6144xf32, 3> to memref<2048xf32, #map4, 3>
    %31 = miopen.subview(%30, %c0) : memref<2048xf32, #map4, 3> to memref<16x128xf32, #map5, 3>
    %32 = miopen.alloc() : memref<4x4xf32, 5>
    %33 = miopen.alloc() : memref<2x4xf32, 5>
    ...
    %43 = miopen.alloc() : memref<32xf32, 5>
    %44 = miopen.alloc() : memref<16xf32, 5>
    ...
    %45:4, %blah, %blah2 = scf.for %arg3 = %c0 to %c63 step %c1 iter_args(%arg4 = %cst, %arg5 = %cst, %arg6 = %cst, %arg7 = %cst, %arg8 = %34, %arg9 = %36) -> (vector<32xf32>, vector<32xf32>, vector<32xf32>, vector<32xf32>, vector<2xi32>, vector<2xi32>) {
      ...
      miopen.blockwise_copy_v2(%0, %32, %a_src, %35) {block_size = 256 : i32, dest_data_per_write = 1 : i32, dest_dim_access_order = [0 : i32, 1 : i32], dest_vector_write_dim = 1 : i32, source_data_per_read = 4 : i32, source_dim_access_order = [1 : i32, 0 : i32], source_vector_read_dim = 0 : i32} : memref<1024x1024xf32, #map0>, memref<4x4xf32, 5>, vector<2xi32>, vector<2xi32>
      ...
      miopen.blockwise_copy_v2(%3, %33, %b_src, %37) {block_size = 256 : i32, dest_data_per_write = 4 : i32, dest_dim_access_order = [0 : i32, 1 : i32], dest_vector_write_dim = 1 : i32, source_data_per_read = 4 : i32, source_dim_access_order = [0 : i32, 1 : i32], source_vector_read_dim = 1 : i32} : memref<1024x25088xf32, #map2>, memref<2x4xf32, 5>, vector<2xi32>, vector<2xi32>

      miopen.workgroup_barrier
      %204:4 = miopen.blockwise_gemm_v2(%29, %31, %41, %42, %43, %44, %arg4, %arg5, %arg6, %arg7) {block_size = 256 : i32, coord_transforms = [], k = 16 : i32, m = 256 : i32, m_per_wave = 128 : i32, m_waves = 2 : i32, n = 128 : i32, n_per_wave = 64 : i32, n_waves = 2 : i32} : memref<16x256xf32, #map3, 3>, memref<16x128xf32, #map5, 3>, index, index, memref<32xf32, 5>, memref<16xf32, 5>, vector<32xf32>, vector<32xf32>, vector<32xf32>, vector<32xf32>
      miopen.workgroup_barrier

      miopen.blockwise_copy_v2(%32, %29, %a_src, %35) {block_size = 256 : i32, dest_data_per_write = 1 : i32, dest_dim_access_order = [0 : i32, 1 : i32], dest_vector_write_dim = 1 : i32, source_data_per_read = 4 : i32, source_dim_access_order = [1 : i32, 0 : i32], source_vector_read_dim = 0 : i32} : memref<4x4xf32, 5>, memref<16x256xf32, #map3, 3>, vector<2xi32>, vector<2xi32>
      miopen.blockwise_copy_v2(%33, %31, %b_src, %37) {block_size = 256 : i32, dest_data_per_write = 4 : i32, dest_dim_access_order = [0 : i32, 1 : i32], dest_vector_write_dim = 1 : i32, source_data_per_read = 4 : i32, source_dim_access_order = [0 : i32, 1 : i32], source_vector_read_dim = 1 : i32} : memref<2x4xf32, 5>, memref<16x128xf32, #map5, 3>, vector<2xi32>, vector<2xi32>
    ...
    miopen.workgroup_barrier
    %46:4 = miopen.blockwise_gemm_v2(%29, %31, %41, %42, %43, %44, %45#0, %45#1, %45#2, %45#3) {block_size = 256 : i32, coord_transforms = [], k = 16 : i32, m = 256 : i32, m_per_wave = 128 : i32, m_waves = 2 : i32, n = 128 : i32, n_per_wave = 64 : i32, n_waves = 2 : i32} : memref<16x256xf32, #map3, 3>, memref<16x128xf32, #map5, 3>, index, index, memref<32xf32, 5>, memref<16xf32, 5>, vector<32xf32>, vector<32xf32>, vector<32xf32>, vector<32xf32>
    %47 = miopen.transform(%4) : memref<1024x25088xf32, #map2> to memref<128x2x4x25088xf32, #map6>
    ...
    miopen.threadwise_copy_v2(%46#0, %47, %c0_i32, %c0_i32, %c0_i32, %c0_i32, %c0_i32, %62, %64, %65, %61) {bound = [4 : i32, 1 : i32, 4 : i32, 1 : i32], coord_transforms = [{operand = 0 : i32, transforms = [affine_map<(d0, d1, d2, d3) -> (d0 * 4 + d2)>]}], dest_data_per_write = 1 : i32, dim_access_order = [0 : i32, 1 : i32, 2 : i32, 3 : i32], source_data_per_read = 1 : i32, vector_read_write_dim = 3 : i32} : vector<32xf32>, memref<128x2x4x25088xf32, #map6>
    ...
    miopen.threadwise_copy_v2(%46#1, %47, %c0_i32, %c0_i32, %c0_i32, %c0_i32, %c0_i32, %100, %102, %103, %99) {bound = [4 : i32, 1 : i32, 4 : i32, 1 : i32], coord_transforms = [{operand = 0 : i32, transforms = [affine_map<(d0, d1, d2, d3) -> (d0 * 4 + d2)>]}], dest_data_per_write = 1 : i32, dim_access_order = [0 : i32, 1 : i32, 2 : i32, 3 : i32], source_data_per_read = 1 : i32, vector_read_write_dim = 3 : i32} : vector<32xf32>, memref<128x2x4x25088xf32, #map6>
    ...
    miopen.threadwise_copy_v2(%46#1, %47, %c16_i32, %c0_i32, %c0_i32, %c0_i32, %c0_i32, %120, %122, %123, %119) {bound = [4 : i32, 1 : i32, 4 : i32, 1 : i32], coord_transforms = [{operand = 0 : i32, transforms = [affine_map<(d0, d1, d2, d3) -> (d0 * 4 + d2)>]}], dest_data_per_write = 1 : i32, dim_access_order = [0 : i32, 1 : i32, 2 : i32, 3 : i32], source_data_per_read = 1 : i32, vector_read_write_dim = 3 : i32} : vector<32xf32>, memref<128x2x4x25088xf32, #map6>
    ...
    miopen.threadwise_copy_v2(%46#2, %47, %c0_i32, %c0_i32, %c0_i32, %c0_i32, %c0_i32, %139, %141, %142, %138) {bound = [4 : i32, 1 : i32, 4 : i32, 1 : i32], coord_transforms = [{operand = 0 : i32, transforms = [affine_map<(d0, d1, d2, d3) -> (d0 * 4 + d2)>]}], dest_data_per_write = 1 : i32, dim_access_order = [0 : i32, 1 : i32, 2 : i32, 3 : i32], source_data_per_read = 1 : i32, vector_read_write_dim = 3 : i32} : vector<32xf32>, memref<128x2x4x25088xf32, #map6>
    ...
    miopen.threadwise_copy_v2(%46#2, %47, %c16_i32, %c0_i32, %c0_i32, %c0_i32, %c0_i32, %159, %161, %162, %158) {bound = [4 : i32, 1 : i32, 4 : i32, 1 : i32], coord_transforms = [{operand = 0 : i32, transforms = [affine_map<(d0, d1, d2, d3) -> (d0 * 4 + d2)>]}], dest_data_per_write = 1 : i32, dim_access_order = [0 : i32, 1 : i32, 2 : i32, 3 : i32], source_data_per_read = 1 : i32, vector_read_write_dim = 3 : i32} : vector<32xf32>, memref<128x2x4x25088xf32, #map6>
    ...
    miopen.threadwise_copy_v2(%46#3, %47, %c0_i32, %c0_i32, %c0_i32, %c0_i32, %c0_i32, %179, %181, %182, %178) {bound = [4 : i32, 1 : i32, 4 : i32, 1 : i32], coord_transforms = [{operand = 0 : i32, transforms = [affine_map<(d0, d1, d2, d3) -> (d0 * 4 + d2)>]}], dest_data_per_write = 1 : i32, dim_access_order = [0 : i32, 1 : i32, 2 : i32, 3 : i32], source_data_per_read = 1 : i32, vector_read_write_dim = 3 : i32} : vector<32xf32>, memref<128x2x4x25088xf32, #map6>
    ...
    miopen.threadwise_copy_v2(%46#3, %47, %c16_i32, %c0_i32, %c0_i32, %c0_i32, %c0_i32, %200, %202, %203, %199) {bound = [4 : i32, 1 : i32, 4 : i32, 1 : i32], coord_transforms = [{operand = 0 : i32, transforms = [affine_map<(d0, d1, d2, d3) -> (d0 * 4 + d2)>]}], dest_data_per_write = 1 : i32, dim_access_order = [0 : i32, 1 : i32, 2 : i32, 3 : i32], source_data_per_read = 1 : i32, vector_read_write_dim = 3 : i32} : vector<32xf32>, memref<128x2x4x25088xf32, #map6>
    return
  }
}
