...
#define GEN_PASS_DECL_ROCKGRIDWISEWINOGRADGEMMLOWERINGPASS
#define GEN_PASS_DECL_ROCKCONVTOWINOGRADPASS
#define GEN_PASS_DECL_ROCKWINOGRADTOGEMMPASS
...
#define GEN_PASS_DECL_ROCKEXPANDSTRIDESLOWERINGPASS
