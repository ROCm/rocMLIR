...
namespace mlir {
namespace miopen {
inline Value padFilter(int64_t gemmMExtra, int64_t gemmNExtra,
...
inline Value padInput(int64_t gemmMExtra, int64_t gemmNExtra,
...
inline Value padOutput(int64_t gemmMExtra, int64_t gemmNExtra,
