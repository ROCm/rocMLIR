...
namespace mlir {
namespace miopen {
auto padFilter(int64_t& gemmMExtra, int64_t& gemmNExtra, int64_t& gemmKExtra, auto& gemmAPad, PatternRewriter &b,
               auto& loc, llvm::DenseSet<int>& filterOobCheckDims, llvm::DenseMap<StringRef, int>& nameToDims, auto& filterShape, auto& filterElementType,
               int64_t& g, int64_t& k, int64_t& c, auto& yDotSlice, auto& xDotSlice) {
...
auto padInput(int64_t& gemmMExtra, int64_t& gemmNExtra, int64_t gemmKExtra, auto& gemmBPad,
		PatternRewriter &b, auto& loc, llvm::DenseSet<int>& inputOobCheckDims, llvm::DenseMap<StringRef, int>& nameToDims,
		auto& transformedShape, auto& inputShape, auto& inputElementType)
{
...
auto padOutput(int64_t& gemmMExtra, int64_t& gemmNExtra, int64_t gemmKExtra, auto& gemmCPad,
		PatternRewriter &b, auto& loc, llvm::DenseSet<int>& outputOobCheckDims, llvm::DenseMap<StringRef, int>& nameToDims,
		auto& transformedShape, auto& outputShape, auto& outputElementType)
