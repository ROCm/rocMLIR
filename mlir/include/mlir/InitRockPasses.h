//===- InitRockPasses.h - MLIR Rock Passes Registration -----------*- C++
//-*-===//
//
...
#ifndef MLIR_INITROCKPASSES_H_
#define MLIR_INITROCKPASSES_H_
...
// This function may be called to register the MLIR Rock passes with the
// global registry.
...
inline void registerRockPasses() {
  registerRockConversionPasses();
  rock::registerPasses();
