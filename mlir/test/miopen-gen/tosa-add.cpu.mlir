// RUN: mlir-miopen-driver -host-pipeline=highlevel %s | miopen-gen -rand=none -ph -pr -fut test_fusion - | miopen-opt -convert-linalg-to-loops -lower-affine -convert-scf-to-cf | mlir-rocm-runner --target=%targets --shared-libs=%linalg_test_lib_dir/libmlir_rocm_runtime%shlibext,%conv_validation_wrapper_library_dir/libconv-validation-wrappers%shlibext,%linalg_test_lib_dir/libmlir_runner_utils%shlibext --entry-point-result=void | FileCheck %s
