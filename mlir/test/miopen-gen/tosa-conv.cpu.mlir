// RUN: miopen-opt -tosa-to-linalg -linalg-fuse-elementwise-ops -linalg-bufferize -func-bufferize -buffer-results-to-out-params -finalizing-bufferize -miopen-copy-opt  %s | miopen-gen -ph -pvr -rand 1 -fut test_fusion - | miopen-opt -convert-linalg-to-loops -lower-affine -convert-scf-to-std | mlir-rocm-runner --shared-libs=%rocm_wrapper_library_dir/librocm-runtime-wrappers%shlibext,%linalg_test_lib_dir/libmlir_runner_utils%shlibext --entry-point-result=void | FileCheck %s
