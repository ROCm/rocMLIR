...
func.func @quant_dot_with_scales(%arg0: tensor<8192xf4E2M1FN>, %arg1: tensor<8192xf4E2M1FN>, %arg2: tensor<256xf8E8M0FNU>, %arg3: tensor<256xf8E8M0FNU>) -> tensor<4096xf32> attributes {rock.arch = "##TOKEN_ARCH##", rock.kernel} {
...
#map1 = affine_map<(d0, d1, d2, d3) -> (d0, d3, d2)>
#map2 = affine_map<(d0, d1, d2, d3) -> (d0, d1, d2)>
func.func @quant_dot_with_scales_perf_config(%arg0: tensor<8192xf4E2M1FN>, %arg1: tensor<8192xf4E2M1FN>, %arg2: tensor<256xf8E8M0FNU>, %arg3: tensor<256xf8E8M0FNU>) -> tensor<4096xf32> attributes {rock.arch = "##TOKEN_ARCH##", rock.kernel} {
    %expanded = tensor.expand_shape %arg1 [[0, 1, 2]] output_shape [1, 128, 64] : tensor<8192xf4E2M1FN> into tensor<1x128x64xf4E2M1FN>
    %expanded_0 = tensor.expand_shape %arg0 [[0, 1, 2]] output_shape [1, 64, 128] : tensor<8192xf4E2M1FN> into tensor<1x64x128xf4E2M1FN>
    %expanded_1 = tensor.expand_shape %arg2 [[0, 1, 2]] output_shape [1, 64, 4] : tensor<256xf8E8M0FNU> into tensor<1x64x4xf8E8M0FNU>
    %0 = tensor.empty() : tensor<1x64x4x32xf8E8M0FNU>
