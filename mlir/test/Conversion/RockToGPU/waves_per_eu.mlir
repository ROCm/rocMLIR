...
module {
  func.func @misckernel(%arg0: memref<?xf32>, %arg1: memref<?xf32>) attributes {block_size = 128 : i32, enable_splitk_for_tuning, grid_size = 256 : i32, kernel, mhal.arch = "amdgcn-amd-amdhsa:gfx1100", num_cu = 96 : i64, waves_per_eu = 8 : i64} {
