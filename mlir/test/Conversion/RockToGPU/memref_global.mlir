...
func.func @kern(%arg0 : memref<2xi32> {llvm.noalias}) attributes {kernel, rock.block_size = 64 : i32, rock.grid_size = 1 : i32 } {
...
func.func @kern2(%arg0 : memref<2xi32>) attributes {kernel, rock.block_size = 64 : i32, rock.grid_size = 1 : i32 } {
  %c0 = arith.constant 0 : index
  %c1 = arith.constant 1 : index
