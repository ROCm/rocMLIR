...
module {
  ...
  func @mfma_bf16(%a : vector<2xbf16>, %b : vector<2xbf16>, %c : memref<64xf32>) {
    ...
    miopen.mfma(%a, %b, %c) { m_per_wave = 32, n_per_wave = 64 }: vector<2xbf16>, memref<64xf32>
    // MFMA_BF16:      %[[MV:.*]] = vector.type_cast %{{.*}} : memref<64xf32> to memref<2xvector<32xf32>>
    ...
    miopen.mfma(%a, %b, %c) { m_per_wave = 64, n_per_wave = 32 }: vector<2xbf16>, memref<64xf32>
    // MFMA_BF16:      %[[MV:.*]] = vector.type_cast %{{.*}} : memref<64xf32> to memref<2xvector<32xf32>>
    // MFMA_BF16-NEXT: %[[IT:.*]] = constant 0 : index
    // MFMA_BF16-NEXT: %[[LD:.*]] = load %[[MV]][%[[IT]]] : memref<2xvector<32xf32>>
    ...
    miopen.mfma(%a, %b, %c) { m_per_wave = 32, n_per_wave = 32 }: vector<2xbf16>, memref<64xf32>
    ...
    miopen.mfma(%a, %b, %c) { m_per_wave = 16, n_per_wave = 16 }: vector<2xbf16>, memref<64xf32>
    ...
    miopen.mfma(%a, %b, %c) { m_per_wave = 16, n_per_wave = 64 }: vector<2xbf16>, memref<64xf32>
    // MFMA_BF16:      %[[MV:.*]] = vector.type_cast %{{.*}} : memref<64xf32> to memref<4xvector<16xf32>>
    // MFMA_BF16-NEXT: %[[IT:.*]] = constant 0 : index
    // MFMA_BF16-NEXT: %[[LD:.*]] = load %[[MV]][%[[IT]]] : memref<4xvector<16xf32>>
    ...
    miopen.mfma(%a, %b, %c) { m_per_wave = 64, n_per_wave = 16 }: vector<2xbf16>, memref<64xf32>
    // MFMA_BF16:      %[[MV:.*]] = vector.type_cast %{{.*}} : memref<64xf32> to memref<4xvector<16xf32>>
    // MFMA_BF16-NEXT: %[[IT:.*]] = constant 0 : index
    // MFMA_BF16-NEXT: %[[LD:.*]] = load %[[MV]][%[[IT]]] : memref<4xvector<16xf32>>
    ...
    miopen.mfma(%a, %b, %c) { m_per_wave = 4, n_per_wave = 64 }: vector<2xbf16>, memref<64xf32>
    // MFMA_BF16:      %[[MV:.*]] = vector.type_cast %{{.*}} : memref<64xf32> to memref<16xvector<4xf32>>
    // MFMA_BF16-NEXT: %[[IT:.*]] = constant 0 : index
    // MFMA_BF16-NEXT: %[[LD:.*]] = load %[[MV]][%[[IT]]] : memref<16xvector<4xf32>>
    ...
    miopen.mfma(%a, %b, %c) { m_per_wave = 8, n_per_wave = 64 }: vector<2xbf16>, memref<64xf32>
    // MFMA_BF16:      %[[MV:.*]] = vector.type_cast %{{.*}} : memref<64xf32> to memref<16xvector<4xf32>>
    // MFMA_BF16-NEXT: %[[IT0:.*]] = constant 0 : index
