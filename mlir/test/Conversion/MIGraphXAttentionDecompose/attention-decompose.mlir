...
) -> (tensor<1x7x3xf32>, tensor<1x7xf32>) {
  %0, %1 = migraphx.attention %q, %k, %v
    ...
    -> tensor<1x7x3xf32>, tensor<1x7xf32>
  return %0, %1 : tensor<1x7x3xf32>, tensor<1x7xf32>
}
