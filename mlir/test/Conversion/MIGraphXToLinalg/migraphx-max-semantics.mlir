...
// Floating maximum propagates a NaN from either operand. It carries `nsz`, so
// signed-zero ordering is intentionally not guaranteed.

// CHECK-LABEL: func.func @max_f32
// CHECK-NOT: fastmath<nnan
// CHECK: arith.maximumf {{.*}} fastmath<nsz>
