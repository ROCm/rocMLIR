...
// Floating maximum propagates a NaN from either operand. Check both the
// explicit TOSA contract and the `nsz` scalar operation selected by rocMLIR's
// TOSA-to-Linalg path. Signed-zero ordering is intentionally not guaranteed.
...
// LINALG-NOT: fastmath<nnan
// LINALG: arith.maximumf {{.*}} fastmath<nsz>
