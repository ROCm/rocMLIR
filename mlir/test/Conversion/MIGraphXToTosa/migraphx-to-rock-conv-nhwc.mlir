...
func.func @convNHWC(%in: !migraphx.shaped<1x4x5x5xf32, 100x1x20x4>, %fil: !migraphx.shaped<7x4x3x3xf32, 36x1x12x4>) -> !migraphx.shaped<1x7x3x3xf32, 63x1x21x7> attributes {rock.kernel, rock.arch = "gfx1100", rock.num_cu = 48 : i64} {
  // CHECK: rock.conv
  // CHECK-SAME: filter_layout = ["k", "y", "x", "g", "c"]
  // CHECK-SAME: input_layout = ["hi", "wi", "ni", "gi", "ci"]
