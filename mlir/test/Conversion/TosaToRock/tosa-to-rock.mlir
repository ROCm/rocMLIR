...
// CHECK: %[[convRes:.*]] = rock.conv2d(%{{.*}}, %{{.*}}, %{{.*}}) features = {{none|xdlops}}, convParams = {padding : [0, 0, 0, 0], stride : [1, 1], dilation : [1, 1]} {arch = {{.*}}, filter_layout = ["k", "y", "x", "c", "g"], input_layout = ["ni", "hi", "wi", "ci", "gi"], output_layout = ["no", "ho", "wo", "ko", "go"]} : tensor<128x8x3x3x1xf32>, tensor<128x8x32x32x1xf32>, tensor<128x128x30x30x1xf32>
