...
// CHECK: causal
func.func @mlir_nokvcache_causal_attention(%arg0: tensor<24576xf16>, %arg1: tensor<262144xf16>, %arg2: tensor<262144xf16>) -> tensor<8192xf16> attributes {rock.kernel, rock.arch = "##TOKEN_ARCH##"} {
...
// CHECK: causal
func.func @mlir_causal_attention(%arg0: tensor<24576xf16>, %arg1: tensor<262144xf16>, %arg2: tensor<262144xf16>, %arg3: tensor<1xi32>) -> tensor<8192xf16> attributes {rock.kernel, rock.arch = "##TOKEN_ARCH##"} {
  %expanded = tensor.expand_shape %arg2 [[0, 1, 2, 3]] output_shape [1, 32, 64, 128] : tensor<262144xf16> into tensor<1x32x64x128xf16>
...
// CHECK: currentSeqLen = (%{{.*}} : tensor<32xi32>)
// CHECK: causal
func.func @mlir_causal_attention2(%arg0: tensor<24576xf16>, %arg1: tensor<262144xf16>, %arg2: tensor<262144xf16>, %arg3: tensor<1xi32>) -> tensor<8192xf16> attributes {rock.kernel, rock.arch = "##TOKEN_ARCH##"} {
...
// CHECK-LABEL: func @mlir_causal_attention_hardcoded_causal_mask
// CHECK: rock.attention
// CHECK: currentSeqLen = (%{{.*}} : tensor<32xi32>)
// CHECK: causal
func.func @mlir_causal_attention_hardcoded_causal_mask(%arg0: tensor<49152xf16> {mhal.read_access}, %arg1: tensor<1048576xf16> {mhal.read_access}, %arg2: tensor<1xi32> {mhal.read_access}, %arg3: tensor<1048576xf16> {mhal.read_access}) -> (tensor<16384xf16> {mhal.write_access}) attributes {rock.arch = "gfx942", rock.kernel} {
  ...
  %5 = "tosa.const"() <{values = dense<1.000000e+00> : tensor<1x32x4x256xf16>}> : () -> tensor<1x32x4x256xf16>
  %6 = tosa.const_shape  {values = dense<1> : tensor<4xindex>} : () -> !tosa.shape<4>
  %7 = "tosa.const"() <{values = dense<1> : tensor<1x32x4x256xi8>}> : () -> tensor<1x32x4x256xi8>
  %8 = "tosa.const"() <{values = dense<8.837890e-02> : tensor<1x32x4x256xf16>}> : () -> tensor<1x32x4x256xf16>
  %9 = "tosa.const"() <{values = dense<0xFC00> : tensor<1x32x4x256xf16>}> : () -> tensor<1x32x4x256xf16>
  %10 = tosa.const_shape  {values = dense<[1, 32, 4, 256]> : tensor<4xindex>} : () -> !tosa.shape<4>
  %11 = "tosa.const"() <{values = dense<0.000000e+00> : tensor<1xf16>}> : () -> tensor<1xf16>
  %12 = tosa.const_shape  {values = dense<[32, 128, 256]> : tensor<3xindex>} : () -> !tosa.shape<3>
  %13 = tosa.const_shape  {values = dense<[32, 4, 128]> : tensor<3xindex>} : () -> !tosa.shape<3>
  %14 = tosa.const_shape  {values = dense<[1, 32, 4, 128]> : tensor<4xindex>} : () -> !tosa.shape<4>
  %15 = "tosa.const"() <{values = dense<0> : tensor<1xi8>}> : () -> tensor<1xi8>
  %16 = "tosa.const"() <{values = dense<1> : tensor<1x1x1x256xi32>}> : () -> tensor<1x1x1x256xi32>
  ...
  %21 = tosa.matmul %collapsed, %collapsed_1, %11, %11 {acc_type = f32} : (tensor<32x4x128xf16>, tensor<32x128x256xf16>, tensor<1xf16>, tensor<1xf16>) -> tensor<32x4x256xf16>
  %expanded_2 = tensor.expand_shape %21 [[0, 1], [2], [3]] output_shape [1, 32, 4, 256] : tensor<32x4x256xf16> into tensor<1x32x4x256xf16>
  %22 = tosa.mul %expanded_2, %8, %15 : (tensor<1x32x4x256xf16>, tensor<1x32x4x256xf16>, tensor<1xi8>) -> tensor<1x32x4x256xf16>
  %23 = tosa.mul %0, %7, %15 : (tensor<1x1x4x256xi8>, tensor<1x32x4x256xi8>, tensor<1xi8>) -> tensor<1x32x4x256xi8>
  %24 = tosa.cast %23 : (tensor<1x32x4x256xi8>) -> tensor<1x32x4x256xi1>
  %25 = tosa.select %24, %9, %22 : (tensor<1x32x4x256xi1>, tensor<1x32x4x256xf16>, tensor<1x32x4x256xf16>) -> tensor<1x32x4x256xf16>
  %expanded_3 = tensor.expand_shape %arg2 [[0, 1, 2, 3]] output_shape [1, 1, 1, 1] : tensor<1xi32> into tensor<1x1x1x1xi32>
  %26 = tosa.mul %expanded_3, %16, %15 : (tensor<1x1x1x1xi32>, tensor<1x1x1x256xi32>, tensor<1xi8>) -> tensor<1x1x1x256xi32>
  ...
  %30 = tosa.mul %29, %7, %15 : (tensor<1x1x1x256xi8>, tensor<1x32x4x256xi8>, tensor<1xi8>) -> tensor<1x32x4x256xi8>
  %31 = tosa.cast %30 : (tensor<1x32x4x256xi8>) -> tensor<1x32x4x256xi1>
  %32 = tosa.select %31, %9, %25 : (tensor<1x32x4x256xi1>, tensor<1x32x4x256xf16>, tensor<1x32x4x256xf16>) -> tensor<1x32x4x256xf16>
  %33 = tosa.reduce_max %32 {axis = 3 : i32} : (tensor<1x32x4x256xf16>) -> tensor<1x32x4x1xf16>
  %34 = tosa.mul %33, %5, %15 : (tensor<1x32x4x1xf16>, tensor<1x32x4x256xf16>, tensor<1xi8>) -> tensor<1x32x4x256xf16>
  ...
  %38 = tosa.mul %37, %5, %15 : (tensor<1x32x4x1xf16>, tensor<1x32x4x256xf16>, tensor<1xi8>) -> tensor<1x32x4x256xf16>
  %39 = tosa.reciprocal %38 : (tensor<1x32x4x256xf16>) -> tensor<1x32x4x256xf16>
  %40 = tosa.mul %36, %39, %15 : (tensor<1x32x4x256xf16>, tensor<1x32x4x256xf16>, tensor<1xi8>) -> tensor<1x32x4x256xf16>
  ...
  %41 = tosa.matmul %collapsed_4, %expanded_5, %11, %11 {acc_type = f32} : (tensor<32x4x256xf16>, tensor<32x256x128xf16>, tensor<1xf16>, tensor<1xf16>) -> tensor<32x4x128xf16>
...
// CHECK-LABEL: func @mlir_causal_attention_hardcoded_causal_mask2
// CHECK: rock.attention
// CHECK: currentSeqLen = (%{{.*}} : tensor<32xi32>)
// CHECK: causal
func.func @mlir_causal_attention_hardcoded_causal_mask2(%arg0: tensor<1xi32> {mhal.read_access}, %arg1: tensor<49152xf16> {mhal.read_access}, %arg2: tensor<1048576xf16> {mhal.read_access}, %arg3: tensor<1048576xf16> {mhal.read_access}) -> (tensor<16384xf16> {mhal.write_access}) attributes {rock.kernel} {
  %0 = "tosa.const"() <{values = dense<""> : tensor<1x1x4x256xi8>}> : () -> tensor<1x1x4x256xi8>
  %1 = "tosa.const"() <{values = dense<""> : tensor<1x1x1x256xi32>}> : () -> tensor<1x1x1x256xi32>
  %2 = tosa.const_shape  {values = dense<16384> : tensor<1xindex>} : () -> !tosa.shape<1>
  %3 = tosa.const_shape  {values = dense<[32, 256, 128]> : tensor<3xindex>} : () -> !tosa.shape<3>
  %4 = tosa.const_shape  {values = dense<[32, 4, 256]> : tensor<3xindex>} : () -> !tosa.shape<3>
  %5 = "tosa.const"() <{values = dense<1.000000e+00> : tensor<1x32x4x256xf16>}> : () -> tensor<1x32x4x256xf16>
  %6 = "tosa.const"() <{values = dense<0xFC00> : tensor<1x32x4x256xf16>}> : () -> tensor<1x32x4x256xf16>
  %7 = tosa.const_shape  {values = dense<[1, 32, 4, 256]> : tensor<4xindex>} : () -> !tosa.shape<4>
  %8 = "tosa.const"() <{values = dense<0.000000e+00> : tensor<1xf16>}> : () -> tensor<1xf16>
  %9 = tosa.const_shape  {values = dense<[32, 128, 256]> : tensor<3xindex>} : () -> !tosa.shape<3>
  %10 = tosa.const_shape  {values = dense<[32, 4, 128]> : tensor<3xindex>} : () -> !tosa.shape<3>
  %11 = tosa.const_shape  {values = dense<[1, 32, 4, 128]> : tensor<4xindex>} : () -> !tosa.shape<4>
  %12 = tosa.const_shape  {values = dense<1> : tensor<4xindex>} : () -> !tosa.shape<4>
  %13 = "tosa.const"() <{values = dense<1> : tensor<1x32x4x256xi8>}> : () -> tensor<1x32x4x256xi8>
  %14 = "tosa.const"() <{values = dense<8.837890e-02> : tensor<1x32x4x256xf16>}> : () -> tensor<1x32x4x256xf16>
  %15 = "tosa.const"() <{values = dense<0> : tensor<1xi8>}> : () -> tensor<1xi8>
  %16 = "tosa.const"() <{values = dense<1> : tensor<1x1x1x256xi32>}> : () -> tensor<1x1x1x256xi32>
  %17 = tosa.const_shape  {values = dense<[1, 4, 96, 128]> : tensor<4xindex>} : () -> !tosa.shape<4>
  %18 = tosa.const_shape  {values = dense<[1, 32, 256, 128]> : tensor<4xindex>} : () -> !tosa.shape<4>
  ...
  %19 = tosa.transpose %expanded_0 {perms = array<i32: 0, 2, 1, 3>} : (tensor<1x4x96x128xf16>) -> tensor<1x96x4x128xf16>
  %20 = tosa.mul %0, %13, %15 : (tensor<1x1x4x256xi8>, tensor<1x32x4x256xi8>, tensor<1xi8>) -> tensor<1x32x4x256xi8>
  %expanded_1 = tensor.expand_shape %arg0 [[0, 1, 2, 3]] output_shape [1, 1, 1, 1] : tensor<1xi32> into tensor<1x1x1x1xi32>
  %21 = tosa.mul %expanded_1, %16, %15 : (tensor<1x1x1x1xi32>, tensor<1x1x1x256xi32>, tensor<1xi8>) -> tensor<1x1x1x256xi32>
  ...
  %25 = tosa.mul %24, %13, %15 : (tensor<1x1x1x256xi8>, tensor<1x32x4x256xi8>, tensor<1xi8>) -> tensor<1x32x4x256xi8>
  %extracted_slice = tensor.extract_slice %19[0, 0, 0, 0] [1, 32, 4, 128] [1, 1, 1, 1] : tensor<1x96x4x128xf16> to tensor<1x32x4x128xf16>
  ...
  %27 = tosa.matmul %collapsed, %collapsed_2, %8, %8 {acc_type = f32} : (tensor<32x4x128xf16>, tensor<32x128x256xf16>, tensor<1xf16>, tensor<1xf16>) -> tensor<32x4x256xf16>
  %expanded_3 = tensor.expand_shape %27 [[0, 1], [2], [3]] output_shape [1, 32, 4, 256] : tensor<32x4x256xf16> into tensor<1x32x4x256xf16>
  %28 = tosa.mul %expanded_3, %14, %15 : (tensor<1x32x4x256xf16>, tensor<1x32x4x256xf16>, tensor<1xi8>) -> tensor<1x32x4x256xf16>
  %29 = tosa.cast %20 : (tensor<1x32x4x256xi8>) -> tensor<1x32x4x256xi1>
  %30 = tosa.select %29, %6, %28 : (tensor<1x32x4x256xi1>, tensor<1x32x4x256xf16>, tensor<1x32x4x256xf16>) -> tensor<1x32x4x256xf16>
  %31 = tosa.cast %25 : (tensor<1x32x4x256xi8>) -> tensor<1x32x4x256xi1>
  %32 = tosa.select %31, %6, %30 : (tensor<1x32x4x256xi1>, tensor<1x32x4x256xf16>, tensor<1x32x4x256xf16>) -> tensor<1x32x4x256xf16>
  %33 = tosa.reduce_max %32 {axis = 3 : i32} : (tensor<1x32x4x256xf16>) -> tensor<1x32x4x1xf16>
  %34 = tosa.mul %33, %5, %15 : (tensor<1x32x4x1xf16>, tensor<1x32x4x256xf16>, tensor<1xi8>) -> tensor<1x32x4x256xf16>
  %35 = tosa.sub %32, %34 : (tensor<1x32x4x256xf16>, tensor<1x32x4x256xf16>) -> tensor<1x32x4x256xf16>
  %36 = tosa.exp %35 : (tensor<1x32x4x256xf16>) -> tensor<1x32x4x256xf16>
  ...
  %collapsed_4 = tensor.collapse_shape %40 [[0, 1], [2], [3]] : tensor<1x32x4x256xf16> into tensor<32x4x256xf16>
  %expanded_5 = tensor.expand_shape %arg3 [[0, 1, 2]] output_shape [32, 256, 128] : tensor<1048576xf16> into tensor<32x256x128xf16>
  %41 = tosa.matmul %collapsed_4, %expanded_5, %8, %8 {acc_type = f32} : (tensor<32x4x256xf16>, tensor<32x256x128xf16>, tensor<1xf16>, tensor<1xf16>) -> tensor<32x4x128xf16>
  %expanded_6 = tensor.expand_shape %41 [[0, 1], [2], [3]] output_shape [1, 32, 4, 128] : tensor<32x4x128xf16> into tensor<1x32x4x128xf16>
  %42 = tosa.transpose %expanded_6 {perms = array<i32: 0, 2, 1, 3>} : (tensor<1x32x4x128xf16>) -> tensor<1x4x32x128xf16>
  %collapsed_7 = tensor.collapse_shape %42 [[0, 1, 2, 3]] : tensor<1x4x32x128xf16> into tensor<16384xf16>
  return %collapsed_7 : tensor<16384xf16>
...
// CHECK-LABEL: func @mlir_causal_attention_no_select
// CHECK: rock.attention
// CHECK: qk = {{.*}} * {{.*}} : tensor<14x8x64xf16>, tensor<14x64x8xf16>
// CHECK: causal
func.func @mlir_causal_attention_no_select(%arg0: tensor<1024xf16>, %arg1: tensor<7168xf16>, %arg2: tensor<7168xf16>) -> tensor<7168xf16> attributes {rock.kernel} {
  ...
  %13 = "tosa.const"() <{values = dense<[[[[-0.000000e+00, 0xFC00, 0xFC00, 0xFC00, 0xFC00, 0xFC00, 0xFC00, 0xFC00], [-0.000000e+00, -0.000000e+00, 0xFC00, 0xFC00, 0xFC00, 0xFC00, 0xFC00, 0xFC00], [-0.000000e+00, -0.000000e+00, -0.000000e+00, 0xFC00, 0xFC00, 0xFC00, 0xFC00, 0xFC00], [-0.000000e+00, -0.000000e+00, -0.000000e+00, -0.000000e+00, 0xFC00, 0xFC00, 0xFC00, 0xFC00], [-0.000000e+00, -0.000000e+00, -0.000000e+00, -0.000000e+00, -0.000000e+00, 0xFC00, 0xFC00, 0xFC00], [-0.000000e+00, -0.000000e+00, -0.000000e+00, -0.000000e+00, -0.000000e+00, -0.000000e+00, 0xFC00, 0xFC00], [-0.000000e+00, -0.000000e+00, -0.000000e+00, -0.000000e+00, -0.000000e+00, -0.000000e+00, -0.000000e+00, 0xFC00], [-0.000000e+00, -0.000000e+00, -0.000000e+00, -0.000000e+00, -0.000000e+00, -0.000000e+00, -0.000000e+00, -0.000000e+00]]]]> : tensor<1x1x8x8xf16>}> : () -> tensor<1x1x8x8xf16>
...
// Test the bf16 version of `mlir_causal_attention_add_cast_non_inf_mask` where
// the masked-out positions use `0xC61C`. That is the bf16 representation of
// `-9984.0`, i.e. what casting the BERT additive-mask constant `-10000.0f`
// into bf16 actually rounds to. This specifically exercises the
// converted-threshold branch of `isMaskingNegInfValue`: the value is neither
// -inf nor bf16's largest negative finite (0xFF7F), and a fixed-double
// `<= -1.0e4` cutoff would *not* catch it (since -9984 > -10000), but
// rounding `kMaskingConstantThreshold` into bf16 semantics first yields the
// matching cutoff of -9984.0.
// CHECK-LABEL: func @mlir_causal_attention_add_cast_non_inf_mask_bf16
// CHECK: rock.attention
// CHECK: qk = {{.*}} * {{.*}} : tensor<14x8x64xbf16>, tensor<14x64x8xbf16>
// CHECK-NOT: currentSeqLen =
// CHECK: causal
func.func @mlir_causal_attention_add_cast_non_inf_mask_bf16(%arg0: tensor<1024xbf16>, %arg1: tensor<7168xbf16>, %arg2: tensor<7168xbf16>) -> tensor<7168xbf16> attributes {rock.kernel} {
  %0 = tosa.const_shape  {values = dense<7168> : tensor<1xindex>} : () -> !tosa.shape<1>
  %1 = tosa.const_shape  {values = dense<[14, 8, 8]> : tensor<3xindex>} : () -> !tosa.shape<3>
  %2 = "tosa.const"() <{values = dense<1.000000e+00> : tensor<1x14x8x8xf32>}> : () -> tensor<1x14x8x8xf32>
  %3 = tosa.const_shape  {values = dense<[1, 14, 8, 8]> : tensor<4xindex>} : () -> !tosa.shape<4>
  %4 = "tosa.const"() <{values = dense<0.000000e+00> : tensor<1xbf16>}> : () -> tensor<1xbf16>
  %5 = tosa.const_shape  {values = dense<[14, 64, 8]> : tensor<3xindex>} : () -> !tosa.shape<3>
  %6 = tosa.const_shape  {values = dense<[14, 8, 64]> : tensor<3xindex>} : () -> !tosa.shape<3>
  %7 = "tosa.const"() <{values = dense<1.000000e+00> : tensor<1x14x8x8xbf16>}> : () -> tensor<1x14x8x8xbf16>
  %8 = "tosa.const"() <{values = dense<3.535160e-01> : tensor<1x14x64x8xbf16>}> : () -> tensor<1x14x64x8xbf16>
  %9 = tosa.const_shape  {values = dense<[1, 14, 64, 8]> : tensor<4xindex>} : () -> !tosa.shape<4>
  %10 = "tosa.const"() <{values = dense<0> : tensor<1xi8>}> : () -> tensor<1xi8>
  %11 = "tosa.const"() <{values = dense<1.000000e+00> : tensor<1x2x7x64x8xbf16>}> : () -> tensor<1x2x7x64x8xbf16>
  %12 = tosa.const_shape  {values = dense<[1, 2, 1, 8, 64]> : tensor<5xindex>} : () -> !tosa.shape<5>
  %13 = "tosa.const"() <{values = dense<[[[[-0.000000e+00, 0xC61C, 0xC61C, 0xC61C, 0xC61C, 0xC61C, 0xC61C, 0xC61C], [-0.000000e+00, -0.000000e+00, 0xC61C, 0xC61C, 0xC61C, 0xC61C, 0xC61C, 0xC61C], [-0.000000e+00, -0.000000e+00, -0.000000e+00, 0xC61C, 0xC61C, 0xC61C, 0xC61C, 0xC61C], [-0.000000e+00, -0.000000e+00, -0.000000e+00, -0.000000e+00, 0xC61C, 0xC61C, 0xC61C, 0xC61C], [-0.000000e+00, -0.000000e+00, -0.000000e+00, -0.000000e+00, -0.000000e+00, 0xC61C, 0xC61C, 0xC61C], [-0.000000e+00, -0.000000e+00, -0.000000e+00, -0.000000e+00, -0.000000e+00, -0.000000e+00, 0xC61C, 0xC61C], [-0.000000e+00, -0.000000e+00, -0.000000e+00, -0.000000e+00, -0.000000e+00, -0.000000e+00, -0.000000e+00, 0xC61C], [-0.000000e+00, -0.000000e+00, -0.000000e+00, -0.000000e+00, -0.000000e+00, -0.000000e+00, -0.000000e+00, -0.000000e+00]]]]> : tensor<1x1x8x8xbf16>}> : () -> tensor<1x1x8x8xbf16>
  %14 = tosa.const_shape  {values = dense<[1, 8, 14, 64]> : tensor<4xindex>} : () -> !tosa.shape<4>
  %expanded = tensor.expand_shape %arg1 [[0, 1, 2, 3]] output_shape [1, 8, 14, 64] : tensor<7168xbf16> into tensor<1x8x14x64xbf16>
  %15 = tosa.transpose %expanded {perms = array<i32: 0, 2, 1, 3>} : (tensor<1x8x14x64xbf16>) -> tensor<1x14x8x64xbf16>
  %expanded_0 = tensor.expand_shape %arg0 [[0, 1, 2, 3, 4]] output_shape [1, 2, 1, 8, 64] : tensor<1024xbf16> into tensor<1x2x1x8x64xbf16>
  %16 = tosa.transpose %expanded_0 {perms = array<i32: 0, 1, 2, 4, 3>} : (tensor<1x2x1x8x64xbf16>) -> tensor<1x2x1x64x8xbf16>
  %17 = tosa.mul %16, %11, %10 : (tensor<1x2x1x64x8xbf16>, tensor<1x2x7x64x8xbf16>, tensor<1xi8>) -> tensor<1x2x7x64x8xbf16>
  %collapsed = tensor.collapse_shape %17 [[0], [1, 2], [3], [4]] : tensor<1x2x7x64x8xbf16> into tensor<1x14x64x8xbf16>
  %18 = tosa.mul %collapsed, %8, %10 : (tensor<1x14x64x8xbf16>, tensor<1x14x64x8xbf16>, tensor<1xi8>) -> tensor<1x14x64x8xbf16>
  %19 = tosa.mul %13, %7, %10 : (tensor<1x1x8x8xbf16>, tensor<1x14x8x8xbf16>, tensor<1xi8>) -> tensor<1x14x8x8xbf16>
  %collapsed_1 = tensor.collapse_shape %15 [[0, 1], [2], [3]] : tensor<1x14x8x64xbf16> into tensor<14x8x64xbf16>
  %collapsed_2 = tensor.collapse_shape %18 [[0, 1], [2], [3]] : tensor<1x14x64x8xbf16> into tensor<14x64x8xbf16>
  %20 = tosa.matmul %collapsed_1, %collapsed_2, %4, %4 {acc_type = f32} : (tensor<14x8x64xbf16>, tensor<14x64x8xbf16>, tensor<1xbf16>, tensor<1xbf16>) -> tensor<14x8x8xbf16>
  %expanded_3 = tensor.expand_shape %20 [[0, 1], [2], [3]] output_shape [1, 14, 8, 8] : tensor<14x8x8xbf16> into tensor<1x14x8x8xbf16>
  %scores_f32 = tosa.cast %expanded_3 : (tensor<1x14x8x8xbf16>) -> tensor<1x14x8x8xf32>
  %mask_f32 = tosa.cast %19 : (tensor<1x14x8x8xbf16>) -> tensor<1x14x8x8xf32>
  %21 = tosa.add %scores_f32, %mask_f32 : (tensor<1x14x8x8xf32>, tensor<1x14x8x8xf32>) -> tensor<1x14x8x8xf32>
  %23 = tosa.reduce_max %21 {axis = 3 : i32} : (tensor<1x14x8x8xf32>) -> tensor<1x14x8x1xf32>
  %24 = tosa.mul %23, %2, %10 : (tensor<1x14x8x1xf32>, tensor<1x14x8x8xf32>, tensor<1xi8>) -> tensor<1x14x8x8xf32>
  %25 = tosa.sub %21, %24 : (tensor<1x14x8x8xf32>, tensor<1x14x8x8xf32>) -> tensor<1x14x8x8xf32>
  %26 = tosa.exp %25 : (tensor<1x14x8x8xf32>) -> tensor<1x14x8x8xf32>
  %27 = tosa.reduce_sum %26 {axis = 3 : i32} : (tensor<1x14x8x8xf32>) -> tensor<1x14x8x1xf32>
  %28 = tosa.mul %27, %2, %10 : (tensor<1x14x8x1xf32>, tensor<1x14x8x8xf32>, tensor<1xi8>) -> tensor<1x14x8x8xf32>
  %29 = tosa.reciprocal %28 : (tensor<1x14x8x8xf32>) -> tensor<1x14x8x8xf32>
  %30 = tosa.mul %26, %29, %10 : (tensor<1x14x8x8xf32>, tensor<1x14x8x8xf32>, tensor<1xi8>) -> tensor<1x14x8x8xf32>
  %31 = tosa.cast %30 : (tensor<1x14x8x8xf32>) -> tensor<1x14x8x8xbf16>
  %collapsed_4 = tensor.collapse_shape %31 [[0, 1], [2], [3]] : tensor<1x14x8x8xbf16> into tensor<14x8x8xbf16>
  %expanded_5 = tensor.expand_shape %arg2 [[0, 1, 2]] output_shape [14, 8, 64] : tensor<7168xbf16> into tensor<14x8x64xbf16>
  %32 = tosa.matmul %collapsed_4, %expanded_5, %4, %4 {acc_type = f32} : (tensor<14x8x8xbf16>, tensor<14x8x64xbf16>, tensor<1xbf16>, tensor<1xbf16>) -> tensor<14x8x64xbf16>
  %collapsed_6 = tensor.collapse_shape %32 [[0, 1, 2]] : tensor<14x8x64xbf16> into tensor<7168xbf16>
  return %collapsed_6 : tensor<7168xbf16>
}
...
//   2. The mask uses the largest negative finite f16 value (-65504.0 / 0xFBFF)
//      instead of -inf (0xFC00).
// CHECK-LABEL: func @mlir_causal_attention_add_cast_non_inf_mask
// CHECK: rock.attention
// CHECK: qk = {{.*}} * {{.*}} : tensor<14x8x64xf16>, tensor<14x64x8xf16>
// CHECK-NOT: currentSeqLen =
// CHECK: causal
func.func @mlir_causal_attention_add_cast_non_inf_mask(%arg0: tensor<1024xf16>, %arg1: tensor<7168xf16>, %arg2: tensor<7168xf16>) -> tensor<7168xf16> attributes {rock.kernel} {
  %0 = tosa.const_shape  {values = dense<7168> : tensor<1xindex>} : () -> !tosa.shape<1>
  %1 = tosa.const_shape  {values = dense<[14, 8, 8]> : tensor<3xindex>} : () -> !tosa.shape<3>
  %2 = "tosa.const"() <{values = dense<1.000000e+00> : tensor<1x14x8x8xf32>}> : () -> tensor<1x14x8x8xf32>
  %3 = tosa.const_shape  {values = dense<[1, 14, 8, 8]> : tensor<4xindex>} : () -> !tosa.shape<4>
  ...
  %11 = "tosa.const"() <{values = dense<1.000000e+00> : tensor<1x2x7x64x8xf16>}> : () -> tensor<1x2x7x64x8xf16>
  %12 = tosa.const_shape  {values = dense<[1, 2, 1, 8, 64]> : tensor<5xindex>} : () -> !tosa.shape<5>
  %13 = "tosa.const"() <{values = dense<[[[[-0.000000e+00, 0xFBFF, 0xFBFF, 0xFBFF, 0xFBFF, 0xFBFF, 0xFBFF, 0xFBFF], [-0.000000e+00, -0.000000e+00, 0xFBFF, 0xFBFF, 0xFBFF, 0xFBFF, 0xFBFF, 0xFBFF], [-0.000000e+00, -0.000000e+00, -0.000000e+00, 0xFBFF, 0xFBFF, 0xFBFF, 0xFBFF, 0xFBFF], [-0.000000e+00, -0.000000e+00, -0.000000e+00, -0.000000e+00, 0xFBFF, 0xFBFF, 0xFBFF, 0xFBFF], [-0.000000e+00, -0.000000e+00, -0.000000e+00, -0.000000e+00, -0.000000e+00, 0xFBFF, 0xFBFF, 0xFBFF], [-0.000000e+00, -0.000000e+00, -0.000000e+00, -0.000000e+00, -0.000000e+00, -0.000000e+00, 0xFBFF, 0xFBFF], [-0.000000e+00, -0.000000e+00, -0.000000e+00, -0.000000e+00, -0.000000e+00, -0.000000e+00, -0.000000e+00, 0xFBFF], [-0.000000e+00, -0.000000e+00, -0.000000e+00, -0.000000e+00, -0.000000e+00, -0.000000e+00, -0.000000e+00, -0.000000e+00]]]]> : tensor<1x1x8x8xf16>}> : () -> tensor<1x1x8x8xf16>
  %14 = tosa.const_shape  {values = dense<[1, 8, 14, 64]> : tensor<4xindex>} : () -> !tosa.shape<4>
  %expanded = tensor.expand_shape %arg1 [[0, 1, 2, 3]] output_shape [1, 8, 14, 64] : tensor<7168xf16> into tensor<1x8x14x64xf16>
  %15 = tosa.transpose %expanded {perms = array<i32: 0, 2, 1, 3>} : (tensor<1x8x14x64xf16>) -> tensor<1x14x8x64xf16>
  %expanded_0 = tensor.expand_shape %arg0 [[0, 1, 2, 3, 4]] output_shape [1, 2, 1, 8, 64] : tensor<1024xf16> into tensor<1x2x1x8x64xf16>
  ...
  %20 = tosa.matmul %collapsed_1, %collapsed_2, %4, %4 {acc_type = f32} : (tensor<14x8x64xf16>, tensor<14x64x8xf16>, tensor<1xf16>, tensor<1xf16>) -> tensor<14x8x8xf16>
  %expanded_3 = tensor.expand_shape %20 [[0, 1], [2], [3]] output_shape [1, 14, 8, 8] : tensor<14x8x8xf16> into tensor<1x14x8x8xf16>
  %scores_f32 = tosa.cast %expanded_3 : (tensor<1x14x8x8xf16>) -> tensor<1x14x8x8xf32>
  %mask_f32 = tosa.cast %19 : (tensor<1x14x8x8xf16>) -> tensor<1x14x8x8xf32>
  %21 = tosa.add %scores_f32, %mask_f32 : (tensor<1x14x8x8xf32>, tensor<1x14x8x8xf32>) -> tensor<1x14x8x8xf32>
  %23 = tosa.reduce_max %21 {axis = 3 : i32} : (tensor<1x14x8x8xf32>) -> tensor<1x14x8x1xf32>
  %24 = tosa.mul %23, %2, %10 : (tensor<1x14x8x1xf32>, tensor<1x14x8x8xf32>, tensor<1xi8>) -> tensor<1x14x8x8xf32>
  %25 = tosa.sub %21, %24 : (tensor<1x14x8x8xf32>, tensor<1x14x8x8xf32>) -> tensor<1x14x8x8xf32>
