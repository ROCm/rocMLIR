...
func.func @k_not_multiple_of_block_size_via_transpose_b(
    ...
    %b_scale: tensor<1x100x8xf8E8M0FNU>) -> tensor<1x128x100xf32> attributes {rock.kernel} {
...
func.func @a_scale_k_mismatch_via_transpose_a_scale(
    ...
    %b_scale: tensor<1x512x8xf8E8M0FNU>) -> tensor<1x128x512xf32> attributes {rock.kernel} {
