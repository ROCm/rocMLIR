...
func.func @mlir_softmaxf32_attention(%arg0: tensor<786432xf16>, %arg1: tensor<786432xf16>, %arg2: tensor<786432xi8>, %arg3: tensor<786432xf16>, %arg4: tensor<786432xf16>) -> (tensor<786432xf16>) attributes {rock.kernel, rock.arch = "##TOKEN_ARCH##"} {
  ...
  %15 = "tosa.const"() <{values = dense<1.000000e+00> : tensor<12x256x256xf32>}> : () -> tensor<12x256x256xf32>
  %shift = "tosa.const"() <{values = dense<0> : tensor<1xi8>}> : () -> tensor<1xi8> 
  %16 = tosa.mul %13, %15, %shift : (tensor<12x256x1xf32>, tensor<12x256x256xf32>, tensor<1xi8>) -> tensor<12x256x256xf32>
  ...
  %20 = tosa.mul %19, %15, %shift : (tensor<12x256x1xf32>, tensor<12x256x256xf32>, tensor<1xi8>) -> tensor<12x256x256xf32>
...
func.func @mlir_softmaxf64_attention(%arg0: tensor<786432xf16>, %arg1: tensor<786432xf16>, %arg2: tensor<786432xi8>, %arg3: tensor<786432xf16>, %arg4: tensor<786432xf16>) -> (tensor<786432xf16>) attributes {rock.kernel, rock.arch = "##TOKEN_ARCH##"} {
  ...
  %14 = tosa.const_shape  {values = dense<[12, 256, 1]> : tensor<3xindex>} : () -> !tosa.shape<3>
  %15 = "tosa.const"() <{values = dense<1.000000e+00> : tensor<12x256x256xf64>}> : () -> tensor<12x256x256xf64>
  %shift = "tosa.const"() <{values = dense<0> : tensor<1xi8>}> : () -> tensor<1xi8> 
  %16 = tosa.mul %13, %15, %shift : (tensor<12x256x1xf64>, tensor<12x256x256xf64>, tensor<1xi8>) -> tensor<12x256x256xf64>
  ...
  %20 = tosa.mul %19, %15, %shift : (tensor<12x256x1xf64>, tensor<12x256x256xf64>, tensor<1xi8>) -> tensor<12x256x256xf64>
...
func.func @mlir_softmaxf32_lse_attention(%arg0: tensor<786432xf16>, %arg1: tensor<786432xf16>, %arg2: tensor<786432xi8>, %arg3: tensor<786432xf16>, %arg4: tensor<786432xf16>) -> (tensor<786432xf16>, tensor<3072xf16>) attributes {rock.kernel, rock.arch = "##TOKEN_ARCH##"} {
  %0 = tosa.const_shape  {values = dense<[12, 256, 256]> : tensor<3xindex>} : () -> !tosa.shape<3>
  %expanded = tensor.expand_shape %arg4 [[0, 1, 2]] output_shape [12, 256, 256] : tensor<786432xf16> into tensor<12x256x256xf16>
  %expanded_0 = tensor.expand_shape %arg2 [[0, 1, 2]] output_shape [12, 256, 256] : tensor<786432xi8> into tensor<12x256x256xi8>
  %1 = tosa.const_shape  {values = dense<[1, 12, 256, 256]> : tensor<4xindex>} : () -> !tosa.shape<4>
...
func.func @mlir_softmaxf32_attention_with_scaling(%arg0: tensor<48225280xf16>, %arg1: tensor<48225280xf16>, %arg2: tensor<48225280xf16>) -> tensor<48225280xf16> attributes {rock.arch = "gfx942", rock.kernel = "mixr", rock.num_cu = 304 : i64} {
  ...
  %16 = "tosa.const"() <{values = dense<1.000000e+00> : tensor<1x5x75352x75352xf32>}> : () -> tensor<1x5x75352x75352xf32>
  %shift = "tosa.const"() <{values = dense<0> : tensor<1xi8>}> : () -> tensor<1xi8> 
  %17 = tosa.mul %14, %16, %shift : (tensor<1x5x75352x1xf32>, tensor<1x5x75352x75352xf32>, tensor<1xi8>) -> tensor<1x5x75352x75352xf32>
...
func.func @mlir_attention_convert_scale_bias_kvcache_softmax_convert(%arg0: tensor<12288xf16>, %arg1: tensor<4194304xf16>, %arg2: tensor<4194304xf16>, %arg3: tensor<32xi32>, %arg4: tensor<32768xf32>, %arg5: tensor<32768xf32>) -> tensor<4096xf16> attributes {rock.arch = "gfx942", rock.kernel} {
  ...
  %5 = "tosa.const"() <{values = dense<1> : tensor<1x32x1x1024xi32>}> : () -> tensor<1x32x1x1024xi32>
  %shift = "tosa.const"() <{values = dense<0> : tensor<1xi8>}> : () -> tensor<1xi8> 
  ...
  %20 = tosa.mul %0, %5, %shift : (tensor<1x1x1x1024xi32>, tensor<1x32x1x1024xi32>, tensor<1xi8>) -> tensor<1x32x1x1024xi32>
  %expanded_5 = tensor.expand_shape %arg3 [[0, 1, 2, 3]] output_shape [1, 32, 1, 1] : tensor<32xi32> into tensor<1x32x1x1xi32>
  %21 = tosa.mul %expanded_5, %5, %shift: (tensor<1x32x1x1xi32>, tensor<1x32x1x1024xi32>, tensor<1xi8>) -> tensor<1x32x1x1024xi32>
...
func.func @mlir_attention_scale_bias_kvcache_convert_softmax_convert(%arg0: tensor<12288xf16>, %arg1: tensor<4194304xf16>, %arg2: tensor<4194304xf16>, %arg3: tensor<32xi32>, %arg4: tensor<32768xf16>, %arg5: tensor<32768xf16>) -> tensor<4096xf16> attributes {rock.arch = "gfx942", rock.kernel} {
  ...
  %17 = tosa.mul %expanded_4, %expanded_0, %8 : (tensor<1x32x1x1024xf16>, tensor<1x32x1x1024xf16>, tensor<1xi8>) -> tensor<1x32x1x1024xf16>
  %18 = tosa.add %17, %expanded : (tensor<1x32x1x1024xf16>, tensor<1x32x1x1024xf16>) -> tensor<1x32x1x1024xf16>
  %19 = tosa.mul %0, %5, %shift : (tensor<1x1x1x1024xi32>, tensor<1x32x1x1024xi32>, tensor<1xi8>) -> tensor<1x32x1x1024xi32>
  %expanded_5 = tensor.expand_shape %arg3 [[0, 1, 2, 3]] output_shape [1, 32, 1, 1] : tensor<32xi32> into tensor<1x32x1x1xi32>
  %20 = tosa.mul %expanded_5, %5, %shift : (tensor<1x32x1x1xi32>, tensor<1x32x1x1024xi32>, tensor<1xi8>) -> tensor<1x32x1x1024xi32>
