...
module {
  func.func @mlir_attention(%arg0: tensor<65536xf16>, %arg1: tensor<65536xf16>, %arg2: tensor<65536xf16>) -> (tensor<131072xf16>, tensor<512xf32>) attributes {arch = "##TOKEN_ARCH##", kernel = "mixr"} {
