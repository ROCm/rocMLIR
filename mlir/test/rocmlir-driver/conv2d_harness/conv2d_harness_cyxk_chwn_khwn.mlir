...
// HARNESS: module
// HARNESS: func.func @rock_conv_gc01k_gc01n_gk01n_0([[FILTER_MEMREF:%.*]]: memref<9216xf32>, [[INPUT_MEMREF:%.*]]: memref<1048576xf32>, [[OUTPUT_MEMREF:%.*]]: memref<14745600xf32>)
// LOWERING: module
...
func.func @main() {
  ...
  // launch kernel.
  call @rock_conv_gc01k_gc01n_gk01n_0(%filter, %input, %output) : (memref<9216xf32>, memref<1048576xf32>, memref<14745600xf32>) -> ()
