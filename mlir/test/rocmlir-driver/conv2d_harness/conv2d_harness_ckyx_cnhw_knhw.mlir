...
func.func private @rock_conv_gck01_gcn01_gkn01_0(%filter : memref<9216xf32>, %input : memref<1048576xf32>, %output : memref<14745600xf32>) -> ()

// HARNESS: module
// HARNESS: func.func @rock_conv_gck01_gcn01_gkn01_0([[FILTER_MEMREF:%.*]]: memref<9216xf32>, [[INPUT_MEMREF:%.*]]: memref<1048576xf32>, [[OUTPUT_MEMREF:%.*]]: memref<14745600xf32>)
// LOWERING: module
...
func.func @main() {
  ...
  // launch kernel.
  call @rock_conv_gck01_gcn01_gkn01_0(%filter, %input, %output) : (memref<9216xf32>, memref<1048576xf32>, memref<14745600xf32>) -> ()
