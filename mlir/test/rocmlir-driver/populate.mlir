...
// F32-NEXT: rock.conv2d({{.*}}, {{.*}}, {{.*}})  features = dot {arch = "{{.*}}", dilations = [1, 1], filter_layout = ["g", "k", "c", "y", "x"], input_layout = ["ni", "gi", "ci", "hi", "wi"], numCU = {{.*}} : i32, output_layout = ["no", "go", "ko", "ho", "wo"], padding = [0, 0, 0, 0], strides = [1, 1]} : memref<1x128x8x3x3xf32>, memref<128x1x8x32x32xf32>, memref<128x1x128x30x30xf32>
...
// F16-NEXT: rock.conv2d({{.*}}, {{.*}}, {{.*}})  features = dot {arch = "{{.*}}", dilations = [1, 1], filter_layout = ["g", "k", "c", "y", "x"], input_layout = ["ni", "gi", "ci", "hi", "wi"], numCU = {{.*}} : i32, output_layout = ["no", "go", "ko", "ho", "wo"], padding = [0, 0, 0, 0], strides = [1, 1]} : memref<1x128x8x3x3xf16>, memref<128x1x8x32x32xf16>, memref<128x1x128x30x30xf16>
...
// BF16-NEXT: rock.conv2d({{.*}}, {{.*}}, {{.*}}) features = dot {arch = "{{.*}}", dilations = [1, 1], filter_layout = ["g", "k", "c", "y", "x"], input_layout = ["ni", "gi", "ci", "hi", "wi"], numCU = {{.*}} : i32, output_layout = ["no", "go", "ko", "ho", "wo"], padding = [0, 0, 0, 0], strides = [1, 1]} : memref<1x128x8x3x3xbf16>, memref<128x1x8x32x32xbf16>, memref<128x1x128x30x30xbf16>
...
// INT8-NEXT: rock.conv2d({{.*}}, {{.*}}, {{.*}}) features = dot {arch = "{{.*}}", dilations = [1, 1], filter_layout = ["g", "k", "c", "y", "x"], input_layout = ["ni", "gi", "ci", "hi", "wi"], numCU = {{.*}} : i32, output_layout = ["no", "go", "ko", "ho", "wo"], padding = [0, 0, 0, 0], strides = [1, 1]} : memref<1x128x8x3x3xi8>, memref<128x1x8x32x32xi8>, memref<128x1x128x30x30xi32>
