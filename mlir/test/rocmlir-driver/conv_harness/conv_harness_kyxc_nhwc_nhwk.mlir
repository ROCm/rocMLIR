...
func.func private @rock_conv_gk01c_n01gc_n01gk_0(%filter : memref<1x128x3x3x8xf32>, %input : memref<128x32x32x1x8xf32>, %output : memref<128x30x30x1x128xf32>) -> ()

// HARNESS: module
// HARNESS: func.func @rock_conv_gk01c_n01gc_n01gk_0([[FILTER_MEMREF:%.*]]: memref<1x128x3x3x8xf32>, [[INPUT_MEMREF:%.*]]: memref<128x32x32x1x8xf32>, [[OUTPUT_MEMREF:%.*]]: memref<128x30x30x1x128xf32>)
// LOWERING: module
// LOWERING: llvm.mlir.global internal constant @rock_conv_gk01c_n01gc_n01gk_0_module_gpubin_cst
...
func.func @main() {
  ...
  // launch kernel.
  call @rock_conv_gk01c_n01gc_n01gk_0(%filter, %input, %output) : (memref<1x128x3x3x8xf32>, memref<128x32x32x1x8xf32>, memref<128x30x30x1x128xf32>) -> ()
