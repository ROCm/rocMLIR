...
func.func private @rock_conv_g01ck_01gcn_01gkn_0(%filter : memref<1x3x3x8x128xf32>, %input : memref<32x32x1x8x128xf32>, %output : memref<30x30x1x128x128xf32>) -> ()

// HARNESS: module
// HARNESS: func.func @rock_conv_g01ck_01gcn_01gkn_0([[FILTER_MEMREF:%.*]]: memref<1x3x3x8x128xf32>, [[INPUT_MEMREF:%.*]]: memref<32x32x1x8x128xf32>, [[OUTPUT_MEMREF:%.*]]: memref<30x30x1x128x128xf32>)
// LOWERING: module
// LOWERING: llvm.mlir.global internal constant @rock_conv_g01ck_01gcn_01gkn_0_module_gpubin_cst
...
func.func @main() {
  ...
  // launch kernel.
  call @rock_conv_g01ck_01gcn_01gkn_0(%filter, %input, %output) : (memref<1x3x3x8x128xf32>, memref<32x32x1x8x128xf32>, memref<30x30x1x128x128xf32>) -> ()
