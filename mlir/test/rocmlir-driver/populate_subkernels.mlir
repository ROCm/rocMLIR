...
// KERNEL0-NEXT:  func.func @conv_fwd_0(%arg0: memref<1048576xf32>, %arg1: memref<12845056xf32>, %arg2: memref<12845056xf32>) attributes {enable_splitk_for_tuning, kernel = 0 : i32, mhal.arch = "{{.*}}", num_cu = {{.*}}} {
...
// KERNEL1-NEXT:  func.func @conv_fwd_1(%arg0: memref<1048576xf32>, %arg1: memref<12845056xf32>, %arg2: memref<12845056xf32>) attributes {enable_splitk_for_tuning, kernel = 1 : i32, mhal.arch = "{{.*}}", num_cu = {{.*}}} {
...
// KERNEL2-NEXT:  func.func @conv_fwd_2(%arg0: memref<1048576xf32>, %arg1: memref<12845056xf32>, %arg2: memref<12845056xf32>) attributes {enable_splitk_for_tuning, kernel = 2 : i32, mhal.arch = "{{.*}}", num_cu = {{.*}}} {
...
// KERNEL3-NEXT:  func.func @conv_fwd_3(%arg0: memref<1048576xf32>, %arg1: memref<12845056xf32>, %arg2: memref<12845056xf32>) attributes {enable_splitk_for_tuning, kernel = 3 : i32, mhal.arch = "{{.*}}", num_cu = {{.*}}} {
