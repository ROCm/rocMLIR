...
// BINARY-SAME: convert-gpu-to-rocdl{chipset=gfx90a index-bitwidth=0 runtime=HIP use-bare-ptr-memref-call-conv=true},
...
// BINARY_MI300-SAME: convert-gpu-to-rocdl{chipset=gfx940 index-bitwidth=0 runtime=HIP use-bare-ptr-memref-call-conv=true},
...
// HIGHLEVEL-SAME: func.func(tosa-to-linalg-named{prefer-conv2d-kernel-layout-hwcf=false}),
// HIGHLEVEL-SAME: func.func(canonicalize{  max-iterations=10 max-num-rewrites=-1 region-simplify=true test-convergence=false top-down=true}),
// HIGHLEVEL-SAME: func.func(tosa-layerwise-constant-fold{aggressive-reduce-constant=false}),
// HIGHLEVEL-SAME: func.func(tosa-make-broadcastable),
// HIGHLEVEL-SAME: tosa-validate{level=none profile=undefined strict-op-spec-alignment=false},
// HIGHLEVEL-SAME: func.func(tosa-to-linalg{aggressive-reduce-constant=false disable-tosa-decompositions=false}),
