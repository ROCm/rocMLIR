// RUN: rocmlir-gen -ph -p -rand=none | FileCheck %s
...
// RUN: rocmlir-gen -ph -p -rand 1| FileCheck %s --check-prefix=RAND1
...
// RUN: rocmlir-gen -ph -p -rand 2| FileCheck %s --check-prefix=RAND2
...
// RUN: rocmlir-gen -ph -p -rand 1 -rand_side filter | FileCheck %s --check-prefix=FWD_FILTER
...
// RUN: rocmlir-gen -ph -p -rand 1 -rand_side input | FileCheck %s --check-prefix=FWD_INPUT
...
// RUN: rocmlir-gen -ph -p -rand 1 -rand_side filter -operation conv2d_bwd_data | FileCheck %s --check-prefix=BWD_DATA_FILTER
...
// RUN: rocmlir-gen -ph -p -rand 1 -rand_side output  -operation conv2d_bwd_data | FileCheck %s --check-prefix=BWD_DATA_OUTPUT
...
// RUN: rocmlir-gen -ph -p -rand 1 -rand_side input -operation conv2d_bwd_weight | FileCheck %s --check-prefix=BWD_WEIGHT_INPUT
...
// RUN: rocmlir-gen -ph -p -rand 1 -rand_side output  -operation conv2d_bwd_weight | FileCheck %s --check-prefix=BWD_WEIGHT_OUTPUT
...
// RUN: rocmlir-gen -ph -p -rand 1 -rand_type float | FileCheck %s --check-prefix=RAND_FLOAT
