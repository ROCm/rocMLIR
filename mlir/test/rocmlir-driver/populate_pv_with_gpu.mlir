...
// GEMM-CHECK: rock.gemm {{.*}} = {{.*}} * {{.*}} features = mfma|dot|atomic_add|atomic_add_f16 storeMethod = {{.*}} {[[PARMS:.*]]} : memref<[[CDIMS:[x0-9]+]]xf32> = memref<[[ADIMS:[x0-9]+]]xf32> * memref<[[BDIMS:[x0-9]+]]xf32>
...
// GEMM-CHECK: rock.gemm {{.*}} = {{.*}} * {{.*}} features = dot|atomic_add|atomic_add_f16 storeMethod = {{.*}} {[[PARMS:.*]]} : memref<[[CDIMS]]xf32> = memref<[[ADIMS]]xf32> * memref<[[BDIMS]]xf32>
