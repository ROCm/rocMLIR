// RUN: rocmlir-gen --arch %targetChip  -p -feature mfma -pv_with_gpu | FileCheck %s
...
// RUN: rocmlir-gen --arch %targetChip  -p -t f16 -pv_with_gpu | FileCheck %s --check-prefix=F16-CHECK
