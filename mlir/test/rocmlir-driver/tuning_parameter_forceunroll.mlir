...
// UNROLL: #xdlops_gemm_params = #rock.mfma_gemm_params<kpackPerBlock = 64, mPerBlock = 16, nPerBlock = 16, kpack = 1, mPerWave = 16, nPerWave = 16, mnPerXdl = 32, forceUnroll = true>
...
// NOTUNROLL: #xdlops_gemm_params = #rock.mfma_gemm_params<kpackPerBlock = 64, mPerBlock = 16, nPerBlock = 16, kpack = 1, mPerWave = 16, nPerWave = 16, mnPerXdl = 32, forceUnroll = false>
...
// HEURISTIC: #xdlops_gemm_params = #rock.mfma_gemm_params<kpackPerBlock = 4, mPerBlock = 128, nPerBlock = 128, kpack = 4, mPerWave = 64, nPerWave = 64, mnPerXdl = 32, forceUnroll = true>
