...
// UNROLL: #xdlops_gemm_params = #rock.accel_gemm_params<kPerBlock = 64, mPerBlock = 16, nPerBlock = 16, kpack = 1, mPerWave = 16, nPerWave = 16, forceUnroll = true>
...
// NOTUNROLL: #xdlops_gemm_params = #rock.accel_gemm_params<kPerBlock = 64, mPerBlock = 16, nPerBlock = 16, kpack = 1, mPerWave = 16, nPerWave = 16, forceUnroll = false>
...
// HEURISTIC: #xdlops_gemm_params = #rock.accel_gemm_params<kPerBlock = 4, mPerBlock = 128, nPerBlock = 128, kpack = 4, mPerWave = 64, nPerWave = 64, forceUnroll = true>
