...
// RUNNER-SAME: convert-vector-to-llvm{enable-amx=false enable-arm-neon=false enable-arm-sme=false enable-arm-sve=false enable-x86vector=false force-32bit-vector-indices=true reassociate-fp-reductions=false use-opaque-pointers=true},
// RUNNER-SAME: finalize-memref-to-llvm{index-bitwidth=0 use-aligned-alloc=false use-generic-functions=false use-opaque-pointers=true},
...
// RUNNER-SAME: convert-async-to-llvm{use-opaque-pointers=true},
// RUNNER-SAME: gpu-to-llvm{gpu-binary-annotation=gpu.binary use-bare-pointers-for-host=false use-bare-pointers-for-kernels=true use-opaque-pointers=true},
// RUNNER-SAME: convert-func-to-llvm{data-layout= index-bitwidth=0 use-bare-ptr-memref-call-conv=false use-opaque-pointers=true},
