...
//PVGPU: rock.conv2d_bwd_weight(%arg0, %arg1, %arg2) features = mfma|dot|atomic_add, convParams = {padding : [1, 1, 1, 1], stride : [2, 2], dilation : [2, 2]} {arch = "gfx908", filter_layout = ["g", "k", "c", "y", "x"], gemm_id = 0 : i32, input_layout = ["ni", "gi", "ci", "hi", "wi"], numCu = 120 : i32, output_layout = ["no", "go", "ko", "ho", "wo"]} : memref<1x2048x1024x1x1xf32>, memref<256x1x1024x14x14xf32>, memref<256x1x2048x8x8xf32>
