...
// STRIDE2: {{rock.gemm.*gemm_id = 0 : i32.*}}
// STRIDE2: {{rock.gemm.*gemm_id = 1 : i32.*}}
// STRIDE2: {{rock.gemm.*gemm_id = 2 : i32.*}}
// STRIDE2: {{rock.gemm.*gemm_id = 3 : i32.*}}

// STRIDE2_GKYXC: {{rock.gemm.*gemm_id = 0 : i32.*}}
// STRIDE2_GKYXC: {{rock.gemm.*gemm_id = 1 : i32.*}}
