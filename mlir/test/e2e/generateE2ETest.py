...
The configuration files are in TOML format.  Below is an example:
    ...
    prefix = "rocmlir-gen"
    suffix = "--arch %targetChip %pv %random_data %features | rocmlir-driver -c | mlir-rocm-runner --shared-libs=%conv_validation_wrapper_library_dir/libconv-validation-wrappers%shlibext,%linalg_test_lib_dir/libmlir_runner_utils%shlibext --entry-point-result=void | FileCheck %s --check-prefix="
