...
// RUN: | mlir-opt --tosa-partition-pipeline --tosa-to-linalg --tosa-to-standard \
...
// RUN:   --convert-math-to-llvm --arith-expand --convert-std-to-llvm --reconcile-unrealized-casts \
