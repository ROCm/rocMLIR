...
static bool testReduceFusible(MlirContext ctx) {
  ...
  const char *mlirModuleText = R"mlir(
    module {
      func.func @mlir_convolution_reshape_reshape_broadcast_add_mul_reshape_reduce_sum_reshape_mul_mul_reshape_reduce_sum_reshape(%arg0: memref<32768xf32>, %arg1: memref<11520xf32>, %arg2: memref<320xf32>, %arg3: memref<64xf32> {mhal.read_access, rock.prefill = 0.000000e+00 : f32}, %arg4: memref<64xf32> {mhal.read_access, rock.prefill = 0.000000e+00 : f32}, %arg5: memref<2621440xf32>) attributes {rock.arch = "gfx942:sramecc+:xnack-", rock.enable_splitk_for_tuning, rock.kernel = "mixr", rock.num_cu = 304 : i64, rock.num_chiplets = 8 : i64} {
        ...
        %alloc_2 = memref.alloc() alignment = 64 : memref<2x32x1xf32>
