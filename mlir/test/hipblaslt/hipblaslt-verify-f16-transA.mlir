// RUN: %python %mlir_src_root/utils/performance/hipblaslt-benchmark-driver/verify_hipblaslt.py -m 256 -n 128 -k 64 -g 1 -t f16 --transA True \
...
// Verify hipblaslt GEMM f16 256x128x64 with transA produces correct results
// CHECK: PASSED
