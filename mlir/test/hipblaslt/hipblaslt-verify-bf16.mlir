// RUN: %python %mlir_src_root/utils/performance/hipblaslt-benchmark-driver/verify_hipblaslt.py -m 256 -n 256 -k 128 -g 1 -t bf16 \
...
// Verify hipblaslt GEMM bf16 256x256x128 produces correct results
// CHECK: PASSED
