// RUN: %python %mlir_src_root/utils/performance/hipblaslt-benchmark-driver/verify_hipblaslt.py -m 128 -n 128 -k 64 -g 1 -t f16 --transA True --transB True \
...
// Verify hipblaslt GEMM f16 128x128x64 with transA and transB produces correct results
// CHECK: PASSED
