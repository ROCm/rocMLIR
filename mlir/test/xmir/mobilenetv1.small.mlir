...
module {
// CHECK:  func private @mobilenetv1_outlined_part_0(%arg0: tensor<1x112x112x32xf32> {func.read_access}, %arg1: tensor<3x3x32x1xf32> {func.read_access}) -> (tensor<1x112x112x32xf32> {func.write_access}) attributes {kernel} {
