...
// CHECK-NEXT:    %[[T0:.*]], %[[RES0:.*]] = async.launch @mobilenetv1__part_0 (%arg0, %arg2) : (tensor<1x112x112x32xf32>, tensor<3x3x32x1xf32>) -> tensor<1x112x112x32xf32>
// CHECK-NEXT:    %[[T1:.*]], %[[RES1:.*]] = async.launch @mobilenetv1__part_1 [%[[T0]]] (%[[RES0]], %arg3) : (tensor<1x112x112x32xf32>, tensor<64x1x1x32xf32>) -> tensor<1x112x112x64xf32>
