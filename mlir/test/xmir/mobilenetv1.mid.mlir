...
module {
// CHECK:  func.func private @mobilenetv1__part_1(%arg0: memref<1x112x112x64xf32> {mhal.read_access}, %arg1: memref<3x3x64x1xf32> {mhal.read_access}, %arg2: memref<1x56x56x64xf32> {mhal.write_access}) {
...
// CHECK:   mhal.await %token_{{.*}} : !mhal.token
  ...
  func.func @mobilenetv1(%input_image: tensor<1x224x224x3xf32>, %f0: tensor<32x3x3x3xf32>, %f1: tensor<3x3x32x1xf32>, %f2: tensor<64x1x1x32xf32>, %f3: tensor<3x3x64x1xf32>, %f4: tensor<128x1x1x64xf32>) -> tensor<1x56x56x128xf32> {
    ...
    %conv0 = "tosa.conv2d"(%input_image, %f0, %bias0) {acc_type = f32, dilation = array<i64: 1, 1>, pad = array<i64: 1, 1, 1, 1>, stride = array<i64: 2, 2>} : (tensor<1x224x224x3xf32>, tensor<32x3x3x3xf32>, tensor<32xf32>) -> tensor<1x112x112x32xf32>
    ...
    %dwconv1 = "tosa.depthwise_conv2d"(%relu0, %f1, %bias0) {acc_type = f32, dilation = array<i64: 1, 1>, pad = array<i64: 1, 1, 1, 1>, stride = array<i64: 1, 1>} : (tensor<1x112x112x32xf32>, tensor<3x3x32x1xf32>, tensor<32xf32>) -> tensor<1x112x112x32xf32>
    ...
    %conv1 = "tosa.conv2d"(%relu1, %f2, %bias1) {acc_type = f32, dilation = array<i64: 1, 1>, pad = array<i64: 0, 0, 0, 0>, stride = array<i64: 1, 1>} : (tensor<1x112x112x32xf32>, tensor<64x1x1x32xf32>, tensor<64xf32>) -> tensor<1x112x112x64xf32>
    ...
    %dwconv2 = "tosa.depthwise_conv2d"(%relu2, %f3, %bias1) {acc_type = f32, dilation = array<i64: 1, 1>, pad = array<i64: 1, 1, 1, 1>, stride = array<i64: 2, 2>} : (tensor<1x112x112x64xf32>, tensor<3x3x64x1xf32>, tensor<64xf32>) -> tensor<1x56x56x64xf32>
    ...
    // matmul
    %conv2 = "tosa.conv2d"(%relu3, %f4, %bias2) {acc_type = f32, dilation = array<i64: 1, 1>, pad = array<i64: 0, 0, 0, 0>, stride = array<i64: 1, 1>} : (tensor<1x56x56x64xf32>, tensor<128x1x1x64xf32>, tensor<128xf32>) -> tensor<1x56x56x128xf32>
