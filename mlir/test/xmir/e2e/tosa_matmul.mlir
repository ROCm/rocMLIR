...
module attributes {torch.debug_module_name = "ResNet"} {
  // func.func @forward(%arg0: tensor<1x3x224x224xf32>) -> tensor<1x512x1000xf32> {
  func.func @forward(%arg0: tensor<1x1x512xf32>, %arg1: tensor<1x512x1000xf32>) -> tensor<1x1x1000xf32> {
    ...
    %358 = "tosa.matmul"(%arg0, %arg1) : (tensor<1x1x512xf32>, tensor<1x512x1000xf32>) -> tensor<1x1x1000xf32>
    ...
    return %358 : tensor<1x1x1000xf32>
  }
}
