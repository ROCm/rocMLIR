// RUN: rocmlir-driver -host-pipeline partition,highlevel -targets %arch %s | rocmlir-gen -ph -print-results -rand 1 -rand_type float -fut resnet50_part_12 --verifier clone - | rocmlir-driver -host-pipeline xmodel -kernel-pipeline full | xmir-runner --shared-libs=%linalg_test_lib_dir/libmlir_rocm_runtime%shlibext,%conv_validation_wrapper_library_dir/libconv-validation-wrappers%shlibext,%linalg_test_lib_dir/libmlir_runner_utils%shlibext,%linalg_test_lib_dir/libmlir_c_runner_utils%shlibext,%linalg_test_lib_dir/libmlir_async_runtime%shlibext --entry-point-result=void | FileCheck %s
// CHECK: RMS = {{.*}}e-08
// CHECK: [1 1 0]
module {
  func.func @resnet50_part_12(%arg0: tensor<2x128x50x50xf32> {func.read_access}, %arg1: tensor<128x128x3x3xf32> {func.read_access}, %arg2: tensor<1x128x1x1xf32> {func.read_access}, %arg3: tensor<1x128x1x1xf32> {func.read_access}, %arg4: tensor<1x128x1x1xf32> {func.read_access}, %arg5: tensor<1x128x1x1xf32> {func.read_access}) -> (tensor<2x128x25x25xf32> {func.write_access}) {
    ...
    %2 = "tosa.transpose"(%arg1, %1) : (tensor<128x128x3x3xf32>, tensor<4xi32>) -> tensor<128x3x3x128xf32>
    %3 = "tosa.transpose"(%arg0, %1) : (tensor<2x128x50x50xf32>, tensor<4xi32>) -> tensor<2x50x50x128xf32>
    %4 = "tosa.conv2d"(%3, %2, %0) {dilation = [1, 1], pad = [1, 1, 1, 1], stride = [2, 2]} : (tensor<2x50x50x128xf32>, tensor<128x3x3x128xf32>, tensor<128xf32>) -> tensor<2x25x25x128xf32>
