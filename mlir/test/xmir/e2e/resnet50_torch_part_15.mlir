// RUN: rocmlir-driver -host-pipeline partition,highlevel -targets %arch %s | rocmlir-gen -ph -print-results -rand 1 -rand_type float -fut resnet50_part_15 --verifier clone - | rocmlir-driver -host-pipeline xmodel -kernel-pipeline full | xmir-runner --shared-libs=%linalg_test_lib_dir/libmlir_rocm_runtime%shlibext,%conv_validation_wrapper_library_dir/libconv-validation-wrappers%shlibext,%linalg_test_lib_dir/libmlir_runner_utils%shlibext,%linalg_test_lib_dir/libmlir_c_runner_utils%shlibext,%linalg_test_lib_dir/libmlir_async_runtime%shlibext --entry-point-result=void | FileCheck %s
// CHECK: RMS = {{.*}}e-08
// CHECK: [1 1 0]
module {
  func.func @resnet50_part_15(%arg0: tensor<2x512x25x25xf32> {func.read_access}, %arg1: tensor<128x512x1x1xf32> {func.read_access}, %arg2: tensor<1x128x1x1xf32> {func.read_access}, %arg3: tensor<1x128x1x1xf32> {func.read_access}, %arg4: tensor<1x128x1x1xf32> {func.read_access}, %arg5: tensor<1x128x1x1xf32> {func.read_access}) -> (tensor<2x128x25x25xf32> {func.write_access}) {
