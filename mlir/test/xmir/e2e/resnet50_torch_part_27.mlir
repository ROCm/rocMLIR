// RUN: rocmlir-driver -host-pipeline partition,highlevel -targets %arch %s | rocmlir-gen -ph -print-results -rand 1 -rand_type float -fut resnet50_part_27 --verifier clone - | rocmlir-driver -host-pipeline xmodel -kernel-pipeline full | xmir-runner --shared-libs=%linalg_test_lib_dir/libmlir_rocm_runtime%shlibext,%conv_validation_wrapper_library_dir/libconv-validation-wrappers%shlibext,%linalg_test_lib_dir/libmlir_runner_utils%shlibext,%linalg_test_lib_dir/libmlir_c_runner_utils%shlibext,%linalg_test_lib_dir/libmlir_async_runtime%shlibext --entry-point-result=void | FileCheck %s
// CHECK: RMS = {{.*}}e-08
// CHECK: [1 1 0]
module {
  func.func @resnet50_part_27(%arg0: tensor<2x512x25x25xf32> {func.read_access}, %arg1: tensor<1024x512x1x1xf32> {func.read_access}, %arg2: tensor<1x1024x1x1xf32> {func.read_access}, %arg3: tensor<1x1024x1x1xf32> {func.read_access}, %arg4: tensor<1x1024x1x1xf32> {func.read_access}, %arg5: tensor<1x1024x1x1xf32> {func.read_access}) -> (tensor<2x1024x13x13xf32> {func.write_access}) {
    ...
    %2 = "tosa.transpose"(%arg1, %1) : (tensor<1024x512x1x1xf32>, tensor<4xi32>) -> tensor<1024x1x1x512xf32>
    %3 = "tosa.transpose"(%arg0, %1) : (tensor<2x512x25x25xf32>, tensor<4xi32>) -> tensor<2x25x25x512xf32>
    %4 = "tosa.conv2d"(%3, %2, %0) {dilation = [1, 1], pad = [0, 0, 0, 0], stride = [2, 2]} : (tensor<2x25x25x512xf32>, tensor<1024x1x1x512xf32>, tensor<1024xf32>) -> tensor<2x13x13x1024xf32>
    ...
    return %10 : tensor<2x1024x13x13xf32>
  }
}
