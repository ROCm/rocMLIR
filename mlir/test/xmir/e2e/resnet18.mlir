// RUN: rocmlir-driver -host-pipeline partition,highlevel -targets gfx908 %s | rocmlir-gen -ph -print-results -rand_type float -rand 1 -fut forward - | rocmlir-driver -host-pipeline xmodel -kernel-pipeline full -triple amdgcn-amd-amdhsa -targets gfx908 | xmir-runner --shared-libs=%mlir_lib_dir/libmlir_rocm_runtime%shlibext,%conv_validation_wrapper_library_dir/libconv-validation-wrappers%shlibext,%mlir_lib_dir/libmlir_runner_utils%shlibext,%mlir_lib_dir/libmlir_c_runner_utils%shlibext --entry-point-result=void | FileCheck %s
