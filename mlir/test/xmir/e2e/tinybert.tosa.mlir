...
module attributes {torch.debug_module_name = "BertTinyWrapper"} {
  func.func @forward(%arg0: tensor<2x128xi64>) -> tensor<2x128x30522xf32> {
    ...
    %30 = "tosa.slice"(%8) {size = [1, 128], start = [0, 0]} : (tensor<1x512xi64>) -> tensor<1x128xi64>
    %31 = "tosa.reshape"(%9) {new_shape = [1, 30522, 128]} : (tensor<30522x128xf32>) -> tensor<1x30522x128xf32>
    %32 = "tosa.reshape"(%arg0) {new_shape = [1, 256]} : (tensor<2x128xi64>) -> tensor<1x256xi64>
    ...
    %35 = "tosa.reshape"(%34) {new_shape = [2, 128, 128]} : (tensor<1x256x128xf32>) -> tensor<2x128x128xf32>
    %36 = "tosa.reshape"(%7) {new_shape = [1, 2, 128]} : (tensor<2x128xf32>) -> tensor<1x2x128xf32>
    %37 = "tosa.gather"(%36, %26) : (tensor<1x2x128xf32>, tensor<1x128xi32>) -> tensor<1x128x128xf32>
    %38 = "tosa.reshape"(%37) {new_shape = [2, 128, 128]} : (tensor<1x128x128xf32>) -> tensor<2x128x128xf32>
    %39 = "tosa.add"(%35, %38) : (tensor<2x128x128xf32>, tensor<2x128x128xf32>) -> tensor<2x128x128xf32>
    %40 = "tosa.reshape"(%4) {new_shape = [1, 512, 128]} : (tensor<512x128xf32>) -> tensor<1x512x128xf32>
    ...
    %52 = "tosa.reshape"(%0) {new_shape = [1, 1, 128]} : (tensor<128xf32>) -> tensor<1x1x128xf32>
    ...
    %59 = "tosa.reshape"(%58) {new_shape = [1, 128, 128]} : (tensor<128x128xf32>) -> tensor<1x128x128xf32>
    %60 = "tosa.reshape"(%57) {new_shape = [1, 256, 128]} : (tensor<2x128x128xf32>) -> tensor<1x256x128xf32>
    %61 = "tosa.transpose"(%59, %12) : (tensor<1x128x128xf32>, tensor<3xi32>) -> tensor<128x1x128xf32>
    %62 = "tosa.reshape"(%61) {new_shape = [1, 128, 128]} : (tensor<128x1x128xf32>) -> tensor<1x128x128xf32>
    %63 = "tosa.matmul"(%60, %62) : (tensor<1x256x128xf32>, tensor<1x128x128xf32>) -> tensor<1x256x128xf32>
    %64 = "tosa.reshape"(%63) {new_shape = [2, 128, 128]} : (tensor<1x256x128xf32>) -> tensor<2x128x128xf32>
    %65 = "tosa.add"(%64, %52) : (tensor<2x128x128xf32>, tensor<1x1x128xf32>) -> tensor<2x128x128xf32>
    %66 = "tosa.reshape"(%65) {new_shape = [2, 128, 2, 64]} : (tensor<2x128x128xf32>) -> tensor<2x128x2x64xf32>
    ...
    %69 = "tosa.reshape"(%67) {new_shape = [4, 128, 64]} : (tensor<2x2x128x64xf32>) -> tensor<4x128x64xf32>
    %70 = "tosa.reshape"(%68) {new_shape = [4, 64, 128]} : (tensor<2x2x64x128xf32>) -> tensor<4x64x128xf32>
    %71 = "tosa.matmul"(%69, %70) : (tensor<4x128x64xf32>, tensor<4x64x128xf32>) -> tensor<4x128x128xf32>
    %72 = "tosa.reshape"(%71) {new_shape = [2, 2, 128, 128]} : (tensor<4x128x128xf32>) -> tensor<2x2x128x128xf32>
    ...
    %83 = "tosa.reshape"(%82) {new_shape = [4, 128, 128]} : (tensor<2x2x128x128xf32>) -> tensor<4x128x128xf32>
    %84 = "tosa.matmul"(%83, %69) : (tensor<4x128x128xf32>, tensor<4x128x64xf32>) -> tensor<4x128x64xf32>
    %85 = "tosa.reshape"(%84) {new_shape = [2, 2, 128, 64]} : (tensor<4x128x64xf32>) -> tensor<2x2x128x64xf32>
    %86 = "tosa.transpose"(%85, %13) : (tensor<2x2x128x64xf32>, tensor<4xi64>) -> tensor<2x128x2x64xf32>
    %87 = "tosa.reshape"(%86) {new_shape = [1, 256, 128]} : (tensor<2x128x2x64xf32>) -> tensor<1x256x128xf32>
    %88 = "tosa.matmul"(%87, %62) : (tensor<1x256x128xf32>, tensor<1x128x128xf32>) -> tensor<1x256x128xf32>
    %89 = "tosa.reshape"(%88) {new_shape = [2, 128, 128]} : (tensor<1x256x128xf32>) -> tensor<2x128x128xf32>
    ...
    %104 = "tosa.reshape"(%103) {new_shape = [1, 128, 512]} : (tensor<128x512xf32>) -> tensor<1x128x512xf32>
    %105 = "tosa.reshape"(%102) {new_shape = [1, 256, 128]} : (tensor<2x128x128xf32>) -> tensor<1x256x128xf32>
    %106 = "tosa.transpose"(%104, %12) : (tensor<1x128x512xf32>, tensor<3xi32>) -> tensor<128x1x512xf32>
    %107 = "tosa.reshape"(%106) {new_shape = [1, 128, 512]} : (tensor<128x1x512xf32>) -> tensor<1x128x512xf32>
    %108 = "tosa.matmul"(%105, %107) : (tensor<1x256x128xf32>, tensor<1x128x512xf32>) -> tensor<1x256x512xf32>
    %109 = "tosa.reshape"(%108) {new_shape = [2, 128, 512]} : (tensor<1x256x512xf32>) -> tensor<2x128x512xf32>
    %110 = "tosa.reshape"(%5) {new_shape = [1, 1, 512]} : (tensor<512xf32>) -> tensor<1x1x512xf32>
    ...
    %137 = "tosa.reshape"(%136) {new_shape = [1, 512, 128]} : (tensor<512x128xf32>) -> tensor<1x512x128xf32>
    %138 = "tosa.reshape"(%135) {new_shape = [1, 256, 512]} : (tensor<2x128x512xf32>) -> tensor<1x256x512xf32>
    %139 = "tosa.transpose"(%137, %12) : (tensor<1x512x128xf32>, tensor<3xi32>) -> tensor<512x1x128xf32>
    %140 = "tosa.reshape"(%139) {new_shape = [1, 512, 128]} : (tensor<512x1x128xf32>) -> tensor<1x512x128xf32>
    %141 = "tosa.matmul"(%138, %140) : (tensor<1x256x512xf32>, tensor<1x512x128xf32>) -> tensor<1x256x128xf32>
    %142 = "tosa.reshape"(%141) {new_shape = [2, 128, 128]} : (tensor<1x256x128xf32>) -> tensor<2x128x128xf32>
    ...
    %156 = "tosa.reshape"(%155) {new_shape = [1, 256, 128]} : (tensor<2x128x128xf32>) -> tensor<1x256x128xf32>
    %157 = "tosa.matmul"(%156, %62) : (tensor<1x256x128xf32>, tensor<1x128x128xf32>) -> tensor<1x256x128xf32>
    %158 = "tosa.reshape"(%157) {new_shape = [2, 128, 128]} : (tensor<1x256x128xf32>) -> tensor<2x128x128xf32>
    %159 = "tosa.add"(%158, %52) : (tensor<2x128x128xf32>, tensor<1x1x128xf32>) -> tensor<2x128x128xf32>
    %160 = "tosa.reshape"(%159) {new_shape = [2, 128, 2, 64]} : (tensor<2x128x128xf32>) -> tensor<2x128x2x64xf32>
    ...
    %163 = "tosa.reshape"(%161) {new_shape = [4, 128, 64]} : (tensor<2x2x128x64xf32>) -> tensor<4x128x64xf32>
    %164 = "tosa.reshape"(%162) {new_shape = [4, 64, 128]} : (tensor<2x2x64x128xf32>) -> tensor<4x64x128xf32>
    %165 = "tosa.matmul"(%163, %164) : (tensor<4x128x64xf32>, tensor<4x64x128xf32>) -> tensor<4x128x128xf32>
    %166 = "tosa.reshape"(%165) {new_shape = [2, 2, 128, 128]} : (tensor<4x128x128xf32>) -> tensor<2x2x128x128xf32>
    ...
    %175 = "tosa.reshape"(%174) {new_shape = [4, 128, 128]} : (tensor<2x2x128x128xf32>) -> tensor<4x128x128xf32>
    %176 = "tosa.matmul"(%175, %163) : (tensor<4x128x128xf32>, tensor<4x128x64xf32>) -> tensor<4x128x64xf32>
    %177 = "tosa.reshape"(%176) {new_shape = [2, 2, 128, 64]} : (tensor<4x128x64xf32>) -> tensor<2x2x128x64xf32>
    %178 = "tosa.transpose"(%177, %13) : (tensor<2x2x128x64xf32>, tensor<4xi64>) -> tensor<2x128x2x64xf32>
    %179 = "tosa.reshape"(%178) {new_shape = [1, 256, 128]} : (tensor<2x128x2x64xf32>) -> tensor<1x256x128xf32>
    %180 = "tosa.matmul"(%179, %62) : (tensor<1x256x128xf32>, tensor<1x128x128xf32>) -> tensor<1x256x128xf32>
    %181 = "tosa.reshape"(%180) {new_shape = [2, 128, 128]} : (tensor<1x256x128xf32>) -> tensor<2x128x128xf32>
    ...
    %195 = "tosa.reshape"(%194) {new_shape = [1, 256, 128]} : (tensor<2x128x128xf32>) -> tensor<1x256x128xf32>
    %196 = "tosa.matmul"(%195, %107) : (tensor<1x256x128xf32>, tensor<1x128x512xf32>) -> tensor<1x256x512xf32>
    %197 = "tosa.reshape"(%196) {new_shape = [2, 128, 512]} : (tensor<1x256x512xf32>) -> tensor<2x128x512xf32>
    ...
    %223 = "tosa.reshape"(%222) {new_shape = [1, 256, 512]} : (tensor<2x128x512xf32>) -> tensor<1x256x512xf32>
    %224 = "tosa.matmul"(%223, %140) : (tensor<1x256x512xf32>, tensor<1x512x128xf32>) -> tensor<1x256x128xf32>
    %225 = "tosa.reshape"(%224) {new_shape = [2, 128, 128]} : (tensor<1x256x128xf32>) -> tensor<2x128x128xf32>
    ...
    %239 = "tosa.reshape"(%238) {new_shape = [1, 256, 128]} : (tensor<2x128x128xf32>) -> tensor<1x256x128xf32>
    %240 = "tosa.matmul"(%239, %62) : (tensor<1x256x128xf32>, tensor<1x128x128xf32>) -> tensor<1x256x128xf32>
    %241 = "tosa.reshape"(%240) {new_shape = [2, 128, 128]} : (tensor<1x256x128xf32>) -> tensor<2x128x128xf32>
    ...
    %279 = "tosa.reshape"(%278) {new_shape = [1, 128, 30522]} : (tensor<128x30522xf32>) -> tensor<1x128x30522xf32>
    %280 = "tosa.reshape"(%277) {new_shape = [1, 256, 128]} : (tensor<2x128x128xf32>) -> tensor<1x256x128xf32>
    %281 = "tosa.transpose"(%279, %12) : (tensor<1x128x30522xf32>, tensor<3xi32>) -> tensor<128x1x30522xf32>
    %282 = "tosa.reshape"(%281) {new_shape = [1, 128, 30522]} : (tensor<128x1x30522xf32>) -> tensor<1x128x30522xf32>
    %283 = "tosa.matmul"(%280, %282) : (tensor<1x256x128xf32>, tensor<1x128x30522xf32>) -> tensor<1x256x30522xf32>
    %284 = "tosa.reshape"(%283) {new_shape = [2, 128, 30522]} : (tensor<1x256x30522xf32>) -> tensor<2x128x30522xf32>
    %285 = "tosa.reshape"(%2) {new_shape = [1, 1, 30522]} : (tensor<30522xf32>) -> tensor<1x1x30522xf32>
