...
// CHECK: [1 1 1]
module {
  func.func @bert_part_3(%arg0: tensor<1x12x12x32xf32> {func.read_access}, %arg1: tensor<1x12x32x12xf32> {func.read_access}, %arg2: tensor<1x1x1x1xf32> {func.read_access}, %arg3: tensor<1x1x1x12xf32> {func.read_access}) -> (tensor<1x12x12x12xf32> {func.write_access}) {
