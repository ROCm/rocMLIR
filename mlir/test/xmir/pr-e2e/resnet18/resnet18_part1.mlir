...
module {
  func.func private @forward__part_1(%arg0: tensor<1x512x7x7xf32> {mhal.read_access}, %arg1: tensor<512x1x1xf32> {mhal.read_access}, %arg2: tensor<1x512x7x7xf32> {mhal.read_access}) -> (tensor<1x7x7x512xf32> {mhal.write_access}) {
    ...
    %2 = "tosa.const"() <{value = dense<2.87286908E-4> : tensor<512x3x3x512xf32>}> : () -> tensor<512x3x3x512xf32>
    %3 = "tosa.const"() <{value = dense<0.000000e+00> : tensor<512xf32>}> : () -> tensor<512xf32>
    %5 = "tosa.const"() <{value = dense<-0.0139527479> : tensor<1x512x1x1xf32>}> : () -> tensor<1x512x1x1xf32>
    ...
    %7 = "tosa.const"() <{value = dense<1.84192443> : tensor<1x512x1x1xf32>}> : () -> tensor<1x512x1x1xf32>
    %8 = "tosa.const"() <{value = dense<0.237053066> : tensor<1x512x1x1xf32>}> : () -> tensor<1x512x1x1xf32>
    ...
    %15 = tosa.add %14, %arg2 : (tensor<1x512x7x7xf32>, tensor<1x512x7x7xf32>) -> tensor<1x512x7x7xf32>
    %16 = tosa.clamp %15 {max_val = 3.40282347E+38 : f32, min_val = 0.000000e+00 : f32} : (tensor<1x512x7x7xf32>) -> tensor<1x512x7x7xf32>
    %17 = tosa.transpose %16 {perms = array<i32: 0, 2, 3, 1>} : (tensor<1x512x7x7xf32>) -> tensor<1x7x7x512xf32>
    return %17 : tensor<1x7x7x512xf32>
  }
}
