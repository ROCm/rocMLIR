...
module {
  func.func private @forward__part_4(%arg0: tensor<1x512x7x7xf32> {mhal.read_access}, %arg1: tensor<512x1x1xf32> {mhal.read_access}) -> (tensor<1x512x7x7xf32> {mhal.write_access}) {
    ...
    %2 = "tosa.const"() <{value = dense<1.62181284E-4> : tensor<512x3x3x512xf32>}> : () -> tensor<512x3x3x512xf32>
    %3 = "tosa.const"() <{value = dense<0.000000e+00> : tensor<512xf32>}> : () -> tensor<512xf32>
    %5 = "tosa.const"() <{value = dense<-0.232302353> : tensor<1x512x1x1xf32>}> : () -> tensor<1x512x1x1xf32>
    ...
    %7 = "tosa.const"() <{value = dense<0.447422773> : tensor<1x512x1x1xf32>}> : () -> tensor<1x512x1x1xf32>
