...
// RUN-DISABLE: rocmlir-driver -host-pipeline partition,highlevel -targets %arch %s | rocmlir-gen -ph -print-results -verifier clone -fut forward - | rocmlir-driver -host-pipeline mhal -kernel-pipeline full | xmir-runner --shared-libs=%linalg_test_lib_dir/libmlir_rocm_runtime%shlibext,%conv_validation_wrapper_library_dir/libconv-validation-wrappers %shlibext,%linalg_test_lib_dir/libmlir_runner_utils%shlibext,%linalg_test_lib_dir/libmlir_float16_utils%shlibext,%linalg_test_lib_dir/libmlir_c_runner_utils%shlibext,%linalg_test_lib_dir/libmlir_async_runtime%shlibext --entry-point-result=void | FileCheck %s
// COM: CHECK: [1 1 1]
...
module attributes {torch.debug_module_name = "BertTinyWrapper"} {
  func.func @forward(%arg0: tensor<2x128xi64>) -> tensor<2x128x30522xf32> {
    ...
    %29 = "tosa.mul"(%28, %24) {shift = 0 : i8} : (tensor<2x1x1x128xf32>, tensor<1x1x1x1xf32>) -> tensor<2x1x1x128xf32>
    ...
    %45 = "tosa.reduce_sum"(%43) {axis = 2 : i32} : (tensor<2x128x128xf32>) -> tensor<2x128x1xf32>
    %46 = "tosa.reshape"(%44) {new_shape = array<i64: 1, 1, 1>} : (tensor<1xf32>) -> tensor<1x1x1xf32>
    %47 = "tosa.mul"(%45, %46) {shift = 0 : i8} : (tensor<2x128x1xf32>, tensor<1x1x1xf32>) -> tensor<2x128x1xf32>
    %48 = "tosa.sub"(%43, %47) : (tensor<2x128x128xf32>, tensor<2x128x1xf32>) -> tensor<2x128x128xf32>
    %49 = "tosa.mul"(%48, %48) {shift = 0 : i8} : (tensor<2x128x128xf32>, tensor<2x128x128xf32>) -> tensor<2x128x128xf32>
    %50 = "tosa.reduce_sum"(%49) {axis = 2 : i32} : (tensor<2x128x128xf32>) -> tensor<2x128x1xf32>
    %51 = "tosa.mul"(%50, %46) {shift = 0 : i8} : (tensor<2x128x1xf32>, tensor<1x1x1xf32>) -> tensor<2x128x1xf32>
    ...
    %55 = "tosa.mul"(%48, %54) {shift = 0 : i8} : (tensor<2x128x128xf32>, tensor<2x128x1xf32>) -> tensor<2x128x128xf32>
    %56 = "tosa.mul"(%55, %52) {shift = 0 : i8} : (tensor<2x128x128xf32>, tensor<1x1x128xf32>) -> tensor<2x128x128xf32>
    ...
    %75 = "tosa.mul"(%72, %74) {shift = 0 : i8} : (tensor<2x2x128x128xf32>, tensor<1x1x1x1xf32>) -> tensor<2x2x128x128xf32>
    %76 = "tosa.add"(%75, %29) : (tensor<2x2x128x128xf32>, tensor<2x1x1x128xf32>) -> tensor<2x2x128x128xf32>
    %77 = "tosa.reduce_max"(%76) {axis = 3 : i32} : (tensor<2x2x128x128xf32>) -> tensor<2x2x128x1xf32>
    ...
    %80 = "tosa.reduce_sum"(%79) {axis = 3 : i32} : (tensor<2x2x128x128xf32>) -> tensor<2x2x128x1xf32>
    %81 = "tosa.reciprocal"(%80) : (tensor<2x2x128x1xf32>) -> tensor<2x2x128x1xf32>
    %82 = "tosa.mul"(%79, %81) {shift = 0 : i8} : (tensor<2x2x128x128xf32>, tensor<2x2x128x1xf32>) -> tensor<2x2x128x128xf32>
    ...
    %92 = "tosa.reduce_sum"(%91) {axis = 2 : i32} : (tensor<2x128x128xf32>) -> tensor<2x128x1xf32>
    %93 = "tosa.mul"(%92, %46) {shift = 0 : i8} : (tensor<2x128x1xf32>, tensor<1x1x1xf32>) -> tensor<2x128x1xf32>
    %94 = "tosa.sub"(%91, %93) : (tensor<2x128x128xf32>, tensor<2x128x1xf32>) -> tensor<2x128x128xf32>
    %95 = "tosa.mul"(%94, %94) {shift = 0 : i8} : (tensor<2x128x128xf32>, tensor<2x128x128xf32>) -> tensor<2x128x128xf32>
    %96 = "tosa.reduce_sum"(%95) {axis = 2 : i32} : (tensor<2x128x128xf32>) -> tensor<2x128x1xf32>
    %97 = "tosa.mul"(%96, %46) {shift = 0 : i8} : (tensor<2x128x1xf32>, tensor<1x1x1xf32>) -> tensor<2x128x1xf32>
    ...
    %100 = "tosa.mul"(%94, %99) {shift = 0 : i8} : (tensor<2x128x128xf32>, tensor<2x128x1xf32>) -> tensor<2x128x128xf32>
    %101 = "tosa.mul"(%100, %52) {shift = 0 : i8} : (tensor<2x128x128xf32>, tensor<1x1x128xf32>) -> tensor<2x128x128xf32>
    ...
    %113 = "tosa.mul"(%112, %20) {shift = 0 : i8} : (tensor<2x128x512xf32>, tensor<1x1x1xf32>) -> tensor<2x128x512xf32>
    %114 = "tosa.abs"(%113) : (tensor<2x128x512xf32>) -> tensor<2x128x512xf32>
    %115 = "tosa.mul"(%114, %19) {shift = 0 : i8} : (tensor<2x128x512xf32>, tensor<1x1x1xf32>) -> tensor<2x128x512xf32>
    %116 = "tosa.add"(%115, %23) : (tensor<2x128x512xf32>, tensor<1x1x1xf32>) -> tensor<2x128x512xf32>
    %117 = "tosa.mul"(%114, %114) {shift = 0 : i8} : (tensor<2x128x512xf32>, tensor<2x128x512xf32>) -> tensor<2x128x512xf32>
    %118 = "tosa.mul"(%117, %18) {shift = 0 : i8} : (tensor<2x128x512xf32>, tensor<1x1x1xf32>) -> tensor<2x128x512xf32>
    %119 = "tosa.add"(%116, %118) : (tensor<2x128x512xf32>, tensor<2x128x512xf32>) -> tensor<2x128x512xf32>
    %120 = "tosa.mul"(%117, %114) {shift = 0 : i8} : (tensor<2x128x512xf32>, tensor<2x128x512xf32>) -> tensor<2x128x512xf32>
    %121 = "tosa.mul"(%120, %17) {shift = 0 : i8} : (tensor<2x128x512xf32>, tensor<1x1x1xf32>) -> tensor<2x128x512xf32>
    %122 = "tosa.add"(%119, %121) : (tensor<2x128x512xf32>, tensor<2x128x512xf32>) -> tensor<2x128x512xf32>
    %123 = "tosa.mul"(%120, %114) {shift = 0 : i8} : (tensor<2x128x512xf32>, tensor<2x128x512xf32>) -> tensor<2x128x512xf32>
    %124 = "tosa.mul"(%123, %16) {shift = 0 : i8} : (tensor<2x128x512xf32>, tensor<1x1x1xf32>) -> tensor<2x128x512xf32>
    ...
    %127 = "tosa.mul"(%126, %126) {shift = 0 : i8} : (tensor<2x128x512xf32>, tensor<2x128x512xf32>) -> tensor<2x128x512xf32>
    %128 = "tosa.mul"(%127, %127) {shift = 0 : i8} : (tensor<2x128x512xf32>, tensor<2x128x512xf32>) -> tensor<2x128x512xf32>
    ...
    %134 = "tosa.mul"(%133, %15) {shift = 0 : i8} : (tensor<2x128x512xf32>, tensor<1x1x1xf32>) -> tensor<2x128x512xf32>
    %135 = "tosa.mul"(%111, %134) {shift = 0 : i8} : (tensor<2x128x512xf32>, tensor<2x128x512xf32>) -> tensor<2x128x512xf32>
    ...
    %145 = "tosa.reduce_sum"(%144) {axis = 2 : i32} : (tensor<2x128x128xf32>) -> tensor<2x128x1xf32>
    %146 = "tosa.mul"(%145, %46) {shift = 0 : i8} : (tensor<2x128x1xf32>, tensor<1x1x1xf32>) -> tensor<2x128x1xf32>
    %147 = "tosa.sub"(%144, %146) : (tensor<2x128x128xf32>, tensor<2x128x1xf32>) -> tensor<2x128x128xf32>
    %148 = "tosa.mul"(%147, %147) {shift = 0 : i8} : (tensor<2x128x128xf32>, tensor<2x128x128xf32>) -> tensor<2x128x128xf32>
    %149 = "tosa.reduce_sum"(%148) {axis = 2 : i32} : (tensor<2x128x128xf32>) -> tensor<2x128x1xf32>
    %150 = "tosa.mul"(%149, %46) {shift = 0 : i8} : (tensor<2x128x1xf32>, tensor<1x1x1xf32>) -> tensor<2x128x1xf32>
    ...
    %153 = "tosa.mul"(%147, %152) {shift = 0 : i8} : (tensor<2x128x128xf32>, tensor<2x128x1xf32>) -> tensor<2x128x128xf32>
    %154 = "tosa.mul"(%153, %52) {shift = 0 : i8} : (tensor<2x128x128xf32>, tensor<1x1x128xf32>) -> tensor<2x128x128xf32>
    ...
    %167 = "tosa.mul"(%166, %74) {shift = 0 : i8} : (tensor<2x2x128x128xf32>, tensor<1x1x1x1xf32>) -> tensor<2x2x128x128xf32>
    %168 = "tosa.add"(%167, %29) : (tensor<2x2x128x128xf32>, tensor<2x1x1x128xf32>) -> tensor<2x2x128x128xf32>
    %169 = "tosa.reduce_max"(%168) {axis = 3 : i32} : (tensor<2x2x128x128xf32>) -> tensor<2x2x128x1xf32>
    ...
    %172 = "tosa.reduce_sum"(%171) {axis = 3 : i32} : (tensor<2x2x128x128xf32>) -> tensor<2x2x128x1xf32>
    %173 = "tosa.reciprocal"(%172) : (tensor<2x2x128x1xf32>) -> tensor<2x2x128x1xf32>
    %174 = "tosa.mul"(%171, %173) {shift = 0 : i8} : (tensor<2x2x128x128xf32>, tensor<2x2x128x1xf32>) -> tensor<2x2x128x128xf32>
    ...
    %184 = "tosa.reduce_sum"(%183) {axis = 2 : i32} : (tensor<2x128x128xf32>) -> tensor<2x128x1xf32>
    %185 = "tosa.mul"(%184, %46) {shift = 0 : i8} : (tensor<2x128x1xf32>, tensor<1x1x1xf32>) -> tensor<2x128x1xf32>
    %186 = "tosa.sub"(%183, %185) : (tensor<2x128x128xf32>, tensor<2x128x1xf32>) -> tensor<2x128x128xf32>
    %187 = "tosa.mul"(%186, %186) {shift = 0 : i8} : (tensor<2x128x128xf32>, tensor<2x128x128xf32>) -> tensor<2x128x128xf32>
    %188 = "tosa.reduce_sum"(%187) {axis = 2 : i32} : (tensor<2x128x128xf32>) -> tensor<2x128x1xf32>
    %189 = "tosa.mul"(%188, %46) {shift = 0 : i8} : (tensor<2x128x1xf32>, tensor<1x1x1xf32>) -> tensor<2x128x1xf32>
    ...
    %192 = "tosa.mul"(%186, %191) {shift = 0 : i8} : (tensor<2x128x128xf32>, tensor<2x128x1xf32>) -> tensor<2x128x128xf32>
    %193 = "tosa.mul"(%192, %52) {shift = 0 : i8} : (tensor<2x128x128xf32>, tensor<1x1x128xf32>) -> tensor<2x128x128xf32>
    ...
    %200 = "tosa.mul"(%199, %20) {shift = 0 : i8} : (tensor<2x128x512xf32>, tensor<1x1x1xf32>) -> tensor<2x128x512xf32>
    %201 = "tosa.abs"(%200) : (tensor<2x128x512xf32>) -> tensor<2x128x512xf32>
    %202 = "tosa.mul"(%201, %19) {shift = 0 : i8} : (tensor<2x128x512xf32>, tensor<1x1x1xf32>) -> tensor<2x128x512xf32>
    %203 = "tosa.add"(%202, %23) : (tensor<2x128x512xf32>, tensor<1x1x1xf32>) -> tensor<2x128x512xf32>
    %204 = "tosa.mul"(%201, %201) {shift = 0 : i8} : (tensor<2x128x512xf32>, tensor<2x128x512xf32>) -> tensor<2x128x512xf32>
    %205 = "tosa.mul"(%204, %18) {shift = 0 : i8} : (tensor<2x128x512xf32>, tensor<1x1x1xf32>) -> tensor<2x128x512xf32>
    %206 = "tosa.add"(%203, %205) : (tensor<2x128x512xf32>, tensor<2x128x512xf32>) -> tensor<2x128x512xf32>
    %207 = "tosa.mul"(%204, %201) {shift = 0 : i8} : (tensor<2x128x512xf32>, tensor<2x128x512xf32>) -> tensor<2x128x512xf32>
    %208 = "tosa.mul"(%207, %17) {shift = 0 : i8} : (tensor<2x128x512xf32>, tensor<1x1x1xf32>) -> tensor<2x128x512xf32>
    %209 = "tosa.add"(%206, %208) : (tensor<2x128x512xf32>, tensor<2x128x512xf32>) -> tensor<2x128x512xf32>
    %210 = "tosa.mul"(%207, %201) {shift = 0 : i8} : (tensor<2x128x512xf32>, tensor<2x128x512xf32>) -> tensor<2x128x512xf32>
    %211 = "tosa.mul"(%210, %16) {shift = 0 : i8} : (tensor<2x128x512xf32>, tensor<1x1x1xf32>) -> tensor<2x128x512xf32>
    ...
    %214 = "tosa.mul"(%213, %213) {shift = 0 : i8} : (tensor<2x128x512xf32>, tensor<2x128x512xf32>) -> tensor<2x128x512xf32>
    %215 = "tosa.mul"(%214, %214) {shift = 0 : i8} : (tensor<2x128x512xf32>, tensor<2x128x512xf32>) -> tensor<2x128x512xf32>
    ...
    %221 = "tosa.mul"(%220, %15) {shift = 0 : i8} : (tensor<2x128x512xf32>, tensor<1x1x1xf32>) -> tensor<2x128x512xf32>
    %222 = "tosa.mul"(%198, %221) {shift = 0 : i8} : (tensor<2x128x512xf32>, tensor<2x128x512xf32>) -> tensor<2x128x512xf32>
    ...
    %228 = "tosa.reduce_sum"(%227) {axis = 2 : i32} : (tensor<2x128x128xf32>) -> tensor<2x128x1xf32>
    %229 = "tosa.mul"(%228, %46) {shift = 0 : i8} : (tensor<2x128x1xf32>, tensor<1x1x1xf32>) -> tensor<2x128x1xf32>
    %230 = "tosa.sub"(%227, %229) : (tensor<2x128x128xf32>, tensor<2x128x1xf32>) -> tensor<2x128x128xf32>
    %231 = "tosa.mul"(%230, %230) {shift = 0 : i8} : (tensor<2x128x128xf32>, tensor<2x128x128xf32>) -> tensor<2x128x128xf32>
    %232 = "tosa.reduce_sum"(%231) {axis = 2 : i32} : (tensor<2x128x128xf32>) -> tensor<2x128x1xf32>
    %233 = "tosa.mul"(%232, %46) {shift = 0 : i8} : (tensor<2x128x1xf32>, tensor<1x1x1xf32>) -> tensor<2x128x1xf32>
    ...
    %236 = "tosa.mul"(%230, %235) {shift = 0 : i8} : (tensor<2x128x128xf32>, tensor<2x128x1xf32>) -> tensor<2x128x128xf32>
    %237 = "tosa.mul"(%236, %52) {shift = 0 : i8} : (tensor<2x128x128xf32>, tensor<1x1x128xf32>) -> tensor<2x128x128xf32>
    ...
    %244 = "tosa.mul"(%243, %20) {shift = 0 : i8} : (tensor<2x128x128xf32>, tensor<1x1x1xf32>) -> tensor<2x128x128xf32>
    %245 = "tosa.abs"(%244) : (tensor<2x128x128xf32>) -> tensor<2x128x128xf32>
    %246 = "tosa.mul"(%245, %19) {shift = 0 : i8} : (tensor<2x128x128xf32>, tensor<1x1x1xf32>) -> tensor<2x128x128xf32>
    %247 = "tosa.add"(%246, %23) : (tensor<2x128x128xf32>, tensor<1x1x1xf32>) -> tensor<2x128x128xf32>
    %248 = "tosa.mul"(%245, %245) {shift = 0 : i8} : (tensor<2x128x128xf32>, tensor<2x128x128xf32>) -> tensor<2x128x128xf32>
    %249 = "tosa.mul"(%248, %18) {shift = 0 : i8} : (tensor<2x128x128xf32>, tensor<1x1x1xf32>) -> tensor<2x128x128xf32>
    %250 = "tosa.add"(%247, %249) : (tensor<2x128x128xf32>, tensor<2x128x128xf32>) -> tensor<2x128x128xf32>
    %251 = "tosa.mul"(%248, %245) {shift = 0 : i8} : (tensor<2x128x128xf32>, tensor<2x128x128xf32>) -> tensor<2x128x128xf32>
    %252 = "tosa.mul"(%251, %17) {shift = 0 : i8} : (tensor<2x128x128xf32>, tensor<1x1x1xf32>) -> tensor<2x128x128xf32>
    %253 = "tosa.add"(%250, %252) : (tensor<2x128x128xf32>, tensor<2x128x128xf32>) -> tensor<2x128x128xf32>
    %254 = "tosa.mul"(%251, %245) {shift = 0 : i8} : (tensor<2x128x128xf32>, tensor<2x128x128xf32>) -> tensor<2x128x128xf32>
    %255 = "tosa.mul"(%254, %16) {shift = 0 : i8} : (tensor<2x128x128xf32>, tensor<1x1x1xf32>) -> tensor<2x128x128xf32>
    ...
    %258 = "tosa.mul"(%257, %257) {shift = 0 : i8} : (tensor<2x128x128xf32>, tensor<2x128x128xf32>) -> tensor<2x128x128xf32>
    %259 = "tosa.mul"(%258, %258) {shift = 0 : i8} : (tensor<2x128x128xf32>, tensor<2x128x128xf32>) -> tensor<2x128x128xf32>
    ...
    %265 = "tosa.mul"(%264, %15) {shift = 0 : i8} : (tensor<2x128x128xf32>, tensor<1x1x1xf32>) -> tensor<2x128x128xf32>
    %266 = "tosa.mul"(%242, %265) {shift = 0 : i8} : (tensor<2x128x128xf32>, tensor<2x128x128xf32>) -> tensor<2x128x128xf32>
    %267 = "tosa.reduce_sum"(%266) {axis = 2 : i32} : (tensor<2x128x128xf32>) -> tensor<2x128x1xf32>
    %268 = "tosa.mul"(%267, %46) {shift = 0 : i8} : (tensor<2x128x1xf32>, tensor<1x1x1xf32>) -> tensor<2x128x1xf32>
    %269 = "tosa.sub"(%266, %268) : (tensor<2x128x128xf32>, tensor<2x128x1xf32>) -> tensor<2x128x128xf32>
    %270 = "tosa.mul"(%269, %269) {shift = 0 : i8} : (tensor<2x128x128xf32>, tensor<2x128x128xf32>) -> tensor<2x128x128xf32>
    %271 = "tosa.reduce_sum"(%270) {axis = 2 : i32} : (tensor<2x128x128xf32>) -> tensor<2x128x1xf32>
    %272 = "tosa.mul"(%271, %46) {shift = 0 : i8} : (tensor<2x128x1xf32>, tensor<1x1x1xf32>) -> tensor<2x128x1xf32>
    ...
    %275 = "tosa.mul"(%269, %274) {shift = 0 : i8} : (tensor<2x128x128xf32>, tensor<2x128x1xf32>) -> tensor<2x128x128xf32>
    %276 = "tosa.mul"(%275, %52) {shift = 0 : i8} : (tensor<2x128x128xf32>, tensor<1x1x128xf32>) -> tensor<2x128x128xf32>
