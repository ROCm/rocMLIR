...
// RUN:   --target=%targets --shared-libs=%linalg_test_lib_dir/libmlir_rocm_runtime%shlibext,%conv_validation_wrapper_library_dir/libconv-validation-wrappers%shlibext \
// RUN:   --target=%targets --shared-libs=%linalg_test_lib_dir/libmlir_runner_utils%shlibext \
