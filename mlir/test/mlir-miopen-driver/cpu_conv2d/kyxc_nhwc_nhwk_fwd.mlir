...
// RUN: mlir-miopen-driver -prc -fil_layout=kyxc -in_layout=nhwc -out_layout=nhwk  -batchsize=1 -in_channels=2 -out_channels=2 -in_h=8 -in_w=8 -fil_h=1 -fil_w=1 --dilation_h=1 --dilation_w=1 --padding_h=0 --padding_w=0 --conv_stride_h=1 --conv_stride_w=1 -p=false  -c | mlir-rocm-runner --shared-libs=%rocm_wrapper_library_dir/librocm-runtime-wrappers%shlibext,%linalg_test_lib_dir/libmlir_runner_utils%shlibext --entry-point-result=void | FileCheck %s --check-prefix=CHECK1
// CHECK1: Unranked Memref base@ = 0x{{.*}} rank = 4 offset = 0 sizes = [1, 8, 8, 2] strides = [128, 16, 2, 1] data = 
...
// CHECK2: Unranked Memref base@ = 0x{{.*}} rank = 4 offset = 0 sizes = [1, 8, 8, 2] strides = [128, 16, 2, 1] data = 
...
// CHECK3: Unranked Memref base@ = 0x{{.*}} rank = 4 offset = 0 sizes = [1, 10, 10, 2] strides = [200, 20, 2, 1] data = 
...
// CHECK4: Unranked Memref base@ = 0x{{.*}} rank = 4 offset = 0 sizes = [1, 10, 10, 2] strides = [200, 20, 2, 1] data = 
...
// RUN: mlir-miopen-driver -prc -fil_layout=kyxc -in_layout=nhwc -out_layout=nhwk  -batchsize=1 -in_channels=2 -out_channels=2 -in_h=8 -in_w=8 -fil_h=1 -fil_w=1 --dilation_h=1 --dilation_w=1 --padding_h=0 --padding_w=0 --conv_stride_h=2 --conv_stride_w=2 -p=false  -c | mlir-rocm-runner --shared-libs=%rocm_wrapper_library_dir/librocm-runtime-wrappers%shlibext,%linalg_test_lib_dir/libmlir_runner_utils%shlibext --entry-point-result=void | FileCheck %s --check-prefix=CHECK5
// CHECK5: Unranked Memref base@ = 0x{{.*}} rank = 4 offset = 0 sizes = [1, 4, 4, 2] strides = [32, 8, 2, 1] data = 
...
// CHECK7: Unranked Memref base@ = 0x{{.*}} rank = 4 offset = 0 sizes = [1, 5, 5, 2] strides = [50, 10, 2, 1] data = 
...
// CHECK8: Unranked Memref base@ = 0x{{.*}} rank = 4 offset = 0 sizes = [1, 5, 5, 2] strides = [50, 10, 2, 1] data = 
...
// RUN: mlir-miopen-driver -prc -fil_layout=kyxc -in_layout=nhwc -out_layout=nhwk  -batchsize=1 -in_channels=2 -out_channels=2 -in_h=8 -in_w=8 -fil_h=3 -fil_w=3 --dilation_h=1 --dilation_w=1 --padding_h=0 --padding_w=0 --conv_stride_h=1 --conv_stride_w=1 -p=false  -c | mlir-rocm-runner --shared-libs=%rocm_wrapper_library_dir/librocm-runtime-wrappers%shlibext,%linalg_test_lib_dir/libmlir_runner_utils%shlibext --entry-point-result=void | FileCheck %s --check-prefix=CHECK9
...
// CHECK10: Unranked Memref base@ = 0x{{.*}} rank = 4 offset = 0 sizes = [1, 4, 4, 2] strides = [32, 8, 2, 1] data = 
...
// CHECK11: Unranked Memref base@ = 0x{{.*}} rank = 4 offset = 0 sizes = [1, 8, 8, 2] strides = [128, 16, 2, 1] data = 
...
// CHECK13: Unranked Memref base@ = 0x{{.*}} rank = 4 offset = 0 sizes = [1, 3, 3, 2] strides = [18, 6, 2, 1] data = 
...
// CHECK15: Unranked Memref base@ = 0x{{.*}} rank = 4 offset = 0 sizes = [1, 4, 4, 2] strides = [32, 8, 2, 1] data = 
...
// CHECK16: Unranked Memref base@ = 0x{{.*}} rank = 4 offset = 0 sizes = [1, 3, 3, 2] strides = [18, 6, 2, 1] data = 
