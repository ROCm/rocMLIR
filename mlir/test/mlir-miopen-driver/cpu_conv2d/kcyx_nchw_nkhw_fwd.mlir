...
// RUN: mlir-miopen-driver -prc -fil_layout=kcyx -in_layout=nchw -out_layout=nkhw  -batchsize=1 -in_channels=2 -out_channels=2 -in_h=8 -in_w=8 -fil_h=1 -fil_w=1   --dilation_h=1 --dilation_w=1 --padding_h=0 --padding_w=0 --conv_stride_h=1 --conv_stride_w=1 -p=false  -c | mlir-rocm-runner --shared-libs=%rocm_wrapper_library_dir/librocm-runtime-wrappers%shlibext,%linalg_test_lib_dir/libmlir_runner_utils%shlibext --entry-point-result=void | FileCheck %s --check-prefix=CHECK1
// CHECK1: Unranked Memref base@ = 0x{{.*}} rank = 4 offset = 0 sizes = [1, 2, 8, 8] strides = [128, 64, 8, 1] data = 
...
// CHECK2: Unranked Memref base@ = 0x{{.*}} rank = 4 offset = 0 sizes = [1, 2, 8, 8] strides = [128, 64, 8, 1] data = 
...
// CHECK3: Unranked Memref base@ = 0x{{.*}} rank = 4 offset = 0 sizes = [1, 2, 10, 10] strides = [200, 100, 10, 1] data = 
...
// CHECK4: Unranked Memref base@ = 0x{{.*}} rank = 4 offset = 0 sizes = [1, 2, 10, 10] strides = [200, 100, 10, 1] data = 
...
// RUN: mlir-miopen-driver -prc -fil_layout=kcyx -in_layout=nchw -out_layout=nkhw  -batchsize=1 -in_channels=2 -out_channels=2 -in_h=8 -in_w=8 -fil_h=1 -fil_w=1   --dilation_h=1 --dilation_w=1 --padding_h=0 --padding_w=0 --conv_stride_h=2 --conv_stride_w=2 -p=false  -c | mlir-rocm-runner --shared-libs=%rocm_wrapper_library_dir/librocm-runtime-wrappers%shlibext,%linalg_test_lib_dir/libmlir_runner_utils%shlibext --entry-point-result=void | FileCheck %s --check-prefix=CHECK5
// CHECK5: Unranked Memref base@ = 0x{{.*}} rank = 4 offset = 0 sizes = [1, 2, 4, 4] strides = [32, 16, 4, 1] data = 
...
// CHECK6: Unranked Memref base@ = 0x{{.*}} rank = 4 offset = 0 sizes = [1, 2, 4, 4] strides = [32, 16, 4, 1] data = 
...
// RUN: mlir-miopen-driver -prc -fil_layout=kcyx -in_layout=nchw -out_layout=nkhw  -batchsize=1 -in_channels=2 -out_channels=2 -in_h=8 -in_w=8 -fil_h=1 -fil_w=1   --dilation_h=1 --dilation_w=1 --padding_h=1 --padding_w=1 --conv_stride_h=2 --conv_stride_w=2 -p=false  -c | mlir-rocm-runner --shared-libs=%rocm_wrapper_library_dir/librocm-runtime-wrappers%shlibext,%linalg_test_lib_dir/libmlir_runner_utils%shlibext --entry-point-result=void | FileCheck %s --check-prefix=CHECK7
// CHECK7: Unranked Memref base@ = 0x{{.*}} rank = 4 offset = 0 sizes = [1, 2, 5, 5] strides = [50, 25, 5, 1] data = 
...
// CHECK8: Unranked Memref base@ = 0x{{.*}} rank = 4 offset = 0 sizes = [1, 2, 5, 5] strides = [50, 25, 5, 1] data = 
...
// CHECK10: Unranked Memref base@ = 0x{{.*}} rank = 4 offset = 0 sizes = [1, 2, 4, 4] strides = [32, 16, 4, 1] data = 
...
// CHECK11: Unranked Memref base@ = 0x{{.*}} rank = 4 offset = 0 sizes = [1, 2, 8, 8] strides = [128, 64, 8, 1] data = 
...
// RUN: mlir-miopen-driver -prc -fil_layout=kcyx -in_layout=nchw -out_layout=nkhw  -batchsize=1 -in_channels=2 -out_channels=2 -in_h=8 -in_w=8 -fil_h=3 -fil_w=3   --dilation_h=1 --dilation_w=1 --padding_h=0 --padding_w=0 --conv_stride_h=2 --conv_stride_w=2 -p=false  -c | mlir-rocm-runner --shared-libs=%rocm_wrapper_library_dir/librocm-runtime-wrappers%shlibext,%linalg_test_lib_dir/libmlir_runner_utils%shlibext --entry-point-result=void | FileCheck %s --check-prefix=CHECK13
// CHECK13: Unranked Memref base@ = 0x{{.*}} rank = 4 offset = 0 sizes = [1, 2, 3, 3] strides = [18, 9, 3, 1] data = 
...
// CHECK14: Unranked Memref base@ = 0x{{.*}} rank = 4 offset = 0 sizes = [1, 2, 2, 2] strides = [8, 4, 2, 1] data = 
...
// CHECK15: Unranked Memref base@ = 0x{{.*}} rank = 4 offset = 0 sizes = [1, 2, 4, 4] strides = [32, 16, 4, 1] data = 
...
// CHECK16: Unranked Memref base@ = 0x{{.*}} rank = 4 offset = 0 sizes = [1, 2, 3, 3] strides = [18, 9, 3, 1] data = 
