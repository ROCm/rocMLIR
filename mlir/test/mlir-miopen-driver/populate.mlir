...
// F32-LABEL: module
// F32-NEXT: func @miopen_conv2d_gkcyx_ngchw_ngkhw({{.*}}: memref<1x128x8x3x3xf32>, {{.*}}: memref<128x1x8x32x32xf32>, {{.*}}: memref<128x1x128x30x30xf32>) attributes {kernel = 0 : i32}
...
// F16-LABEL: module
// F16-NEXT: func @miopen_conv2d_gkcyx_ngchw_ngkhw({{.*}}: memref<1x128x8x3x3xf16>, {{.*}}: memref<128x1x8x32x32xf16>, {{.*}}: memref<128x1x128x30x30xf16>) attributes {kernel = 0 : i32}
...
// BF16-LABEL: module
// BF16-NEXT: func @miopen_conv2d_gkcyx_ngchw_ngkhw({{.*}}: memref<1x128x8x3x3xi16>, {{.*}}: memref<128x1x8x32x32xi16>, {{.*}}: memref<128x1x128x30x30xi16>) attributes {kernel = 0 : i32}
