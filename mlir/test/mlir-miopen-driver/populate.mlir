...
// BF16-LABEL: module
// BF16-NEXT: func @miopen_conv2d_gkcyx_ngchw_ngkhw_0({{.*}}: memref<1x128x8x3x3xbf16>, {{.*}}: memref<128x1x8x32x32xbf16>, {{.*}}: memref<128x1x128x30x30xbf16>) attributes {kernel = 0 : i32}
...
// INT8-LABEL: module
// INT8-NEXT: func @miopen_conv2d_gkcyx_ngchw_ngkhw_0({{.*}}: memref<1x128x8x3x3xi8>, {{.*}}: memref<128x1x8x32x32xi8>, {{.*}}: memref<128x1x128x30x30xi32>) attributes {kernel = 0 : i32} {
