...
// LOWERING: gpu.launch_func  @miopen_kernel_module::@miopen_conv2d_kcyx_nchw_nkhw blocks in (%{{.*}}, %{{.*}}, %{{.*}}) threads in (%{{.*}}, %{{.*}}, %{{.*}}) args([[FILTER_MEMREF]] : memref<3x3x8x128xf32>, [[INPUT_MEMREF]] : memref<32x32x8x128xf32>, [[OUTPUT_MEMREF]] : memref<30x30x128x128xf32>)
