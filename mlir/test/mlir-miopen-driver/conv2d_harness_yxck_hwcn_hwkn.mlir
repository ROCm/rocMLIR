...
// LOWERING: gpu.launch_func  @miopen_kernel_module::@miopen_conv2d_gyxck_hwgcn_hwgkn blocks in (%{{.*}}, %{{.*}}, %{{.*}}) threads in (%{{.*}}, %{{.*}}, %{{.*}}) args([[FILTER_MEMREF]] : memref<1x3x3x8x128xf32>, [[INPUT_MEMREF]] : memref<32x32x1x8x128xf32>, [[OUTPUT_MEMREF]] : memref<30x30x1x128x128xf32>)
