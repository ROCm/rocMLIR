...
// LOWERING: gpu.launch_func  @miopen_kernel_module::@miopen_conv2d_gcyxk_gchwn_gkhwn blocks in (%{{.*}}, %{{.*}}, %{{.*}}) threads in (%{{.*}}, %{{.*}}, %{{.*}}) args([[FILTER_MEMREF]] : memref<1x8x3x3x128xf32>, [[INPUT_MEMREF]] : memref<1x8x32x32x128xf32>, [[OUTPUT_MEMREF]] : memref<1x128x30x30x128xf32>)
