...
// RUN: miopen-gen -p -x2 | mlir-miopen-driver -miopen-affix-params -miopen-conv-to-gemm -miopen-gridwise-gemm-to-blockwise -miopen-blockwise-gemm-to-threadwise -miopen-threadwise-gemm-lowering -miopen-sugar-to-loops -miopen-loops-to-cf -convert-miopen-to-gpu "-convert-gpu-to-rocdl=chipset=gfx908 index-bitwidth=32" | miopen-opt
// RUN: miopen-gen -p -x2 | mlir-miopen-driver -miopen-affix-params -miopen-conv-to-gemm -miopen-gridwise-gemm-to-blockwise -miopen-blockwise-gemm-to-threadwise -miopen-threadwise-gemm-lowering -miopen-sugar-to-loops -miopen-loops-to-cf -convert-miopen-to-gpu "-convert-gpu-to-rocdl=chipset=gfx908 index-bitwidth=32" | miopen-translate -gpu-module-to-rocdlir
...
// RUN: miopen-gen -p -t f16 -x2 | mlir-miopen-driver -miopen-affix-params -miopen-conv-to-gemm -miopen-gridwise-gemm-to-blockwise -miopen-blockwise-gemm-to-threadwise -miopen-threadwise-gemm-lowering -miopen-sugar-to-loops -miopen-loops-to-cf -convert-miopen-to-gpu "-convert-gpu-to-rocdl=chipset=gfx908 index-bitwidth=32" | miopen-opt
// RUN: miopen-gen -p -t f16 -x2 | mlir-miopen-driver -miopen-affix-params -miopen-conv-to-gemm -miopen-gridwise-gemm-to-blockwise -miopen-blockwise-gemm-to-threadwise -miopen-threadwise-gemm-lowering -miopen-sugar-to-loops -miopen-loops-to-cf -convert-miopen-to-gpu "-convert-gpu-to-rocdl=chipset=gfx908 index-bitwidth=32" | miopen-translate -gpu-module-to-rocdlir
...
// RUN: miopen-gen -p -t bf16 -x2 | mlir-miopen-driver -miopen-affix-params -miopen-conv-to-gemm -miopen-gridwise-gemm-to-blockwise -miopen-blockwise-gemm-to-threadwise -miopen-threadwise-gemm-lowering -miopen-sugar-to-loops -miopen-loops-to-cf -convert-miopen-to-gpu "-convert-gpu-to-rocdl=chipset=gfx908 index-bitwidth=32" | miopen-opt
// RUN: miopen-gen -p -t bf16 -x2 | mlir-miopen-driver -miopen-affix-params -miopen-conv-to-gemm -miopen-gridwise-gemm-to-blockwise -miopen-blockwise-gemm-to-threadwise -miopen-threadwise-gemm-lowering -miopen-sugar-to-loops -miopen-loops-to-cf -convert-miopen-to-gpu "-convert-gpu-to-rocdl=chipset=gfx908 index-bitwidth=32" | miopen-translate -gpu-module-to-rocdlir
...
// RUN: miopen-gen -p -t i8 -x2 | mlir-miopen-driver -miopen-affix-params -miopen-conv-to-gemm -miopen-gridwise-gemm-to-blockwise -miopen-blockwise-gemm-to-threadwise -miopen-threadwise-gemm-lowering -miopen-sugar-to-loops -miopen-loops-to-cf -convert-miopen-to-gpu "-convert-gpu-to-rocdl=chipset=gfx908 index-bitwidth=32" | miopen-opt
// RUN: miopen-gen -p -t i8 -x2 | mlir-miopen-driver -miopen-affix-params -miopen-conv-to-gemm -miopen-gridwise-gemm-to-blockwise -miopen-blockwise-gemm-to-threadwise -miopen-threadwise-gemm-lowering -miopen-sugar-to-loops -miopen-loops-to-cf -convert-miopen-to-gpu "-convert-gpu-to-rocdl=chipset=gfx908 index-bitwidth=32" | miopen-translate -gpu-module-to-rocdlir
