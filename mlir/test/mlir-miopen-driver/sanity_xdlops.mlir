...
// RUN: miopen-gen -p -x2 | mlir-miopen-driver -c -target=rocdl | miopen-translate -gpu-module-to-rocdlir
...
// RUN: miopen-gen -p -t f16 -x2 | mlir-miopen-driver -c -target=rocdl | miopen-translate -gpu-module-to-rocdlir
...
// RUN: miopen-gen -p -t bf16 -x2 | mlir-miopen-driver -c -target=rocdl | miopen-translate -gpu-module-to-rocdlir
