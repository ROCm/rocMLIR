...
// RUN: not mlir-miopen-driver -p -fil_layout ykcx 2>&1 | FileCheck %s --check-prefix=ERR1
// RUN: not mlir-miopen-driver -p -fil_layout kycx 2>&1 | FileCheck %s --check-prefix=ERR2
