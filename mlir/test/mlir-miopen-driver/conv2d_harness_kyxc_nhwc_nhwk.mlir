...
// LOWERING: gpu.launch_func  @miopen_kernel_module::@miopen_conv2d_gkyxc_nhwgc_nhwgk blocks in (%{{.*}}, %{{.*}}, %{{.*}}) threads in (%{{.*}}, %{{.*}}, %{{.*}}) args([[FILTER_MEMREF]] : memref<1x128x3x3x8xf32>, [[INPUT_MEMREF]] : memref<128x32x32x1x8xf32>, [[OUTPUT_MEMREF]] : memref<128x30x30x1x128xf32>)
