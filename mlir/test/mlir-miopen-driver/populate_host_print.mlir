...
// F32-NEXT: memref.alloc() : memref<[[N]]x[[G:[0-9]+]]x[[K]]x[[HO]]x[[WO]]x[[PRINT_TYPE:[a-zA-Z0-9]+]]>
// F32-NEXT: call @convert_tensor[[N]]x[[G]]x[[K]]x[[HO]]x[[WO]]x[[TYPE]](%{{.*}}, %{{.*}}) : (memref<[[N]]x[[G]]x[[K]]x[[HO]]x[[WO]]x[[TYPE]]>, memref<[[N]]x[[G]]x[[K]]x[[HO]]x[[WO]]x[[PRINT_TYPE]]>) -> ()
// F32-NEXT: memref.cast %{{.*}} : memref<[[N]]x[[G]]x[[K]]x[[HO]]x[[WO]]x[[PRINT_TYPE]]> to memref<*x[[PRINT_TYPE]]>
// F32-NEXT: call @print_memref_f32(%{{.*}}) : (memref<*x[[PRINT_TYPE]]>) -> ()
// F32-NEXT: memref.dealloc {{.*}} : memref<[[N]]x[[G]]x[[K]]x[[HO]]x[[WO]]x[[PRINT_TYPE]]>
...
// F16-NEXT: call @convert_tensor[[N]]x[[G]]x[[K]]x[[HO]]x[[WO]]x[[TYPE]](%{{.*}}, %{{.*}}) : (memref<[[N]]x[[G]]x[[K]]x[[HO]]x[[WO]]x[[TYPE]]>, memref<[[N]]x[[G]]x[[K]]x[[HO]]x[[WO]]x[[PRINT_TYPE]]>) -> ()
