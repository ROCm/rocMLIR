...
// F32-NEXT: call @convert_result(%{{.*}}, %{{.*}}) : (memref<[[N]]x[[G]]x[[K]]x[[HO]]x[[WO]]x[[TYPE]]>, memref<[[N]]x[[G]]x[[K]]x[[HO]]x[[WO]]x[[PRINT_TYPE]]>) -> ()
...
// F16-NEXT: call @convert_result(%{{.*}}, %{{.*}}) : (memref<[[N]]x[[G]]x[[K]]x[[HO]]x[[WO]]x[[TYPE]]>, memref<[[N]]x[[G]]x[[K]]x[[HO]]x[[WO]]x[[PRINT_TYPE]]>) -> ()
