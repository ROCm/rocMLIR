...
//PVGPU: miopen.conv2d_bwd_weight(%{{.*}}, %{{.*}}, %{{.*}}) {arch = "gfx908", dilations = [2 : i32, 2 : i32], filter_layout = ["g", "k", "c", "y", "x"], gemm_id = 0 : i32, ignore_tuning = true, input_layout = ["ni", "gi", "ci", "hi", "wi"], num_cu = 120 : i32, output_layout = ["no", "go", "ko", "ho", "wo"], padding = [1 : i32, 1 : i32, 1 : i32, 1 : i32], strides = [2 : i32, 2 : i32]} : memref<1x2048x1024x1x1xf32>, memref<256x1x1024x14x14xf32>, memref<256x1x2048x8x8xf32>
