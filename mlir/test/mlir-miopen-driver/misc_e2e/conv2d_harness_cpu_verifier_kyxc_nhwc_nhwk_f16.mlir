...
module  {
  func @main() {
    ...
    %1 = memref.alloc() : memref<128x32x32x1x8xf16>
    %2 = memref.alloc() : memref<128x30x30x1x128xf16>

    %3 = memref.cast %0 : memref<1x128x3x3x8xf16> to memref<?x?x?x?x?xf16>
    %4 = memref.cast %1 : memref<128x32x32x1x8xf16> to memref<?x?x?x?x?xf16>
    %5 = memref.cast %2 : memref<128x30x30x1x128xf16> to memref<?x?x?x?x?xf16>
    ...
    %8 = memref.alloc() : memref<1x128x3x3x8xf32>
    %9 = memref.cast %8 : memref<1x128x3x3x8xf32> to memref<?x?x?x?x?xf32>
    ...
    %12 = memref.alloc() : memref<128x32x32x1x8xf32>
    %13 = memref.cast %12 : memref<128x32x32x1x8xf32> to memref<?x?x?x?x?xf32>
    ...
    memref.dealloc %13 : memref<?x?x?x?x?xf32>

    // allocate CPU memory for cpu output tensor and initialize
    %14 = memref.alloc() : memref<128x30x30x1x128xf32>
    %15 = memref.cast %14 : memref<128x30x30x1x128xf32> to memref<?x?x?x?x?xf32>
    ...
    memref.dealloc %16 : memref<128x30x30x1x128xf16>
    memref.dealloc %0 : memref<1x128x3x3x8xf16>
    memref.dealloc %1 : memref<128x32x32x1x8xf16>
    memref.dealloc %2 : memref<128x30x30x1x128xf16>
    memref.dealloc %6 : memref<1x128x3x3x8xf32>
    memref.dealloc %10 : memref<128x32x32x1x8xf32>
    memref.dealloc %14 : memref<128x30x30x1x128xf32>
    return
  }
  ...
  func @gpu_conv(%arg0: memref<1x128x3x3x8xf16>, %arg1: memref<128x32x32x1x8xf16>, %arg2: memref<128x30x30x1x128xf16>) {
    %0 = memref.cast %arg0 : memref<1x128x3x3x8xf16> to memref<?x?x?x?x?xf16>
    %1 = memref.cast %arg1 : memref<128x32x32x1x8xf16> to memref<?x?x?x?x?xf16>
    %2 = memref.cast %arg2 : memref<128x30x30x1x128xf16> to memref<?x?x?x?x?xf16>
  ...
  func @conv2d_host(%arg0: memref<1x128x3x3x8xf32>, %arg1: memref<128x32x32x1x8xf32>, %arg2: memref<128x30x30x1x128xf32>) {
    %0 = memref.cast %arg0 : memref<1x128x3x3x8xf32> to memref<*xf32>
    %1 = memref.cast %arg1 : memref<128x32x32x1x8xf32> to memref<*xf32>
    %2 = memref.cast %arg2 : memref<128x30x30x1x128xf32> to memref<*xf32>
    %c1_i32 = constant 1 : i32
    ...
    memref.store %c121_i8, %3[%c2] : memref<5xi8>
    memref.store %c120_i8, %3[%c3] : memref<5xi8>
    memref.store %c99_i8, %3[%c4] : memref<5xi8>
    memref.store %c110_i8, %4[%c0] : memref<5xi8>
    memref.store %c104_i8, %4[%c1] : memref<5xi8>
    memref.store %c119_i8, %4[%c2] : memref<5xi8>
    memref.store %c103_i8, %4[%c3] : memref<5xi8>
    memref.store %c99_i8, %4[%c4] : memref<5xi8>
    memref.store %c110_i8, %5[%c0] : memref<5xi8>
    memref.store %c104_i8, %5[%c1] : memref<5xi8>
    memref.store %c119_i8, %5[%c2] : memref<5xi8>
    memref.store %c103_i8, %5[%c3] : memref<5xi8>
    memref.store %c107_i8, %5[%c4] : memref<5xi8>
