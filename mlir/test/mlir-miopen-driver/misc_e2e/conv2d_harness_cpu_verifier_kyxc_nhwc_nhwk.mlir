...
module {
  ...
  func.func @gpu_conv(%arg0: memref<1x128x3x3x8xf32>, %arg1: memref<128x32x32x1x8xf32>, %arg2: memref<128x30x30x1x128xf32>) {
    ...
    // launch kernel.
    call @miopen_conv2d_gkyxc_nhwgc_nhwgk_0(%0, %1, %2) : (memref<1x128x3x3x8xf32>, memref<128x32x32x1x8xf32>, memref<128x30x30x1x128xf32>) -> ()
