...
// CHECK: func @miopen_conv2d_gkcyx_ngchw_ngkhw_0_ver({{.*}}) attributes {kernel = 0 : i32} {
// CHECK: miopen.conv2d({{.*}} {[[PARMS]]} : memref<[[FILTERDIMS]]xf32>, memref<[[INPUTDIMS]]xf32>, memref<[[OUTPUTDIMS]]xf32>
...
// F16-CHECK: func @miopen_conv2d_gkcyx_ngchw_ngkhw_0_ver({{.*}}) attributes {kernel = 0 : i32} {
// F16-CHECK: miopen.conv2d({{.*}} {[[PARMS]]} : memref<[[FILTERDIMS]]xf32>, memref<[[INPUTDIMS]]xf32>, memref<[[OUTPUTDIMS]]xf32>
