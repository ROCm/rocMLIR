...
// F32: func @convert_result([[SOURCE:%[a-zA-Z_0-9]+]]: memref<[[G:[0-9]+]]x[[N:[0-9]+]]x[[K:[0-9]+]]x[[HO:[0-9]+]]x[[WO:[0-9]+]]x[[TYPE:[a-zA-Z0-9]+]]>, [[DEST:%[a-zA-Z_0-9]+]]: memref<[[G]]x[[N]]x[[K]]x[[HO]]x[[WO]]x[[PRINT_TYPE:[a-zA-Z0-9]+]]>)
...
// F32-NEXT:           [[VALUE:%[a-zA-Z_0-9]+]] = load [[SOURCE]]{{\[}}[[IV_G]], [[IV_N]], [[IV_K]], [[IV_HO]], [[IV_WO]]] : memref<[[G]]x[[N]]x[[K]]x[[HO]]x[[WO]]x[[TYPE]]>
// F32-NEXT:           store [[VALUE]], [[DEST]]{{\[}}[[IV_G]], [[IV_N]], [[IV_K]], [[IV_HO]], [[IV_WO]]] : memref<[[G]]x[[N]]x[[K]]x[[HO]]x[[WO]]x[[PRINT_TYPE]]>
// F32-NEXT:         }
// F32-NEXT:       }
// F32-NEXT:     }
// F32-NEXT:   }
...
// F16: func @convert_result([[SOURCE:%[a-zA-Z_0-9]+]]: memref<[[G:[0-9]+]]x[[N:[0-9]+]]x[[K:[0-9]+]]x[[HO:[0-9]+]]x[[WO:[0-9]+]]x[[TYPE:[a-zA-Z0-9]+]]>, [[DEST:%[a-zA-Z_0-9]+]]: memref<[[G]]x[[N]]x[[K]]x[[HO]]x[[WO]]x[[PRINT_TYPE:[a-zA-Z0-9]+]]>)
...
// F16-NEXT:           [[VALUE:%[a-zA-Z_0-9]+]] = load [[SOURCE]]{{\[}}[[IV_G]], [[IV_N]], [[IV_K]], [[IV_HO]], [[IV_WO]]] : memref<[[G]]x[[N]]x[[K]]x[[HO]]x[[WO]]x[[TYPE]]>
// F16-NEXT:           [[CONVERTED_VALUE:%[a-zA-Z_0-9]+]] = fpext [[VALUE]] : [[TYPE]] to [[PRINT_TYPE]]
// F16-NEXT:           store [[CONVERTED_VALUE]], [[DEST]]{{\[}}[[IV_G]], [[IV_N]], [[IV_K]], [[IV_HO]], [[IV_WO]]] : memref<[[G]]x[[N]]x[[K]]x[[HO]]x[[WO]]x[[PRINT_TYPE]]>
// F16-NEXT:         }
// F16-NEXT:       }
// F16-NEXT:     }
// F16-NEXT:   }
...
//BF16-NOT: func @convert_result([[SOURCE:%[a-zA-Z_0-9]+]]: memref<[[G:[0-9]+]]x[[N:[0-9]+]]x[[K:[0-9]+]]x[[HO:[0-9]+]]x[[WO:[0-9]+]]x[[TYPE:[a-zA-Z0-9]+]]>, [[DEST:%[a-zA-Z_0-9]+]]: memref<[[G]]x[[N]]x[[K]]x[[HO]]x[[WO]]x[[PRINT_TYPE:[a-zA-Z0-9]+]]>)
