...
// RUN: miopen-gen -p | mlir-miopen-driver -c -target=rocdl | miopen-translate -gpu-module-to-rocdlir | opt -passes='default<O3>,strip' -S | llc -mcpu=gfx900
// RUN: miopen-gen -p --operation conv2d | mlir-miopen-driver -c -target=rocdl | miopen-translate -gpu-module-to-rocdlir | opt -passes='default<O3>,strip' -S | llc -mcpu=gfx900
...
// RUN: miopen-gen -p -t f16 | mlir-miopen-driver -c -target=rocdl | miopen-translate -gpu-module-to-rocdlir | opt -passes='default<O3>,strip' -S | llc -mcpu=gfx900
// RUN: miopen-gen -p -t f16 --operation conv2d | mlir-miopen-driver -c -target=rocdl | miopen-translate -gpu-module-to-rocdlir | opt -passes='default<O3>,strip' -S | llc -mcpu=gfx900
...
// RUN: miopen-gen -p -t bf16 | mlir-miopen-driver -c -target=rocdl | miopen-translate -gpu-module-to-rocdlir | opt -passes='default<O3>,strip' -S | llc -mcpu=gfx900
// RUN: miopen-gen -p -t bf16 --operation conv2d | mlir-miopen-driver -c -target=rocdl | miopen-translate -gpu-module-to-rocdlir | opt -passes='default<O3>,strip' -S | llc -mcpu=gfx900
