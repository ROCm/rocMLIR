...
module  {
  func @pad_parameters_00(%arg0: memref<256x1x128x28x28xf32>) attributes {kernel} {
...
// CHECK: affine_map<(d0, d1, d2, d3, d4) -> (d0, d1, d2, d3 - 1, d4 - 1)>
// CHECK: affine_map<(d0, d1, d2, d3, d4) -> (d0, d1, d2, d3 - 1, d4 + d4 ceildiv 28 - 1)>
