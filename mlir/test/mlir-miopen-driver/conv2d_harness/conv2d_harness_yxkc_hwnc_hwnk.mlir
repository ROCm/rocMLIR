...
// LOWERING: module
// LOWERING: gpu.launch_func  @miopen_conv2d_gyxkc_hwngc_hwngk_0_module::@miopen_conv2d_gyxkc_hwngc_hwngk_0 blocks in (%{{.*}}, %{{.*}}, %{{.*}}) threads in (%{{.*}}, %{{.*}}, %{{.*}}) args(%{{.*}} : memref<1x3x3x128x8xf32>, %{{.*}} : memref<32x32x128x1x8xf32>, %{{.*}} : memref<30x30x128x1x128xf32>)
