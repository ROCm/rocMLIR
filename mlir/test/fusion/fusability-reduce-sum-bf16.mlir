...
module {
  func.func @mlir_dot_add(%arg0: memref<1x2x320xbf16>, %arg1: memref<1x2x1280xbf16>, %arg2: memref<1x1280x320xbf16>, %arg3: memref<1x2x1xbf16>) attributes {rock.enable_splitk_for_tuning, rock.kernel, mhal.arch = "amdgcn-amd-amdhsa:gfx942:sramecc+:xnack-", features = #rock<GemmFeatures mfma|dot|atomic_add>} {
    %alloc = memref.alloc() alignment = 64 : memref<1x2x320xbf16>
    rock.gemm %alloc = %arg1 * %arg2 storeMethod =  set {rock.arch = "amdgcn-amd-amdhsa:gfx942:sramecc+:xnack-"} : memref<1x2x320xbf16> = memref<1x2x1280xbf16> * memref<1x1280x320xbf16>
    ...
    %alloc_1 = memref.alloc() alignment = 64 : memref<2x1xbf16>
    rock.reduce  sum %0 into %alloc_1 {axis = 1 : index, blockSize = 256 : i32, gridSize = 2 : i32} : memref<2x320xbf16> into memref<2x1xbf16>
