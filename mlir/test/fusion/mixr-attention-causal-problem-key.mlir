...
// CHECK: gfx942
// CHECK-SAME: 304
// CHECK-SAME: -t f16 -transQ false -transK true -transV false -transO false -causal true -return_lse false -split_kv 1 -g 32 -seq_len_q 2 -seq_len_k 64 -head_dim_qk 128 -head_dim_v 128
module {
