...
func.func @mlir_convolution_reshape_mul_reshape_reduce_sum_reshape_mul_mul_reshape_reduce_sum_reshape(%arg0: memref<320xf32>, %arg1: memref<32768xf32>, %arg2: memref<11520xf32>, %arg3: memref<64xf32> {mhal.read_access, rock.prefill = 0.000000e+00 : f32}, %arg4: memref<64xf32>, %arg5: memref<2621440xf32>) attributes {rock.arch = "gfx908:sramecc+:xnack-", block_size = 256 : i32, grid_size = 1536 : i32, rock.kernel = "mixr", rock.num_cu = 120 : i64} {
  ...
  rock.gridwise_gemm_accel(%10, %11, %12) storeMethod( set) {blockSize = 256 : i32, gridSize = 1536 : i32, params = #rock.accel_gemm_params<kpackPerBlock = 4, mPerBlock = 128, nPerBlock = 16, kpack = 8, mPerWave = 32, nPerWave = 16, mnPerXdl = 16, splitKFactor = 1, scheduleVersion = 1, outputSwizzle = 2, wavesPerEU = 0, gridGroupSize = 0, forceUnroll = true>} : memref<1x64x384xf32>, memref<1x64x8192xf32>, memref<1x384x8192xf32>
  ...
  %alloc_1 = memref.alloc() alignment = 64 : memref<2x32x1xf32>
  rock.reduce  sum %15 into %alloc_1 {axis = 2 : index, blockSize = 256 : i32, gridSize = 2400 : i32} : memref<2x32x40960xf32> into memref<2x32x1xf32>
  ...
  %alloc_2 = memref.alloc() alignment = 64 : memref<2x32x10x64x64xf32>
  ...
  %alloc_3 = memref.alloc() alignment = 64 : memref<2x32x1xf32>
  rock.reduce  sum %17 into %alloc_3 {axis = 2 : index, blockSize = 256 : i32, gridSize = 2400 : i32} : memref<2x32x40960xf32> into memref<2x32x1xf32>
