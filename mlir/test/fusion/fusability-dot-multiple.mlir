...
module {
  func.func @mlir_dot_add(%arg0: memref<1x2x320xf32>, %arg1: memref<1x2x320xf16>, %arg2: memref<1x2x1280xf32>, %arg3: memref<1x1280x320xf32>, %arg4: memref<1x2x320xf16>) attributes {rock.enable_splitk_for_tuning, rock.kernel, mhal.arch = "amdgcn-amd-amdhsa:gfx90a:sramecc+:xnack-"} {
    %alloc = memref.alloc() alignment = 64 : memref<1x2x320xf32>
    rock.gemm %alloc = %arg2 * %arg3 features =  "mfma|dot|atomic_add|atomic_add_f16" storeMethod =  set {rock.arch = "amdgcn-amd-amdhsa:gfx90a:sramecc+:xnack-"} : memref<1x2x320xf32> = memref<1x2x1280xf32> * memref<1x1280x320xf32>
