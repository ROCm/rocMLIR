...
func.func @test_gemm_reduce_last_axis_fusion(%arg0: memref<1x128x64xf32>, %arg1: memref<1x64x256xf32>, %arg2: memref<1x128x1xf32>) attributes {arch = "gfx1030", kernel} {
  ...
  rock.gemm %0 = %arg0 * %arg1 storeMethod =  set {arch = "gfx1030", perf_config = "v3:128,128,128,16,4,4,1,1,2"} : memref<1x128x256xf32> = memref<1x128x64xf32> * memref<1x64x256xf32>
