...
#map3 = affine_map<(d0, d1, d2, d3, d4) -> (d0, d1, d3, d2, d4)>
  ...
  func.func @invalid_generic_multi_output(%arg0: memref<1x1x32x32x8xf32>, %arg1: memref<1x16x3x3x8xf32>, %arg2: memref<16xf32>, %arg3: memref<1x1x30x30x16xf32>, %arg4: memref<1x1x30x30x16xf32>) attributes {kernel, mhal.arch = ""} {
