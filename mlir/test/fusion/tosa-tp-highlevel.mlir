...
module {
  func.func @layout_opt(%arg0: tensor<256x128x28x28xf32>, %arg1: tensor<64x128x3x3xf32>, %arg2: tensor<256x64x28x28xf32>, %arg3: tensor<64x64x3x3xf32>, %arg4: tensor<64xf32>) -> tensor<256x64x28x28xf32> {
    ...
    %5 = "tosa.transpose"(%4) {perms = array<i32: 0, 2, 3, 1>} : (tensor<256x64x28x28xf32>) -> tensor<256x28x28x64xf32>
    %6 = "tosa.transpose"(%arg3) {perms = array<i32: 0, 2, 3, 1>} : (tensor<64x64x3x3xf32>) -> tensor<64x3x3x64xf32>
    %7 = "tosa.conv2d"(%5, %6, %arg4, %input_zp, %weight_zp) {acc_type = f32, dilation = array<i64: 1, 1>, expected_filter_layout = "kyxc", expected_input_layout = "nhwc", expected_output_layout = "nhwk", pad = array<i64: 1, 1, 1, 1>, stride = array<i64: 1, 1>} : (tensor<256x28x28x64xf32>, tensor<64x3x3x64xf32>, tensor<64xf32>, tensor<1xf32>, tensor<1xf32>) -> tensor<256x28x28x64xf32>
    %8 = "tosa.transpose"(%7) {perms = array<i32: 0, 3, 1, 2>} : (tensor<256x28x28x64xf32>) -> tensor<256x64x28x28xf32>
