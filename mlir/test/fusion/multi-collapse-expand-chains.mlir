// RUN: rocmlir-opt -rock-affix-params -rock-conv-to-gemm -rock-gemm-to-gridwise -rock-regularize -rock-gridwise-gemm-to-blockwise -rock-blockwise-load-tile-to-threadwise -rock-linalg-align -rock-pipeline %s | FileCheck %s
...
module {
  ...
  func.func @test(%arg0: memref<1x4x1x1xf32>, %arg1: memref<4x3x3x3xf32>, %arg2: memref<4x3x3x3xf32>, %arg3: memref<4x4x1x1xf32>) attributes {arch = "gfx908:sramecc+:xnack-", kernel = "mixr"} {
    ...
    rock.conv(%2, %1, %3) {arch = "gfx908:sramecc+:xnack-", dilations = [1 : index, 1 : index], filter_layout = ["k", "c", "0", "1", "g"], input_layout = ["ni", "ci", "0i", "1i", "gi"], output_layout = ["no", "ko", "0o", "1o", "go"], padding = [0 : index, 0 : index, 0 : index, 0 : index], strides = [1 : index, 1 : index]} : memref<4x3x3x3x1xf32>, memref<4x3x3x3x1xf32>, memref<4x4x1x1x1xf32>
