// RUN: rocmlir-opt -rock-affix-params -rock-conv-to-gemm -rock-regularize -rock-gemm-to-gridwise -rock-gridwise-gemm-to-blockwise -rock-linalg-align %s | FileCheck %s
