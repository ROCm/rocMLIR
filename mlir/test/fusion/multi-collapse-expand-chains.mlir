...
module {
  ...
  func.func @test(%arg0: memref<1x4x1x1xf32>, %arg1: memref<4x3x3x3xf32>, %arg2: memref<4x3x3x3xf32>, %arg3: memref<4x4x1x1xf32>) attributes {mhal.arch = "gfx908:sramecc+:xnack-", kernel = "mixr"} {
