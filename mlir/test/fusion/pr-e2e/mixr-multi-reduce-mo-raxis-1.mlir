...
// CHECK: [1 1 1]
module {
  func.func @mlir_convolution_multi_reduce(%arg0: !migraphx.shaped<2x32x10x64x64xf32, 0x10x1x0x0>, %arg1: !migraphx.shaped<2x4x64x64xf32, 16384x4096x64x1>, %arg2: !migraphx.shaped<320x4x3x3xf32, 36x9x3x1>) -> (!migraphx.shaped<2x32x1x1x1xf32, 32x1x1x1x1>, !migraphx.shaped<2x1x32xf32, 32x32x1>, !migraphx.shaped<2x32x10x64x64xf32, 1310720x40960x4096x64x1>) // attributes {rock.arch = "gfx942:sramecc+:xnack-", rock.kernel = "mixr"} 
  {
    ...
    %14 = migraphx.transpose %13 {permutation = [0, 2, 1]} : <2x32x40960xf32, 1310720x40960x1> -> <2x40960x32xf32, 1310720x32x1>
    %15 = migraphx.reduce_sum %14 {axes = [1]} : <2x40960x32xf32, 1310720x32x1> -> <2x1x32xf32, 32x32x1>
    return %9, %15, %4 : !migraphx.shaped<2x32x1x1x1xf32, 32x1x1x1x1>, !migraphx.shaped<2x1x32xf32, 32x32x1>, !migraphx.shaped<2x32x10x64x64xf32, 1310720x40960x4096x64x1>
  }
}
