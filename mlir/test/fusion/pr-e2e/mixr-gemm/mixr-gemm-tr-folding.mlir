...
module {
  func.func private @mlir_transpose_reshape_dot(%arg0: !migraphx.shaped<2x8x4x4xf32, 128x16x4x1> {func.read_access}, %arg1: !migraphx.shaped<1x8x8xf32, 64x8x1> {func.read_access}) -> (!migraphx.shaped<2x16x8xf32, 128x8x1> {func.write_access}) {
    %0 = migraphx.multibroadcast %arg1 {out_dyn_dims = [], out_lens = [2, 8, 8]} : !migraphx.shaped<1x8x8xf32, 64x8x1> -> !migraphx.shaped<2x8x8xf32, 0x8x1>
    ...
    %3 = migraphx.dot %2, %0 : !migraphx.shaped<2x16x8xf32, 128x8x1>, !migraphx.shaped<2x8x8xf32, 0x8x1> -> !migraphx.shaped<2x16x8xf32, 128x8x1>
