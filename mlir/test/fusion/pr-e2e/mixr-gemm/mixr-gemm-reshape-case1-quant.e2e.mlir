...
module {
  ...
  func.func @quant_dot(%arg0: !migraphx.shaped<1x5x4xi8, 20x4x1>, %arg1: !migraphx.shaped<1x4x3xi8, 12x3x1>) -> !migraphx.shaped<1x15xi32, 15x1> attributes{rock.kernel, rock.arch = ""} {
