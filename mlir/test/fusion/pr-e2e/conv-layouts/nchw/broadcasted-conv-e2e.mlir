...
module {
  func.func @test(%arg0: !migraphx.shaped<2x160x160x1xf16, 25600x160x1x25600>, %arg1: !migraphx.shaped<16x16x3x3xf16, 144x1x48x16>, %arg2: !migraphx.shaped<2x16x160x160xf16, 0x1x0x0>) -> !migraphx.shaped<2x16x160x160xf16, 409600x1x2560x16> {
    %0 = migraphx.multibroadcast %arg0 {out_dyn_dims = [], out_lens = [2, 160, 160, 16]} : <2x160x160x1xf16, 25600x160x1x25600> -> <2x160x160x16xf16, 25600x160x1x0>
    %transposed = migraphx.transpose %0 {permutation = [0, 3, 1, 2]} : <2x160x160x16xf16, 25600x160x1x0> -> <2x16x160x160xf16, 25600x0x160x1>
    %1 = migraphx.convolution %transposed, %arg1 {dilation = [1, 1], group = 1 : i64, padding = [1, 1, 1, 1], padding_mode = 0 : i64, stride = [1, 1]} : <2x16x160x160xf16, 25600x0x160x1>, <16x16x3x3xf16, 144x1x48x16> -> <2x16x160x160xf16, 409600x1x2560x16>
