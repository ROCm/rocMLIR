...
module {
  func.func @test(%arg0: !migraphx.shaped<80x80x1x1xf16, 80x1x1x1>, %arg1: !migraphx.shaped<64x80x20x20xf16, 32000x1x1600x80>, %arg2: !migraphx.shaped<64x80x20x20xf16, 0x1x0x0>) -> !migraphx.shaped<64x80x20x20xf16, 32000x1x1600x80> {
    %0 = migraphx.convolution %arg1, %arg0 {perf_config="v2:128,128,4,128,16,8,1,1,1", dilation = [1, 1], group = 1 : i64, padding = [0, 0, 0, 0], padding_mode = 0 : i64, stride = [1, 1]} : <64x80x20x20xf16, 32000x1x1600x80>, <80x80x1x1xf16, 80x1x1x1> -> <64x80x20x20xf16, 32000x1x1600x80>
