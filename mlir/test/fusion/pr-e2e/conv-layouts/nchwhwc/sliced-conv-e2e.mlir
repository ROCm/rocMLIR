...
module {
  func.func @test(%arg0: !migraphx.shaped<16x16x3x3xf16, 144x1x48x16>, %arg1: !migraphx.shaped<2x2x16x32x5x32x5xf16, 819200x409600x1x512x81920x16x16384>, %arg2: !migraphx.shaped<2x16x160x160xf16, 0x1x0x0>) -> !migraphx.shaped<2x16x160x160xf16, 409600x1x2560x16> {
    %0 = migraphx.slice %arg1 {axes = [1], ends = [2], starts = [1]} : <2x2x16x32x5x32x5xf16, 819200x409600x1x512x81920x16x16384> -> <2x1x16x32x5x32x5xf16, 819200x409600x1x512x81920x16x16384>
    %1 = migraphx.reshape %0 {dims = [2, 16, 160, 160]} : <2x1x16x32x5x32x5xf16, 819200x409600x1x512x81920x16x16384> -> <2x16x160x160xf16, 819200x1x2560x16>
