...
// EMITKEY: convfp16 -F 1 -f GN01C -I NGC01 -O NGC01 -n 2 -c 32 -H 160 -W 160 -k 16 -y 3 -x 3 -p 1 -q 1 -u 1 -v 1 -l 1 -j 1 -g 1
...
module {
  func.func @test(%arg0: !migraphx.shaped<16x32x3x3xf16, 288x1x96x32>, %arg1: !migraphx.shaped<2x2x1x32x5x32x5xf16, 51200x25600x1x32x5120x1x1024>, %arg2: !migraphx.shaped<2x16x160x160xf16, 0x1x0x0>) -> !migraphx.shaped<2x16x160x160xf16, 409600x1x2560x16> {
    %0 = migraphx.multibroadcast %arg1 {out_dyn_dims = [], out_lens = [2, 2, 16, 32, 5, 32, 5]} : <2x2x1x32x5x32x5xf16, 51200x25600x1x32x5120x1x1024> -> <2x2x16x32x5x32x5xf16, 51200x25600x1x32x5120x1x1024>
    %1 = migraphx.reshape %0 {dims = [2, 32, 160, 160]} : <2x2x16x32x5x32x5xf16, 51200x25600x1x32x5120x1x1024> -> <2x32x160x160xf16, 819200x1x2560x16>
