...
module {
  func.func @test(%arg0: !migraphx.shaped<16x32x3x3xf16, 288x1x96x32>, %arg1: !migraphx.shaped<2x2x1x160x160xf16, 51200x25600x1x160x1>, %arg2: !migraphx.shaped<2x16x160x160xf16, 0x1x0x0>) -> !migraphx.shaped<2x16x160x160xf16, 409600x1x2560x16> {
    %0 = migraphx.multibroadcast %arg1 {out_dyn_dims = [], out_lens = [2, 2, 16, 160, 160]} : <2x2x1x160x160xf16, 51200x25600x1x160x1> -> <2x2x16x160x160xf16, 51200x25600x0x160x1>
    %1 = migraphx.reshape %0 {dims = [2, 32, 160, 160]} : <2x2x16x160x160xf16, 51200x25600x0x160x1> -> <2x32x160x160xf16, 819200x1x2560x16>
