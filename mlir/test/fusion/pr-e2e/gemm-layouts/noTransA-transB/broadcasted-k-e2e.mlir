...
module {
  func.func @test(%arg0: !migraphx.shaped<2x4096x1xf16, 4096x1x1>, %arg1: !migraphx.shaped<2x320x640xf16, 204800x1x320>, %arg2: !migraphx.shaped<2x64x10x64x64xf16, 0x10x1x40960x640>) -> !migraphx.shaped<2x64x10x64x64xf16, 2621440x10x1x40960x640> {
    %0 = migraphx.multibroadcast %arg0 {out_dyn_dims = [], out_lens = [2, 4096, 320]} : <2x4096x1xf16, 4096x1x1> -> <2x4096x320xf16, 4096x1x0>
    %2 = migraphx.dot %0, %arg1 : <2x4096x320xf16, 4096x1x0>, <2x320x640xf16, 204800x1x320> -> <2x4096x640xf16, 2621440x640x1>
