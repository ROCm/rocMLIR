...
module {
  ...
  func.func @func_mbcast(%arg0: !migraphx.shaped<1x64x1x1xf32, 64x1x1x1>, %arg1: !migraphx.shaped<1x3x224x224xf32, 150528x50176x224x1>, %arg2: !migraphx.shaped<64x3x7x7xf32, 147x49x7x1>) -> !migraphx.shaped<1x64x112x112xf32, 802816x12544x112x1> {
    %0 = migraphx.multibroadcast %arg0 {out_lens = [1, 64, 112, 112]} : !migraphx.shaped<1x64x1x1xf32, 64x1x1x1> -> !migraphx.shaped<1x64x112x112xf32, 64x1x0x0>
    ...
    %2 = migraphx.add %1, %0 : !migraphx.shaped<1x64x112x112xf32, 802816x12544x112x1>, !migraphx.shaped<1x64x112x112xf32, 64x1x0x0> -> !migraphx.shaped<1x64x112x112xf32, 802816x12544x112x1>
