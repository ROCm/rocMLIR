...
module {
  ...
  {
    %0 = migraphx.convolution %arg1, %arg2 {perf_config="v3:64,64,8,32,32,8,1,1,2,1,1", dilation = [1, 1], group = 1 : i64, padding = [0, 0, 0, 0], padding_mode = 0 : i64, stride = [1, 1]} : <2x64x64x64xf16, 262144x1x4096x64>, <128x64x1x1xf16, 64x1x8192x8192> -> <2x128x64x64xf16, 524288x1x8192x128>
