...
// CHECK: [1 1 1]
module {
  func.func @mlir_conv_gemm(%arg0: !migraphx.shaped<2x8x8x16xf16, 1024x8x1x64>, %arg1: !migraphx.shaped<16x16x3x3xf16, 144x1x48x16>, %arg2: !migraphx.shaped<1x16x32xf16, 0x1x0>) -> !migraphx.shaped<1x128x32xf16, 4096x32x1> {
    ...
    %4 = migraphx.dot %3, %arg2 {perf_config="attn:v2:64,128,32,16,32,16,4,4,1,2,1"} : <1x128x16xf16, 2048x16x1>, <1x16x32xf16, 0x1x0> -> <1x128x32xf16, 4096x32x1>
