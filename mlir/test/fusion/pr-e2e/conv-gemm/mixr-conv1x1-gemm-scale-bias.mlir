...
module {
  func.func @mlir_conv_gemm(%arg0: !migraphx.shaped<2x8x8x16xf16, 1024x8x1x64>, %arg1: !migraphx.shaped<16x16x1x1xf16, 16x1x16x16>, %arg2: !migraphx.shaped<2x16x8x8xf16, 0x1x0x0>, %arg3: !migraphx.shaped<2x16x8x8xf16, 0x1x0x0>, %arg4: !migraphx.shaped<1x16x32xf16, 0x1x0>) -> !migraphx.shaped<1x128x32xf16, 4096x32x1> {
    %transposed = migraphx.transpose %arg0 {permutation = [0, 3, 1, 2]} : <2x8x8x16xf16, 1024x8x1x64> -> <2x16x8x8xf16, 1024x64x8x1>
    %1 = migraphx.convolution %transposed, %arg1 {dilation = [1, 1], group = 1 : i64, padding = [0, 0, 0, 0], padding_mode = 0 : i64, stride = [1, 1]} : <2x16x8x8xf16, 1024x64x8x1>, <16x16x1x1xf16, 16x1x16x16> -> <2x16x8x8xf16, 2048x1x128x16>
