...
module {
  func.func @mlir_conv_gemm(%arg0: !migraphx.shaped<2x8x8x16xf16, 1024x8x1x64>, %arg1: !migraphx.shaped<16x16x3x3xf16, 144x1x48x16>, %arg2: !migraphx.shaped<2x16x8x8xf16, 0x1x0x0>, %arg3: !migraphx.shaped<2x16x8x8xf16, 0x1x0x0>, %arg4: !migraphx.shaped<1x16x32xf16, 0x1x0>) -> !migraphx.shaped<1x128x32xf16, 4096x32x1> {
    ...
    %scaled = migraphx.mul %3, %arg3rs : <1x128x16xf16, 2048x16x1>, <1x128x16xf16, 0x0x1> -> <1x128x16xf16, 2048x16x1>
    %exp = migraphx.exp %scaled : <1x128x16xf16, 2048x16x1> -> <1x128x16xf16, 2048x16x1>
    %biased = migraphx.add %exp, %arg2rs : <1x128x16xf16, 2048x16x1>, <1x128x16xf16, 0x0x1> -> <1x128x16xf16, 2048x16x1>
    %8 = migraphx.dot %biased, %arg4: <1x128x16xf16, 2048x16x1>, <1x16x32xf16, 0x1x0> -> <1x128x32xf16, 4096x32x1>
