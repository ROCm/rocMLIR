...
// RUN: rocmlir-driver -kernel-pipeline migraphx-linalg,highlevel %s | rocmlir-opt -rock-affix-params -rock-conv-to-gemm -rock-gemm-to-gridwise --rock-regularize -rock-gridwise-gemm-to-blockwise -rock-blockwise-load-tile-to-threadwise -rock-linalg-align --rock-pipeline | FileCheck %s
