...
module {
  ...
  func.func @main(%arg0: tensor<1x1x1x1xf32>, %arg1: tensor<1x3x32x32xf32>, %arg2: tensor<1x3x5x5xf32>) -> tensor<1x1x28x28xf32> attributes {mhal.arch = "gfx908:sramecc+:xnack-", kernel = "mixr"} {
