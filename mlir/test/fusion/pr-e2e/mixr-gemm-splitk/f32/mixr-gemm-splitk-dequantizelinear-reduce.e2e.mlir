...
module {
  // CHECK: [1 1 1]
  // CHECK: [1 1 1]
  func.func @dot_splitk_dequantizelinear(%arg0: !migraphx.shaped<1x128x1x1xf32, 128x1x1x1>, %arg1: !migraphx.shaped<1x128x56x56xi8, 401408x3136x56x1>, %arg2: !migraphx.shaped<128x128x3x3xi8, 1152x9x3x1>) -> (!migraphx.shaped<1x128x28x28xf32, 100352x784x28x1>, !migraphx.shaped<1x1x28x28xf32, 784x784x28x1>) attributes{rock.arch = "", rock.enable_splitk_for_tuning, rock.kernel = "mixr"} {
