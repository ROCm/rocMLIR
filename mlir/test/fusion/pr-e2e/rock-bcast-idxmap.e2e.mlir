...
module {
  func.func @test_fusion(%arg0: memref<1x64x64x64x64xf32>, %arg1: memref<1x64x1x1x64xf32>, %arg2: memref<64xf32>, %arg3: memref<1x64x64x64x64xf32>) attributes {kernel, arch = ""} {
    ...
    rock.conv(%arg1, %arg0, %0) features = none {arch = "", dilations = [1 : index, 1 : index], filter_layout = ["g", "k", "y", "x", "c"], input_layout = ["gi", "ni", "hi", "wi", "ci"], output_layout = ["go", "no", "ho", "wo", "ko"], padding = [0 : index, 0 : index, 0 : index, 0 : index], strides = [1 : index, 1 : index]} : memref<1x64x1x1x64xf32>, memref<1x64x64x64x64xf32>, memref<1x64x64x64x64xf32>
