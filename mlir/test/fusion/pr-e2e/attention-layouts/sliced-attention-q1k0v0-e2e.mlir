...
// EMITKEY: -t f16 -transQ true -transK false -transV false -transO false -causal false -return_lse false -split_kv 1 -num_heads_q 1 -num_heads_kv 1 -g 1 -seq_len_q 32 -seq_len_k 64 -head_dim_qk 16 -head_dim_v 8
...
module {
  func.func @test(%arg0: !migraphx.shaped<1x32x32xf16, 1024x1x32>, %arg1: !migraphx.shaped<1x64x16xf16, 1024x1x64>, %arg2: !migraphx.shaped<1x8x64xf16, 512x1x8>) -> !migraphx.shaped<1x32x8xf16, 256x8x1> {
    ...
    %0 = migraphx.dot %sliced0, %trans1: !migraphx.shaped<1x32x16xf16, 1024x1x32>, !migraphx.shaped<1x16x64xf16, 1024x64x1> -> !migraphx.shaped<1x32x64xf16, 2048x64x1>
