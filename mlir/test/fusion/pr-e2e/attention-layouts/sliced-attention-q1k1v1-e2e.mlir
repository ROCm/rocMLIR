...
module {
  func.func @test(%arg0: !migraphx.shaped<1x32x32xf16, 1024x1x32>, %arg1: !migraphx.shaped<1x16x64xf16, 1024x1x16>, %arg2: !migraphx.shaped<1x64x8xf16, 512x1x64>) -> !migraphx.shaped<1x32x8xf16, 256x8x1> {
