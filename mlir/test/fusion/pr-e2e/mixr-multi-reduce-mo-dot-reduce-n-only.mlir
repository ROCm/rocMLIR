...
// CHECK: [1 1 1]
module {
  func.func @mlir_dot_multi_reduce(%arg0: !migraphx.shaped<2x32x10x64x64xf16, 0x10x1x20480x320>, %arg1: !migraphx.shaped<2x32x10x64x64xf16, 1310720x40960x4096x64x1>, %arg2: !migraphx.shaped<2x4096x320xf16, 1310720x320x1>, %arg3: !migraphx.shaped<320x320xf16, 320x1>) -> (!migraphx.shaped<2x320x1xf32, 320x1x1>, !migraphx.shaped<2x32x10x64x64xf16, 1310720x40960x4096x64x1>) // attributes {rock.arch = "gfx942:sramecc+:xnack-", rock.kernel = "mixr", rock.num_cu = 304 : i64} 
  {
