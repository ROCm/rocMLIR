...
module {
  ...
  func.func @mlir_dot(%arg0: !migraphx.shaped<1x1x1x1xf32, 1x1x1x1>, %arg1: !migraphx.shaped<1x384x2304xf32, 884736x2304x1>, %arg2: !migraphx.shaped<1x384x2304xf32, 884736x2304x1>) -> !migraphx.shaped<1x12x384x384xf32, 1769472x147456x384x1> {
    ...
    %10 = migraphx.multibroadcast %0 {out_dyn_dims = [], out_lens = [1, 12, 384, 384]} : !migraphx.shaped<1xf32, 1> -> !migraphx.shaped<1x12x384x384xf32, 1769472x147456x384x1>
    %11 = migraphx.mul %9, %10 : !migraphx.shaped<1x12x384x384xf32, 1769472x147456x384x1>, !migraphx.shaped<1x12x384x384xf32, 1769472x147456x384x1> -> !migraphx.shaped<1x12x384x384xf32, 1769472x147456x384x1>
    %12 = migraphx.add %11, %1 : !migraphx.shaped<1x12x384x384xf32, 1769472x147456x384x1>, !migraphx.shaped<1x12x384x384xf32, 1769472x147456x384x1> -> !migraphx.shaped<1x12x384x384xf32, 1769472x147456x384x1>
