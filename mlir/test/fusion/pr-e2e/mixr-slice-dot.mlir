...
module {
  ...
  func.func @mlir_dot(%arg0: !migraphx.shaped<1x1x1x1xf32, 1x1x1x1>, %arg1: !migraphx.shaped<1x384x2304xf32, 884736x2304x1>, %arg2: !migraphx.shaped<1x384x2304xf32, 884736x2304x1>) -> !migraphx.shaped<1x12x384x384xf32, 1769472x147456x384x1> {
    ...
    %1 = migraphx.multibroadcast %arg0 {out_dyn_dims = [], out_lens = [1, 12, 384, 384]} : !migraphx.shaped<1x1x1x1xf32, 1x1x1x1> -> !migraphx.shaped<1x12x384x384xf32, 1x0x0x0>
    %2 = migraphx.reshape %arg1 {dims = [1, 384, 36, 64]} : !migraphx.shaped<1x384x2304xf32, 884736x2304x1> -> !migraphx.shaped<1x384x36x64xf32, 884736x2304x64x1>
    ...
    %5 = migraphx.reshape %arg2 {dims = [1, 384, 36, 64]} : !migraphx.shaped<1x384x2304xf32, 884736x2304x1> -> !migraphx.shaped<1x384x36x64xf32, 884736x2304x64x1>
    ...
    %9 = migraphx.dot %4, %8 : !migraphx.shaped<1x12x384x64xf32, 294912x24576x64x1>, !migraphx.shaped<1x12x64x384xf32, 294912x24576x384x1> -> !migraphx.shaped<1x12x384x384xf32, 1769472x147456x384x1>
    %10 = migraphx.multibroadcast %0 {out_dyn_dims = [], out_lens = [1, 12, 384, 384]} : !migraphx.shaped<1xf32, 0> -> !migraphx.shaped<1x12x384x384xf32, 0x0x0x0>
    %11 = migraphx.mul %9, %10 : !migraphx.shaped<1x12x384x384xf32, 1769472x147456x384x1>, !migraphx.shaped<1x12x384x384xf32, 0x0x0x0> -> !migraphx.shaped<1x12x384x384xf32, 1769472x147456x384x1>
    %12 = migraphx.add %11, %1 : !migraphx.shaped<1x12x384x384xf32, 1769472x147456x384x1>, !migraphx.shaped<1x12x384x384xf32, 1x0x0x0> -> !migraphx.shaped<1x12x384x384xf32, 1769472x147456x384x1>
    return %12 : !migraphx.shaped<1x12x384x384xf32, 1769472x147456x384x1>
  }
}
