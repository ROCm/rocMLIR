...
// CHECK: [1 1 1]
  func.func @mlir_attention_where(%arg0: !migraphx.shaped<1x12x256x256xf16, 786432x65536x256x1>, %arg1: !migraphx.shaped<1x12x256x256xf16, 786432x65536x256x1>, %arg2: !migraphx.shaped<1x12x256x256xi8, 786432x65536x256x1>, %arg3: !migraphx.shaped<1x12x256x256xf16, 786432x65536x256x1>, %arg4: !migraphx.shaped<1x12x256x256xf16, 786432x65536x256x1>) -> !migraphx.shaped<1x12x256x256xf16, 786432x65536x256x1>  // attributes {rock.arch = "gfx942", rock.kernel = "mixr"} 
  {
