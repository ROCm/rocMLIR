...
module {
  func.func private @mlir_attention(%arg0: !migraphx.shaped<1x32x32xf32, 1024x32x1> {func.read_access}, %arg1: !migraphx.shaped<1x32x32xf32, 1024x32x1> {func.read_access}, %arg2: !migraphx.shaped<1x32x32xf32, 1024x32x1> {func.read_access}) -> (!migraphx.shaped<1x32x32xf32, 1024x32x1> {func.write_access}) {
    %0 = migraphx.dot %arg0, %arg1: !migraphx.shaped<1x32x32xf32, 1024x32x1>, !migraphx.shaped<1x32x32xf32, 1024x32x1> -> !migraphx.shaped<1x32x32xf32, 1024x32x1>
    %1 = migraphx.softmax %0{axis = 2 : i64} : !migraphx.shaped<1x32x32xf32, 1024x32x1> -> !migraphx.shaped<1x32x32xf32, 1024x32x1>
    %2 = migraphx.dot %1, %arg2: !migraphx.shaped<1x32x32xf32, 1024x32x1>, !migraphx.shaped<1x32x32xf32, 1024x32x1> -> !migraphx.shaped<1x32x32xf32, 1024x32x1>
