...
module {
  func.func private @mlir_attention_int4(%arg0: !migraphx.shaped<64x64xf16, 128x1>, %arg1: !migraphx.shaped<64x64xf16, 128x1>, %arg2: !migraphx.shaped<64x64xf16, 64x1>, %arg3: !migraphx.shaped<64x32xui8, 32x1>, %arg4: !migraphx.shaped<64x64xf16, 64x1>) -> !migraphx.shaped<64x64xf16, 64x1> attributes {arch = "##TOKEN_ARCH##", kernel = "mixr"} {
