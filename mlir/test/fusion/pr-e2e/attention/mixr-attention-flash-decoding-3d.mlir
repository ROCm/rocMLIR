...
module {
  func.func @mlir_attention(%arg0: !migraphx.shaped<1x256x256xf16, 65536x256x1>, %arg1: !migraphx.shaped<1x256x256xf16, 65536x256x1>, %arg2: !migraphx.shaped<1x256x256xf16, 65536x256x1>) -> (!migraphx.shaped<1x2x256x256xf16, 131072x65536x256x1>, !migraphx.shaped<1x2x256x1xf32, 512x256x1x1>) attributes {rock.kernel = "mixr"} {
