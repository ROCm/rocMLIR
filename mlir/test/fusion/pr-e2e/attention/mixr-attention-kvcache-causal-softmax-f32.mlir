...
module {
  func.func @mlir_attention(%arg0: !migraphx.shaped<1x96x2x128xf16, 24576x128x12288x1>, %arg1: !migraphx.shaped<1x32x64x128xf16, 262144x8192x128x1>, %arg2: !migraphx.shaped<1x32x64x128xf16, 262144x8192x128x1>, %arg3: !migraphx.shaped<1x32xsi32, 0x0>) -> !migraphx.shaped<1x2x4096xf16, 8192x4096x1> {
    ...
    %2 = migraphx.literal(dense<0xFF800000> : tensor<1xf32>) : <1xf32, 1> // -neg inf
    ...
    %cast = migraphx.convert %6 {target_type = 2 : i32} : <1x32x2x64xf16, 4096x128x64x1> to <1x32x2x64xf32, 4096x128x64x1>
    ...
    %20 = migraphx.where %18, %8, %14 : <1x32x2x64xsi8, 4096x128x64x1>, <1x32x2x64xf32, 0x0x0x0>, <1x32x2x64xf32, 4096x128x64x1> -> <1x32x2x64xf32, 4096x128x64x1>
    %21 = migraphx.softmax %20 {axis = 3 : i64} : <1x32x2x64xf32, 4096x128x64x1> -> <1x32x2x64xf32, 4096x128x64x1>
    %cast_fp16 = migraphx.convert %21 {target_type = 1 : i32} : <1x32x2x64xf32, 4096x128x64x1> to <1x32x2x64xf16, 4096x128x64x1>
    %22 = migraphx.dot %cast_fp16, %arg2 : <1x32x2x64xf16, 4096x128x64x1>, <1x32x64x128xf16, 262144x8192x128x1> -> <1x32x2x128xf16, 8192x256x128x1>
