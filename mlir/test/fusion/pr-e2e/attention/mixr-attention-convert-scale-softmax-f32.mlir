...
module {
  func.func private @mlir_attention(%arg0: !migraphx.shaped<1x12x256x256xf16, 786432x65536x256x1> {mhal.read_access}, %arg1: !migraphx.shaped<1x12x256x256xf16, 786432x65536x256x1> {mhal.read_access}, %arg2: !migraphx.shaped<12x256x256xsi8, 65536x256x1> {mhal.read_access}, %arg3: !migraphx.shaped<1x12x256x256xf16, 786432x65536x256x1> {mhal.read_access}, %arg4: !migraphx.shaped<12x256x256xf16, 65536x256x1> {mhal.read_access}) -> (!migraphx.shaped<12x256x256xf16, 65536x256x1> {mhal.write_access}) {
    ...
    %7 = migraphx.convert %6 {target_type = 2 : i64} : <12x256x256xf16, 65536x256x1> to <12x256x256xf32, 65536x256x1>
    %8 = migraphx.convert %1 {target_type = 2 : i64} : <12x256x256xf16, 65536x256x1> to <12x256x256xf32, 65536x256x1>
    %9 = migraphx.mul %8, %7 : <12x256x256xf32, 65536x256x1>, <12x256x256xf32, 65536x256x1> -> <12x256x256xf32, 65536x256x1>
    %10 = migraphx.where %arg2, %9, %0 : <12x256x256xsi8, 65536x256x1>, <12x256x256xf32, 65536x256x1>, <12x256x256xf32, 65536x256x1> -> <12x256x256xf32, 65536x256x1>
    ...
    %14 = migraphx.sub %10, %13 : <12x256x256xf32, 65536x256x1>, <12x256x256xf32, 256x1x0> -> <12x256x256xf32, 65536x256x1>
    ...
    return %23 : !migraphx.shaped<12x256x256xf16, 65536x256x1>
  }
}
