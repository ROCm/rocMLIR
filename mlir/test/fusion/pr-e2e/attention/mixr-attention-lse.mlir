...
module {
  func.func private @mlir_attention(%v: !migraphx.shaped<2x2x32x32xf32, 2048x1024x32x1>, 
    ...
    %max = migraphx.reduce_max %qk {axes = [3 : i64]} : <2x4x32x32xf32, 4096x1024x32x1> -> <2x4x32x1xf32, 128x32x1x1>
    %norm = migraphx.sub %qk, %max : <2x4x32x32xf32, 4096x1024x32x1>, <2x4x32x1xf32, 128x32x1x1> -> <2x4x32x32xf32, 4096x1024x32x1>
    ...
    return %res, %lse_add : !migraphx.shaped<2x4x32x32xf32, 4096x1024x32x1>, !migraphx.shaped<2x4x32x1xf32, 128x32x1x1>
  }
}
