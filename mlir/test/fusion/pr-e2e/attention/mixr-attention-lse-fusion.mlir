...
module {
  func.func private @mlir_attention(%v: !migraphx.shaped<2x2x32x32xf32, 2048x1024x32x1> {mhal.read_access}, 
                            ...
                            %presoftmax_fusion: !migraphx.shaped<2x4x32x32xf32, 0x0x0x1> {mhal.read_access},
                            %lse_add_tensor: !migraphx.shaped<2x4x32x1xf32, 0x0x0x1> {mhal.read_access},
                            %res_add_tensor: !migraphx.shaped<2x4x32x32xf32, 0x0x0x1> {mhal.read_access}) 
    ...
    %qk_fusion = migraphx.add %qk, %presoftmax_fusion : <2x4x32x32xf32, 4096x1024x32x1>, <2x4x32x32xf32, 0x0x0x1> -> <2x4x32x32xf32, 4096x1024x32x1>

    %max = migraphx.reduce_max %qk_fusion {axes = [3 : i64]} : <2x4x32x32xf32, 4096x1024x32x1> -> <2x4x32x1xf32, 128x32x1x1>
    %norm = migraphx.sub %qk_fusion, %max : <2x4x32x32xf32, 4096x1024x32x1>, <2x4x32x1xf32, 128x32x1x1> -> <2x4x32x32xf32, 4096x1024x32x1>
    %exp = migraphx.exp %norm : <2x4x32x32xf32, 4096x1024x32x1> -> <2x4x32x32xf32, 4096x1024x32x1>
    %se = migraphx.reduce_sum %exp {axes = [3 : i64]} : <2x4x32x32xf32, 4096x1024x32x1> -> <2x4x32x1xf32, 128x32x1x1>
    %recip = migraphx.recip %se : <2x4x32x1xf32, 128x32x1x1> -> <2x4x32x1xf32, 128x32x1x1>
    %att = migraphx.mul %exp, %recip : <2x4x32x32xf32, 4096x1024x32x1>, <2x4x32x1xf32, 128x32x1x1> -> <2x4x32x32xf32, 4096x1024x32x1>
    
    %lse = migraphx.log %se : <2x4x32x1xf32, 128x32x1x1> -> <2x4x32x1xf32, 128x32x1x1>
    %lse_add = migraphx.add %lse, %max : <2x4x32x1xf32, 128x32x1x1>, <2x4x32x1xf32, 128x32x1x1> -> <2x4x32x1xf32, 128x32x1x1>
    %res = migraphx.dot %att, %vreshaped : <2x4x32x32xf32, 4096x1024x32x1>, <2x4x32x32xf32, 2048x1024x32x1> -> <2x4x32x32xf32, 4096x1024x32x1>
    %lse_fusion = migraphx.add %lse_add, %lse_add_tensor : <2x4x32x1xf32, 128x32x1x1>, <2x4x32x1xf32, 0x0x0x1> -> <2x4x32x1xf32, 128x32x1x1>
    %res_fusion = migraphx.add %res, %res_add_tensor : <2x4x32x32xf32, 4096x1024x32x1>, <2x4x32x32xf32, 0x0x0x1> -> <2x4x32x32xf32, 4096x1024x32x1>
    return %res_fusion, %lse_fusion : !migraphx.shaped<2x4x32x32xf32, 4096x1024x32x1>, !migraphx.shaped<2x4x32x1xf32, 128x32x1x1>
  }
}
