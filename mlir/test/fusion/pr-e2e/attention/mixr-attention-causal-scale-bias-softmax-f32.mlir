...
// CHECK: [1 1 1]
module {
  func.func @mlir_attention(%arg0: !migraphx.shaped<1x96x2x128xf16, 24576x128x12288x1>, %arg1: !migraphx.shaped<1x32x64x128xf16, 262144x8192x128x1>, %arg2: !migraphx.shaped<1x32x64x128xf16, 262144x8192x128x1>, %scale: !migraphx.shaped<1x32x2x64xf32, 4096x128x64x1>, %bias: !migraphx.shaped<1x32x2x64xf32, 4096x128x64x1>) -> !migraphx.shaped<1x2x4096xf16, 8192x4096x1> {
    ...
    %cast = migraphx.convert %6 {target_type = 1 : i64} : <1x32x2x64xf16, 4096x128x64x1> to <1x32x2x64xf32, 4096x128x64x1>
    %qk_scaled = migraphx.mul %cast, %scale : <1x32x2x64xf32, 4096x128x64x1>, <1x32x2x64xf32, 4096x128x64x1> -> <1x32x2x64xf32, 4096x128x64x1>
    %qk_biased = migraphx.add %qk_scaled, %bias : <1x32x2x64xf32, 4096x128x64x1>, <1x32x2x64xf32, 4096x128x64x1> -> <1x32x2x64xf32, 4096x128x64x1>
    ...
    %fused = migraphx.mul %qk_biased, %9 : <1x32x2x64xf32, 4096x128x64x1>, <1x32x2x64xf32, 0x0x0x0> -> <1x32x2x64xf32, 4096x128x64x1>
    ...
    %cast_f16 = migraphx.convert %21 {target_type = 2 : i64} : <1x32x2x64xf32, 4096x128x64x1> to <1x32x2x64xf16, 4096x128x64x1>
    %22 = migraphx.dot %cast_f16, %arg2 : <1x32x2x64xf16, 4096x128x64x1>, <1x32x64x128xf16, 262144x8192x128x1> -> <1x32x2x128xf16, 8192x256x128x1>
