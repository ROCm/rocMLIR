...
module {
  func.func private @mlir_attention(%v: !migraphx.shaped<2x2x32x32xf32, 2048x1024x32x1> {mhal.read_access}, 
                            %scale: !migraphx.shaped<2x4x32x32xf32, 4096x1024x32x1> {mhal.read_access}, 
    ...
    %qk_scaled = migraphx.mul %qk, %scale : <2x4x32x32xf32, 4096x1024x32x1>, <2x4x32x32xf32, 4096x1024x32x1> -> <2x4x32x32xf32, 4096x1024x32x1>
    %qk_biased = migraphx.add %qk_scaled, %bias : <2x4x32x32xf32, 4096x1024x32x1>, <2x4x32x32xf32, 4096x1024x32x1> -> <2x4x32x32xf32, 4096x1024x32x1>
