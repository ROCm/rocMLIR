...
// CHECK-NEXT: [1 1 1]
module {
  func.func @mlir_attention(%arg0: !migraphx.shaped<1x96x2x128xf16, 24576x128x12288x1>, %arg1: !migraphx.shaped<1x32x64x128xf16, 262144x8192x128x1>, %arg2: !migraphx.shaped<1x32x64x128xf16, 262144x8192x128x1>) -> (!migraphx.shaped<1x2x4096xf16, 8192x4096x1>, !migraphx.shaped<1x32x2x1xf16, 64x2x1x1>) {
    ...
    %max = migraphx.reduce_max %14 {axes = [3 : i64]} : <1x32x2x64xf16, 4096x128x64x1> -> <1x32x2x1xf16, 64x2x1x1>
    %norm = migraphx.sub %14, %max : <1x32x2x64xf16, 4096x128x64x1>, <1x32x2x1xf16, 64x2x1x1> -> <1x32x2x64xf16, 4096x128x64x1>
    %exp = migraphx.exp %norm : <1x32x2x64xf16, 4096x128x64x1> -> <1x32x2x64xf16, 4096x128x64x1>
    %se = migraphx.reduce_sum %exp {axes = [3 : i64]} : <1x32x2x64xf16, 4096x128x64x1> -> <1x32x2x1xf16, 64x2x1x1>
    %recip = migraphx.recip %se : <1x32x2x1xf16, 64x2x1x1> -> <1x32x2x1xf16, 64x2x1x1>
    %att = migraphx.mul %exp, %recip : <1x32x2x64xf16, 4096x128x64x1>, <1x32x2x1xf16, 64x2x1x1> -> <1x32x2x64xf16, 4096x128x64x1>

    %lse = migraphx.log %se : <1x32x2x1xf16, 64x2x1x1> -> <1x32x2x1xf16, 64x2x1x1>
    %lse_add = migraphx.add %lse, %max : <1x32x2x1xf16, 64x2x1x1>, <1x32x2x1xf16, 64x2x1x1> -> <1x32x2x1xf16, 64x2x1x1>

    %22 = migraphx.dot %att, %arg2 : <1x32x2x64xf16, 4096x128x64x1>, <1x32x64x128xf16, 262144x8192x128x1> -> <1x32x2x128xf16, 8192x256x128x1>
    ...
    return %24, %lse_add : !migraphx.shaped<1x2x4096xf16, 8192x4096x1>, !migraphx.shaped<1x32x2x1xf16, 64x2x1x1>
  }
}
