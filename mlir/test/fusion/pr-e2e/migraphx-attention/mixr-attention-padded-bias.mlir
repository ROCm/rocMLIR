...
// migraphx.attention variant of pr-e2e/attention/mixr-attention-padded-bias.mlir.
// Padded 3D shape with a single-input bias body (add).
module {
  func.func private @mlir_attention(%arg0: !migraphx.shaped<1x7x3xf32, 21x3x1>,
    ...
    %0 = migraphx.attention %arg0, %arg1, %arg2
      pre_softmax_inputs(%bias : !migraphx.shaped<1x7x7xf32, 49x7x1>) {
      ^bb0(%qk: !migraphx.shaped<1x7x7xf32, 49x7x1>,
        ...
        %sum = migraphx.add %qk, %b
          ...
          -> <1x7x7xf32, 49x7x1>
        migraphx.yield %sum : !migraphx.shaped<1x7x7xf32, 49x7x1>
      }
