...
// migraphx.attention variant of pr-e2e/attention/mixr-attention.mlir.
// Bare 3D dot+softmax+dot, square 64x64 shapes, no body.
module {
  func.func private @mlir_attention(%arg0: !migraphx.shaped<1x64x64xf32, 4096x64x1>,
    ...
    } : <1x64x64xf32, 4096x64x1>, <1x64x64xf32, 4096x64x1>, <1x64x64xf32, 4096x64x1>
      -> !migraphx.shaped<1x64x64xf32, 4096x64x1>
