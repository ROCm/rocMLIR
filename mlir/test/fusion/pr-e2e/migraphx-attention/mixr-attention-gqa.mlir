...
// CHECK: [1 1 1]
module {
  func.func private @mlir_attention(%arg0: !migraphx.shaped<2x4x32x64xf16, 8192x2048x64x1>,
                                     %arg1: !migraphx.shaped<2x2x64x32xf16, 4096x2048x32x1>,
                                     %arg2: !migraphx.shaped<2x2x32x64xf16, 4096x2048x64x1>)
