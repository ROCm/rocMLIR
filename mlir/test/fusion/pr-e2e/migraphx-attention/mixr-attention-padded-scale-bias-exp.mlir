...
// migraphx.attention variant of pr-e2e/attention/mixr-attention-padded-scale-bias-exp.mlir.
// Padded 3D shape with a multi-op body: scale -> exp -> bias add. Exercises
// the linalg.generic body's elementwise op chain plus math.exp lowering.
module {
  func.func private @mlir_attention(%arg0: !migraphx.shaped<1x7x3xf32, 21x3x1>,
    ...
    %0 = migraphx.attention %arg0, %arg1, %arg2
      ...
      ^bb0(%qk: !migraphx.shaped<1x7x7xf32, 49x7x1>,
           ...
           %b: !migraphx.shaped<1x7x7xf32, 49x7x1>):
        %scaled = migraphx.mul %qk, %s
          : <1x7x7xf32, 49x7x1>, <1x7x7xf32, 49x7x1>
          -> <1x7x7xf32, 49x7x1>
        %exp = migraphx.exp %scaled
          : <1x7x7xf32, 49x7x1> -> <1x7x7xf32, 49x7x1>
        %biased = migraphx.add %exp, %b
          : <1x7x7xf32, 49x7x1>, <1x7x7xf32, 49x7x1>
          -> <1x7x7xf32, 49x7x1>
