...
// migraphx.attention variant of pr-e2e/attention/mixr-attention-first-gemm-i8-f16.mlir.
// i8 Q/K with f16 V/output, f16 dequant scale, f16 softmax. softmaxType is
// set explicitly because Q is integer-typed.
module {
