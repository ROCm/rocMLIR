...
// migraphx.attention variant of pr-e2e/attention/mixr-attention-first-gemm-i8-bias-padded.mlir.
// Padded shapes plus a dequant zero-point (qbias) operand exercise the
// three-operand dequantize lowering (sitofp + subf + mulf inside the body).
module {
  func.func private @mlir_attention(%arg0: !migraphx.shaped<1x7x3xi8, 21x3x1>,
                                    ...
                                    %qbias: !migraphx.shaped<1x7x7xi8, 49x7x1>)
                                    -> (!migraphx.shaped<1x7x3xf32, 21x3x1>) {
    %0 = migraphx.attention %arg0, %arg1, %arg2
      pre_softmax_inputs(%qscale, %qbias, %arg3
        : !migraphx.shaped<1x7x7xf32, 49x7x1>,
          !migraphx.shaped<1x7x7xi8, 49x7x1>,
          !migraphx.shaped<1x7x7xf32, 49x7x1>) {
      ^bb0(%qk: !migraphx.shaped<1x7x7xi32, 49x7x1>,
           %scale: !migraphx.shaped<1x7x7xf32, 49x7x1>,
           %qb: !migraphx.shaped<1x7x7xi8, 49x7x1>,
           %bias: !migraphx.shaped<1x7x7xf32, 49x7x1>):
        %dq = migraphx.dequantizelinear %qk, %scale, %qb
          : <1x7x7xi32, 49x7x1>, <1x7x7xf32, 49x7x1>, !migraphx.shaped<1x7x7xi8, 49x7x1>
          -> <1x7x7xf32, 49x7x1>
