...
module {
  func.func private @mlir_reshape_convolution_real__part_0(%arg0: !migraphx.shaped<1x1x16x1x16x1xf32, 256x256x16x16x1x1> {func.read_access}, %arg1: !migraphx.shaped<1x1x3x3xf32, 9x9x3x1> {func.read_access}) -> (!migraphx.shaped<1x1x32x32xf32, 1024x1024x32x1> {func.write_access}) {
    %0 = migraphx.multibroadcast %arg0 {out_dyn_dims = [], out_lens = [1, 1, 16, 2, 16, 2]} : !migraphx.shaped<1x1x16x1x16x1xf32, 256x256x16x16x1x1> -> !migraphx.shaped<1x1x16x2x16x2xf32, 256x256x16x0x1x0>
    %1 = migraphx.reshape %0 {dims = [2, 4, 32, 32]} : !migraphx.shaped<1x1x16x2x16x2xf32, 256x256x16x0x1x0> -> !migraphx.shaped<1x1x32x32xf32, 1024x1024x32x1>
