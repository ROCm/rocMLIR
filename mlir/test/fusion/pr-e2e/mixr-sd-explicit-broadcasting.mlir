...
module {
  func.func private @mlir_reshape_convolution_real__part_0(%arg0: !migraphx.shaped<1x1x16x1x16x1xf32, 256x256x16x16x1x1> {mhal.read_access}, %arg1: !migraphx.shaped<1x1x3x3xf32, 9x9x3x1> {mhal.read_access}) -> (!migraphx.shaped<1x1x32x32xf32, 1024x1024x32x1> {mhal.write_access}) {
    ...
    %1 = migraphx.reshape %0 {dims = [1, 1, 32, 32]} : <1x1x16x2x16x2xf32, 256x256x16x0x1x0> -> <1x1x32x32xf32, 1024x1024x32x1>
  ...
  module @__xmodule_ attributes {mhal.arch = "##TOKEN_ARCH##", mhal.module} {
    func.func private @mlir_reshape_convolution_real__part_0(%arg0: !migraphx.shaped<1x1x16x1x16x1xf32, 256x256x16x16x1x1> {mhal.read_access}, %arg1: !migraphx.shaped<1x1x3x3xf32, 9x9x3x1> {mhal.read_access}) -> (!migraphx.shaped<1x1x32x32xf32, 1024x1024x32x1> {mhal.write_access}) attributes {rock.kernel, original_func = @mlir_reshape_convolution_real__part_0} {
      %0 = migraphx.multibroadcast %arg0 {out_dyn_dims = [], out_lens = [1, 1, 16, 2, 16, 2]} : <1x1x16x1x16x1xf32, 256x256x16x16x1x1> -> <1x1x16x2x16x2xf32, 256x256x16x0x1x0>
      %1 = migraphx.reshape %0 {dims = [1, 1, 32, 32]} : <1x1x16x2x16x2xf32, 256x256x16x0x1x0> -> <1x1x32x32xf32, 1024x1024x32x1>
      %2 = migraphx.convolution %1, %arg1 {dilation = [1, 1], group = 1 : i64, padding = [1, 1, 1, 1], padding_mode = 0 : i64, stride = [1, 1]} : <1x1x32x32xf32, 1024x1024x32x1>, <1x1x3x3xf32, 9x9x3x1> -> <1x1x32x32xf32, 1024x1024x32x1>
      return %2 : !migraphx.shaped<1x1x32x32xf32, 1024x1024x32x1>
