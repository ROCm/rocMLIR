...
module {
  func.func @test(%arg0: !migraphx.shaped<1x32x16xf16, 512x1x32>, %arg1: !migraphx.shaped<1x64x32xf16, 2048x1x64>, %arg2: !migraphx.shaped<4x32x2x4x4xf16, 0x2x1x256x64>) -> !migraphx.shaped<4x32x2x4x4xf16, 1024x2x1x256x64> {
    ...
    %0 = migraphx.multibroadcast %trans0 {out_dyn_dims = [], out_lens = [4, 16, 32]} : <1x16x32xf16, 512x32x1> -> <4x16x32xf16, 0x32x1>
    %1 = migraphx.multibroadcast %trans1 {out_dyn_dims = [], out_lens = [4, 32, 64]} : <1x32x64xf16, 2048x64x1> -> <4x32x64xf16, 0x64x1>
    %2 = migraphx.dot %0, %1 : <4x16x32xf16, 0x32x1>, <4x32x64xf16, 0x64x1> -> <4x16x64xf16, 1024x64x1>
