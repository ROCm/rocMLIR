...
#fma_gemm_params = #rock.fma_gemm_params<blockSize = 256, kpackPerBlock = 16, mPerBlock = 64, nPerBlock = 64, kpack = 1, splitKFactor = 1, scheduleVersion = 1, outputSwizzle = 2, forceUnroll = true>
