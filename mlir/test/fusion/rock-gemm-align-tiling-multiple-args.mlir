...
#fma_gemm_params = #rock.fma_gemm_params<kpackPerBlock = 16, mPerBlock = 64, nPerBlock = 64, kpack = 1, mPerWave = 32, nPerWave = 16, splitKFactor = 1, scheduleVersion = 1, outputSwizzle = 2, forceUnroll = true>
func.func @rock_gemm(%arg0: memref<64x64x64xf16>, %arg1: memref<64x64x64xf32>, %arg2: memref<64x64x64xf32>, %arg3: memref<64x64x64xf32>) attributes {block_size = 256 : i32, grid_size = 64 : i32, kernel, mhal.arch = "amdgcn-amd-amdhsa:gfx1100", wave_size = 32 : i32} {
  ...
  rock.gridwise_gemm_accel(%0, %arg1, %arg2) storeMethod( set) features =  dot|atomic_add|atomic_add_f16 {arch = "amdgcn-amd-amdhsa:gfx1100", blockSize = 256 : i32, gridSize = 64 : i32, numCU = 48 : i32, params = #fma_gemm_params} : memref<64x64x64xf32>, memref<64x64x64xf32>, memref<64x64x64xf32>
  return
}
