...
// CHECK: gfx942  120     -t f32 -transA false -transB false -transC false -transO false -g 1 -m 128 -n 256 -k 64 -gemmO 128 -fusion_reduce count=1 sum:rank3:axis1:stride1
...
#transform_map9 = #rock.transform_map<#map4 by [<Merge{1, 1, 128} ["dim0"] at [0] -> ["col0", "col1", "col2"] at [0, 1, 2]>] bounds = [128] -> [1, 1, 128]>
module {
  func.func private @gemm_gemm_reduce_sum_axis1(%arg0: memref<8192xf32> {mhal.read_access}, %arg1: memref<16384xf32> {mhal.read_access}, %arg2: memref<32768xf32> {mhal.read_access}, %arg3: memref<128xf32> {mhal.read_access, mhal.write_access, rock.prefill = 0.000000e+00 : f32}) attributes {arch = "gfx942", kernel, num_cu = 120 : i64} {
    ...
    %alloc_0 = memref.alloc() {alignment = 64 : i64} : memref<1x1x128xf32>
    rock.reduce  sum %alloc into %alloc_0 {axis = 1 : index, blockSize = 256 : i32, gridSize = 64 : i32} : memref<1x128x128xf32> into memref<1x1x128xf32>
    %9 = rock.transform %alloc_0 by #transform_map9 : memref<1x1x128xf32> to memref<128xf32>
