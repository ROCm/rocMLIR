...
module {
  func.func private @gemm_add_reduce_sum(%a: !migraphx.shaped<1x128x64xf32, 8192x64x1> {mhal.read_access}, 
                                         %b: !migraphx.shaped<1x64x256xf32, 16384x256x1> {mhal.read_access},
                                         %bias: !migraphx.shaped<1x128x256xf32, 32768x256x1> {mhal.read_access}) 
    ...
    %add = migraphx.add %gemm, %bias : <1x128x256xf32, 32768x256x1>, <1x128x256xf32, 32768x256x1> -> <1x128x256xf32, 32768x256x1>
    %result = migraphx.reduce_sum %add {axes = [2 : i64]} : <1x128x256xf32, 32768x256x1> -> <1x128x1xf32, 128x1x1>
