...
module {
  func.func private @gemm_gemm_no_fusion(%a: !migraphx.shaped<1x128x64xf32, 8192x64x1> {mhal.read_access}, 
                                         %b: !migraphx.shaped<1x64x256xf32, 16384x256x1> {mhal.read_access},
                                         %c: !migraphx.shaped<1x256x128xf32, 32768x128x1> {mhal.read_access}) 
                                         -> (!migraphx.shaped<1x128x128xf32, 16384x128x1> {mhal.write_access}) 
    ...
    return %gemm1 : !migraphx.shaped<1x128x128xf32, 16384x128x1>
  }
}
