...
#map4 = affine_map<(d0) -> (0, d0 floordiv 128, d0 mod 128)>
...
#transform_map9 = #rock.transform_map<#map4 by [<Merge{1, 128, 128} ["dim0"] at [0] -> ["col0", "col1", "col2"] at [0, 1, 2]>] bounds = [16384] -> [1, 128, 128]>
module {
  func.func private @gemm_gemm_no_fusion(%arg0: memref<8192xf32> {mhal.read_access}, %arg1: memref<16384xf32> {mhal.read_access}, %arg2: memref<32768xf32> {mhal.read_access}, %arg3: memref<16384xf32> {mhal.write_access}) attributes {arch = "gfx942", kernel, num_cu = 120 : i64} {
    ...
    %9 = rock.transform %alloc by #transform_map9 : memref<1x128x128xf32> to memref<16384xf32>
    memref.copy %9, %arg3 : memref<16384xf32> to memref<16384xf32>
    return
  }
}
