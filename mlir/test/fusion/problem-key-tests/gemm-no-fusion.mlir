...
module {
  func.func private @gemm_no_fusion(%a: !migraphx.shaped<1x128x64xf32, 8192x64x1> {mhal.read_access}, 
    ...
    %result = migraphx.dot %a, %b : <1x128x64xf32, 8192x64x1>, <1x64x256xf32, 16384x256x1> -> <1x128x256xf32, 32768x256x1>
    return %result : !migraphx.shaped<1x128x256xf32, 32768x256x1>
  }
}
