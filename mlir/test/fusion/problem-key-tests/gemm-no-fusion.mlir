...
module {
  func.func private @gemm_no_fusion(%arg0: memref<8192xf32> {mhal.read_access}, %arg1: memref<16384xf32> {mhal.read_access}, %arg2: memref<32768xf32> {mhal.write_access}) attributes {arch = "gfx942", kernel, num_cu = 120 : i64} {
