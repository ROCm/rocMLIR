...
module {
  func.func private @gemm_gemm_reduce_sum_axis2(%a: !migraphx.shaped<1x128x64xf32, 8192x64x1> {mhal.read_access}, 
    ...
    %result = migraphx.reduce_sum %gemm1 {axes = [2 : i64]} : <1x128x128xf32, 16384x128x1> -> <1x128x1xf32, 128x1x1>
