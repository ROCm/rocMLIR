...
#transform_map10 = #rock.transform_map<#map5 by [<Merge{1, 128} ["dim0"] at [0] -> ["col0", "col1"] at [0, 1]>, <PassThrough ["dim1"] at [1] -> ["dim1"] at [2]>] bounds = [128, 128] -> [1, 128, 128]>
#transform_map11 = #rock.transform_map<#map7 by [<Unmerge{128} ["exp1"] at [1] -> ["dim0"] at [0]>, <PassThrough ["dim1"] at [2] -> ["dim1"] at [1]>, <AddDim{1} ["unit0"] at [0] -> [] at []>] bounds = [1, 128, 128] -> [128, 128]>
module {
  func.func private @gemm_gemm_multi_reduce(%arg0: memref<8192xf32> {mhal.read_access}, %arg1: memref<16384xf32> {mhal.read_access}, %arg2: memref<32768xf32> {mhal.read_access}, %arg3: memref<128xf32> {mhal.read_access, mhal.write_access, rock.prefill = 0.000000e+00 : f32}, %arg4: memref<128xf32> {mhal.read_access, mhal.write_access, rock.prefill = 0.000000e+00 : f32}) attributes {arch = "gfx942", kernel, num_cu = 120 : i64} {
    ...
    rock.reduce  sum %11 into %alloc_2 {axis = 2 : index, blockSize = 256 : i32, gridSize = 64 : i32} : memref<1x128x128xf32> into memref<1x128x1xf32>
    %12 = rock.transform %alloc_2 by #transform_map9 : memref<1x128x1xf32> to memref<128xf32>
    memref.copy %9, %arg3 : memref<128xf32> to memref<128xf32>
    memref.copy %12, %arg4 : memref<128xf32> to memref<128xf32>
    return
  }
}
