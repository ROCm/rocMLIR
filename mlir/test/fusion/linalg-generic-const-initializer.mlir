...
#transform_map22 = #rock.transform_map<#map18 by [<PassThrough ["g_block", "m_block", "n_block"] at [0, 1, 2] -> ["g_block", "m_block", "n_block"] at [0, 1, 2]>, <Merge{2, 2, 2, 16} ["tid"] at [3] -> ["1ave_m", "1ave_n", "m_tid", "n_tid"] at [3, 4, 5, 6]>, <Merge{4, 4, 8} ["item"] at [4] -> ["rep_i", "rep_j", "item_i"] at [7, 8, 9]>] bounds = [32, 3, 24, 128, 128] -> [32, 3, 24, 2, 2, 2, 16, 4, 4, 8]>
#transform_map23 = #rock.transform_map<#map19 by [<PassThrough ["g_block"] at [0] -> ["gemmG"] at [0]>, <Unmerge{3, 4, 2, 8, 2} ["m_block", "rep_i", "1ave_m", "item_i", "m_tid"] at [1, 7, 3, 9, 5] -> ["gemmM"] at [1]>, <Unmerge{24, 4, 2, 16} ["n_block", "rep_j", "1ave_n", "n_tid"] at [2, 8, 4, 6] -> ["gemmN"] at [2]>] bounds = [32, 3, 24, 2, 2, 2, 16, 4, 4, 8] -> [32, 384, 3072]>
...
module {
  func.func @mlir_simplified_issue_(%arg0: memref<1x1x3072xf32>, %arg1: memref<32x384x768xi8>, %arg2: memref<32x768x3072xi8>, %arg3: memref<32x384x3072xi8>) attributes {rock.arch = "gfx1100", block_size = 128 : i32, grid_size = 2304 : i32, rock.kernel = "mixr", rock.num_cu = 48 : i64, wave_size = 32 : i32} {
