...
func.func @mlir_dot_mul(%arg0: memref<6xf32>, %arg1: memref<12xf32>, %arg2: memref<8xf32>, %arg3: memref<8xf32>) attributes {arch = "gfx908:sramecc+:xnack-", block_size = 64 : i32, grid_size = 1 : i32, kernel = "mixr", num_cu = 120 : i64} {
  ...
  rock.gridwise_gemm_accel(%3, %4, %5) storeMethod( set) {blockSize = 64 : i32, gridSize = 1 : i32, params = #rock.xdlops_gemm_derived_params<kpackPerBlock = 4, mPerBlock = 16, nPerBlock = 16, kpack = 4, mPerWave = 16, nPerWave = 16, mnPerXdl = 16, splitKFactor = 1, scheduleVersion = 1, outputSwizzle = 2, forceUnroll = true>} : memref<1x16x16xf32>, memref<1x16x16xf32>, memref<1x16x16xf32>
