...
// CHECK: rock.conv2d(%{{.*}}, %{{.*}}, %{{.*}}) features = dot, convParams = {padding : [1, 1, 1, 1], stride : [1, 1], dilation : [1, 1]} {arch = "gfx906", filter_layout = ["k", "c", "y", "x", "g"], input_layout = ["ni", "hi", "wi", "ci", "gi"], output_layout = ["no", "ho", "wo", "ko", "go"]} : memref<64x128x3x3x1xf32>, memref<256x28x28x128x1xf32>, memref<256x28x28x64x1xf32>
