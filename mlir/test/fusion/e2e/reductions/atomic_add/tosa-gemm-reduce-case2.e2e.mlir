...
module {
  func.func private @dot_add__part_0(%arg0: tensor<1x128x64xf32> {func.read_access}, %arg1: tensor<1x64x256xf32> {func.read_access}) -> (tensor<1x1x256xf32> {func.write_access}) {
    ...
    %1 = "tosa.reduce_sum"(%0) {axis = 1 : i64} : (tensor<1x128x256xf32>) -> tensor<1x1x256xf32>
    return %1 : tensor<1x1x256xf32>
  }
  func.func @dot_add(%arg0: tensor<1x128x64xf32>, %arg1: tensor<1x64x256xf32>) -> tensor<1x1x256xf32> {
    %token, %results = async.launch @dot_add__part_0 (%arg0, %arg1) : (tensor<1x128x64xf32>, tensor<1x64x256xf32>) -> tensor<1x1x256xf32>
    async.await %token : !async.token
    return %results : tensor<1x1x256xf32>
  }
  module @__xmodule_amdgcn_amd_amdhsa_gfx90a attributes {xmodel.arch = "##TOKEN_ARCH##", xmodel.module} {
    func.func private @dot_add__part_0(%arg0: tensor<1x128x64xf32> {func.read_access}, %arg1: tensor<1x64x256xf32> {func.read_access}) -> (tensor<1x1x256xf32> {func.write_access}) attributes {kernel, original_func = @dot_add__part_0} {
      %0 = "tosa.matmul"(%arg0, %arg1) : (tensor<1x128x64xf32>, tensor<1x64x256xf32>) -> tensor<1x128x256xf32>
      %1 = "tosa.reduce_sum"(%0) {axis = 1 : i64} : (tensor<1x128x256xf32>) -> tensor<1x1x256xf32>
      return %1 : tensor<1x1x256xf32>
    }
