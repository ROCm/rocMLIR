...
// CHECK: gfx942
// CHECK-SAME: 304
// CHECK-SAME: -t f32 -f N01GC -I N01GC -transC true -transO false -n 2 -c 64 -H 32 -W 32 -k 64 -y 3 -x 3 -p 1 -q 1 -u 1 -v 1 -l 1 -j 1 -g 1 -gemmO 16
module 
{
  func.func private @mlir_conv_gemm(%arg0: !migraphx.shaped<2x64x32x32xf32, 65536x1x2048x64>,
    ...
    %biased = migraphx.add %2, %arg3 : <1x2048x64xf32, 131072x64x1>, <1x2048x64xf32, 0x0x1> -> <1x2048x64xf32, 131072x64x1>
    %3 = migraphx.dot %biased, %arg2: <1x2048x64xf32, 131072x64x1>, <1x64x16xf32, 1024x1x64> -> <1x2048x16xf32, 32768x16x1>
