...
module {
  func.func @matmul_broadcast_op(%arg0: memref<262144xf32>, %arg1: memref<16777216xf32>, %arg2: memref<262144xf32>, %arg3: memref<4096xf32> {mhal.read_access, rock.prefill = 0.000000e+00 : f32}) attributes {arch = "gfx942:sramecc+:xnack-", enable_splitk_for_tuning, kernel = "mixr"} {
