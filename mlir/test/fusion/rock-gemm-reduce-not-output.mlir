...
#map7 = affine_map<(d0, d1) -> (d0, d1, 0)>
#map8 = affine_map<(d0, d1) -> (d0, d1)>
#map9 = affine_map<(d0, d1, d2) -> (d0, d1 + d2)>
#map10 = affine_map<(d0) -> (d0 floordiv 64, d0 mod 64, 0)>
...
#transform_map7 = #rock.transform_map<#map7 by [<PassThrough ["dim0"] at [0] -> ["dim0"] at [0]>, <Merge{64, 1} ["dim1"] at [1] -> ["col1", "col2"] at [1, 2]>] bounds = [64, 64] -> [64, 64, 1]>
#transform_map8 = #rock.transform_map<#map9 by [<PassThrough ["dim0"] at [0] -> ["dim0"] at [0]>, <Unmerge{64, 1} ["exp1", "exp2"] at [1, 2] -> ["dim1"] at [1]>] bounds = [64, 64, 1] -> [64, 64]>
#transform_map9 = #rock.transform_map<#map10 by [<Merge{64, 64, 1} ["dim0"] at [0] -> ["col0", "col1", "col2"] at [0, 1, 2]>] bounds = [4096] -> [64, 64, 1]>
module {
  func.func @matmul_broadcast_op(%arg0: memref<262144xf32>, %arg1: memref<16777216xf32>, %arg2: memref<262144xf32>, %arg3: memref<4096xf32> {mhal.read_access, rock.prefill = 0.000000e+00 : f32}) attributes {rock.arch = "gfx942:sramecc+:xnack-", rock.enable_splitk_for_tuning, rock.kernel = "mixr"} {
    ...
    %alloc = memref.alloc() alignment = 64 : memref<64x64x64xf32>
    ...
    %alloc_0 = memref.alloc() alignment = 64 : memref<64x64x64xf32>
    ...
    %alloc_1 = memref.alloc() alignment = 64 : memref<64x64x1xf32>
    ...
    %7 = rock.transform %alloc_1 by #transform_map7 : memref<64x64x1xf32> to memref<64x64xf32>
    %alloc_2 = memref.alloc() alignment = 64 : memref<64x64xf32>
    linalg.generic {indexing_maps = [#map8, #map8], iterator_types = ["parallel", "parallel"]} ins(%7 : memref<64x64xf32>) outs(%alloc_2 : memref<64x64xf32>) {
    ^bb0(%in: f32, %out: f32):
      %10 = arith.maximumf %in, %cst : f32
      linalg.yield %10 : f32
    }
    %8 = rock.transform %alloc_2 by #transform_map8 : memref<64x64xf32> to memref<64x64x1xf32>
    %9 = rock.transform %8 by #transform_map9 : memref<64x64x1xf32> to memref<4096xf32>
    memref.copy %9, %arg3 : memref<4096xf32> to memref<4096xf32>
    return
  }
}
