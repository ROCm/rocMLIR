...
module {
  func.func @test(%arg0: !migraphx.shaped<1x512x1x1xf32, 512x1x1x1>, %arg1: !migraphx.shaped<1x1024x14x14xf32, 200704x196x14x1>, %arg2: !migraphx.shaped<512x1024x1x1xf32, 1024x1x1x1>) -> !migraphx.shaped<1x512x14x14xf32, 100352x196x14x1> {
    %0 = migraphx.multibroadcast %arg0 {out_lens = [1, 512, 14, 14]} : !migraphx.shaped<1x512x1x1xf32, 512x1x1x1> -> !migraphx.shaped<1x512x14x14xf32, 100352x196x14x1>
    ...
    %2 = migraphx.add %1, %0 : !migraphx.shaped<1x512x14x14xf32, 100352x196x14x1>, !migraphx.shaped<1x512x14x14xf32, 100352x196x14x1> -> !migraphx.shaped<1x512x14x14xf32, 100352x196x14x1>
