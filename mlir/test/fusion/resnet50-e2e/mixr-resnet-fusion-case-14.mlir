...
module {
  func.func @test(%arg0: !migraphx.shaped<1x64x56x56xf32, 0x1x0x0>, %arg1: !migraphx.shaped<1x64x56x56xf32, 200704x3136x56x1>, %arg2: !migraphx.shaped<64x64x3x3xf32, 576x9x3x1>) -> !migraphx.shaped<1x64x56x56xf32, 200704x3136x56x1> {
    %1 = migraphx.convolution %arg1, %arg2 {dilation = [1, 1], group = 1 : i64, padding = [1, 1, 1, 1], padding_mode = 0 : i64, stride = [1, 1]} : !migraphx.shaped<1x64x56x56xf32, 200704x3136x56x1>, !migraphx.shaped<64x64x3x3xf32, 576x9x3x1> -> !migraphx.shaped<1x64x56x56xf32, 200704x3136x56x1>
