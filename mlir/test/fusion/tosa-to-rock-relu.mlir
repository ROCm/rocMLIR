...
module attributes {xmodel.arch = "amdgcn-amd-amdhsa:gfx1030"} {
// CHECK: llvm.func @test_fusion
  func.func @test_fusion(%arg0: tensor<128x32x32x8xf32>, %arg1: tensor<128x3x3x8xf32>) -> tensor<128x30x30x128xf32> attributes {kernel, xmodel.arch = "amdgcn-amd-amdhsa:gfx1030"} {
