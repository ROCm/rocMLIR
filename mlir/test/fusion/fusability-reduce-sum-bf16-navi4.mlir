...
module {
  func.func @mlir_dot_add(%arg0: memref<1x2x320xbf16>, %arg1: memref<1x2x1280xbf16>, %arg2: memref<1x1280x320xbf16>, %arg3: memref<1x2x1xbf16>) attributes {enable_splitk_for_tuning, kernel, mhal.arch = "amdgcn-amd-amdhsa:gfx1201", features = #rock<GemmFeatures mfma|dot|atomic_add|atomic_add_bf16>} {
