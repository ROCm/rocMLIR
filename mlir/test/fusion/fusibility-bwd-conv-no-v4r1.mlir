...
// SPLITK: fusible:0
module {  
  func.func @mlir_conv_bwd_data_add_relu(%arg0: memref<1x64x3x7x7xf32>, %arg1: memref<256x1x3x230x230xf32>, %arg2: memref<256x1x64x112x112xf32>, %arg3: memref<64x1x1x1xf32>, %arg4: memref<256x1x64x112x112xf32>) attributes {rock.enable_splitk_for_tuning, rock.kernel, mhal.arch = "amdgcn-amd-amdhsa:gfx908:sramecc+:xnack-", features = #rock<GemmFeatures mfma|dot|atomic_add|atomic_add_f16|atomic_fmax_f32>} {  
    ...
    %alloc = memref.alloc() alignment = 64 : memref<256x1x64x112x112xf32>  
    ...
    %alloc_0 = memref.alloc() alignment = 64 : memref<256x64x112x112xf32>  
    ...
    %alloc_1 = memref.alloc() alignment = 64 : memref<256x64x112x1xf32>  
    rock.reduce max %alloc_0 into %alloc_1 {axis = 3 : index, blockSize = 256 : i32, gridSize = 1 : i32} : memref<256x64x112x112xf32> into memref<256x64x112x1xf32>
