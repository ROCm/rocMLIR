...
module {
  func.func @mlir_dot_add(%arg0: memref<1x2x320xf16>, %arg1: memref<1x2x1280xi8>, %arg2: memref<1x1280x320xi8>, %arg3: memref<1x2x320xf16>, %arg4: memref<1x2x1xf16>) attributes {rock.enable_splitk_for_tuning, rock.kernel, mhal.arch = "amdgcn-amd-amdhsa:gfx90a:sramecc+:xnack-", features = #rock<GemmFeatures mfma|dot|atomic_add|atomic_add_f16>} {
    %alloc = memref.alloc() alignment = 64 : memref<1x2x320xi8>
    rock.gemm %alloc = %arg1 * %arg2 storeMethod =  set {rock.arch = "amdgcn-amd-amdhsa:gfx90a:sramecc+:xnack-"} : memref<1x2x320xi8> = memref<1x2x1280xi8> * memref<1x1280x320xi8>
    ...
    %alloc_1 = memref.alloc() alignment = 64 : memref<2x320xf16>
    ...
    %alloc_2 = memref.alloc() alignment = 64 : memref<2x1xf16>
