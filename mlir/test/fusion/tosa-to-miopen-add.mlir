// RUN: miopen-opt --tosa-to-miopen --tosa-to-linalg --linalg-fuse-elementwise-ops --linalg-bufferize --func-bufferize --buffer-results-to-out-params --finalizing-bufferize -miopen-copy-opt -miopen-affix-params -miopen-lowering -miopen-lowering-step2 -miopen-linalg-align -convert-linalg-to-affine-loops -miopen-lowering-step3 -miopen-lowering-step4 -miopen-lowering-step5 -convert-miopen-to-gpu -convert-gpu-to-rocdl %s -o -| FileCheck %s
