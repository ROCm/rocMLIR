...
// CHECK: rock.conv2d(%{{.*}}, %{{.*}}, %{{.*}}) features =  dot {arch = "amdgcn-amd-amdhsa:gfx906", dilations = [1, 1], filter_layout = ["g", "k", "c", "y", "x"], input_layout = ["ni", "hi", "wi", "gi", "ci"], output_layout = ["no", "go", "ko", "ho", "wo"], padding = [1, 1, 1, 1], strides = [1, 1]} : memref<1x64x128x3x3xf32>, memref<256x28x28x1x128xf32>, memref<256x1x64x28x28xf32>
