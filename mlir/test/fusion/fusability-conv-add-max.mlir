...
module {
  func.func @mlir_convolution_add_relu(%arg0: memref<64x1x1x1xf32>, %arg1: memref<1x256x56x56xf32>, %arg2: memref<64x256x1x1xf32>, %arg3: memref<1x64x56x56xf32>) attributes {rock.enable_splitk_for_tuning, rock.kernel, mhal.arch = "amdgcn-amd-amdhsa:gfx90a:sramecc+:xnack-"} {
    ...
    %alloc = memref.alloc() alignment = 64 : memref<1x64x56x56xf32>
    ...
    rock.conv(%3, %2, %4) features =  "mfma|dot|atomic_add|atomic_add_f16" {rock.arch = "amdgcn-amd-amdhsa:gfx90a:sramecc+:xnack-", dilations = [1 : index, 1 : index], filter_layout = ["g", "k", "c", "y", "x"], input_layout = ["ni", "gi", "ci", "hi", "wi"], output_layout = ["no", "go", "ko", "ho", "wo"], padding = [0 : index, 0 : index, 0 : index, 0 : index], strides = [1 : index, 1 : index]} : memref<1x64x256x1x1xf32>, memref<1x1x256x56x56xf32>, memref<1x1x64x56x56xf32>
    ...
    %alloc_0 = memref.alloc() alignment = 64 : memref<64x56x56xf32>
