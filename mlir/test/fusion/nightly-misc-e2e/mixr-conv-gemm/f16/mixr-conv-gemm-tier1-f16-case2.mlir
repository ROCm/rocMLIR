...
module {
  func.func private @mlir_conv_gemm(%arg0: !migraphx.shaped<2x64x32x32xf16, 65536x1x2048x64>,
                                    %arg1: !migraphx.shaped<64x64x1x1xf16, 64x1x64x64>,
    ...
    %0 = migraphx.convolution %arg0, %arg1 {dilation = [1, 1], group = 1 : i64, padding = [0, 0, 0, 0], padding_mode = 0 : i64, stride = [1, 1]} : <2x64x32x32xf16, 65536x1x2048x64>, <64x64x1x1xf16, 64x1x64x64> -> <2x64x32x32xf16, 65536x1x2048x64>
