...
// CHECK: [1 1 1]
module {
  func.func private @mlir_gemm_gemm(%arg0: !migraphx.shaped<2x16x384x64xf16, 393216x24576x64x1>, %arg1: !migraphx.shaped<2x16x64x384xf16, 393216x24576x384x1>, %arg2: !migraphx.shaped<2x16x384x64xf16, 393216x24576x64x1>) -> (!migraphx.shaped<2x16x384x64xf16, 393216x24576x64x1>) {
    ...
    %2 = migraphx.dot %0, %arg2: <2x16x384x384xf16, 2359296x147456x384x1>, <2x16x384x64xf16, 393216x24576x64x1> -> <2x16x384x64xf16, 393216x24576x64x1>
