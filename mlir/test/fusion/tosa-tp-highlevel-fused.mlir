// RUN: rocmlir-driver --host-pipeline highlevel %s | rocmlir-opt --rock-affix-params --rock-conv-to-gemm --rock-grid-config --rock-gemm-to-gridwise -rock-regularize | FileCheck %s
