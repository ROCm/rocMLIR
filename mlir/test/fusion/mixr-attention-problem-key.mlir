...
// CHECK: gfx942
// CHECK-SAME: 304
// CHECK-SAME: -t f32 -transQ false -transK false -transV false -transO false -causal false -return_lse false -g 1 -seq_len_q 7 -seq_len_k 7 -head_dim_qk 3 -head_dim_v 3
module 
{
