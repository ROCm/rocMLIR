...
module {
  func.func @main(%arg0: tensor<1x64x112x112xf32>, %arg1: tensor<1x3x224x224xf32>, %arg2: tensor<64x3x7x7xf32>) -> tensor<1x64x112x112xf32> attributes {kernel, arch = "amdgcn-amd-amdhsa:gfx908"} {
    ...
    %2 = "tosa.conv2d"(%0, %1, %cst_0) {acc_type = f32, dilation = array<i64: 1, 1>, expected_filter_layout = "kcyx", expected_input_layout = "nchw", expected_output_layout = "nkhw", pad = array<i64: 3, 3, 3, 3>, stride = array<i64: 2, 2>, xdlopsV2 = true} : (tensor<1x224x224x3xf32>, tensor<64x7x7x3xf32>, tensor<1xf32>) -> tensor<1x112x112x64xf32>
