...
module {
  func.func @main(%arg0: tensor<1x64x112x112xf32>, %arg1: tensor<1x3x224x224xf32>, %arg2: tensor<64x3x7x7xf32>) -> tensor<1x64x112x112xf32> attributes {kernel, mhal.arch = "amdgcn-amd-amdhsa:gfx908"} {
    ...
    return {kernel, mhal.arch = "amdgcn-amd-amdhsa:gfx908"} %5 : tensor<1x64x112x112xf32>
  }
}
