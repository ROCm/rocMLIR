// RUN: miopen-opt -migraphx-to-tosa %s | mlir-miopen-driver -host-pipeline highlevel | miopen-gen -ph -print-results -rand none - | mlir-miopen-driver -c  | mlir-rocm-runner --shared-libs=%rocm_wrapper_library_dir/librocm-runtime-wrappers%shlibext,%linalg_test_lib_dir/libmlir_runner_utils%shlibext --entry-point-result=void | FileCheck %s

// CHECK:  6,     6,     6,     6
module {
  func.func @main0(%arg0: tensor<1x5x4x4xf32>, %arg1: tensor<4x5x1x1xf32>, %arg2: tensor<4xf32>) -> tensor<1x4x4x4xf32> attributes{kernel} {
