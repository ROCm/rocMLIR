...
module {
  func.func @mlir_convolution_multi_reduce(%arg0: memref<320xf16>, %arg1: memref<32768xf16>, %arg2: memref<11520xf16>, %arg3: memref<64xf16> {mhal.read_access, rock.prefill = 0.000000e+00 : f16}, %arg4: memref<2621440xf16>) attributes {rock.arch = "gfx942:sramecc+:xnack-", rock.enable_splitk_for_tuning, rock.kernel = "mixr", features = #rock<GemmFeatures mfma|dot|atomic_add|atomic_add_f16>} {
