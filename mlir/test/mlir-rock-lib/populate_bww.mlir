...
// RUN: rocmlir-gen --operation conv_bwd_weight --arch amdgcn-amd-amdhsa:gfx906 --num_cu 64 -t fp32 --fil_layout gkcyx --in_layout ngchw --out_layout ngkhw --batchsize 64 --in_channels 1024 --out_channels 1024 --in_h 14 --in_w 14 --out_h 14 --out_w 14 --fil_h 1 --fil_w 1 --dilation_h 1 --dilation_w 1 --conv_stride_h 1 --conv_stride_w 1 --padding_h 0 --padding_w 0 --groupsize 1 --kernel_name conv | FileCheck %s --check-prefix=DRIVER1
...
// RUN: rocmlir-gen --operation conv_bwd_weight --arch amdgcn-amd-amdhsa:gfx908:sramecc+:xnack- --num_cu 120 -t fp32 --fil_layout gkcyx --in_layout ngchw --out_layout ngkhw --batchsize 64 --in_channels 1024 --out_channels 1024 --in_h 14 --in_w 14 --out_h 14 --out_w 14 --fil_h 1 --fil_w 1 --dilation_h 1 --dilation_w 1 --conv_stride_h 1 --conv_stride_w 1 --padding_h 0 --padding_w 0 --groupsize 1 --kernel_name conv | FileCheck %s --check-prefix=ZEROINIT_DRIVER
...
// RUN: rocmlir-gen --operation conv_bwd_weight --arch amdgcn-amd-amdhsa:gfx908:sramecc+:xnack- --num_cu 120 -t fp16 --fil_layout gkcyx --in_layout ngchw --out_layout ngkhw --batchsize 64 --in_channels 1024 --out_channels 1024 --in_h 14 --in_w 14 --out_h 14 --out_w 14 --fil_h 1 --fil_w 1 --dilation_h 1 --dilation_w 1 --conv_stride_h 1 --conv_stride_w 1 --padding_h 0 --padding_w 0 --groupsize 1 --kernel_name conv | FileCheck %s --check-prefix=DRIVER2
