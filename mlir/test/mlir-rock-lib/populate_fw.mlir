...
// DRIVER: rock.conv2d(%arg0, %arg1, %arg2) features = dot, convParams = {padding : [0, 0, 0, 0], stride : [1, 1], dilation : [1, 1]} {arch = "gfx906", filter_layout = ["g", "k", "c", "y", "x"], gemm_id = 0 : i32, input_layout = ["ni", "gi", "ci", "hi", "wi"], output_layout = ["no", "go", "ko", "ho", "wo"]} : memref<1x1024x1024x1x1xf32>, memref<64x1x1024x14x14xf32>, memref<64x1x1024x14x14xf32>
