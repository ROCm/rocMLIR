...
// RUN: rocmlir-gen --operation conv_bwd_data --arch amdgcn-amd-amdhsa:gfx906 --num_cu 64 -t fp32 --fil_layout gkcyx --in_layout ngchw --out_layout ngkhw --batchsize 64 --in_channels 1024 --out_channels 1024 --in_h 14 --in_w 14 --out_h 14 --out_w 14 --fil_h 1 --fil_w 1 --dilation_h 1 --dilation_w 1 --conv_stride_h 1 --conv_stride_w 1 --padding_h 0 --padding_w 0 --groupsize 1 --kernel_name foo --v4r1 1 | FileCheck %s --check-prefix=DRIVER1
...
// RUN: rocmlir-gen --operation conv_bwd_data --arch amdgcn-amd-amdhsa:gfx906 --num_cu 64 -t fp32 --fil_layout gkcyx --in_layout ngchw --out_layout ngkhw --batchsize 64 --in_channels 1024 --out_channels 1024 --in_h 14 --in_w 14 --out_h 6 --out_w 6 --fil_h 3 --fil_w 3 --dilation_h 1 --dilation_w 1 --conv_stride_h 2 --conv_stride_w 2 --padding_h 0 --padding_w 0 --groupsize 1 --kernel_name bar --v4r1 1 | FileCheck %s --check-prefix=DRIVER4
...
// RUN: rocmlir-gen --operation conv_bwd_data --arch amdgcn-amd-amdhsa:gfx906 --num_cu 64 -t fp16 --fil_layout gkcyx --in_layout ngchw --out_layout ngkhw --batchsize 256 --in_channels 1024 --out_channels 2048 --in_h 14 --in_w 14 --out_h 7 --out_w 7 --fil_h 1 --fil_w 1 --dilation_h 1 --dilation_w 1 --conv_stride_h 2 --conv_stride_w 2 --padding_h 0 --padding_w 0 --groupsize 1 --kernel_name baz --v4r1 1 | FileCheck %s --check-prefix=ZEROINIT_DRIVER
