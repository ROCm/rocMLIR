...
func.func @in_bounds_load_vector(%buf: memref<2x2xf32, 3>) -> vector<4xf32> {
    ...
    %ret = rock.in_bounds_load %buf[%c0, %c0] : memref<2x2xf32, 3>, index, index -> vector<4xf32>
...
func.func @in_bounds_store_vector(%data: vector<4xf32>, %buf: memref<2x2xf32, 3>) {
    ...
    rock.in_bounds_store %data -> %buf[%c0, %c0] : vector<4xf32> -> memref<2x2xf32, 3>, index, index
    return
}
}
