...
func.func @test_reduce_sum(%arg0: memref<2x12x12xf32>, %arg1: memref<2x12x1xf32>) attributes {kernel, arch = ""} {
    ...
    rock.reduce sum %arg0 into %arg1 features = mfma|dot|atomic_add|atomic_add_f16 {axis = 2 : index, blockSize = 64 : i32, gridSize = 2 : i32} : memref<2x12x12xf32> into memref<2x12x1xf32>
    func.return
}
...
func.func @test_reduce_max(%arg0: memref<2x12x12xf32>, %arg1: memref<2x12x1xf32>) attributes {kernel, arch = ""} {
    ...
    rock.reduce max %arg0 into %arg1 features = mfma|dot|atomic_add|atomic_add_f16 {axis = 2 : index, blockSize = 64 : i32, gridSize = 2 : i32} : memref<2x12x12xf32> into memref<2x12x1xf32>
    func.return
}

// CHECK: @test_reduce_sum_f16
func.func @test_reduce_sum_f16(%arg0: memref<2x12x12xf16>, %arg1: memref<2x12x1xf16>) attributes {kernel, arch = ""} {
    // CHECK-DAG: %[[bid:.*]] = rock.workgroup_id : index
    // CHECK-DAG: %[[tid:.*]] = rock.workitem_id : index
    // CHECK: rock.transforming_for {{.*}} (%[[loadCoord0:.*]], %[[loadCoord1:.*]], %[[loadCoord2:.*]]) = {{.*}}#[[MAP0]], #[[MAP1]], #[[MAP2]]](%[[bid]], %c0, %[[tid]]) (%[[valid:.*]]) = validity
    // CHECK: %[[ld:.*]] = rock.global_load %arg0[%[[loadCoord0]], %[[loadCoord1]], %[[loadCoord2]]]
