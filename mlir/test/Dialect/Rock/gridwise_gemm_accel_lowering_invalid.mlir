...
#xdlops_gemm_params_too_much_lds = #rock.mfma_gemm_params<kpackPerBlock = 32, mPerBlock = 256, nPerBlock = 256, kpack = 8, mPerWave = 64, nPerWave = 64, mnPerXdl = 32, splitKFactor = 1, scheduleVersion = 1, outputSwizzle = 2, wavesPerEU = 0, gridGroupSize = 0, forceUnroll = true>
...
// Format: A (G x K x M), B (G x K x N), C (G x M x N)
#xdlops_gemm_params_gfx950_lds = #rock.mfma_gemm_params<kpackPerBlock = 16, mPerBlock = 512, nPerBlock = 512, kpack = 8, mPerWave = 64, nPerWave = 64, mnPerXdl = 32, splitKFactor = 1, scheduleVersion = 1, outputSwizzle = 2, wavesPerEU = 0, gridGroupSize = 0, forceUnroll = true>
...
#xdlops_gemm_params_scaled_lds_exceeded = #rock.mfma_gemm_params<kpackPerBlock = 32, mPerBlock = 256, nPerBlock = 256, kpack = 32, mPerWave = 32, nPerWave = 32, mnPerXdl = 32, splitKFactor = 1, scheduleVersion = 1, outputSwizzle = 2, wavesPerEU = 0, gridGroupSize = 0, forceUnroll = true>
...
// Format: A (G x K x M), B (G x K x N), C (G x M x N), scaleA (G x K x M), scaleB (G x K x N)
#xdlops_gemm_params_scaled_lds_exceeded2 = #rock.mfma_gemm_params<kpackPerBlock = 32, mPerBlock = 512, nPerBlock = 512, kpack = 32, mPerWave = 32, nPerWave = 32, mnPerXdl = 32, splitKFactor = 1, scheduleVersion = 1, outputSwizzle = 2, wavesPerEU = 0, gridGroupSize = 0, forceUnroll = true>
