...
func.func @matmul_splitk_addf_constant(%arg0: memref<32768xf32>, %arg1: memref<16384xf32>, %arg2: memref<32xf32>) attributes {rock.arch = "gfx942:sramecc+:xnack-", block_size = 128 : i32, rock.enable_splitk_for_tuning, rock.kernel} {
  ...
  %alloc = memref.alloc() alignment = 64 : memref<2x4x4xf32>
  ...
  rock.gemm %5 = %3 * %4 storeMethod =  set {derivedBlockSize = 128 : i32, params = #rock.accel_gemm_params<kpackPerBlock = 4, mPerBlock = 16, nPerBlock = 32, kpack = 4, mPerWave = 16, nPerWave = 16, mnPerXdl = 16, splitKFactor = 4, scheduleVersion = 1, outputSwizzle = 2, wavesPerEU = 0, gridGroupSize = 0, forceUnroll = true>, perf_config = "v3:16,32,4,16,16,4,4,1,2,1,1"} : memref<8x4xf32> = memref<8x4096xf32> * memref<4096x4xf32>
  %alloc_0 = memref.alloc() alignment = 64 : memref<2x4x4xf32>
...
func.func @matmul_splitk_multiple(%arg0: memref<2x4x4xf32>, %arg1: memref<2x4x4xf16>, %arg2: memref<32768xf32>, %arg3: memref<16384xf32>, %arg4: memref<32xf16>) attributes {rock.arch = "gfx942:sramecc+:xnack-", block_size = 128 : i32, rock.enable_splitk_for_tuning, rock.kernel} {
  ...
  %5 = rock.transform %alloc by <affine_map<(d0, d1) -> (d0 floordiv 4, d0 mod 4, d1)> by [<Merge{2, 4} ["gd0"] at [0] -> ["g", "d0"] at [0, 1]>, <PassThrough ["d1"] at [1] -> ["d1"] at [2]>] bounds = [8, 4] -> [2, 4, 4]> : memref<2x4x4xf32> to memref<8x4xf32>
  rock.gemm %5 = %3 * %4 storeMethod =  set {derivedBlockSize = 128 : i32, params = #rock.accel_gemm_params<kpackPerBlock = 4, mPerBlock = 16, nPerBlock = 32, kpack = 4, mPerWave = 16, nPerWave = 16, mnPerXdl = 16, splitKFactor = 4, scheduleVersion = 1, outputSwizzle = 2, wavesPerEU = 0, gridGroupSize = 0, forceUnroll = true>, perf_config = "v3:16,32,4,16,16,4,4,1,2,1,1"} : memref<8x4xf32> = memref<8x4096xf32> * memref<4096x4xf32>
  %alloc_0 = memref.alloc() alignment = 64 : memref<2x4x4xf16>
...
func.func @convolution_multi_output_add(%arg0: memref<32768xf32>, %arg1: memref<11520xf32>, %arg2: memref<2621440xf32>, %arg3: memref<2621440xf32>) attributes {rock.arch = "gfx942:sramecc+:xnack-", block_size = 128 : i32, rock.enable_splitk_for_tuning, rock.kernel} {
  ...
  rock.gemm %9 = tr %5 * %8 storeMethod =  set {derivedBlockSize = 128 : i32, params = #rock.accel_gemm_params<kpackPerBlock = 4, mPerBlock = 16, nPerBlock = 32, kpack = 4, mPerWave = 16, nPerWave = 16, mnPerXdl = 16, splitKFactor = 4, scheduleVersion = 1, outputSwizzle = 2, wavesPerEU = 0, gridGroupSize = 0, forceUnroll = true>} : memref<1x320x8192xf32> = memref<1x36x320xf32> * memref<1x36x8192xf32>
  %alloc_2 = memref.alloc() alignment = 64 : memref<2x320x64x64xf32>
  ...
  %alloc_3 = memref.alloc() alignment = 64 : memref<2x320x64x64xf32>
  ...
  %alloc_4 = memref.alloc() alignment = 64 : memref<2x320x64x64xf32>
...
func.func @convolution_multi_output_add_twice(%arg0: memref<32768xf32> {mhal.read_access}, %arg1: memref<11520xf32> {mhal.read_access}, %arg2: memref<2621440xf32> {mhal.write_access}, %arg3: memref<2621440xf32> {mhal.write_access}) attributes {rock.arch = "gfx942:sramecc+:xnack-", block_size = 128 : i32, rock.enable_splitk_for_tuning, rock.kernel, original_func = @mlir_convolution_multi_output_add} {
  ...
  %alloc_5 = memref.alloc() alignment = 64 : memref<2x320x64x64xf32>
