...
func.func @gridwise_attn_causal_scale_gqa(%arg0: memref<8192xf16>, %arg1: memref<8388608xf16>, %arg2: memref<8388608xf16>, %arg3: memref<524288xf16>, %arg4: memref<64xf16>, %arg5: memref<8192xf16>) attributes {block_size = 32 : i32, features = #rock<GemmFeatures wmma|dot|atomic_add|atomic_fmax_f32>, grid_size = 8 : i32, kernel, mhal.arch = "amdgcn-amd-amdhsa:gfx1100"} {
  ...
  ^bb0(%arg6: memref<64x1x8192xf16>, %arg7: memref<64x1x8192xf16>, %arg8: memref<64x1x8192xf16>):
    ...
    rock.yield
  } {blockSize = 32 : i32, causalMaskingValue = 0 : i32, firstGemmIndices = array<i64: 0>, gridSize = 8 : i32, numRepeatsGQA = 8 : index, operandSegmentSizes = array<i32: 1, 1, 1, 1, 0, 0, 1, 1>, params0 = #rock.wmma_gemm_params<kpackPerBlock = 32, mPerBlock = 32, nPerBlock = 32, kpack = 1, mPerWave = 32, nPerWave = 32, mnPerXdl = 16, splitKFactor = 1, scheduleVersion = 1, outputSwizzle = 2, forceUnroll  = true>, params1 = #rock.wmma_gemm_params<kpackPerBlock = 32, mPerBlock = 32, nPerBlock = 32, kpack = 1, mPerWave = 32, nPerWave = 32, mnPerXdl = 16, splitKFactor = 1, scheduleVersion = 1, outputSwizzle = 2, forceUnroll  = true>, prePadG0N = 8 : index, softmaxType = f32, splitKV = 1 : i32, storeMethod = #rock<StoreMethod set>} : memref<8x128x32xf16>, memref<8x128x8192xf16>, memref<8x8192x128xf16>, memref<64x1x8192xf16>, memref<8x32x128xf16>, memref<8x32xf16>
  return
}
