...
// CHECK-DAG: #[[$XDLOPS_PARAMS_0:.*]] = #rock.accel_gemm_params<kPerBlock = 8, mPerBlock = 64, nPerBlock = 64, kpack = 4, mPerWave = 32, nPerWave = 32, forceUnroll = true>
// CHECK-DAG: #[[$XDLOPS_PARAMS_1:.*]] = #rock.accel_gemm_params<kPerBlock = 4, mPerBlock = 128, nPerBlock = 128, kpack = 4, mPerWave = 64, nPerWave = 64, forceUnroll = true>
// CHECK-DAG: #[[$XDLOPS_PARAMS_2:.*]] = #rock.accel_gemm_params<kPerBlock = 4, mPerBlock = 128, nPerBlock = 128, kpack = 8, mPerWave = 64, nPerWave = 64, forceUnroll = true>
// CHECK-DAG: #[[$XDLOPS_PARAMS_3:.*]] = #rock.accel_gemm_params<kPerBlock = 8, mPerBlock = 64, nPerBlock = 256, kpack = 1, mPerWave = 64, nPerWave = 64, forceUnroll = true>
// CHECK-DAG: #[[$XDLOPS_PARAMS_4:.*]] = #rock.accel_gemm_params<kPerBlock = 2, mPerBlock = 32, nPerBlock = 64, kpack = 4, mPerWave = 8, nPerWave = 64, forceUnroll = true>
// CHECK-DAG: #[[$XDLOPS_PARAMS_5:.*]] = #rock.accel_gemm_params<kPerBlock = 8, mPerBlock = 16, nPerBlock = 128, kpack = 1, mPerWave = 16, nPerWave = 64, forceUnroll = true>
// CHECK-DAG: #[[$XDLOPS_PARAMS_6:.*]] = #rock.accel_gemm_params<kPerBlock = 16, mPerBlock = 4, nPerBlock = 64, kpack = 1, mPerWave = 4, nPerWave = 64, forceUnroll = true>
// CHECK-DAG: #[[$XDLOPS_PARAMS_7:.*]] = #rock.accel_gemm_params<kPerBlock = 8, mPerBlock = 128, nPerBlock = 128, kpack = 8, mPerWave = 64, nPerWave = 64, forceUnroll = true>
