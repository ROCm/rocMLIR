...
#transform_map1 = #rock.transform_map<affine_map<(d0, d1) -> (d1, d0)>
    by [#rock.transform<PassThrough ["x", "y"] at [1, 0] -> ["x", "y"] at [0, 1]>]
    bounds = [4, 16] -> [16, 4]>
...
func.func @no_transform_to_affine() {
    ...
    rock.transforming_for (%arg0, %arg1) = [](%c0, %c0) bounds [2, 3] strides [1, 1] {
...
func.func @no_transform_to_affine_strided() {
    ...
    // CHECK: affine.for %[[arg1:.*]] = {{.*}}to 3
    // CHECK: gpu.printf "%d, %d" %[[arg0]], %[[arg1]]
    rock.transforming_for (%arg0, %arg1) = [](%c0, %c0) bounds [2, 3] strides [2, 1] {
        gpu.printf "%d, %d" %arg0, %arg1 : index, index
    }
    return
}
...
func.func @no_transform_unrolled() {
    ...
    rock.transforming_for {forceUnroll} (%arg0, %arg1) = [](%c0, %c0) bounds [2, 3] strides [1, 1] {
        gpu.printf "%d, %d" %arg0, %arg1 : index, index
    }
    return
}
...
func.func @no_transform_unrolled_strided() {
    ...
    rock.transforming_for {forceUnroll} (%arg0, %arg1) = [](%c0, %c0) bounds [2, 3] strides [2, 1] {
        gpu.printf "%d, %d" %arg0, %arg1 : index, index
    }
    return
}
...
func.func @one_transform(%arg0: index, %arg1: index) {
    ...
    rock.transforming_for (%arg2) = [#transform_map0](%arg0, %arg1) bounds [2, 3] strides [1, 1] {
...
func.func @one_transform_index_diff(%arg0: index, %arg1: index) {
    ...
    // CHECK-NEXT: gpu.printf "%d" %[[l0]]
    rock.transforming_for {useIndexDiffs} (%arg2) = [#transform_map0](%arg0, %arg1) bounds [2, 3] strides [1, 1] {
        gpu.printf "%d" %arg2 : index
    }
    return
}
...
func.func @one_transform_unroll(%arg0: index, %arg1: index) {
    ...
    // CHECK-COUNT-3: gpu.printf
    rock.transforming_for {forceUnroll} (%arg2) = [#transform_map0](%arg0, %arg1) bounds [2, 3] strides [1, 1] {
        gpu.printf "%d" %arg2 : index
    }
    return
}
...
func.func @one_transform_index_diff_unroll(%arg0: index, %arg1: index) {
    ...
    rock.transforming_for {forceUnroll, useIndexDiffs} (%arg2) = [#transform_map0](%arg0, %arg1) bounds [2, 3] strides [1, 1] {
        gpu.printf "%d" %arg2 : index
    }
    return
}
...
func.func @deep_transforms(%arg0: index, %arg1: index) {
    rock.transforming_for (%arg2) = [#transform_map1, #transform_map0](%arg0, %arg1) bounds [2, 3] strides [1, 1] {
...
func.func @deep_transforms_index_diff(%arg0: index, %arg1: index) {
    ...
    // CHECK: affine.for %[[d0:.*]] = 0 to 2
    // CHECK-NEXT: affine.for %[[d1:.*]] = 0 to 3
    rock.transforming_for {useIndexDiffs} (%arg2) = [#transform_map1, #transform_map0](%arg0, %arg1) bounds [2, 3] strides [1, 1] {
...
func.func @multi_iteration() {
    %c0 = arith.constant 0 : index
    // CHECK-COUNT-6: gpu.printf
    rock.transforming_for {forceUnroll} (%arg0, %arg1) = [#transform_map1](%c0, %c0), (%arg2) = [#transform_map0](%c0, %c0) bounds [2, 3] strides [1, 1] {
