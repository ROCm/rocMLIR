...
#map20 = affine_map<(d0, d1) -> (d1 * 64 + d0)>
#map21 = affine_map<(d0, d1, d2) -> (d1, d2)>
#map22 = affine_map<(d0, d1) -> (d0 floordiv 64, d0 mod 64, d1)>
#map23 = affine_map<(d0, d1) -> (d1 + d0, d1)>
#map24 = affine_map<(d0, d1, d2, d3, d4, d5) -> ((d4 * 2 + d0) * 32 + d3, d2 * 4 + d5)>
#map25 = affine_map<(d0, d1, d2, d3, d4) -> (d0 floordiv 2, d0 mod 2, d1, d2, d3, d4)>
#map26 = affine_map<(d0, d1, d2) -> (d0 floordiv 64, (d0 mod 64) floordiv 32, d0 mod 32, d1, d2)>
#map27 = affine_map<(d0, d1, d2, d3, d4, d5) -> ((d4 * 2 + d1) * 32 + d3, d2 * 4 + d5)>
...
#transform_map24 = #rock.transform_map<#map20 by [<Unmerge{8, 64} ["k", "d"] at [1, 0] -> ["source_offset"] at [0]>] bounds = [64, 8] -> [512]>
#transform_map25 = #rock.transform_map<#map21 by [<AddDim{8} ["to_discard"] at [0] -> [] at []>, <PassThrough ["d"] at [1] -> ["d"] at [0]>, <PassThrough ["k"] at [2] -> ["k"] at [1]>] bounds = [8, 64, 8] -> [64, 8]>
#transform_map26 = #rock.transform_map<#map22 by [<Merge{8, 64} ["d"] at [0] -> ["to_discard", "d"] at [0, 1]>, <PassThrough ["k"] at [1] -> ["k"] at [2]>] bounds = [512, 8] -> [8, 64, 8]>
#transform_map27 = #rock.transform_map<#map23 by [<Embed{1, 1} ["k", "d"] at [1, 0] -> ["d"] at [0]>, <PassThrough ["k"] at [1] -> ["k"] at [1]>] bounds = [64, 8] -> [512, 8]>
#transform_map28 = #rock.transform_map<#map24 by [<Unmerge{1, 2, 32} ["d_iter", "wave_m", "blk_td"] at [4, 0, 3] -> ["d"] at [0]>, <Unmerge{2, 4} ["blk_id", "k_iter"] at [2, 5] -> ["k"] at [1]>, <AddDim{2} ["wave_n"] at [1] -> [] at []>] bounds = [2, 2, 2, 32, 64, 4] -> [64, 8]>
#transform_map29 = #rock.transform_map<#map25 by [<Merge{2, 2} ["wave_id"] at [0] -> ["wave_m", "wave_n"] at [0, 1]>, <PassThrough ["blk_id", "blk_td", "d_iter", "k_iter"] at [1, 2, 3, 4] -> ["blk_id", "blk_td", "d_iter", "k_iter"] at [2, 3, 4, 5]>] bounds = [4, 2, 32, 64, 4] -> [2, 2, 2, 32, 64, 4]>
#transform_map30 = #rock.transform_map<#map26 by [<Merge{4, 2, 32} ["tid"] at [0] -> ["wave_id", "blk_id", "blk_td"] at [0, 1, 2]>, <PassThrough ["d_iter", "k_iter"] at [1, 2] -> ["d_iter", "k_iter"] at [3, 4]>] bounds = [256, 64, 4] -> [4, 2, 32, 64, 4]>
#transform_map31 = #rock.transform_map<#map27 by [<Unmerge{1, 2, 32} ["d_iter", "wave_n", "blk_td"] at [4, 1, 3] -> ["d"] at [0]>, <Unmerge{2, 4} ["blk_id", "k_iter"] at [2, 5] -> ["k"] at [1]>, <AddDim{2} ["wave_m"] at [0] -> [] at []>] bounds = [2, 2, 2, 32, 64, 4] -> [64, 8]>
// CHECK-LABEL: rock_gemm_ii_1
func.func @rock_gemm_ii_1(%arg0: memref<1x384x1024xf16>, %arg1: memref<1x1024x1024xf16>, %arg2: memref<1x384x1024xf16>) attributes {block_size = 256 : i32, grid_size = 96 : i32, kernel, mhal.arch = "amdgcn-amd-amdhsa:gfx90a", wave_size = 64 : i32} {
  ...
  // CHECK: %[[mb0:.*]] = rock.alloc() : memref<64xi8, #gpu.address_space<private>>
  %7 = rock.alloc() : memref<32xi8, #gpu.address_space<private>>
  // CHECK: rock.reinterpret_multibuffer %[[mb0]] {multibufferFactor = 2 : index}
  // CHECK: %[[mb1:.*]] = rock.alloc() : memref<64xi8, #gpu.address_space<private>>
  %view = memref.view %7[%c0][] : memref<32xi8, #gpu.address_space<private>> to memref<16xf16, #gpu.address_space<private>>
  // CHECK: rock.reinterpret_multibuffer %[[mb1]] {multibufferFactor = 2 : index}
  %8 = rock.alloc() : memref<32xi8, #gpu.address_space<private>>
  %view_0 = memref.view %8[%c0][] : memref<32xi8, #gpu.address_space<private>> to memref<16xf16, #gpu.address_space<private>>
  ...
  %19 = rock.alloc() : memref<32xi8, #gpu.address_space<private>>
  %view_1 = memref.view %19[%c0][] : memref<32xi8, #gpu.address_space<private>> to memref<16xf16, #gpu.address_space<private>>
  %20 = rock.alloc() : memref<32xi8, #gpu.address_space<private>>
  %view_2 = memref.view %20[%c0][] : memref<32xi8, #gpu.address_space<private>> to memref<16xf16, #gpu.address_space<private>>
  %21 = rock.transform %view by #transform_map5 : memref<16xf16, #gpu.address_space<private>> to memref<2x8xf16, #gpu.address_space<private>>
  ...
  %23 = rock.transform %view_1 by #transform_map7 : memref<16xf16, #gpu.address_space<private>> to memref<1x2x8xf16, #gpu.address_space<private>>
  ...
  %25 = rock.transform %view_0 by #transform_map9 : memref<16xf16, #gpu.address_space<private>> to memref<8x2xf16, #gpu.address_space<private>>
  ...
  %27 = rock.transform %view_2 by #transform_map11 : memref<16xf16, #gpu.address_space<private>> to memref<1x2x8xf16, #gpu.address_space<private>>
  ...
  // CHECK: %[[mb2:.*]] = rock.alloc() : memref<16384xi8, #gpu.address_space<workgroup>>
  %29 = rock.alloc() : memref<8192xi8, #gpu.address_space<workgroup>>
  // CHECK: %[[mb3:.*]] = rock.alloc() : memref<16384xi8, #gpu.address_space<workgroup>>
  %30 = rock.alloc() : memref<8192xi8, #gpu.address_space<workgroup>>
  %view_3 = memref.view %29[%c0][] : memref<8192xi8, #gpu.address_space<workgroup>> to memref<512xvector<8xf16>, #gpu.address_space<workgroup>>
  %31 = rock.transform %view_3 by #transform_map13 : memref<512xvector<8xf16>, #gpu.address_space<workgroup>> to memref<8x64x1x8xvector<8xf16>, #gpu.address_space<workgroup>>
  ...
  %view_4 = memref.view %30[%c0][] : memref<8192xi8, #gpu.address_space<workgroup>> to memref<512xvector<8xf16>, #gpu.address_space<workgroup>>
  %38 = rock.transform %view_4 by #transform_map20 : memref<512xvector<8xf16>, #gpu.address_space<workgroup>> to memref<8x64x1x8xvector<8xf16>, #gpu.address_space<workgroup>>
  ...
  %view_5 = memref.view %29[%c0][] : memref<8192xi8, #gpu.address_space<workgroup>> to memref<512xvector<8xf16>, #gpu.address_space<workgroup>>
  %view_6 = memref.view %30[%c0][] : memref<8192xi8, #gpu.address_space<workgroup>> to memref<512xvector<8xf16>, #gpu.address_space<workgroup>>
  %42 = rock.alloc() : memref<64xi8, #gpu.address_space<private>>
  %view_7 = memref.view %42[%c0][] : memref<64xi8, #gpu.address_space<private>> to memref<8xvector<4xf16>, #gpu.address_space<private>>
  %43 = rock.alloc() : memref<64xi8, #gpu.address_space<private>>
  %view_8 = memref.view %43[%c0][] : memref<64xi8, #gpu.address_space<private>> to memref<8xvector<4xf16>, #gpu.address_space<private>>
  %44 = rock.alloc() : memref<64xi8, #gpu.address_space<private>>
  %view_9 = memref.view %44[%c0][] : memref<64xi8, #gpu.address_space<private>> to memref<1xvector<16xf32>, #gpu.address_space<private>>
  affine.for %arg3 = 0 to 1 {
    memref.store %cst, %view_9[%arg3] : memref<1xvector<16xf32>, #gpu.address_space<private>>
  }
  scf.for %arg3 = %c0 to %c16 step %c1 {
    ...
    // CHECK: {name = "MMA"}
    rock.stage {
      rock.threadwise_read_into {forceUnroll, useIndexDiffs} [](%2) [%arg3, %9, %16, %18, %6] -> %view : memref<16x1x6x16x256x16xf16> -> memref<16xf16, #gpu.address_space<private>>
      rock.threadwise_read_into {forceUnroll, useIndexDiffs} [](%4) [%arg3, %9, %16, %18, %6] -> %view_0 : memref<16x1x6x16x256x16xf16> -> memref<16xf16, #gpu.address_space<private>>
    ...
    rock.stage {
      rock.threadwise_write_all features =  mfma|dot|atomic_add {forceUnroll, useIndexDiffs} %view_1 -> [](%37) [%6] by  set : memref<16xf16, #gpu.address_space<private>> -> memref<256x16xvector<8xf16>, #gpu.address_space<workgroup>>
      rock.threadwise_write_all features =  mfma|dot|atomic_add {forceUnroll, useIndexDiffs} %view_2 -> [](%41) [%6] by  set : memref<16xf16, #gpu.address_space<private>> -> memref<256x16xvector<8xf16>, #gpu.address_space<workgroup>>
      rock.yield
    } {name = "LDSWrite"}
    rock.stage {
      %46 = rock.workitem_id : index
      %47 = rock.transform %view_5 by #transform_map24 : memref<512xvector<8xf16>, #gpu.address_space<workgroup>> to memref<64x8xvector<8xf16>, #gpu.address_space<workgroup>>
      %48 = rock.transform %47 by #transform_map25 : memref<64x8xvector<8xf16>, #gpu.address_space<workgroup>> to memref<8x64x8xvector<8xf16>, #gpu.address_space<workgroup>>
      %49 = rock.transform %48 by #transform_map26 : memref<8x64x8xvector<8xf16>, #gpu.address_space<workgroup>> to memref<512x8xvector<8xf16>, #gpu.address_space<workgroup>>
      %50 = rock.transform %49 by #transform_map27 : memref<512x8xvector<8xf16>, #gpu.address_space<workgroup>> to memref<64x8xvector<8xf16>, #gpu.address_space<workgroup>>
      %51 = rock.transform %50 by #transform_map28 : memref<64x8xvector<8xf16>, #gpu.address_space<workgroup>> to memref<2x2x2x32x64x4xvector<8xf16>, #gpu.address_space<workgroup>>
      %52 = rock.transform %51 by #transform_map29 : memref<2x2x2x32x64x4xvector<8xf16>, #gpu.address_space<workgroup>> to memref<4x2x32x64x4xvector<8xf16>, #gpu.address_space<workgroup>>
      %53 = rock.transform %52 by #transform_map30 : memref<4x2x32x64x4xvector<8xf16>, #gpu.address_space<workgroup>> to memref<256x64x4xvector<8xf16>, #gpu.address_space<workgroup>>
      %54 = rock.transform %view_6 by #transform_map24 : memref<512xvector<8xf16>, #gpu.address_space<workgroup>> to memref<64x8xvector<8xf16>, #gpu.address_space<workgroup>>
      %55 = rock.transform %54 by #transform_map31 : memref<64x8xvector<8xf16>, #gpu.address_space<workgroup>> to memref<2x2x2x32x64x4xvector<8xf16>, #gpu.address_space<workgroup>>
      %56 = rock.transform %55 by #transform_map29 : memref<2x2x2x32x64x4xvector<8xf16>, #gpu.address_space<workgroup>> to memref<4x2x32x64x4xvector<8xf16>, #gpu.address_space<workgroup>>
      %57 = rock.transform %56 by #transform_map30 : memref<4x2x32x64x4xvector<8xf16>, #gpu.address_space<workgroup>> to memref<256x64x4xvector<8xf16>, #gpu.address_space<workgroup>>
      affine.for %arg4 = 0 to 1 {
        rock.threadwise_read_into {forceUnroll, useIndexDiffs} [](%53) [%46, %arg4] -> %view_7 : memref<256x64x4xvector<8xf16>, #gpu.address_space<workgroup>> -> memref<8xvector<4xf16>, #gpu.address_space<private>>
        affine.for %arg5 = 0 to 1 {
          rock.threadwise_read_into {forceUnroll, useIndexDiffs} [](%57) [%46, %arg5] -> %view_8 : memref<256x64x4xvector<8xf16>, #gpu.address_space<workgroup>> -> memref<8xvector<4xf16>, #gpu.address_space<private>>
          rock.accel_gemm %view_9 += %view_7[%arg4] * %view_8[%arg5] features =  mfma|dot|atomic_add {arch = "amdgcn-amd-amdhsa:gfx90a", params = #xldops_gemm_params} : memref<1xvector<16xf32>, #gpu.address_space<private>> += memref<8xvector<4xf16>, #gpu.address_space<private>> * memref<8xvector<4xf16>, #gpu.address_space<private>>
        }
      }
      rock.yield
    } {name = "MMA"}
...
func.func @rock_gemm_ii_2(%arg0: memref<1x384x1024xf16>, %arg1: memref<1x1024x1024xf16>, %arg2: memref<1x384x1024xf16>) attributes {block_size = 256 : i32, grid_size = 96 : i32, kernel, mhal.arch = "amdgcn-amd-amdhsa:gfx90a", wave_size = 64 : i32} {
  %c1 = arith.constant 1 : index
  %c16 = arith.constant 16 : index
  %cst = arith.constant dense<0.000000e+00> : vector<16xf32>
  %c96 = arith.constant 96 : index
