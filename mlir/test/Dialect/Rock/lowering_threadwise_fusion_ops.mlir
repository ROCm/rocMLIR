...
func.func @threadwise_read_into( %source: memref<2x64x30xf32>, %dest: memref<32xf32, #gpu.address_space<private>>) attributes {block_size = 128 : i32, rock.arch = "##TOKEN_ARCH##"} {
...
func.func @threadwise_read_into_scalar(%source: memref<f32>, %dest: memref<1xf32, #gpu.address_space<private>>) attributes {block_size = 128 : i32, rock.arch = "##TOKEN_ARCH##"} {
  // CHECK-DAG: [[zero:%.+]] = arith.constant 0
  // CHECK: rock.transforming_for {forceUnroll, useIndexDiffs}
...
func.func @threadwise_read_into_extra_idx( %source: memref<3x2x64x30xf32>, %dest: memref<32xf32, #gpu.address_space<private>>) attributes {block_size = 128 : i32, rock.arch = "##TOKEN_ARCH##"} {
  // CHECK-DAG: [[zero:%.+]] = arith.constant 0
...
func.func @threadwise_write_all(%source: memref<32xf32, #gpu.address_space<private>>, %dest: memref<2x64x30xf32>) attributes {block_size = 128 : i32, rock.arch = "##TOKEN_ARCH##"} {
  // CHECK-DAG: [[zero:%.+]] = arith.constant 0
  // CHECK-DAG: [[bid:%.+]] = rock.workgroup_id
  // CHECK-DAG: [[tid:%.+]] = rock.workitem_id
  // CHECK: rock.transforming_for {forceUnroll, useIndexDiffs}
...
func.func @threadwise_write_all_scalar(%source: memref<1xf32, #gpu.address_space<private>>, %dest: memref<f32>) attributes {block_size = 128 : i32, rock.arch = "##TOKEN_ARCH##"} {
  // CHECK-DAG: [[zero:%.+]] = arith.constant 0
  // CHECK: rock.transforming_for {forceUnroll, useIndexDiffs}
  // CHECK-SAME: ([[i:%.+]]) = []([[zero]])
  // CHECK-SAME: () = [#{{.*}}]([[zero]])
...
func.func @threadwise_write_all_extra_idx(%source: memref<32xf32, #gpu.address_space<private>>, %dest: memref<3x2x64x30xf32>) attributes {block_size = 128 : i32, rock.arch = "##TOKEN_ARCH##"} {
  // CHECK-DAG: [[zero:%.+]] = arith.constant 0
...
func.func @threadwise_read_into_big_to_small_vec(%source: memref<4xvector<8xf16>, #gpu.address_space<workgroup>>, %dest: memref<8xvector<4xf16>, #gpu.address_space<private>>) attributes {block_size = 128 : i32, rock.arch = "##TOKEN_ARCH##"} {
...
func.func @threadwise_read_into_scalar_to_vec(%source: memref<32xf16, #gpu.address_space<workgroup>>, %dest: memref<8xvector<4xf16>, #gpu.address_space<private>>) attributes {block_size = 128 : i32, rock.arch = "##TOKEN_ARCH##"} {
  // CHECK: rock.transforming_for
...
func.func @threadwise_read_into_small_to_big_vec(%source: memref<8xvector<4xf16>, #gpu.address_space<workgroup>>, %dest: memref<4xvector<8xf16>, #gpu.address_space<private>>) attributes {block_size = 128 : i32, rock.arch = "##TOKEN_ARCH##"} {
  // CHECK: rock.transforming_for
...
func.func @threadwise_read_into_validities(%source: memref<2x64x30xf32, #gpu.address_space<private>>,
    ...
    %validIn: vector<32xi1>) -> vector<32xi1> attributes {block_size = 128 : i32, rock.arch = "##TOKEN_ARCH##"} {
...
func.func @threadwise_read_into_lds(%source: memref<1x128x30xf16>, %lds: memref<8192xi8, #gpu.address_space<workgroup>>) attributes {block_size = 128 : i32, rock.arch = "gfx950:sramecc+:xnack-"} {
