...
// GPU-SAME: dlti.dl_spec = #dlti.dl_spec<index = 64 : i32>
  func.func @rock_gemm(%arg0: memref<1x32768x32768xf32>, %arg1: memref<1x32768x1xf32>, %arg2: memref<1x32768x1xf32>) attributes {kernel, block_size = 256 : i32} {
    rock.gemm %arg2 = %arg0 * %arg1 features =  mfma|dot|atomic_add|atomic_add_f16 storeMethod =  set {arch = "amdgcn-amd-amdhsa:gfx908", derivedBlockSize = 256 : i32, gridSize = 512 : i32, params = #xdlops_gemm_params0} : memref<1x32768x1xf32> = memref<1x32768x32768xf32> * memref<1x32768x1xf32>
    return
  }
}
...
// GPU-SAME: dlti.dl_spec = #dlti.dl_spec<index = 32 : i32>
  func.func @rock_gemm(%arg0: memref<1x8192x8192xf32>, %arg1: memref<1x8192x1xf32>, %arg2: memref<1x8192x1xf32>) attributes {kernel, block_size = 256 : i32} {
    rock.gemm %arg2 = %arg0 * %arg1 features =  mfma|dot|atomic_add|atomic_add_f16 storeMethod =  set {arch = "amdgcn-amd-amdhsa:gfx908", derivedBlockSize = 256 : i32, gridSize = 128 : i32, params = #xdlops_gemm_params0} : memref<1x8192x1xf32> = memref<1x8192x8192xf32> * memref<1x8192x1xf32>
    return
  }
}
