...
// RUN:    -rock-gridwise-gemm-to-blockwise -rock-blockwise-load-tile-to-threadwise -rock-blockwise-gemm-to-threadwise -rock-threadwise-gemm-lowering \
// RUN: | FileCheck %s --check-prefixes=BLOCKWISE
// RUN: rocmlir-opt %s -split-input-file -rock-gemm-to-gridwise \
// RUN:    -rock-gridwise-gemm-to-blockwise -rock-blockwise-load-tile-to-threadwise -rock-blockwise-gemm-to-threadwise \
...
// GPU-SAME: dlti.dl_spec = #dlti.dl_spec<index = 64 : i32>
  func.func @rock_gemm(%arg0: memref<1x32768x32768xf32>, %arg1: memref<1x32768x1xf32>, %arg2: memref<1x32768x1xf32>) attributes {block_size = 64 : i32, grid_size = 512 : i32, rock.kernel, mhal.arch = "amdgcn-amd-amdhsa:gfx1100", wave_size = 32 : i32} {
...
// GPU-SAME: dlti.dl_spec = #dlti.dl_spec<index = 32 : i32>
  func.func @rock_gemm(%arg0: memref<1x8192x8192xf32>, %arg1: memref<1x8192x1xf32>, %arg2: memref<1x8192x1xf32>) attributes {block_size = 64 : i32, grid_size = 128 : i32, rock.kernel, mhal.arch = "amdgcn-amd-amdhsa:gfx1100", wave_size = 32 : i32} {
