...
// CHECK-DAG: #rock.transform_map<#[[map3]] by [<PassThrough ["gi", "n0", "n1", "ci"] at [2, 0, 1, 7] -> ["gi", "n0", "n1", "ci"] at [2, 0, 1, 5]>, <Embed{1, 1} ["0", "ho"] at [3, 4] -> ["hipad"] at [3]>, <Embed{1, 1} ["1", "wo"] at [5, 6] -> ["wipad"] at [4]>] bounds = [1, 32, 1, 3, 9, 3, 9, 32] -> [1, 32, 1, 11, 11, 32]>
// CHECK-DAG: #rock.transform_map<#[[map4]] by [<Merge{1, 1} ["gemmG"] at [0] -> ["gi", "n0"] at [2, 0]>, <Merge{32, 9, 9} ["gemmK"] at [1] -> ["n1", "ho", "wo"] at [1, 4, 6]>, <Merge{3, 3, 32} ["gemmN"] at [2] -> ["0", "1", "ci"] at [3, 5, 7]>] bounds = [1, 2592, 288] -> [1, 32, 1, 3, 9, 3, 9, 32]>
