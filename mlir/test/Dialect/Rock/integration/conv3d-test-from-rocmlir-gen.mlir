// RUN: sed -e 's/##TOKEN_ARCH##/%arch/g' %s | rocmlir-driver -c -arch %arch | mlir-runner -O2 --shared-libs=%linalg_test_lib_dir/libmlir_rocm_runtime%shlibext,%conv_validation_wrapper_library_dir/libconv-validation-wrappers%shlibext,%linalg_test_lib_dir/libmlir_runner_utils%shlibext,%linalg_test_lib_dir/libmlir_float16_utils%shlibext --entry-point-result=void | FileCheck %s
// CHECK: [1 1 1]

#map = affine_map<(d0) -> (d0 mod 3)>
module {
  func.func @rock_conv_gkc012_ngc012_ngk012_0(%arg0: memref<1x1x1x3x3x3xf32>, %arg1: memref<1x1x1x8x8x8xf32>, %arg2: memref<1x1x1x6x6x6xf32>) attributes {rock.kernel = 0 : i32, rock.arch = "##TOKEN_ARCH##"} {
    rock.conv(%arg0, %arg1, %arg2) {rock.arch = "##TOKEN_ARCH##", dilations = [1 : index, 1 : index, 1 : index], filter_layout = ["g", "k", "c", "0", "1", "2"], input_layout = ["ni", "gi", "ci", "0i", "1i", "2i"], numCU = 104 : i32, output_layout = ["no", "go", "ko", "0o", "1o", "2o"], padding = [0 : index, 0 : index, 0 : index, 0 : index, 0 : index, 0 : index], strides = [1 : index, 1 : index, 1 : index]} : memref<1x1x1x3x3x3xf32>, memref<1x1x1x8x8x8xf32>, memref<1x1x1x6x6x6xf32>
    return
  }
