...
module {
  ...
  func.func @test_reduce(%arg0: memref<1000x250x100xf32>, %arg1: memref<1x250x100xf32> {mhal.read_access, mhal.write_access}) attributes {rock.arch = ""} {
    call @init_output (%arg1) : (memref<1x250x100xf32>) -> ()
    func.call @test_reduce__part_1(%arg0, %arg1) : (memref<1000x250x100xf32>, memref<1x250x100xf32>) -> ()
    return
  }
  module @__xmodule_ attributes {mhal.arch = "##TOKEN_ARCH##", mhal.module} {
    func.func private @test_reduce__part_1(%arg0: memref<1000x250x100xf32> {mhal.read_access}, %arg1: memref<1x250x100xf32> {mhal.read_access, mhal.write_access, rock.prefill = 0xFF800000 : f32}) attributes {rock.arch = "##TOKEN_ARCH##", rock.kernel, original_func = @test_reduce__part_1, grid_size = 16, block_size = 1024} {
