...
module {
  ...
  func.func @test_reduce(%arg0: memref<5x4x3xf32>, %arg1: memref<1x4x3xf32>) attributes {arch = ""} {
    ...
    %token1 = async.launch @test_reduce__part_1 (%arg0, %arg1) : (memref<5x4x3xf32>, memref<1x4x3xf32>) -> ()
  ...
  module @__xmodule_gfx90a attributes {xmodel.arch = "gfx1030", xmodel.module} {
    func.func private @test_reduce__part_1(%arg0: memref<5x4x3xf32> {func.read_access}, %arg1: memref<1x4x3xf32> {func.read_access, func.write_access}) attributes {kernel, original_func = @test_reduce__part_1, grid_size = 16, block_size = 1024} {
      rock.reduce max %arg0 into %arg1 features = dot|atomic_fmax_f32 {axis = 0 : index, blockSize = 1024 : i32, gridSize = 16 : i32} : memref<5x4x3xf32> into memref<1x4x3xf32>
      return
    }
  }
}
