...
module {
  func.func private @init_output(%arg0: memref<10x1x20xf32> {mhal.write_access}) {
    %cst = arith.constant 0xff800000 : f32 
    linalg.fill ins(%cst : f32) outs(%arg0 : memref<10x1x20xf32>)
    return
  }
  func.func private @test_reduce__part_1(%arg0: memref<10x30x20xf32> {mhal.read_access}, %arg1: memref<10x1x20xf32> {mhal.read_access, mhal.write_access}) {
  ...
  func.func @test_reduce(%arg0: memref<10x30x20xf32>, %arg1: memref<10x1x20xf32> {mhal.read_access, mhal.write_access}) attributes {rock.arch = ""} {
  ...
  module @__xmodule_ attributes {mhal.arch = "##TOKEN_ARCH##",mhal.module} {
    func.func private @test_reduce__part_1(%arg0: memref<10x30x20xf32> {mhal.read_access}, %arg1: memref<10x1x20xf32> {mhal.read_access, mhal.write_access, rock.prefill = 0xFF800000 : f32}) attributes {rock.kernel, original_func = @test_reduce__part_1, grid_size = 1, block_size = 256} {
      rock.reduce max %arg0 into %arg1 {axis = 1 : index, blockSize = 256 : i32, gridSize = 1 : i32} : memref<10x30x20xf32> into memref<10x1x20xf32>
      return
    }
  }
}
