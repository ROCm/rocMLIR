...
module {
  func.func private @zero_init(%arg0: memref<10x1x20xf32> {mhal.write_access}) {
  ...
  module @__xmodule_gfx90a attributes {mhal.arch = "gfx90a",mhal.module} {
    func.func private @test_reduce__part_1(%arg0: memref<10x30x20xf32> {mhal.read_access}, %arg1: memref<10x1x20xf32> {mhal.read_access, mhal.write_access, rock.prefill = 0.000000e+00 : f32}) attributes {rock.kernel, original_func = @test_reduce__part_1, grid_size = 1, block_size = 256} {
