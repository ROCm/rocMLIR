...
module {
  ...
  func.func @test_reduce(%arg0: memref<2x3x40xf32>, %arg1: memref<2x3x1xf32>) attributes {mhal.arch = ""} {
  ...
  module @__xmodule_gfx90a attributes {mhal.arch = "gfx90a", mhal.module} {
    func.func private @test_reduce__part_1(%arg0: memref<2x3x40xf32> {func.read_access}, %arg1: memref<2x3x1xf32> {func.read_access, func.write_access}) attributes {kernel, mhal.reference_func = @test_reduce__part_1, rock.grid_size = 1, rock.block_size = 256} {
      rock.reduce sum %arg0 into %arg1 features = mfma|dot|atomic_add {axis = 2 : index, block_size = 256 : i32, grid_size = 1 : i32} : memref<2x3x40xf32> into memref<2x3x1xf32>
      return
    }
  }
}
