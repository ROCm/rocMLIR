...
module {
  func.func private @zero_init(%arg0: memref<2x3x1xf32> {mhal.write_access}) {
    %cst = arith.constant 0.000000e+00 : f32
    linalg.fill ins(%cst : f32) outs(%arg0 : memref<2x3x1xf32>)
    return
  }

  func.func private @test_reduce__part_1(%arg0: memref<2x3x40xf32> {mhal.read_access}, %arg1: memref<2x3x1xf32> {mhal.read_access, mhal.write_access}) {
  ...
  module @__xmodule_gfx90a attributes {mhal.arch = "gfx90a", mhal.module} {
    func.func private @test_reduce__part_1(%arg0: memref<2x3x40xf32> {mhal.read_access}, %arg1: memref<2x3x1xf32> {mhal.read_access, mhal.write_access, rock.prefill = 0.000000e+00 : f32}) attributes {rock.kernel, original_func = @test_reduce__part_1, grid_size = 1, block_size = 256} {
      rock.reduce sum %arg0 into %arg1 {axis = 2 : index, blockSize = 256 : i32, gridSize = 1 : i32} : memref<2x3x40xf32> into memref<2x3x1xf32>
      return
    }
  }
}
