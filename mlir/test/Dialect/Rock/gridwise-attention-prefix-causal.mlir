...
module {
  ...
  // Verify prefix causal loop bound calculation: effectiveSeqLen = maxRowOfBlock + currentSeqLen
  ...
  // Verify prefix causal masking: col > row + offset
  ...
  func.func @mlir_attention(%arg0: memref<1xi32>, %arg1: memref<4608xf16>, %arg2: memref<2048xf16>, %arg3: memref<14336xf16>, %arg4: memref<3584xf16>) attributes {arch = "gfx950", block_size = 64 : i32, features = #rock<GemmFeatures mfma|dot|atomic_add|atomic_add_bf16|atomic_add_f16|direct_to_lds_32b|direct_to_lds_128b>, grid_size = 14 : i32, kernel} {
    ...
    ^bb0(%arg5: memref<14x4x16xf16>, %arg6: memref<1x14x4x16xf16>):
      ...
      rock.yield
    } {blockSize = 64 : i32, firstGemmIndices = array<i64: 0>, gridSize = 14 : i32, operandSegmentSizes = array<i32: 1, 1, 1, 0, 1, 1, 0>, params0 = #mfma_gemm_params, params1 = #mfma_gemm_params, prePadG0M = 16 : index, prePadG0N = 4 : index, causalMaskingValue = 1 : i64, softmaxType = f32, splitKV = 1 : i32, storeMethod = #rock<StoreMethod set>} : memref<14x64x32xf16>, memref<14x64x32xf16>, memref<14x32x64xf16>, memref<14xi32>, memref<14x32x64xf16>
