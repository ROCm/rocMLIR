...
module {
  ...
  func.func @mlir_attention(%arg0: memref<1xi32>, %arg1: memref<4608xf16>, %arg2: memref<2048xf16>, %arg3: memref<14336xf16>, %arg4: memref<3584xf16>) attributes {rock.arch = "gfx950", block_size = 64 : i32, features = #rock<GemmFeatures mfma|dot|atomic_add|atomic_add_bf16|atomic_add_f16|direct_to_lds_32b|direct_to_lds_128b>, grid_size = 14 : i32, rock.kernel} {
