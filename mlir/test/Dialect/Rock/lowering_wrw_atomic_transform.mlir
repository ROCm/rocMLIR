...
module  {
  func.func @rock_conv_bwd_weight_gkcyx_ngchw_ngkhw_0(%arg0: memref<1x32x32x3x3xf32>, %arg1: memref<32x1x32x7x7xf32>, %arg2: memref<32x1x32x9x9xf32>) attributes {kernel = 0 : i32} {
    rock.conv_bwd_weight(%arg0, %arg1, %arg2) features = mfma|dot|atomic_add {arch = "amdgcn-amd-amdhsa:gfx908", dilations = [1 : index, 1 : index], filter_layout = ["g", "k", "c", "y", "x"], input_layout = ["ni", "gi", "ci", "hi", "wi"], numCU = 120 : i32, output_layout = ["no", "go", "ko", "ho", "wo"], padding = [2 : index, 2 : index, 2 : index, 2 : index], strides = [1 : index, 1 : index]} : memref<1x32x32x3x3xf32>, memref<32x1x32x7x7xf32>, memref<32x1x32x9x9xf32>
    return
  }
}
...
// CHECK-DAG: #rock.transform_map<#[[map2]] by [<PassThrough ["gi"] at [2] -> ["gi"] at [1]>, <Unmerge{1, 32} ["n0", "n1"] at [0, 1] -> ["ni"] at [0]>, <PassThrough ["ci"] at [3] -> ["ci"] at [2]>, <Pad{2, 2, 2, 2} ["hipad", "wipad"] at [4, 5] -> ["0i", "1i"] at [3, 4]>] bounds = [1, 32, 1, 32, 11, 11] -> [32, 1, 32, 7, 7]>
// CHECK-DAG: #rock.transform_map<#[[map3]] by [<PassThrough ["gi", "n0", "n1", "ci"] at [2, 0, 1, 3] -> ["gi", "n0", "n1", "ci"] at [2, 0, 1, 3]>, <Embed{1, 1} ["0", "0o"] at [4, 5] -> ["hipad"] at [4]>, <Embed{1, 1} ["1", "1o"] at [6, 7] -> ["wipad"] at [5]>] bounds = [1, 32, 1, 32, 3, 9, 3, 9] -> [1, 32, 1, 32, 11, 11]>
