...
// CHECK-DAG: #rock.transform_map<#[[map3]] by [<PassThrough ["gi", "n0", "n1", "ci"] at [2, 0, 1, 3] -> ["gi", "n0", "n1", "ci"] at [2, 0, 1, 3]>, <Embed{1, 1} ["0", "ho"] at [4, 5] -> ["hipad"] at [4]>, <Embed{1, 1} ["1", "wo"] at [6, 7] -> ["wipad"] at [5]>] bounds = [1, 32, 1, 32, 3, 9, 3, 9] -> [1, 32, 1, 32, 11, 11]>
// CHECK-DAG: #rock.transform_map<#[[map4]] by [<Merge{1, 1} ["gemmG"] at [0] -> ["gi", "n0"] at [2, 0]>, <Merge{32, 9, 9} ["gemmK"] at [1] -> ["n1", "ho", "wo"] at [1, 5, 7]>, <Merge{32, 3, 3} ["gemmN"] at [2] -> ["ci", "0", "1"] at [3, 4, 6]>] bounds = [1, 2592, 288] -> [1, 32, 1, 32, 3, 9, 3, 9]>
