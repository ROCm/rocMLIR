...
// CHECK-DAG: #[[$MAP:transform_map[0-9]*]] = #rock.transform_map<#map{{.*}} by [<PassThrough ["ni"] at [2] -> ["ni"] at [2]>, <PassThrough ["gi"] at [0] -> ["gi"] at [0]>, <PassThrough ["ci"] at [1] -> ["ci"] at [1]>, <Pad{1, 1, 1, 1} ["0ipad", "1ipad"] at [3, 4] -> ["0i", "1i"] at [3, 4]>] bounds = [1, 8, 128, 34, 34] -> [1, 8, 128, 32, 32]>
...
func.func @rock_conv_gcyxk_gcnhw_gknhw(%filter : memref<1x8x3x3x128xf32>, %input : memref<1x8x128x32x32xf32>, %output : memref<1x128x128x32x32xf32>) attributes {rock.arch = "amdgcn-amd-amdhsa:gfx906"} {
