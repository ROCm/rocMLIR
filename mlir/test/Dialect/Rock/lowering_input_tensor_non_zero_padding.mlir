...
// CHECK-DAG: #[[$MAP:transform_map[0-9]*]] = #rock.transform_map<#map{{.*}} by [<PassThrough ["ni"] at [2] -> ["ni"] at [2]>, <PassThrough ["gi"] at [0] -> ["gi"] at [0]>, <PassThrough ["ci"] at [1] -> ["ci"] at [1]>, <Pad{1, 1, 1, 1} ["hipad", "wipad"] at [3, 4] -> ["0i", "1i"] at [3, 4]>] bounds = [1, 8, 128, 34, 34] -> [1, 8, 128, 32, 32]>
