...
module attributes {mhal.arch = "amdgcn-amd-amdhsa:gfx1201"} {
  memref.global "private" constant @__constant_4xi32 : memref<4xi32> = dense<[0, 1, 2, 3]> alignment = 64
  memref.global "private" constant @__constant_12xi32 : memref<12xi32> = dense<[1, 1, 1, 1, 1, 1, 1, 1, 2, 2, 2, 2]> alignment = 64
  ...
  func.func @rock_attention(%arg0: memref<768xf16>, %arg1: memref<147456xf16>, %arg2: memref<147456xf16>, %arg3: memref<4608xf16>, %arg4: memref<4608xf16>, %arg5: memref<3xi32>, %arg6: memref<48xf16>, %arg7: memref<3072xf16>) attributes {block_size = 32 : i32, features = #rock<GemmFeatures wmma|dot|atomic_add|atomic_add_bf16|atomic_add_f16|atomic_fmax_f32>, grid_size = 24 : i32, rock.kernel, mhal.arch = "amdgcn-amd-amdhsa:gfx1201"} {
    ...
    // CHECK: } {name = "MMA"}
    // CHECK-NEXT: rock.lds_barrier
    // CHECK-NEXT: } {rock.pipeline = #rock.rock.pipeline<2>}
    return
  }
}
