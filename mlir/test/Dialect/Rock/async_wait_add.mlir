    ...
    affine.for %arg4 = 0 to 1 {
      ...
      affine.for %arg5 = 0 to 1 {
        ...
        affine.for %arg6 = 0 to 4 {
          ...
          rock.threadwise_gemm_accel %116 += %112 * %115 at[%arg4, %arg5, %arg6] features =  mfma|dot|atomic_add|atomic_add_bf16|atomic_add_f16|direct_to_lds_32b|direct_to_lds_128b {params = #rock.xdlops_gemm_derived_params<kpackPerBlock = 8, mPerBlock = 64, nPerBlock = 64, kpack = 8, mPerWave = 32, nPerWave = 32, mnPerXdl = 32, splitKFactor = 1, scheduleVersion = 4, outputSwizzle = 2, forceUnroll = true>} : memref<1x1xvector<16xf32>, #gpu.address_space<private>> += memref<1x4xvector<8xbf16>, #gpu.address_space<private>> * memref<1x4xvector<8xbf16>, #gpu.address_space<private>>
        }
      }
    }
    ...
    affine.for %arg4 = 0 to 1 {
      ...
      affine.for %arg5 = 0 to 1 {
        ...
        affine.for %arg6 = 0 to 4 {
          ...
          rock.threadwise_gemm_accel %49 += %51 * %53 at[%arg4, %arg5, %arg6] features =  mfma|dot|atomic_add|atomic_add_bf16|atomic_add_f16|direct_to_lds_32b|direct_to_lds_128b {params = #rock.xdlops_gemm_derived_params<kpackPerBlock = 8, mPerBlock = 64, nPerBlock = 64, kpack = 8, mPerWave = 32, nPerWave = 32, mnPerXdl = 32, splitKFactor = 1, scheduleVersion = 3, outputSwizzle = 2, forceUnroll = true>} : memref<1x1xvector<16xf32>, #gpu.address_space<private>> += memref<1x4xvector<8xbf16>, #gpu.address_space<private>> * memref<1x4xvector<8xbf16>, #gpu.address_space<private>>
        }
      }
    }
  }
