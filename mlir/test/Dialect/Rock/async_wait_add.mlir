...
func.func @gemm_pipelining(%arg0: memref<2359296xbf16>, %arg1: memref<2359296xbf16>, %arg2: memref<3145728xbf16>) attributes {block_size = 256 : i32, rock.enable_splitk_for_tuning, features = #rock<GemmFeatures mfma|dot|atomic_add|atomic_add_bf16|atomic_add_f16|direct_to_lds_32b|direct_to_lds_128b>, grid_size = 768 : i32, rock.kernel, rock.arch = "gfx950:sramecc+:xnack-", rock.num_cu = 256 : i64} {
  ...
  // CHECK: rock.async_wait {numInst =  6 : i32}
...
func.func @gemm_no_pipelining(%arg0: memref<2359296xbf16>, %arg1: memref<2359296xbf16>, %arg2: memref<3145728xbf16>) attributes {block_size = 256 : i32, rock.enable_splitk_for_tuning, features = #rock<GemmFeatures mfma|dot|atomic_add|atomic_add_bf16|atomic_add_f16|direct_to_lds_32b|direct_to_lds_128b>, grid_size = 768 : i32, rock.kernel, rock.arch = "gfx950:sramecc+:xnack-", rock.num_cu = 256 : i64} {
  %c1 = arith.constant 1 : index
...
func.func @async_wait_simple_test(%arg0: memref<4x256xf32>, %arg1: memref<4x256xf32>, %arg2: memref<4x256xf32>, %arg3: memref<4x256xf32>) attributes {rock.arch = "gfx950:sramecc+:xnack-", block_size = 256 : i32, features = #rock<GemmFeatures mfma|dot|atomic_add|atomic_add_bf16|atomic_add_f16|direct_to_lds_32b|direct_to_lds_128b>, grid_size = 1 : i32, rock.kernel, rock.num_cu = 256 : i64} {
  ...
  // 
  // CHECK: rock.async_wait {numInst =  3 : i32}
  ...
  // CHECK: rock.async_wait {numInst =  1 : i32}
...
func.func @async_wait_error(%arg0: memref<4x256xf32>, %arg1: memref<4x256xf32>, %arg2: memref<4x256xf32>, %arg3: memref<4x256xf32>) attributes {rock.arch = "gfx950:sramecc+:xnack-", block_size = 256 : i32, features = #rock<GemmFeatures mfma|dot|atomic_add|atomic_add_bf16|atomic_add_f16|direct_to_lds_32b|direct_to_lds_128b>, grid_size = 1 : i32, rock.kernel, rock.num_cu = 256 : i64} {
  %tid = rock.workitem_id : index
  %1 = rock.alloc() : memref<1x256xf32, #gpu.address_space<workgroup>>
