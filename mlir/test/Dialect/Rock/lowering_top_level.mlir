...
// CHECK-DAG: #[[$MAP_BWD_DATA_IN1_NO_PAD:transform_map[0-9]*]] = {{.*}}by [<PassThrough ["gi", "ni", "ci"] at [1, 0, 2] -> ["gi", "ni", "ci"] at [1, 0, 2]>, <Pad{0, 0, 0, 0} ["hipad", "wipad"] at [3, 4] -> ["0i", "1i"] at [3, 4]>
...
// CHECK-DAG: #[[$MAP_BWD_DATA_OUT1_NO_PAD:transform_map[0-9]*]] = {{.*}}by [<PassThrough ["go", "no", "ko"] at [1, 0, 2] -> ["go", "no", "ko"] at [1, 0, 2]>, <Embed{-1, 1} ["0dot", "htilda"] at [3, 4] -> ["0o"] at [3]>, <Embed{-1, 1} ["1dot", "wtilda"] at [5, 6] -> ["1o"] at [4]>]
