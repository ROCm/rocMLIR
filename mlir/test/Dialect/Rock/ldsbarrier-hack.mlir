// RUN: rocmlir-opt %s -convert-amdgpu-to-rocdl=chipset=gfx942 --convert-func-to-llvm --rock-to-rocdl=chipset=gfx942 | FileCheck %s --check-prefixes=CHECK,GFX942
// RUN: rocmlir-opt %s -convert-amdgpu-to-rocdl=chipset=gfx950 --convert-func-to-llvm --rock-to-rocdl=chipset=gfx950 | FileCheck %s --check-prefixes=CHECK,GFX950
