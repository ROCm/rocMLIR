// RUN: rocmlir-opt %s -convert-amdgpu-to-rocdl=chipset=gfx942 --rock-to-rocdl | FileCheck %s --check-prefixes=CHECK,GFX942
// RUN: rocmlir-opt %s -convert-amdgpu-to-rocdl=chipset=gfx950 --rock-to-rocdl | FileCheck %s --check-prefixes=CHECK,GFX950
