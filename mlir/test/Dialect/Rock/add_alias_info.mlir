...
gpu.module @test_module {
  ...
  llvm.func @test_negative_direct_to_lds(%arg0: !llvm.ptr<1>, %arg1: !llvm.ptr<3>) {        
    // CHECK-NOT: llvm.load %{{.*}} {alias_scopes = [#[[$DIRECT_TO_LDS_SCOPE]]], noalias_scopes = [#[[$LOCAL_LOAD_SCOPE]]]}
    %0 = llvm.load %arg0 : !llvm.ptr<1> -> i32

    // CHECK-NOT: llvm.store %{{.*}}, %{{.*}} {alias_scopes = [#[[$DIRECT_TO_LDS_SCOPE]]], noalias_scopes = [#[[$LOCAL_LOAD_SCOPE]]]}
