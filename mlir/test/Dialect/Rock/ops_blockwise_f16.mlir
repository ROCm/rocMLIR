...
func.func @rock_blockwise_gemm_accel_one_result_f16(%matrixA : memref<8192xf16, 3>, %matrixB : memref<4096xf16, 3>,
  ...
  rock.blockwise_gemm_accel %matrixC += %bufferA (%bufferA) from %matrixA * %bufferB (%bufferB) from %matrixB features = mfma {
    ...
    params = #rock.xdlops_gemm_derived_params<
      ...
      outputSwizzle = 2,
      forceUnroll = true>
  } : memref<1xvector<32xf32>, 5> +=  memref<4xvector<4xf16>, 5> (memref<4xvector<4xf16>, 5>) from memref<8192xf16, 3> * memref<4xvector<4xf16>, 5> (memref<4xvector<4xf16>, 5>) from memref<4096xf16, 3>
  return
}
...
func.func @rock_blockwise_gemm_accel_two_results_f16(%matrixA : memref<8192xf16, 3>, %matrixB : memref<4096xf16, 3>,
  ...
  rock.blockwise_gemm_accel %matrixC += %bufferA (%bufferA) from %matrixA * %bufferB (%bufferB) from %matrixB features = mfma {
    ...
    params = #rock.xdlops_gemm_derived_params<
      ...
      outputSwizzle = 2,
      forceUnroll = true>
  } : memref<2xvector<32xf32>, 5> += memref<4xvector<4xf16>, 5> (memref<4xvector<4xf16>, 5>) from memref<8192xf16, 3> * memref<4xvector<4xf16>, 5> (memref<4xvector<4xf16>, 5>) from memref<4096xf16, 3>
  return
}
