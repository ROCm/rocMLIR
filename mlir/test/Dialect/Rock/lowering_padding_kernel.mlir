...
// RUN: rocmlir-opt -rock-affix-params -rock-conv-to-gemm -rock-grid-config -rock-gemm-to-gridwise %s | FileCheck %s
...
// CHECK-LABEL: func.func @rock_conv2d_kcyx_nchw_nkhw_no_extra_padding
