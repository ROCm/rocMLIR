...
// CHECK: Broadcast{1}
func.func @mlir_reshape_reshape_transpose_dot(%arg0: tensor<1x256x32x64xf32>, %arg1: tensor<1x4x256x64xf32>) -> tensor<1x32x256x256xf32> attributes {rock.arch = "gfx908:sramecc+:xnack-", rock.kernel = "mixr", rock.num_cu = 120 : i64} {
