...
func.func private @bert_part_11__part_0(%arg0: memref<1x12x12x32xf32> {mhal.read_access}, %arg1: memref<1x12x32x12xf32> {mhal.read_access}, %arg2: memref<1x1x1x1xf32> {mhal.read_access}, %arg3: memref<1x1x1x12xf32> {mhal.read_access}, %arg4: memref<1x12x12x12xf32> {mhal.write_access}) attributes {block_size = 64 : i32, grid_size = 12 : i32, kernel, original_func = @bert_part_11__part_0, arch = "amdgcn-amd-amdhsa:gfx90a", numCU = 64 : i32} {
  ...
  rock.gridwise_gemm_accel(%4, %5, %6) storeMethod( set) {blockSize = 64 : i32, gridSize = 12 : i32, params = #rock.xdlops_gemm_derived_params<kpackPerBlock = 16, mPerBlock = 16, nPerBlock = 16, kpack = 1, mPerWave = 16, nPerWave = 16, mnPerXdl = 32, splitKFactor = 1, scheduleVersion = 1, outputSwizzle = 2, forceUnroll = true>} : memref<12x32x16xf32>, memref<12x32x16xf32>, memref<12x16x16xf32>
