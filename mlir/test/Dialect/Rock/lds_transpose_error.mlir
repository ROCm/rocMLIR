...
// geometry combinations. Valid combinations are: (16,16), (16,32), (16,64), (16,128), (32,8), (32,16), (32,32), (32,64)
...
// Error case: Invalid MFMA geometry (64x16 is not valid)
func.func @threadwise_read_into_invalid_mfma_geometry_64x16(
    %source: memref<128xf16, #gpu.address_space<workgroup>>,
    %dest: memref<8xf16, #gpu.address_space<private>>)
    attributes {arch = "amdgcn-amd-amdhsa:gfx950"} {
  rock.threadwise_read_into {
