...
// CHECK-NEXT:  {{miopen.transform.*{extraPad = "true", gemmK_extra = 14 : i32, gemmM_extra = 0 : i32,.*}.*memref.*memref}}
...
// CHECK-NEXT:  {{miopen.transform.*{.*}.*memref.*memref}}
// CHECK-NEXT:  {{miopen.transform.*{.*}.*memref.*memref}}
// CHECK-NEXT:  {{miopen.transform.*{extraPad = "true", gemmM_extra = 0 : i32, gemmN_extra = 0 : i32,.*}.*memref.*memref}}
