...
// RUN: miopen-opt -miopen-affix-params %s | FileCheck %s

// CHECK-DAG: #[[$GENERAL_PARAMS_0:.*]] = #miopen.general_gemm_params<kPerBlock = 8, mPerBlock = 128, nPerBlock = 128, kPerThread = 1, mPerThread = 4, nPerThread = 4, kpack = 1, mThreadsPerCuwave = 4, nThreadsPerCuwave = 4, mCuwavesPerBlock = 4, nCuwavesPerBlock = 4>
// CHECK-DAG: #[[$GENERAL_PARAMS_1:.*]] = #miopen.general_gemm_params<kPerBlock = 16, mPerBlock = 64, nPerBlock = 64, kPerThread = 1, mPerThread = 4, nPerThread = 4, kpack = 1, mThreadsPerCuwave = 4, nThreadsPerCuwave = 4, mCuwavesPerBlock = 2, nCuwavesPerBlock = 2>
// CHECK-DAG: #[[$XDLOPS_PARAMS_0:.*]] = #miopen.xdlops_gemm_params<kPerBlock = 8, mPerBlock = 64, nPerBlock = 64, kpack = 1, mPerWave = 32, nPerWave = 32>
// CHECK-DAG: #[[$XDLOPS_PARAMS_1:.*]] = #miopen.xdlops_gemm_params<kPerBlock = 4, mPerBlock = 128, nPerBlock = 128, kpack = 4, mPerWave = 64, nPerWave = 64>

// CHECK-LABEL: @miopen_conv2d
...
// CHECK-LABEL: func.func @miopen_conv2d_i8
...
// CHECK-LABEL: @miopen_conv2d_bwd_data_f16
...
// CHECK-LABEL: func.func @miopen_conv2d_bwd_data_padMN
...
// CHECK-LABEL: @miopen_conv2d_bwd_data_padMK
...
// CHECK-LABEL: @miopen_conv2d_bwd_weight
func.func @miopen_conv2d_bwd_weight(%filter : memref<1x128x8x3x3xf32>, %input : memref<128x1x8x32x32xf32>, %output : memref<128x1x128x30x30xf32>) {
  // CHECK: miopen.conv2d_bwd_weight
  // CHECK-SAME: blockSize = 64
...
// CHECK-LABEL: @miopen_conv2d_bwd_weight_f16
...
// CHECK-LABEL: func.func @miopen_conv2d_bwd_weight_padALL
...
// CHECK-LABEL: @miopen_conv2d_bwd_weight_padALL_f16
