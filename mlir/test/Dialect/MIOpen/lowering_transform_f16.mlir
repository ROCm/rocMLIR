...
func @miopen_transform_1_to_1(%memref: memref<?x?x?x?xf16>) {
...
func @miopen_transform_n_to_1(%memref : memref<?x?x?x?xf16>) {
  %transformed_memref = miopen.transform(%memref) {
    layout = [
      {
        dimensions = [0],
  ...
  } : memref<?x?x?x?xf16> to memref<?x?xf16>
  return
}
...
func @miopen_transform_1_to_n(%memref : memref<?x?x?x?xf16>) {
  %transformed_memref = miopen.transform(%memref) {
    layout = [
      {
        dimensions = [0],
