...
func @miopen_conv2d_f16(%filter : memref<128x8x3x3xf16>, %input : memref<128x8x32x32xf16>, %output : memref<128x128x30x30xf16>) {
  miopen.conv2d(%filter, %input, %output) {
    arch = "gfx906",
    num_cu = 64,
    filter_layout = ["k", "c", "y", "x"],
...
func @miopen_conv2d_bwd_data_f16(%filter : memref<128x8x3x3xf16>, %input : memref<128x8x32x32xf16>, %output : memref<128x128x30x30xf16>) {
  miopen.conv2d_bwd_data(%filter, %input, %output) {
    arch = "gfx906",
    num_cu = 64,
    filter_layout = ["k", "c", "y", "x"],
...
func @miopen_conv2d_bwd_weight_f16(%filter : memref<128x8x3x3xf16>, %input : memref<128x8x32x32xf16>, %output : memref<128x128x30x30xf16>) {
  miopen.conv2d_bwd_weight(%filter, %input, %output) {
    arch = "gfx906",
    num_cu = 64,
    filter_layout = ["k", "c", "y", "x"],
