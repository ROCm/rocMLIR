...
// CHECK-NEXT:  miopen.transform(%arg0)
// CHECK:       output_layout = ["g", "k", "c", "ydot", "ytilda", "xdot", "xtilda"]
// CHECK-NEXT:  miopen.transform
// CHECK:       output_layout = ["g", "k", "c", "ydotslice", "ytildaslice", "xdotslice", "xtildaslice"]
// CHECK-NEXT:  miopen.transform
// CHECK:       output_layout = ["gemmG", "gemmK", "gemmM"]
// CHECK-NEXT:  miopen.transform(%arg1)
// CHECK:       output_layout = ["gi", "ni", "ci", "hipad", "wipad"]
// CHECK-NEXT:  miopen.transform
// CHECK:       output_layout = ["gi", "ni", "ci", "ytilda", "htilda", "xtilda", "wtilda"]
// CHECK-NEXT:  miopen.transform
// CHECK:       output_layout = ["gi", "ni", "ci", "ytildaslice", "htildaslice", "xtildaslice", "wtildaslice"]
// CHECK-NEXT:  miopen.transform
// CHECK:       output_layout = ["gemmG", "gemmM", "gemmN"]
// CHECK-NEXT:  miopen.transform(%arg2)
// CHECK:       output_layout = ["go", "no", "ko", "ydot", "htilda", "xdot", "wtilda"]
// CHECK-NEXT:  miopen.transform
// CHECK:       output_layout = ["go", "no", "ko", "ydotslice", "htildaslice", "xdotslice", "wtildaslice"]
// CHECK-NEXT:  miopen.transform
