...
// CHECK-DAG: #[[$MAP_BWD_DATA_IN1_NO_PAD:transform_map[0-9]+]] = {{.*}}by[#miopen.transform<PassThrough ["gi"] at [0] -> ["gi"] at [1]>, #miopen.transform<PassThrough ["ni"] at [1] -> ["ni"] at [0]>, #miopen.transform<PassThrough ["ci"] at [2] -> ["ci"] at [2]>, #miopen.transform<Pad{0, 0, 0, 0} ["hipad", "wipad"] at [3, 4] -> ["hi", "wi"] at [3, 4]>
// CHECK-DAG: #[[$MAP_BWD_DATA_IN2_NO_PAD:transform_map[0-9]+]] = {{.*}}by[#miopen.transform<PassThrough ["gi", "ni", "ci"] at [0, 1, 2] -> ["gi", "ni", "ci"] at [0, 1, 2]>, #miopen.transform<Embed{1, 1} ["ytilda", "htilda"] at [3, 4] -> ["hipad"] at [3]>, #miopen.transform<Embed{1, 1} ["xtilda", "wtilda"] at [5, 6] -> ["wipad"] at [4]>]
// CHECK-DAG: #[[$MAP_BWD_DATA_IN3_NO_PAD:transform_map[0-9]+]] = {{.*}}by[#miopen.transform<PassThrough ["gi", "ni", "ci"] at [0, 1, 2] -> ["gi", "ni", "ci"] at [0, 1, 2]>, #miopen.transform<Slice{0, 1, 0, 1} ["yslice", "xslice"] at [3, 5] -> ["ytilda", "xtilda"] at [3, 5]>, #miopen.transform<Slice{0, 14, 0, 14} ["hslice", "wslice"] at [4, 6] -> ["htilda", "wtilda"] at [4, 6]>]
// CHECK-DAG: #[[$MAP_BWD_DATA_IN4_NO_PAD:transform_map[0-9]+]] = {{.*}}by[#miopen.transform<PassThrough ["gemmG"] at [0] -> ["gi"] at [0]>, #miopen.transform<Merge{1024, 1, 1} ["gemmM"] at [1] -> ["ci", "yslice", "xslice"] at [2, 3, 5]>, #miopen.transform<Merge{128, 14, 14} ["gemmN"] at [2] -> ["ni", "hslice", "wslice"] at [1, 4, 6]>]
// CHECK-DAG: #[[$MAP_BWD_DATA_OUT1_NO_PAD:transform_map[0-9]+]] = {{.*}}by[#miopen.transform<PassThrough ["go"] at [0] -> ["go"] at [1]>, #miopen.transform<PassThrough ["no"] at [1] -> ["no"] at [0]>, #miopen.transform<PassThrough ["ko"] at [2] -> ["ko"] at [2]>, #miopen.transform<Embed{-1, 1} ["ydot", "htilda"] at [3, 4] -> ["ho"] at [3]>, #miopen.transform<Embed{-1, 1} ["xdot", "wtilda"] at [5, 6] -> ["wo"] at [4]>]
// CHECK-DAG: #[[$MAP_BWD_DATA_OUT2_NO_PAD:transform_map[0-9]+]] = {{.*}}by[#miopen.transform<PassThrough ["go", "no", "ko"] at [0, 1, 2] -> ["go", "no", "ko"] at [0, 1, 2]>, #miopen.transform<Slice{0, 1, 0, 1} ["yslice", "xslice"] at [3, 5] -> ["ydot", "xdot"] at [3, 5]>, #miopen.transform<Slice{0, 14, 0, 14} ["hslice", "wslice"] at [4, 6] -> ["htilda", "wtilda"] at [4, 6]>]
// CHECK-DAG: #[[$MAP_BWD_DATA_OUT3_NO_PAD:transform_map[0-9]+]] = {{.*}}by[#miopen.transform<PassThrough ["gemmG"] at [0] -> ["go"] at [0]>, #miopen.transform<Merge{1024, 1, 1} ["gemmK"] at [1] -> ["ko", "yslice", "xslice"] at [2, 3, 5]>, #miopen.transform<Merge{128, 14, 14} ["gemmN"] at [2] -> ["no", "hslice", "wslice"] at [1, 4, 6]>]
...
// CHECK-DAG: #[[$MAP_BWD_WEIGHT_FIL1:transform_map[0-9]+]] = {{.*}}by[#miopen.transform<PassThrough ["gemmG"] at [0] -> ["g"] at [0]>, #miopen.transform<PassThrough ["gemmM"] at [1] -> ["k"] at [1]>, #miopen.transform<Unfold{8, 3, 3} ["gemmN"] at [2] -> ["c", "y", "x"] at [2, 3, 4]>]
...
// CHECK-LABEL: func {{@miopen_conv2d_bwd_data_f16.*%arg0.*%arg1.*%arg2}}
// CHECK-NOT:   miopen.conv2d_bwd_data
// CHECK-NEXT:  %[[FIL1:.*]] = miopen.transform %arg0 by [#[[$MAP_BWD_DATA_FIL1_NO_PAD]]]
// CHECK-NEXT:  %[[FIL2:.*]] = miopen.transform %[[FIL1]] by [#[[$MAP_BWD_DATA_FIL2_NO_PAD]]]
// CHECK-NEXT:  %[[FIL3:.*]] = miopen.transform %[[FIL2]] by [#[[$MAP_BWD_DATA_FIL3_NO_PAD]]]
...
// CHECK-LABEL: func {{@miopen_conv2d_bwd_data_padMN.*%arg0.*%arg1.*%arg2}}
// CHECK-NOT:   miopen.conv2d_bwd_data
...
// CHECK-LABEL: func {{@miopen_conv2d_bwd_data_padMK.*%arg0.*%arg1.*%arg2}}
// CHECK-NOT:   miopen.conv2d_bwd_data
// CHECK-NEXT:  %[[FIL1:.*]] = miopen.transform %arg0
// CHECK-NEXT:  %[[FIL2:.*]] = miopen.transform %[[FIL1]]
// CHECK-NEXT:  %[[FIL3:.*]] = miopen.transform %[[FIL2]]
