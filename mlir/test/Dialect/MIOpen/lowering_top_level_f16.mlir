...
func @miopen_conv2d(%filter : memref<128x8x3x3xf16>, %input : memref<128x8x32x32xf16>, %output : memref<128x128x30x30xf16>) {
...
func @miopen_conv2d_bwd_data(%filter : memref<128x8x3x3xf16>, %input : memref<128x8x32x32xf16>, %output : memref<128x128x30x30xf16>) {
...
func @miopen_conv2d_bwd_weight(%filter : memref<128x8x3x3xf16>, %input : memref<128x8x32x32xf16>, %output : memref<128x128x30x30xf16>) {
