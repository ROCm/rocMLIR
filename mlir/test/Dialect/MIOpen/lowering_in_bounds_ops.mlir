...
module {
// CHECK-LABEL: func @in_bounds_load_scalar
// CHECK-SAME: (%[[buf:.*]]: memref<2x2xf32, 3>)
func @in_bounds_load_scalar(%buf: memref<2x2xf32, 3>) -> f32 {
...
// CHECK-LABEL: func @in_bounds_load_vector
// CHECK-SAME: (%[[buf:.*]]: memref<2x2xf32, 3>)
func @in_bounds_load_vector(%buf: memref<2x2xf32, 3>) -> vector<4xf32> {
    %c0 = arith.constant 0 : index
...
// CHECK-LABEL: func @in_bounds_store_scalar
// CHECK-SAME: (%[[data:.*]]: f32, %[[buf:.*]]: memref<2x2xf32, 3>)
func @in_bounds_store_scalar(%data: f32, %buf: memref<2x2xf32, 3>) {
    %c0 = arith.constant 0 : index
...
// CHECK-LABEL: func @in_bounds_store_vector
// CHECK-SAME: (%[[data:.*]]: vector<4xf32>, %[[buf:.*]]: memref<2x2xf32, 3>)
func @in_bounds_store_vector(%data: vector<4xf32>, %buf: memref<2x2xf32, 3>) {
    %c0 = arith.constant 0 : index
    // CHECK-DAG: %[[c0:.*]] = arith.constant 0 : index
    // CHECK-DAG: %[[c1:.*]] = arith.constant 1 : index
    // CHECK-DAG: %[[c2:.*]] = arith.constant 2 : index
