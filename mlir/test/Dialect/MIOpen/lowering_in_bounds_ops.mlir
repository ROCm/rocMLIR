...
func.func @in_bounds_load_vector(%buf: memref<4x4xf32, 3>) -> vector<4xf32> {
    ...
    %ret = miopen.in_bounds_load %buf[%c0, %c0] : memref<4x4xf32, 3>, index, index -> vector<4xf32>
...
func.func @in_bounds_store_vector(%data: vector<4xf32>, %buf: memref<4x4xf32, 3>) {
    ...
    miopen.in_bounds_store %data -> %buf[%c0, %c0] : vector<4xf32> -> memref<4x4xf32, 3>, index, index
    return
}
}
