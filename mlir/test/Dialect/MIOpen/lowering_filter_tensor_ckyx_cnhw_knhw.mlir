...
func @miopen_conv2d_bwd_data_ckyx_cnhw_knhw(%filter : memref<1x64x128x3x3xf32>, %input : memref<1x64x128x32x32xf32>, %output : memref<1x128x128x30x30xf32>) {
  miopen.conv2d_bwd_data(%filter, %input, %output) {
    ...
    padding = [0, 0, 0, 0],
    gemm_id = 0
  } : memref<1x64x128x3x3xf32>, memref<1x64x128x32x32xf32>, memref<1x128x128x30x30xf32>
  return
}
