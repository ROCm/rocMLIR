...
func @miopen_conv2d_ckyx_cnhw_knhw(%filter : memref<8x128x3x3xf16>, %input : memref<8x128x32x32xf16>, %output : memref<128x128x30x30xf16>) {
  miopen.conv2d(%filter, %input, %output) {
    ...
    strides = [1, 1],
    padding = [0, 0]
  } : memref<8x128x3x3xf16>, memref<8x128x32x32xf16>, memref<128x128x30x30xf16>
  return
}
...
func @miopen_conv2d_bwd_data_ckyx_cnhw_knhw(%filter : memref<8x128x3x3xf16>, %input : memref<8x128x32x32xf16>, %output : memref<128x128x30x30xf16>) {
...
func @miopen_conv2d_bwd_weight_ckyx_cnhw_knhw(%filter : memref<8x128x3x3xf16>, %input : memref<8x128x32x32xf16>, %output : memref<128x128x30x30xf16>) {
