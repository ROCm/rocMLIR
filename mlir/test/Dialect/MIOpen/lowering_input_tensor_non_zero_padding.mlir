...
// RUN: mlir-opt -miopen-affix-params -miopen-lowering %s | FileCheck %s --check-prefix=LOWERING
// RUN: mlir-opt -miopen-affix-params -miopen-lowering -miopen-affine-transform %s | FileCheck %s --check-prefix=AFFINE
