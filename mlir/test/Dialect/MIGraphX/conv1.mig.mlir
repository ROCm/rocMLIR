module {
  func @main(%arg0: tensor<1x3x224x224xf32>) -> tensor<1x64x112x112xf32> {
    ...
    %5 = "migraphx.convolution"(%arg0, %0) {padding = [3:i32, 3:i32], stride = [2:i32, 2:i32], dilation = [1:i32, 1:i32], group = 1:i32, padding_mode = 0} : (tensor<1x3x224x224xf32>, tensor<64x3x7x7xf32>) -> tensor<1x64x112x112xf32>
