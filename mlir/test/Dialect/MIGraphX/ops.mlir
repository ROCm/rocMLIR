...
// CHECK-LABEL: func.func @test_unpack_fp4
func.func @test_unpack_fp4(%arg0: !migraphx.shaped<2x3x4xf8E4M3FN, 12x4x1>) -> !migraphx.shaped<2x3x8xf4E2M1FN, 24x8x1> {
  %0 = migraphx.unpack %arg0 {axis = 2 : i64} : <2x3x4xf8E4M3FN, 12x4x1> -> <2x3x8xf4E2M1FN, 24x8x1>
  return %0 : !migraphx.shaped<2x3x8xf4E2M1FN, 24x8x1>
}