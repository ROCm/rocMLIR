...
func.func @expand_strides_output_smaller(%arg0: !migraphx.shaped<4x24x24xf16, 576x24x1>) -> !migraphx.shaped<4x24x24xf16, 288x24x1> {
  // expected-error @+1 {{'migraphx.expand_strides' op output strides must be greater than or equal to input strides for expansion; found output stride 288 < input stride 576}}
  %0 = migraphx.expand_strides %arg0 : <4x24x24xf16, 576x24x1> -> <4x24x24xf16, 288x24x1>
  return %0 : !migraphx.shaped<4x24x24xf16, 288x24x1>
}

// -----

func.func @expand_strides_no_expansion(%arg0: !migraphx.shaped<4x24x24xf16, 576x24x1>) -> !migraphx.shaped<4x24x24xf16, 576x24x1> {
  // expected-error @+1 {{'migraphx.expand_strides' op expand_strides requires at least one output stride to be strictly greater than the corresponding input stride}}
  %0 = migraphx.expand_strides %arg0 : <4x24x24xf16, 576x24x1> -> <4x24x24xf16, 576x24x1>
  return %0 : !migraphx.shaped<4x24x24xf16, 576x24x1>
}

// -----

func.func @expand_strides_shape_mismatch(%arg0: !migraphx.shaped<4x24x24xf16, 576x24x1>) -> !migraphx.shaped<4x48x24xf16, 1152x24x1> {
  // expected-error @+1 {{'migraphx.expand_strides' op failed to verify that all of {input, output} have same shape}}
  %0 = migraphx.expand_strides %arg0 : <4x24x24xf16, 576x24x1> -> <4x48x24xf16, 1152x24x1>
  return %0 : !migraphx.shaped<4x48x24xf16, 1152x24x1>
}

// -----

func.func @expand_strides_element_type_mismatch(%arg0: !migraphx.shaped<4x24x24xf16, 576x24x1>) -> !migraphx.shaped<4x24x24xf32, 1152x24x1> {
  // expected-error @+1 {{'migraphx.expand_strides' op failed to verify that all of {input, output} have same element type}}
  %0 = migraphx.expand_strides %arg0 : <4x24x24xf16, 576x24x1> -> <4x24x24xf32, 1152x24x1>
  return %0 : !migraphx.shaped<4x24x24xf32, 1152x24x1>
}
