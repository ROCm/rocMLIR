...
func.func @dot_with_scale_a(%arg0: !migraphx.shaped<2x3xf32, 3x1>, %arg1: !migraphx.shaped<3x4xf32, 4x1>, %scale: !migraphx.shaped<2x3xf32, 3x1>) {
  // expected-error@+1 {{'migraphx.dot' op operand #2 must be !migraphx.shaped of  values}}
  %0 = migraphx.dot %arg0 scaled by %scale, %arg1 
     : !migraphx.shaped<2x3xf32, 3x1> scaled by !migraphx.shaped<2x3xf32, 3x1>,
       !migraphx.shaped<3x4xf32, 4x1>
    -> !migraphx.shaped<2x4xf32, 4x1>
  return
}

// -----

func.func @dot_with_scale_b(%arg0: !migraphx.shaped<2x3xf32, 3x1>, %arg1: !migraphx.shaped<3x4xf32, 4x1>, %scale: !migraphx.shaped<3x4xf32, 4x1>) {
  // expected-error@+1 {{'migraphx.dot' op operand #2 must be !migraphx.shaped of  values}}
  %0 = migraphx.dot %arg0, %arg1 scaled by %scale 
     : !migraphx.shaped<2x3xf32, 3x1>,
       !migraphx.shaped<3x4xf32, 4x1> scaled by !migraphx.shaped<3x4xf32, 4x1>
    -> !migraphx.shaped<2x4xf32, 4x1>
  return
}
...
func.func @dot_with_both_scales(%arg0: !migraphx.shaped<2x3xf32, 3x1>, %arg1: !migraphx.shaped<3x4xf32, 4x1>, %scaleA: !migraphx.shaped<2x3xf32, 3x1>, %scaleB: !migraphx.shaped<3x4xf32, 4x1>) {
  // expected-error@+1 {{'migraphx.dot' op operand #2 must be !migraphx.shaped of  values}}
  %0 = migraphx.dot %arg0 scaled by %scaleA, %arg1 scaled by %scaleB 
     : !migraphx.shaped<2x3xf32, 3x1> scaled by !migraphx.shaped<2x3xf32, 3x1>,
       !migraphx.shaped<3x4xf32, 4x1> scaled by !migraphx.shaped<3x4xf32, 4x1>
    -> !migraphx.shaped<2x4xf32, 4x1>
  return
...
func.func @quant_dot_wrong_input_type(
  ...
  // expected-error @+1 {{Scaled quant dot ops only supports f4E2M1FN element type}}
  %0 = migraphx.quant_dot
       %arg0 scaled by %arg2,
       %arg1 scaled by %arg3
...
func.func @quant_dot_mismatched_inputs(
  %arg0: !migraphx.shaped<1x16x512xf4E2M1FN, 8192x512x1>, 
  %arg1: !migraphx.shaped<1x512x16xf32, 8192x16x1>,
  %arg2: !migraphx.shaped<1x16x512xf32, 8192x512x1>,
  ...
  %0 = migraphx.quant_dot
     ...
     : !migraphx.shaped<1x16x512xf4E2M1FN, 8192x512x1> scaled by
       !migraphx.shaped<1x16x512xf32, 8192x512x1>,
       !migraphx.shaped<1x512x16xf32, 8192x16x1> scaled by
       !migraphx.shaped<1x512x16xf32, 8192x16x1>
     -> !migraphx.shaped<1x16x16xf32, 256x16x1>
  return %0 : !migraphx.shaped<1x16x16xf32, 256x16x1>
}
