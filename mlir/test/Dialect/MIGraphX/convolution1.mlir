...
module {
  func @main(%arg0: tensor<1x3x224x224xf32>) -> tensor<1x64x112x112xf32> {
    ...
    %5 = "migraphx.convolution"(%arg0, %0) {padding = [3:i64, 3:i64], stride = [2:i64, 2:i64], dilation = [1:i64, 1:i64], group = 1:i64, padding_mode = 0:i64} : (tensor<1x3x224x224xf32>, tensor<64x3x7x7xf32>) -> tensor<1x64x112x112xf32>
