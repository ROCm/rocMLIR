...
// RUN: rock-gen -p -x2 | mlir-rock-driver -rock-affix-params -rock-conv-to-gemm | FileCheck %s --check-prefix=STEP1
// RUN: rock-gen -p -x2 | mlir-rock-driver -rock-affix-params -rock-conv-to-gemm -rock-gridwise-gemm-to-blockwise | FileCheck %s --check-prefix=STEP2
// RUN: rock-gen -p --fil_layout=kyxc --in_layout=nhwc --out_layout=nhwk -x2 | mlir-rock-driver -rock-affix-params -rock-conv-to-gemm | FileCheck %s --check-prefix=NHWC
