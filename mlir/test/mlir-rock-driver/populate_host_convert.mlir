// RUN: rock-gen -p -ph -pr | FileCheck %s --check-prefix=F32
// RUN: rock-gen -p -ph -pr -t f16 | FileCheck %s --check-prefix=F16
// RUN: rock-gen -p -ph -pr -t bf16 | FileCheck %s --check-prefix=BF16
// RUN: rock-gen -p -ph -pr -t i8 | FileCheck %s --check-prefix=I8
