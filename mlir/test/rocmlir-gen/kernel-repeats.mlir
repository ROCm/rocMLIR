...
// RUN: rocmlir-gen --arch gfx900 --operation conv -p -pv --kernel-repeats=5 | FileCheck %s --check-prefix=CONV
// RUN: rocmlir-gen --arch gfx942 --operation conv -p -pv_with_gpu --kernel-repeats=5 | FileCheck %s --check-prefix=CONV
...
// CONV-NEXT: func.call @rock_conv_gkc01_ngc01_ngk01
// CONV-NEXT: }
