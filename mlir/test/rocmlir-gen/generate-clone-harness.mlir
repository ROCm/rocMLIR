...
// CHECK: func.func private @mlir_reshape_convolution({{.*}}: memref<1x1x16x1x16x1xf32> {func.read_access}, {{.*}}: memref<1x1x3x3xf32> {func.read_access}, {{.*}}: memref<1x1x32x32xf32> {func.write_access}) attributes {kernel, mhal.reference_func = @mlir_reshape_convolution}
// CHECK-LABEL: @main
