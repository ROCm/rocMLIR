...
// GEMM: amdgcn-amd-amdhsa:gfx908   {{.*}}     -t f32 -out_datatype f32 -transA false -transB false -accelLayoutA false -accelLayoutB false -g 1 -m 1024 -n 512 -k 769
...
// RUN: rocmlir-gen --arch gfx908 --operation gemm -accelLayoutA=true -accelLayoutB=true -p --emit-tuning-key | FileCheck %s --check-prefix=GEMMACCEL
// GEMMACCEL: amdgcn-amd-amdhsa:gfx908        {{.*}}     -t f32 -out_datatype f32 -transA false -transB false -accelLayoutA true -accelLayoutB true -g 1 -m 1024 -n 512 -k 769
