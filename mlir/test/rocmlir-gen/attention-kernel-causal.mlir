...
// CHECK-DAG: %[[normilizedSqkTensor:.*]] = tosa.sub %[[qkTensor]], %{{.*}} : (tensor<1x512x1024xf32>, tensor<1x512x1xf32>) -> tensor<1x512x1024xf32>
...
// CHECK-DAG: %[[invExpsSums:.*]] = tosa.reciprocal %{{.*}} : (tensor<1x512x1xf32>) -> tensor<1x512x1xf32>
