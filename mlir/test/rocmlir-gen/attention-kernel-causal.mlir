...
// CHECK: %[[rangeBroadcast2:.*]] = tosa.mul %[[one]], %[[range2Reshaped]], %{{.*}} : (tensor<1x512x1024xi32>, tensor<1x512x1xi32>, tensor<1xi8>) -> tensor<1x512x1024xi32>
...
// CHECK: %[[rangeBroadcast3:.*]] = tosa.mul %[[one2]], %[[range3Reshaped]], %{{.*}} : (tensor<1x512x1024xi32>, tensor<1x1x1024xi32>, tensor<1xi8>) -> tensor<1x512x1024xi32>
...
// CHECK: %[[rangeBroadcast4:.*]] = tosa.mul %[[one3]], %[[range4Reshaped]], %{{.*}} : (tensor<1x512x1024xi32>, tensor<1x512x1xi32>, tensor<1xi8>) -> tensor<1x512x1024xi32>
...
// CHECK: %[[rangeBroadcast5:.*]] = tosa.mul %[[one4]], %[[range5Reshaped]], %{{.*}} : (tensor<1x512x1024xi32>, tensor<1x1x1024xi32>, tensor<1xi8>) -> tensor<1x512x1024xi32>
