...
// ALLUNIT-SAME: attributes {enable_splitk_for_tuning, kernel, mhal.arch = "{{.*}}"}
...
// ALLUNIT-SAME: <AddDim{1} ["g"]
// ALLUNIT-SAME: <AddDim{1} ["m"]
// ALLUNIT-NEXT: rock.gemm [[gemmOut]] = [[gemmA]] * [[gemmB]] features = mfma|dot|atomic_add|atomic_add_f16|direct_to_lds_32b storeMethod = set {arch = "{{.*}}"} : memref<1x1x1x[[$OTYPE]]> = memref<1x1x1x[[$ITYPE]]> * memref<1x1x1x[[$ITYPE]]>

// ONLYG-LABEL: module
// ONLYG-NEXT: func.func @rock_gemm
// ONLYG-SAME: ([[arg0:%.+]]: memref<2x[[$ITYPE]]>, [[arg1:%.+]]: memref<2x[[$ITYPE]]>, [[arg2:%.+]]: memref<2x[[$OTYPE]]>)
// ONLYG-SAME: attributes {enable_splitk_for_tuning, kernel, mhal.arch = "{{.*}}"}
...
// ONLYG-SAME: <AddDim{1} ["m"]
// ONLYG-SAME: <AddDim{1} ["n"]
// ONLYG-NEXT: rock.gemm [[gemmOut]] = [[gemmA]] * [[gemmB]] features = mfma|dot|atomic_add|atomic_add_f16|direct_to_lds_32b storeMethod = set {arch = "{{.*}}"} : memref<2x1x1x[[$OTYPE]]> = memref<2x1x1x[[$ITYPE]]> * memref<2x1x1x[[$ITYPE]]>

// ONLYM-LABEL: module
// ONLYM-NEXT: func.func @rock_gemm
// ONLYM-SAME: ([[arg0:%.+]]: memref<2x[[$ITYPE]]>, [[arg1:%.+]]: memref<1x[[$ITYPE]]>, [[arg2:%.+]]: memref<2x[[$OTYPE]]>)
// ONLYM-SAME: attributes {enable_splitk_for_tuning, kernel, mhal.arch = "{{.*}}"}
...
// ONLYM-NEXT: rock.gemm [[gemmOut]] = [[gemmA]] * [[gemmB]] features = mfma|dot|atomic_add|atomic_add_f16|direct_to_lds_32b storeMethod = set {arch = "{{.*}}"} : memref<1x2x1x[[$OTYPE]]> = memref<1x2x1x[[$ITYPE]]> * memref<1x1x1x[[$ITYPE]]>

// ONLYK-LABEL: module
// ONLYK-NEXT: func.func @rock_gemm
// ONLYK-SAME: ([[arg0:%.+]]: memref<2x[[$ITYPE]]>, [[arg1:%.+]]: memref<2x[[$ITYPE]]>, [[arg2:%.+]]: memref<1x[[$OTYPE]]>)
// ONLYK-SAME: attributes {enable_splitk_for_tuning, kernel, mhal.arch = "{{.*}}"}
...
// ONLYK-SAME: <AddDim{1} ["g"]
// ONLYK-SAME: <AddDim{1} ["m"]
// ONLYK-NEXT: rock.gemm [[gemmOut]] = [[gemmA]] * [[gemmB]] features = mfma|dot|atomic_add|atomic_add_f16|direct_to_lds_32b storeMethod = set {arch = "{{.*}}"} : memref<1x1x1x[[$OTYPE]]> = memref<1x1x2x[[$ITYPE]]> * memref<1x2x1x[[$ITYPE]]>

// ONLYN-LABEL: module
// ONLYN-NEXT: func.func @rock_gemm
// ONLYN-SAME: ([[arg0:%.+]]: memref<1x[[$ITYPE]]>, [[arg1:%.+]]: memref<2x[[$ITYPE]]>, [[arg2:%.+]]: memref<2x[[$OTYPE]]>)
// ONLYN-SAME: attributes {enable_splitk_for_tuning, kernel, mhal.arch = "{{.*}}"}
...
// ONLYN-SAME: <AddDim{1} ["g"]
// ONLYN-SAME: <AddDim{1} ["m"]
// ONLYN-NEXT: rock.gemm [[gemmOut]] = [[gemmA]] * [[gemmB]] features = mfma|dot|atomic_add|atomic_add_f16|direct_to_lds_32b storeMethod = set {arch = "{{.*}}"} : memref<1x1x2x[[$OTYPE]]> = memref<1x1x1x[[$ITYPE]]> * memref<1x1x2x[[$ITYPE]]>
