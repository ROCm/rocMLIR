...
// RUN: rocmlir-gen -t f4E2M1FN -m 16 -n 16 -k 256 -out_dtype f32 --scaledGemm --arch gfx950 --operation gemm -pv -block_size 16 | FileCheck %s --check-prefix=GEMM-SCALED-16
