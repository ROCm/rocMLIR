...
// Scaled GEMM with f32 scales is also accepted at the rock.gemm
// verifier (the GemmToGridwise pass inserts a linalg.generic truncf
// down to f8E8M0FNU before the gridwise-only verifier sees the IR).
...
// GEMM-SCALED-F32: rock.gemm
// GEMM-SCALED-F32-SAME: scaled by memref<{{.*}}xf32> * memref<{{.*}}xf4E2M1FN> scaled by memref<{{.*}}xf32>
