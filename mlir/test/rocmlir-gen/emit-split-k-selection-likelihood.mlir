...
// RUN: rocmlir-gen --arch gfx90a --operation gemm -t f32  -g 1 -m 1    -k 1024 -n 1    --emit-split-k-selection-likelihood | FileCheck %s --check-prefixes=TEST_GFX90A_4
...
// RUN: rocmlir-gen --arch gfx1032 --operation gemm -t f32  -g 1 -m 1    -k 1024 -n 1    --emit-split-k-selection-likelihood | FileCheck %s --check-prefixes=TEST_GFX1032_4

// TEST_GFX90A_1: never
// TEST_GFX90A_2: never
// TEST_GFX90A_3: maybe
// TEST_GFX90A_4: always

// TEST_GFX1032_1: never
// TEST_GFX1032_2: never
// TEST_GFX1032_3: maybe
// TEST_GFX1032_4: always
