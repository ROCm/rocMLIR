//===- loweringUtils.cpp - MIOpen utility functions -----------------===//
//
...
LogicalResult mlir::miopen::calculateKBlockNum(
...
SmallVector<int64_t> mlir::miopen::populateBackwardDataGemmIds(
...
ConvOpType mlir::miopen::obtainConvDirection(Operation *op) {
...
Type mlir::miopen::obtainConvDataType(Operation *op) {
