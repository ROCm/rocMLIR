...
int64_t PerformanceImplicitGemmV4R4Fwd::CalculateGemmASrcVectorReadDim(
    const ConvolutionContext &ctx) const {
...
int64_t PerformanceImplicitGemmV4R4Fwd::CalculateGemmBSrcVectorReadDim(
    const ConvolutionContext &ctx) const {
  auto dimIndexVal = ctx.dimIndexVal;
...
int64_t PerformanceImplicitGemmBwdDataV1R1::CalculateGemmASrcVectorReadDim(
    const ConvolutionContext &ctx) const {
  auto dimIndexVal = ctx.dimIndexVal;
  if (dimIndexVal["k"].first == 3)
    return 0;
...
int64_t PerformanceImplicitGemmBwdDataV1R1::CalculateGemmBSrcVectorReadDim(
    const ConvolutionContext &ctx) const {
  auto dimIndexVal = ctx.dimIndexVal;
...
std::tuple<int64_t, LogicalResult> PerformanceImplicitGemmBwdDataV1R1::
  ...
  if (y == 1 && x == 1 && conv_stride_h == 1 && conv_stride_w == 1 &&
    ...
    DstDataPerWrite_GemmN1 = gcd(DstDataPerWrite_GemmN1, in_left_pad_w, wi,
                                 in_right_pad_w, conv_dilation_w);
  } else {
...
PerformanceImplicitGemmV4R4WrW::PerformanceImplicitGemmV4R4WrW(
    int64_t BlockSize_, int64_t GemmMPerBlock_, int64_t GemmNPerBlock_,
    int64_t GemmKPerBlock_, int64_t GemmMPerThread_, int64_t GemmNPerThread_)
    : BlockSize(BlockSize_), GemmMPerBlock(GemmMPerBlock_),
      GemmNPerBlock(GemmNPerBlock_), GemmKPerBlock(GemmKPerBlock_),
...
bool PerformanceImplicitGemmV4R4WrW::operator==(
    const PerformanceImplicitGemmV4R4WrW &other) const {
  // clang-format off
    return BlockSize == other.BlockSize
        && GemmMPerBlock == other.GemmMPerBlock
        && GemmNPerBlock == other.GemmNPerBlock
...
std::tuple<int64_t, LogicalResult>
PerformanceImplicitGemmV4R4WrW::CalculateGridSize(
    const ConvolutionContext &ctx) const {
  int64_t GridSize = 0;
  ...
  std::tie(gemm_m, gemm_n, std::ignore) =
      ConvHipImplicitGemmV4R4WrW::CalculateGemmSize(ctx);
...
int64_t PerformanceImplicitGemmV4R4WrW::CalculateGemmASrcVectorReadDim(
    const ConvolutionContext &ctx) const {
  auto dimIndexVal = ctx.dimIndexVal;
  if (dimIndexVal["k"].first == 3)
    return 1;
...
int64_t PerformanceImplicitGemmV4R4WrW::CalculateGemmBSrcVectorReadDim(
    const ConvolutionContext &ctx) const {
  auto dimIndexVal = ctx.dimIndexVal;
  if (dimIndexVal["ci"].first == 3)
    return 1;
...
PerformanceImplicitGemmV4R4WrW::CalculateGemmBBlockCopyPerformanceParameters(
  ...
  if (conv_stride_w == 1 && in_left_pad_w == 0 && in_right_pad_w == 0 &&
      conv_dilation_w == 1) {
    SrcDataPerRead_GemmK = gcd(SrcDataPerRead_GemmK, wo);
  } else if (conv_stride_w == 1) {
    SrcDataPerRead_GemmK = gcd(SrcDataPerRead_GemmK, in_left_pad_w, wi,
                               in_right_pad_w, conv_dilation_w);
  } else {
  ...
  return std::make_tuple(ClusterLengths_GemmK, ClusterLengths_GemmN,
                         SrcDataPerRead_GemmK, DstDataPerWrite_GemmN,
                         success());
}

std::tuple<int64_t, LogicalResult>
PerformanceImplicitGemmV4R4WrW::CalculateGemmCThreadCopyPerformanceParameters(
    const ConvolutionContext &ctx) const {
  int64_t DstDataPerWrite_GemmN1 = 4;
  ...
  const auto y = dimIndexVal["y"].second;
  const auto x = dimIndexVal["x"].second;
  DstDataPerWrite_GemmN1 = gcd(DstDataPerWrite_GemmN1, c * y * x);

  return std::make_tuple(DstDataPerWrite_GemmN1, success());
}

std::tuple<std::size_t, LogicalResult>
PerformanceImplicitGemmV4R4WrW::CalculateLdsNumberOfByte(
    const ConvolutionContext &ctx) const {
  std::size_t lds_size = 0;
...
LogicalResult PerformanceImplicitGemmV4R4WrW::IsValidValue() const {
  // clang-format off
    if ( IsTwoPower<64, 256>(BlockSize) &&
           IsTwoPower<32, 128>(GemmMPerBlock) &&
           IsTwoPower<32, 128>(GemmNPerBlock) &&
...
LogicalResult
PerformanceImplicitGemmV4R4WrW::IsValid(const ConvolutionContext &ctx) const {
  if (failed(IsValidValue()))
    return failure();
...
LogicalResult
PerformanceImplicitGemmV4R4WrW::EuristicInit(const ConvolutionContext &ctx) {
...
LogicalResult
ConvHipImplicitGemmV4R4WrW::IsApplicable(const ConvolutionContext &ctx) const {
  if (!(ctx.opType == miopen::ConvOpType::Conv2DBwdWeightOpType))
    return failure();
...
PerformanceImplicitGemmV4R4WrW ConvHipImplicitGemmV4R4WrW::GetPerformanceConfig(
    const ConvolutionContext &ctx) const {
  return GetPerformanceConfigBase<PerformanceImplicitGemmV4R4WrW>(ctx);
}

LogicalResult ConvHipImplicitGemmV4R4WrW::IsValidPerformanceConfig(
    const ConvolutionContext &ctx,
    const PerformanceImplicitGemmV4R4WrW &config) const {
  return config.IsValid(ctx);
}

llvm::StringMap<int64_t> ConvHipImplicitGemmV4R4WrW::GetSolution(
    const ConvolutionContext &ctx,
    const PerformanceImplicitGemmV4R4WrW &config) const {
  ...
  int64_t GemmBBlockCopyClusterLengths_GemmK = 0;
  int64_t GemmBBlockCopyClusterLengths_GemmN = 0;
  int64_t GemmBBlockCopySrcDataPerRead_GemmK = 0;
  int64_t GemmBBlockCopyDstDataPerWrite_GemmN = 0;
  int64_t GemmCThreadCopyDstDataPerWrite_GemmN1 = 0;
  ...
  std::tie(
      GemmBBlockCopyClusterLengths_GemmK, GemmBBlockCopyClusterLengths_GemmN,
      GemmBBlockCopySrcDataPerRead_GemmK, GemmBBlockCopyDstDataPerWrite_GemmN,
      std::ignore) = config.CalculateGemmBBlockCopyPerformanceParameters(ctx);
  ...
  result["matrix_b_cluster_lengths_gemmk"] = GemmBBlockCopyClusterLengths_GemmK;
  result["matrix_b_cluster_lengths_gemmN"] = GemmBBlockCopyClusterLengths_GemmN;
  result["matrix_b_source_data_per_read"] = GemmBBlockCopySrcDataPerRead_GemmK;
  result["matrix_b_dest_data_per_write_dim_n"] =
      GemmBBlockCopyDstDataPerWrite_GemmN;
  result["matrix_c_dest_data_per_write"] =
      GemmCThreadCopyDstDataPerWrite_GemmN1;
