//===- GemmToGridwise.cpp - MIOpen GEMM implementation ------------===//
//
...
#define DEBUG_TYPE "miopen-gemm-to-gridwise"

using namespace mlir;
using namespace mlir::miopen;

namespace {
class MIOpenGemmToGridwisePass
    : public MIOpenGemmToGridwisePassBase<MIOpenGemmToGridwisePass> {
...
void MIOpenGemmToGridwisePass::runOnOperation() {
  MLIRContext *ctx = &getContext();
  ConversionTarget target(*ctx);

  target.addIllegalOp<miopen::GemmOp>();
...
std::unique_ptr<Pass> mlir::miopen::createMIOpenGemmToGridwisePass() {
  return std::make_unique<MIOpenGemmToGridwisePass>();
}
