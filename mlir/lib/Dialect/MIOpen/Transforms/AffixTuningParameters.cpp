...
void AffixTuningParameters::runOnFunction() {
  ...
  func.walk([&](miopen::GridwiseGemmOp op) {
    ...
    op.setAttr("m_level0_cluster", b.getI32IntegerAttr(blockGemmDerivedParam.gemmMLevel0Cluster));
    op.setAttr("n_level0_cluster", b.getI32IntegerAttr(blockGemmDerivedParam.gemmNLevel0Cluster));
    op.setAttr("m_level1_cluster", b.getI32IntegerAttr(blockGemmDerivedParam.gemmMLevel1Cluster));
    op.setAttr("n_level1_cluster", b.getI32IntegerAttr(blockGemmDerivedParam.gemmNLevel1Cluster));
