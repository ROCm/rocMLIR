...
auto getMfmaInsnGroupAttrMapAllArch = []() -> const MfmaInsnGroupMap & {
  ...
  static MfmaInsnGroupMap
      ...
      groupAttrMap{
          // f32 - 32x32x2
          {{MfmaTypeId::Fp32TyId, 32, 0, 64,
            64}, // kPerXdl=0 is for default selection
           {ROCDL::mfma_f32_32x32x2f32::getOperationName()}},
          ...
          {{MfmaTypeId::Fp32TyId, 32, 2, 32, 64},
           {ROCDL::mfma_f32_32x32x2f32::getOperationName()}},
          {{MfmaTypeId::Fp32TyId, 32, 2, 32, 32},
           {ROCDL::mfma_f32_32x32x2f32::getOperationName()}},
          // f32 - 16x16x4
          {{MfmaTypeId::Fp32TyId, 16, 0, 64,
            64}, // kPerXdl=0 is for default selection
           {ROCDL::mfma_f32_16x16x4f32::getOperationName()}},
          {{MfmaTypeId::Fp32TyId, 16, 4, 64, 64},
           {ROCDL::mfma_f32_16x16x4f32::getOperationName()}},
          {{MfmaTypeId::Fp32TyId, 16, 4, 64, 32},
           {ROCDL::mfma_f32_16x16x4f32::getOperationName()}},
          {{MfmaTypeId::Fp32TyId, 16, 4, 64, 16},
           {ROCDL::mfma_f32_16x16x4f32::getOperationName()}},
          {{MfmaTypeId::Fp32TyId, 16, 4, 32, 64},
           {ROCDL::mfma_f32_16x16x4f32::getOperationName()}},
          {{MfmaTypeId::Fp32TyId, 16, 4, 32, 32},
           {ROCDL::mfma_f32_16x16x4f32::getOperationName()}},
          {{MfmaTypeId::Fp32TyId, 16, 4, 32, 16},
           {ROCDL::mfma_f32_16x16x4f32::getOperationName()}},
          {{MfmaTypeId::Fp32TyId, 16, 4, 16, 64},
           {ROCDL::mfma_f32_16x16x4f32::getOperationName()}},
          {{MfmaTypeId::Fp32TyId, 16, 4, 16, 32},
           {ROCDL::mfma_f32_16x16x4f32::getOperationName()}},
          {{MfmaTypeId::Fp32TyId, 16, 4, 16, 16},
           {ROCDL::mfma_f32_16x16x4f32::getOperationName()}},
          // f32 - 4x4x1
          {{MfmaTypeId::Fp32TyId, 4, 0, 8,
            64}, // kPerXdl=0 is for default selection
           {ROCDL::mfma_f32_4x4x1f32::getOperationName(),
            {{4, 0, MFMAPermB::none}, {4, 1, MFMAPermB::none}}}},
          {{MfmaTypeId::Fp32TyId, 4, 1, 4, 64},
           {ROCDL::mfma_f32_4x4x1f32::getOperationName(),
            {{4, 0, MFMAPermB::none}}}},
          ...
          {{MfmaTypeId::Fp16TyId, 32, 8, 64, 32},
           {ROCDL::mfma_f32_32x32x8f16::getOperationName()}},
          {{MfmaTypeId::Fp16TyId, 32, 8, 32, 32},
           {ROCDL::mfma_f32_32x32x8f16::getOperationName()}},
          ...
          {{MfmaTypeId::Fp16TyId, 16, 16, 64, 32},
           {ROCDL::mfma_f32_16x16x16f16::getOperationName()}},
          {{MfmaTypeId::Fp16TyId, 16, 16, 64, 16},
           {ROCDL::mfma_f32_16x16x16f16::getOperationName()}},
          {{MfmaTypeId::Fp16TyId, 16, 16, 32, 64},
           {ROCDL::mfma_f32_16x16x16f16::getOperationName()}},
          {{MfmaTypeId::Fp16TyId, 16, 16, 32, 32},
           {ROCDL::mfma_f32_16x16x16f16::getOperationName()}},
          {{MfmaTypeId::Fp16TyId, 16, 16, 32, 16},
           {ROCDL::mfma_f32_16x16x16f16::getOperationName()}},
          ...
          {{MfmaTypeId::Fp16TyId, 16, 4, 32, 64},
           {ROCDL::mfma_f32_16x16x4f16::getOperationName(),
            {{2, 0, MFMAPermB::none}, {2, 1, MFMAPermB::none}}}},
          {{MfmaTypeId::Fp16TyId, 16, 4, 16, 64},
           {ROCDL::mfma_f32_16x16x4f16::getOperationName(),
            {{2, 0, MFMAPermB::none}}}}
          //  {{MfmaTypeId::Fp16TyId, 16, 4, 64, 32},
          //   {ROCDL::mfma_f32_16x16x4f16::getOperationName(), {{0, 0,
          //   MFMAPermB::bcast_first_16}, {0, 0,
          //   MFMAPermB::bcast_second_16}}}},
          //  {{MfmaTypeId::Fp16TyId, 16, 4, 64, 16},
          //   {ROCDL::mfma_f32_16x16x4f16::getOperationName(), {{0, 0,
          //   MFMAPermB::bcast_first_16}}}}
      };
...
auto getMfmaInsnGroupAttrMapGfx908Bf16 = []() -> const MfmaInsnGroupMap & {
  ...
  static MfmaInsnGroupMap
      // bf16
      groupAttrMap{{{MfmaTypeId::Bf16TyId, 32, 4, 64, 64},
                    {ROCDL::mfma_f32_32x32x4bf16::getOperationName()}},
                   {{MfmaTypeId::Bf16TyId, 32, 4, 64, 32},
                    {ROCDL::mfma_f32_32x32x4bf16::getOperationName()}},
                   {{MfmaTypeId::Bf16TyId, 32, 4, 32, 64},
                    {ROCDL::mfma_f32_32x32x4bf16::getOperationName()}},
                   {{MfmaTypeId::Bf16TyId, 16, 8, 64, 16},
                    {ROCDL::mfma_f32_16x16x8bf16::getOperationName()}},
                   {{MfmaTypeId::Bf16TyId, 16, 8, 16, 64},
                    {ROCDL::mfma_f32_16x16x8bf16::getOperationName()}},
                   {{MfmaTypeId::Bf16TyId, 4, 2, 8, 64},
                    {ROCDL::mfma_f32_4x4x2bf16::getOperationName(),
                     {{4, 0, MFMAPermB::none}, {4, 1, MFMAPermB::none}}}},
                   {{MfmaTypeId::Bf16TyId, 4, 2, 4, 64},
                    {ROCDL::mfma_f32_4x4x2bf16::getOperationName(),
                     {{4, 0, MFMAPermB::none}}}},
                   {{MfmaTypeId::Bf16TyId, 32, 4, 32, 32},
                    {ROCDL::mfma_f32_32x32x4bf16::getOperationName()}},
                   {{MfmaTypeId::Bf16TyId, 16, 8, 16, 16},
                    {ROCDL::mfma_f32_16x16x8bf16::getOperationName()}}};
  return groupAttrMap;
};
...
auto getMfmaInsnGroupAttrMapGfx90aPlusBf16 = []() {
  ...
  static llvm::DenseMap<MfmaInsnGroupSelectKey, MfmaInsnGroupAttr,
                        MfmaInsnGroupSelectKeyInfo>
      // bf16
      groupAttrMap{{{MfmaTypeId::Bf16TyId, 32, 8, 64, 64},
                    {ROCDL::mfma_f32_32x32x8bf16_1k::getOperationName()}},
                   {{MfmaTypeId::Bf16TyId, 32, 8, 64, 32},
                    {ROCDL::mfma_f32_32x32x8bf16_1k::getOperationName()}},
                   {{MfmaTypeId::Bf16TyId, 32, 8, 32, 64},
                    {ROCDL::mfma_f32_32x32x8bf16_1k::getOperationName()}},
                   {{MfmaTypeId::Bf16TyId, 16, 16, 64, 16},
                    {ROCDL::mfma_f32_16x16x16bf16_1k::getOperationName()}},
                   {{MfmaTypeId::Bf16TyId, 16, 16, 16, 64},
                    {ROCDL::mfma_f32_16x16x16bf16_1k::getOperationName()}},
                   {{MfmaTypeId::Bf16TyId, 4, 4, 8, 64},
                    {ROCDL::mfma_f32_4x4x4bf16_1k::getOperationName(),
                     {{4, 0, MFMAPermB::none}, {4, 1, MFMAPermB::none}}}},
                   {{MfmaTypeId::Bf16TyId, 4, 4, 4, 64},
                    {ROCDL::mfma_f32_4x4x4bf16_1k::getOperationName(),
                     {{4, 0, MFMAPermB::none}}}},
                   {{MfmaTypeId::Bf16TyId, 32, 8, 32, 32},
                    {ROCDL::mfma_f32_32x32x8bf16_1k::getOperationName()}},
                   {{MfmaTypeId::Bf16TyId, 16, 16, 16, 16},
                    {ROCDL::mfma_f32_16x16x16bf16_1k::getOperationName()}}};
  return groupAttrMap;
};
...
auto getMfmaInsnGroupAttrMapPreGfx940Int8 = []() {
  ...
  static llvm::DenseMap<MfmaInsnGroupSelectKey, MfmaInsnGroupAttr,
                        MfmaInsnGroupSelectKeyInfo>
      // Int8
      groupAttrMap{// 32x32x8
                   {{MfmaTypeId::I8TyId, 32, 8, 64, 64},
                    {ROCDL::mfma_i32_32x32x8i8::getOperationName()}},
                   {{MfmaTypeId::I8TyId, 32, 8, 64, 32},
                    {ROCDL::mfma_i32_32x32x8i8::getOperationName()}},
                   {{MfmaTypeId::I8TyId, 32, 8, 32, 64},
                    {ROCDL::mfma_i32_32x32x8i8::getOperationName()}},
                   {{MfmaTypeId::I8TyId, 32, 8, 32, 32},
                    {ROCDL::mfma_i32_32x32x8i8::getOperationName()}},
                   // 16x16x16
                   {{MfmaTypeId::I8TyId, 16, 16, 64, 64},
                    {ROCDL::mfma_i32_16x16x16i8::getOperationName()}},
                   {{MfmaTypeId::I8TyId, 16, 16, 64, 32},
                    {ROCDL::mfma_i32_16x16x16i8::getOperationName()}},
                   {{MfmaTypeId::I8TyId, 16, 16, 64, 16},
                    {ROCDL::mfma_i32_16x16x16i8::getOperationName()}},
                   {{MfmaTypeId::I8TyId, 16, 16, 32, 64},
                    {ROCDL::mfma_i32_16x16x16i8::getOperationName()}},
                   {{MfmaTypeId::I8TyId, 16, 16, 32, 32},
                    {ROCDL::mfma_i32_16x16x16i8::getOperationName()}},
                   {{MfmaTypeId::I8TyId, 16, 16, 32, 16},
                    {ROCDL::mfma_i32_16x16x16i8::getOperationName()}},
                   {{MfmaTypeId::I8TyId, 16, 16, 16, 64},
                    {ROCDL::mfma_i32_16x16x16i8::getOperationName()}},
                   {{MfmaTypeId::I8TyId, 16, 16, 16, 32},
                    {ROCDL::mfma_i32_16x16x16i8::getOperationName()}},
                   {{MfmaTypeId::I8TyId, 16, 16, 16, 16},
                    {ROCDL::mfma_i32_16x16x16i8::getOperationName()}}};
  ;
  return groupAttrMap;
};
...
auto getMfmaInsnGroupAttrMapGfx940Plus = []() {
  ...
  static MfmaInsnGroupMap
      // Int8
      groupAttrMap{// 32x32x16
                   {{MfmaTypeId::I8TyId, 32, 16, 64, 64},
                    {ROCDL::mfma_i32_32x32x16_i8::getOperationName()}},
                   {{MfmaTypeId::I8TyId, 32, 16, 64, 32},
                    {ROCDL::mfma_i32_32x32x16_i8::getOperationName()}},
                   {{MfmaTypeId::I8TyId, 32, 16, 32, 64},
                    {ROCDL::mfma_i32_32x32x16_i8::getOperationName()}},
                   {{MfmaTypeId::I8TyId, 32, 16, 32, 32},
                    {ROCDL::mfma_i32_32x32x16_i8::getOperationName()}},
                   // 16x16x32
                   {{MfmaTypeId::I8TyId, 16, 32, 64, 64},
                    {ROCDL::mfma_i32_16x16x32_i8::getOperationName()}},
                   {{MfmaTypeId::I8TyId, 16, 32, 64, 32},
                    {ROCDL::mfma_i32_16x16x32_i8::getOperationName()}},
                   {{MfmaTypeId::I8TyId, 16, 32, 64, 16},
                    {ROCDL::mfma_i32_16x16x32_i8::getOperationName()}},
                   {{MfmaTypeId::I8TyId, 16, 32, 32, 64},
                    {ROCDL::mfma_i32_16x16x32_i8::getOperationName()}},
                   {{MfmaTypeId::I8TyId, 16, 32, 32, 32},
                    {ROCDL::mfma_i32_16x16x32_i8::getOperationName()}},
                   {{MfmaTypeId::I8TyId, 16, 32, 32, 16},
                    {ROCDL::mfma_i32_16x16x32_i8::getOperationName()}},
                   {{MfmaTypeId::I8TyId, 16, 32, 16, 64},
                    {ROCDL::mfma_i32_16x16x32_i8::getOperationName()}},
                   {{MfmaTypeId::I8TyId, 16, 32, 16, 32},
                    {ROCDL::mfma_i32_16x16x32_i8::getOperationName()}},
                   {{MfmaTypeId::I8TyId, 16, 32, 16, 16},
                    {ROCDL::mfma_i32_16x16x32_i8::getOperationName()}},

                   // fp8 * fp8
                   // 32x32x16
                   {{MfmaTypeId::Fp8Fp8TyId, 32, 16, 64, 64},
                    {ROCDL::mfma_f32_32x32x16_fp8_fp8::getOperationName()}},
                   {{MfmaTypeId::Fp8Fp8TyId, 32, 16, 64, 32},
                    {ROCDL::mfma_f32_32x32x16_fp8_fp8::getOperationName()}},
                   {{MfmaTypeId::Fp8Fp8TyId, 32, 16, 32, 64},
                    {ROCDL::mfma_f32_32x32x16_fp8_fp8::getOperationName()}},
                   {{MfmaTypeId::Fp8Fp8TyId, 32, 16, 32, 32},
                    {ROCDL::mfma_f32_32x32x16_fp8_fp8::getOperationName()}},
                   // 16x16x32
                   {{MfmaTypeId::Fp8Fp8TyId, 16, 32, 64, 64},
                    {ROCDL::mfma_f32_16x16x32_fp8_fp8::getOperationName()}},
                   {{MfmaTypeId::Fp8Fp8TyId, 16, 32, 64, 32},
                    {ROCDL::mfma_f32_16x16x32_fp8_fp8::getOperationName()}},
                   {{MfmaTypeId::Fp8Fp8TyId, 16, 32, 64, 16},
                    {ROCDL::mfma_f32_16x16x32_fp8_fp8::getOperationName()}},
                   {{MfmaTypeId::Fp8Fp8TyId, 16, 32, 32, 64},
                    {ROCDL::mfma_f32_16x16x32_fp8_fp8::getOperationName()}},
                   {{MfmaTypeId::Fp8Fp8TyId, 16, 32, 32, 32},
                    {ROCDL::mfma_f32_16x16x32_fp8_fp8::getOperationName()}},
                   {{MfmaTypeId::Fp8Fp8TyId, 16, 32, 32, 16},
                    {ROCDL::mfma_f32_16x16x32_fp8_fp8::getOperationName()}},
                   {{MfmaTypeId::Fp8Fp8TyId, 16, 32, 16, 64},
                    {ROCDL::mfma_f32_16x16x32_fp8_fp8::getOperationName()}},
                   {{MfmaTypeId::Fp8Fp8TyId, 16, 32, 16, 32},
                    {ROCDL::mfma_f32_16x16x32_fp8_fp8::getOperationName()}},
                   {{MfmaTypeId::Fp8Fp8TyId, 16, 32, 16, 16},
                    {ROCDL::mfma_f32_16x16x32_fp8_fp8::getOperationName()}},

                   // fp8 * bf8
                   // 32x32x16
                   {{MfmaTypeId::Fp8Bf8TyId, 32, 16, 64, 64},
                    {ROCDL::mfma_f32_32x32x16_fp8_bf8::getOperationName()}},
                   {{MfmaTypeId::Fp8Bf8TyId, 32, 16, 64, 32},
                    {ROCDL::mfma_f32_32x32x16_fp8_bf8::getOperationName()}},
                   {{MfmaTypeId::Fp8Bf8TyId, 32, 16, 32, 64},
                    {ROCDL::mfma_f32_32x32x16_fp8_bf8::getOperationName()}},
                   {{MfmaTypeId::Fp8Bf8TyId, 32, 16, 32, 32},
                    {ROCDL::mfma_f32_32x32x16_fp8_bf8::getOperationName()}},
                   // 16x16x32
                   {{MfmaTypeId::Fp8Bf8TyId, 16, 32, 64, 64},
                    {ROCDL::mfma_f32_16x16x32_fp8_bf8::getOperationName()}},
                   {{MfmaTypeId::Fp8Bf8TyId, 16, 32, 64, 32},
                    {ROCDL::mfma_f32_16x16x32_fp8_bf8::getOperationName()}},
                   {{MfmaTypeId::Fp8Bf8TyId, 16, 32, 64, 16},
                    {ROCDL::mfma_f32_16x16x32_fp8_bf8::getOperationName()}},
                   {{MfmaTypeId::Fp8Bf8TyId, 16, 32, 32, 64},
                    {ROCDL::mfma_f32_16x16x32_fp8_bf8::getOperationName()}},
                   {{MfmaTypeId::Fp8Bf8TyId, 16, 32, 32, 32},
                    {ROCDL::mfma_f32_16x16x32_fp8_bf8::getOperationName()}},
                   {{MfmaTypeId::Fp8Bf8TyId, 16, 32, 32, 16},
                    {ROCDL::mfma_f32_16x16x32_fp8_bf8::getOperationName()}},
                   {{MfmaTypeId::Fp8Bf8TyId, 16, 32, 16, 64},
                    {ROCDL::mfma_f32_16x16x32_fp8_bf8::getOperationName()}},
                   {{MfmaTypeId::Fp8Bf8TyId, 16, 32, 16, 32},
                    {ROCDL::mfma_f32_16x16x32_fp8_bf8::getOperationName()}},
                   {{MfmaTypeId::Fp8Bf8TyId, 16, 32, 16, 16},
                    {ROCDL::mfma_f32_16x16x32_fp8_bf8::getOperationName()}},

                   // bf8 * fp8
                   // 32x32x16
                   {{MfmaTypeId::Bf8Fp8TyId, 32, 16, 64, 64},
                    {ROCDL::mfma_f32_32x32x16_bf8_fp8::getOperationName()}},
                   {{MfmaTypeId::Bf8Fp8TyId, 32, 16, 64, 32},
                    {ROCDL::mfma_f32_32x32x16_bf8_fp8::getOperationName()}},
                   {{MfmaTypeId::Bf8Fp8TyId, 32, 16, 32, 64},
                    {ROCDL::mfma_f32_32x32x16_bf8_fp8::getOperationName()}},
                   {{MfmaTypeId::Bf8Fp8TyId, 32, 16, 32, 32},
                    {ROCDL::mfma_f32_32x32x16_bf8_fp8::getOperationName()}},
                   // 16x16x32
                   {{MfmaTypeId::Bf8Fp8TyId, 16, 32, 64, 64},
                    {ROCDL::mfma_f32_16x16x32_bf8_fp8::getOperationName()}},
                   {{MfmaTypeId::Bf8Fp8TyId, 16, 32, 64, 32},
                    {ROCDL::mfma_f32_16x16x32_bf8_fp8::getOperationName()}},
                   {{MfmaTypeId::Bf8Fp8TyId, 16, 32, 64, 16},
                    {ROCDL::mfma_f32_16x16x32_bf8_fp8::getOperationName()}},
                   {{MfmaTypeId::Bf8Fp8TyId, 16, 32, 32, 64},
                    {ROCDL::mfma_f32_16x16x32_bf8_fp8::getOperationName()}},
                   {{MfmaTypeId::Bf8Fp8TyId, 16, 32, 32, 32},
                    {ROCDL::mfma_f32_16x16x32_bf8_fp8::getOperationName()}},
                   {{MfmaTypeId::Bf8Fp8TyId, 16, 32, 32, 16},
                    {ROCDL::mfma_f32_16x16x32_bf8_fp8::getOperationName()}},
                   {{MfmaTypeId::Bf8Fp8TyId, 16, 32, 16, 64},
                    {ROCDL::mfma_f32_16x16x32_bf8_fp8::getOperationName()}},
                   {{MfmaTypeId::Bf8Fp8TyId, 16, 32, 16, 32},
                    {ROCDL::mfma_f32_16x16x32_bf8_fp8::getOperationName()}},
                   {{MfmaTypeId::Bf8Fp8TyId, 16, 32, 16, 16},
                    {ROCDL::mfma_f32_16x16x32_bf8_fp8::getOperationName()}},

                   // bf8 * bf8
                   // 32x32x16
                   {{MfmaTypeId::Bf8Bf8TyId, 32, 16, 64, 64},
                    {ROCDL::mfma_f32_32x32x16_bf8_bf8::getOperationName()}},
                   {{MfmaTypeId::Bf8Bf8TyId, 32, 16, 64, 32},
                    {ROCDL::mfma_f32_32x32x16_bf8_bf8::getOperationName()}},
                   {{MfmaTypeId::Bf8Bf8TyId, 32, 16, 32, 64},
                    {ROCDL::mfma_f32_32x32x16_bf8_bf8::getOperationName()}},
                   {{MfmaTypeId::Bf8Bf8TyId, 32, 16, 32, 32},
                    {ROCDL::mfma_f32_32x32x16_bf8_bf8::getOperationName()}},
                   // 16x16x32
                   {{MfmaTypeId::Bf8Bf8TyId, 16, 32, 64, 64},
                    {ROCDL::mfma_f32_16x16x32_bf8_bf8::getOperationName()}},
                   {{MfmaTypeId::Bf8Bf8TyId, 16, 32, 64, 32},
                    {ROCDL::mfma_f32_16x16x32_bf8_bf8::getOperationName()}},
                   {{MfmaTypeId::Bf8Bf8TyId, 16, 32, 64, 16},
                    {ROCDL::mfma_f32_16x16x32_bf8_bf8::getOperationName()}},
                   {{MfmaTypeId::Bf8Bf8TyId, 16, 32, 32, 64},
                    {ROCDL::mfma_f32_16x16x32_bf8_bf8::getOperationName()}},
                   {{MfmaTypeId::Bf8Bf8TyId, 16, 32, 32, 32},
                    {ROCDL::mfma_f32_16x16x32_bf8_bf8::getOperationName()}},
                   {{MfmaTypeId::Bf8Bf8TyId, 16, 32, 32, 16},
                    {ROCDL::mfma_f32_16x16x32_bf8_bf8::getOperationName()}},
                   {{MfmaTypeId::Bf8Bf8TyId, 16, 32, 16, 64},
                    {ROCDL::mfma_f32_16x16x32_bf8_bf8::getOperationName()}},
                   {{MfmaTypeId::Bf8Bf8TyId, 16, 32, 16, 32},
                    {ROCDL::mfma_f32_16x16x32_bf8_bf8::getOperationName()}},
                   {{MfmaTypeId::Bf8Bf8TyId, 16, 32, 16, 16},
                    {ROCDL::mfma_f32_16x16x32_bf8_bf8::getOperationName()}}};
  return groupAttrMap;
};
...
MfmaInsnGroup::select(Type elementTypeA, Type elementTypeB, StringRef arch,
                      int64_t mnPerXdl, int64_t kPerXdl, int64_t mPerWave,
                      int64_t nPerWave) {
  ...
  MfmaInsnGroupSelectKey key = {convertTypesToId(elementTypeA, elementTypeB),
                                mnPerXdl, kPerXdl, mPerMfmaGroup,
                                nPerMfmaGroup};
