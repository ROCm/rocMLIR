...
auto getMfmaInsnGroupAttrMapAllArch = []() -> const MfmaInsnGroupMap & {
  ...
  static MfmaInsnGroupMap
      ...
      groupAttrMap{
                   // f32 - 32x32x2
                   {{MfmaTypeId::Fp32TyId, 32, 0, 64, 64}, // kPerXdl=0 is for default selection 
                    {ROCDL::mfma_f32_32x32x2f32::getOperationName()}},
                   ...
                   {{MfmaTypeId::Fp32TyId, 32, 2, 32, 32},
                    {ROCDL::mfma_f32_32x32x2f32::getOperationName()}},
                   // f32 - 16x16x4
                   {{MfmaTypeId::Fp32TyId, 16, 0, 64, 64}, // kPerXdl=0 is for default selection 
                    {ROCDL::mfma_f32_16x16x4f32::getOperationName()}},
                   ...
                   {{MfmaTypeId::Fp32TyId, 16, 4, 16, 16},
                    {ROCDL::mfma_f32_16x16x4f32::getOperationName()}},
                   // f32 - 4x4x1
                   {{MfmaTypeId::Fp32TyId, 4, 0, 8, 64}, // kPerXdl=0 is for default selection 
                    {ROCDL::mfma_f32_4x4x1f32::getOperationName(),
...
FailureOr<MfmaInsnGroup> MfmaInsnGroup::select(Type elementTypeA,
                                               Type elementTypeB,
                                               StringRef arch,
                                               int64_t mnPerXdl, int64_t kPerXdl, int64_t mPerWave, int64_t nPerWave) {
  ...
  MfmaInsnGroupSelectKey key = {convertTypesToId(elementTypeA, elementTypeB),
                                mnPerXdl, kPerXdl, mPerMfmaGroup, nPerMfmaGroup};
