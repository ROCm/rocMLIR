...
static MfmaTypeId convertTypesToId(Type dataTypeA, Type dataTypeB) {
  ...
  if (isa<Float8E4M3FNUZType>(dataTypeA) && isa<Float8E4M3FNUZType>(dataTypeB)) {
    return MfmaTypeId::Fp8Fp8TyId;
  }
  if (isa<Float8E4M3FNUZType>(dataTypeA) && isa<Float8E5M2FNUZType>(dataTypeB)) {
    return MfmaTypeId::Fp8Bf8TyId;
  }
  if(isa<Float8E5M2FNUZType>(dataTypeA) && isa<Float8E4M3FNUZType>(dataTypeB)) {
    return MfmaTypeId::Bf8Fp8TyId;
  }
  if(isa<Float8E5M2FNUZType>(dataTypeA) && isa<Float8E5M2FNUZType>(dataTypeB)) {
