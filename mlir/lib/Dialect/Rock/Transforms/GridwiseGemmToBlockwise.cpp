  ...
  LogicalResult matchAndRewrite(GridwiseAttentionAccelOp op,
        ...
        rewriter.create<affine::AffineForOp>(loc, 0, gemm0NBlocks, 1);
    {
      ...
      rewriter.create<BlockwiseBroadcastReduceOp>(
          ...
          gemm0OutSubTileViews.blockSubTile, /*THIS IS WRONG PROVIDE PARTIAL RED VIEW HERE*/gemm0OutSubTileViews.blockSubTile, gemm0OutSubTileViews.threadSubTile, /*extraViews=*/nullptr, blockSize);
      ...
      rewriter.create<BlockwiseBroadcastReduceOp>(
          ...
          rock::ReduceMethod::Sum, gemm0OutSubTileViews.blockSubTile, /*THIS IS WRONG PROVIDE PARTIAL RED VIEW HERE*/gemm0OutSubTileViews.blockSubTile, gemm0OutSubTileViews.threadSubTile,
