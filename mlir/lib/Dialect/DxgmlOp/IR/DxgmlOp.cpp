...
#include "mlir/Dialect/DxgmlOp/IR/DxgmlOpDialect.cpp.inc"

void DxgmlOpDialect::initialize() {
  addOperations<
#define GET_OP_LIST
#include "mlir/Dialect/DxgmlOp/IR/DxgmlOp.cpp.inc"
      >();
}
...
#include "mlir/Dialect/DxgmlOp/IR/DxgmlOpEnums.cpp.inc"
