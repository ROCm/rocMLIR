...
func @miopen_xdlops_gemm_v2_one_result(%matrixA : memref<1024xi8, 3>, %matrixB : memref<1024xi8, #map, 3>, %bufferA : memref<2xvector<16xi8>, 5>, %bufferB : memref<2xvector<16xi8>, 5>) -> vector<16xi32> {
  ...
  %vectorD0 = miopen.xdlops_gemm_v2(%matrixA, %matrixB, %c0, %c0, %bufferA, %bufferB, %vectorC0) {
    ...
    //n_waves = 2 : i32,
    transforms = [[], []]
  } : memref<1024xi8, 3>, memref<1024xi8, #map, 3>, index, index, memref<2xvector<16xi8>, 5>, memref<2xvector<16xi8>, 5>, vector<16xi32> -> vector<16xi32>
