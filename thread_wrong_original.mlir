...
Emitting load A
vector load A
vector<4xi8>%cst = arith.constant dense<0> : vector<4xi8>
vector load A
vector<4xi8>%cst_9 = arith.constant dense<0> : vector<4xi8>
...
module {
  func @miopen_xdlops_gemm_v2_one_result(%arg0: memref<1024xi8, 3>, %arg1: memref<1024xi8, #map, 3>, %arg2: memref<8xvector<16xi8>, 5>, %arg3: memref<8xvector<16xi8>, 5>) -> vector<16xi32> {
    ...
    affine.for %arg4 = 0 to 8 {
      ...
      memref.store %19, %arg2[%arg4] : memref<8xvector<16xi8>, 5>
      ...
      memref.store %35, %arg3[%arg4] : memref<8xvector<16xi8>, 5>
    }
    %4 = affine.for %arg4 = 0 to 8 step 4 iter_args(%arg5 = %cst_1) -> (vector<16xi32>) {
      %5 = arith.muli %arg4, %c16 : index
      %6 = affine.for %arg6 = 0 to 16 step 4 iter_args(%arg7 = %arg5) -> (vector<16xi32>) {
        %7 = arith.addi %5, %arg6 : index
        %8 = vector.transfer_read %arg2[%7], %cst_0 : memref<8xvector<16xi8>, 5>, vector<4xi8>
        %9 = vector.transfer_read %arg3[%7], %cst_0 : memref<8xvector<16xi8>, 5>, vector<4xi8>
