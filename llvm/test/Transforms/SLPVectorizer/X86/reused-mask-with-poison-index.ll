...
; CHECK-NEXT:    [[TMP17:%.*]] = phi float [ 1.000000e+00, [[TMP5]] ], [ [[TMP66:%.*]], %[[TMP56]] ]
...
; CHECK-NEXT:    [[TMP35:%.*]] = extractelement <4 x float> [[TMP25]], i64 0
; CHECK-NEXT:    [[TMP36:%.*]] = fsub float [[TMP17]], [[TMP35]]
; CHECK-NEXT:    [[TMP37:%.*]] = extractelement <4 x float> [[TMP25]], i64 1
