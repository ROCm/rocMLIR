// bin/rocmlir-gen -operation gemm -t f16 -out_datatype f32 --arch gfx950:sramecc+:xnack- --num_cu 256 -g 1 -m 384 -k 3072 -n 768  | bin/rocmlir-driver -c -arch gfx950:sramecc+:xnack- -mlir-print-ir-after-all -verify-passes
