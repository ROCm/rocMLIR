module {
func.func @mlir_slice_sigmoid_mul_convolution_broadcast_add_sigmoid_mul(%arg0: !migraphx.shaped<1x256x80x80xf16, 1638400x1x20480x256>, %arg1: !migraphx.shaped<128x128x3x3xf16, 1152x1x384x128>, %arg2: !migraphx.shaped<128xf16, 1>) -> !migraphx.shaped<1x128x80x80xf16, 819200x1x10240x128> attributes {arch = "gfx942:sramecc+:xnack-", kernel = "mixr", num_cu = 304 : i64} {
